...
<template>
  <div
    ...
    class=""
    :class="
      cn('container-style relative isolate container transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]',
         '',
      )
    "
      ...
      <div
        :class="
          cn(`
            ...
            rounded-md transition-transform delay-[var(--delay)]
      ...
      <div class="relative grid size-full items-center">
        ...
        <slot>
          <div
            ...
            <span
              class="
                absolute flex size-fit flex-wrap items-center pl-1 text-1 leading-none
                font-medium italic
              ">
              {{ text }}
            </span>
