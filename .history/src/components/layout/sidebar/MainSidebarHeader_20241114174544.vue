...
<template>
    <SidebarHeader>
        <SidebarMenu>
            <SidebarMenuItem
                :class="{
                    '!p-0': gs.sidebarState == 'collapsed justify-start',
                }">
                <DropdownMenu>
                    <DropdownMenuTrigger
                        as-child
                        class="justify-start px-0 py-3">
                        <SidebarMenuButton
                            variant="ghost"
                            size="md"
                            class="flex h-full shrink-0 flex-nowrap items-center gap-3 !border-0 !ring-0 focus:!border-0 focus:!outline-0 focus:!ring-1 focus:!ring-base-200">
                            <div
                                class="flex aspect-square h-8 w-auto shrink-0 items-center justify-center rounded-md bg-neutral text-neutral-content/90">
