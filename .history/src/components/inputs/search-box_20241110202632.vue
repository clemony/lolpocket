...
<div class="group/search peer relative flex items-center gap-2 self-center ">
    <Icon icon="teenyicons:search-outline" class="pointer-events-none absolute left-3 top-3 size-3.5 opacity-60" />

    <Input :placeholder="placeholder" :value="search" @input="handleInput" spellcheck="false"
        class="flex h-10 w-full rounded-md border border-input bg-transparent pl-9 pr-3 py-2 text-sm  file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-base-content/60 focus-visible:outline-none focus-visible:ring-1 hover:ring-1 focus-visible:ring-neutral/40 hover:ring-neutral/5    disabled:cursor-not-allowed disabled:opacity-50"
