...
<template>
    <div
        ...
        class="absolute grid size-9 shrink-0 place-items-center self-center rounded-full border border-base-200 bg-base-100/70 p-1.5 shadow-pretty backdrop-blur-sm"
        :class="
            cn(
                getShardClass(shard)
                    .toString()
