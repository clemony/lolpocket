...
<template>
    <Layout2 class="max-h-inhhert h-inherit" scroll :panel1Size="47">
        <template #panel1>
            <ScrollArea
        ...
        <template #panel2>
            <HeaderCard
                ...
                cardClass="inset-0 w-fit justify-self-end h-[calc(100%-135px)] max-h-[calc(100%-135px)] overflow-hidden pt-4 ml-8 mr-2 "
                headerClass="-ml-px">
                <template #header>
                    <div class="join">
                        <SearchBox
                            ...
                            class="h-10 justify-self-start bg-base-100/40 [&_input]:join-item [&_input]:!rounded-l-lg" />
