  ...
  abilities: [
    {
      ...
      affects: 'Enemies',
      blurb:
        'Innate: Feathers shot by  Xayah will linger in the ground at max range for a few seconds.',
      damageType: 'Physical damage',
      effectRadius: '1000',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Feathers shot by Xayah will linger and be planted in the ground at maximum range for 6 seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Xayah\'s ability casts generate 3 stacks of Clean Cuts, lasting for 8 seconds, refreshing on subsequent casts, and stacking up to 5 times. Xayah\'s basic attacks are empowered to each consume a stack on-attack to instead shoot a Feather that deals the triggering attack\'s damage to the primary target and 30% / 40% / 50% (based on level) AD physical damage to other enemies hit. The secondary target damage can critically strike for (175% + 40%) damage if the triggering attack does.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Lover\'s Leap:</span> If either Xayah or Rakan is channeling Recall, the other may move nearby and channel their own to join alongside them. Both reach base at the time of which the initiator\'s Recall completes.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Xayah barrages out two Feathers that each deal physical damage to enemies hit.',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Xayah barrages two Feathers in the target direction that each deal physical damage to enemies hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self, Rakan',
      blurb:
        'Active:  Xayah empowers herself for a few seconds, gaining  bonus attack speed and causing her basic attacks to strike a second time, dealing reduced damage.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Xayah enters a frenzy for 4 seconds, gaining bonus attack speed and empowering her basic attacks to fire an additional smaller feather at the target on-hit that deals 25% damage of the triggering attack\'s damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Xayah recalls all Feathers to shoot back to her, each dealing physical damage to enemies hit based on her  critical strike chance.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Xayah recalls all planted Feathers to shoot back to her, each dealing physical damage to enemies hit, increased by 0% - 75% (based on critical strike chance). Bladecaller deals 50% damage to minions.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      angle: '30°',
      blurb:
        'Active:  Xayah leaps into the air and briefly becomes  ghosted and  untargetable, then throws five Feathers in a cone in the target direction that each deal physical damage to enemies hit.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Xayah leaps into the air, becoming ghosted and untargetable for 1.5 seconds. After 1 second, she shoots 5 Feathers in a cone in the target direction that deal physical damage to enemies hit.</p>',
          leveling: [
            {
