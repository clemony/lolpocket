...
<template>
<LayoutSpacer />
<div v-if="champion" class="flex-col w-full gap-6 max-w-inherit">
    ...
    <TabListPocket :modelName="cTabs" :defaultTab="2" class='mt-8'>
        <!----------------------⟢ stats ⟣---------------------------->
        ...
        <Tab :value="2" class='max-w-inherit w-inherit'>
            <template #header>
        ...
        <!------------------------⟢ items ⟣------------------------->
        <Tab :value="3" class='w-full grow'>
            <template #header>
                <input type="radio" class="peer hidden" name="cTabs" value="abilities" v-model="cTabs" />
                <span class='grow'>AAAAAAAAAAAAAAAA;;</span>
            </template>
        ...
        <label role="tab" class='w-full grow'></label>
