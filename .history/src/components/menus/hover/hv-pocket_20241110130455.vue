...
<template>
<div class='max-w-48 [&_Button]:gap-3 [&_Button]:justify-start [&_Button]:w-full [&_span]:!text-sm [&_svg]:shrink-0'
    :key="props.type">
    ...
    <VDropdown theme="hoverdd" placement="right-start" :disabled="!ps.pockets.length" :overflowPadding="1000">
    ...
    <Button variant="ghost" size="xs" :disabled="data.length == 0" @click="data.length = 0">
        ...
        <span class='-ml-[2px] !text-sm'>Clear <span class='capitalize'>{{ props.type }}</span>
