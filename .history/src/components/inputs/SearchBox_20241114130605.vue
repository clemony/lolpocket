...
<template>
    <div :class="cn('join relative flex', props.class)">
        ...
        <input
            ...
            @input="handleInput"
            spellcheck="false"
            class="hover:ring-neutral/5disabled:cursor-not-allowed items-center gap-2 self-center rounded-md border border-base-200 focus-within:outline-none focus-within:ring-1 focus-within:ring-neutral/40 hover:ring-1 disabled:opacity-50"
