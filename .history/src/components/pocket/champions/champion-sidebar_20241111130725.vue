    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-8 items-center'>
            <div class='relative w-fit'>
                ...
                <div class='size-[75px]  join-item border-base-300 border grid place-items-center  overflow-y-hidden'>
                ...
                <div class='join-item join join-horizontal overflow-hidden h-9 inset-0 mt-3'>
