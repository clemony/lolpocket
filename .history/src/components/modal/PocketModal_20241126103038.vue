    ...
    <div class="carousel relative w-full justify-center py-2">
        <div ref="elForm" class="carousel-item w-full min-w-full">
            <form
                ...
                <div class="ml-px flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <button
                        ...
                        class="mt-4 aspect-square size-14 self-center rounded-full p-4 ring-neutral/80 hover:ring-1 hover:ring-offset-4">
            ...
            <div
                ref="elIcon"
                class="carousel-item grid w-full grid-cols-[1fr_4fr] justify-end">
