                    ...
                    <InfoCard title=" Starter Items" :key="props.pocket.key"
                        ...
                        <div class='flex flex-col max-h-inherit overflow-y-auto  mt-0 gap-5 px-7'>
                            <ItemsetModel :pocket="props.pocket" :model="props.model"
                                class='rounded-box bg-base-200/60 p-2 -ml-2.5  shadow-sm w-fit border border-base-200'>
                            ...
                            <TransitionGroup name="pop">
                                <label v-for="set in filter" v-close-popper
                                    ...
                                    <template v-if="set.items.length">
                                        ...
                                        <input for="set" type="radio" v-model="model"
                                            @change="emit('update:model', set)" :value="set" class="hidden" />
