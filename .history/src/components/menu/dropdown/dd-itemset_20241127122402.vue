                        ...
                        <InfoCard
                            ...
                            <div
                                ...
                                <ItemsetModel
                                    :pocket="props.pocket"
                                    :model="props.model"
                                    class="-ml-2.5 w-fit rounded-xl border border-base-200 p-2 shadow-xs">
                                    <input
                                        type="checkbox"
                                        :checked="true"
                                ...
                                <TransitionGroup name="fade">
                                    <label
                                        v-for="set in filter"
                                        v-close-popper
                                        class="sets -ml-2.5 flex w-fit cursor-pointer items-center gap-4 overflow-hidden rounded-xl border border-transparent p-2 hover:border-base-300 hover:shadow-xs"
                                        :key="set.key">
