    ...
    "Q": [
      {
        ...
        "effects": [
          {
            "description": "<span class=\"ability-header\">Active:</span> Bard fires an energy bolt in the target direction that deals magic damage to the first enemy hit and slows them by 60% for a duration.",
            "leveling": [
              {
    ...
    "W": [
      {
        ...
        "effects": [
          {
            "description": "<span class=\"ability-header\">Active:</span> Bard conjures a shrine at the target location that gathers power over 5 seconds and grants sight of its surroundings for 1.8 seconds. Shrines last until they are consumed by champions moving over them. Up to 3 shrines may be active at a time."
          },
          {
    ...
    "E": [
      {
        ...
        "effects": [
          {
            "description": "<span class=\"ability-header\">Active:</span> Bard opens a one-way magical corridor through a piece of terrain in the target direction for 10 seconds."
          },
          {
            "description": "A champion can pass through the corridor by selecting it, becoming revealed during the travel. Bard and allies travel through the portal at 33% increased speed."
          },
          {
            "description": "A nearby valid piece of terrain is required to cast this ability. Magical Journey cannot be taken while immobilized or grounded."
          }
        ],
        "cost": [
          30
    ...
    "R": [
      {
        ...
        "effects": [
          {
            "description": "<span class=\"ability-header\">Active:</span> Bard sends magical energy arcing to the target location, granting sight of the area during travel. Upon impact, it puts all units within into stasis for 2.5 seconds, as well as stunning all enemy champions, minions, and turrets struck for the same duration. Enemies hit are revealed for the duration."
          },
          {
