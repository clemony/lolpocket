...
<div v-if="champion" class="flex-col w-full gap-6 max-w-inherit h-full pr-[3px]">
    ...
    <TabListPocket :modelName="cTabs" :defaultTab="2" class='mt-8 relative' default-value="abilities">
        <!----------------------⟢ stats ⟣---------------------------->

        <Tab value="ability" class='ability max-w-inherit w-inherit'>
            <template #header>
