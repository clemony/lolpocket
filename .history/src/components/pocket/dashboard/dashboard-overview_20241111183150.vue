...
<div class='flex flex-col max-h-inherit gap-10 w-full' ref="card">
    ...
    <InfoCard title="Starter Items"
        ...
        cardClass="max-h-inherit relative w-fit pl-6 pt-3  pb-4 pr-12 has-[aria-expanded=true]:invisible has-[aria-expanded=true]:opacity-0 transition-all duration-500"
