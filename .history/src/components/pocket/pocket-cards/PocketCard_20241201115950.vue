            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                            ...
                            <div class="grid w-full px-3">
                                ...
                                <div class="relative flex pb-3">
                                    ...
                                    <div
                                        ...
                                        <div :class="cn('z-0 mt-2 flex gap-2')">
                                            <RuneSet
                                                :pocket="pocket"
                                                type="runes2" />
                                        </div>
                    ...
                    <div
                        ...
                        <div
                            class="flex gap-2 backdrop-blur-sm [&_>*]:grid [&_>*]:!aspect-square [&_>*]:size-11 [&_>*]:place-items-center [&_>*]:justify-start [&_>*]:rounded-full [&_>*]:bg-neutral/70 [&_>*]:text-neutral-content [&_>*]:shadow-sm [&_span]:hidden [&_svg]:mr-1">
                            <Button
                                @click="
