...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Lulu and  Pix each fire a magic bolt toward the target location, dealing magic damage and  slowing enemies hit for a short time.",
      castTime: "0.25",
      cooldown: "7",
      cost: "50 / 55 / 60 / 65 / 70",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lulu and Pix each fire a magic bolt towards the target point, each one dealing magic damage to enemies hit, reduced to 70% against minions, and slowing them by 80% decaying over 2 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lulu can cast Whimsy on herself or a champion.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Enemy Cast:</span> Lulu launches a spell onto the target enemy champion that polymorphs them into a harmless critter for a duration, during which their base movement speed is reduced by 60, and disarms them for the same duration.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Self / Ally Cast:</span> Lulu instantly casts erratic magic upon the target allied champion or herself, granting the target bonus attack speed and 25% (+ 5% per 100 AP) bonus movement speed for a duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lulu can cast Help, Pix! on herself or an ally or enemy.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Enemy Cast:</span> Lulu sends Pix to the far side of the target enemy for 4 seconds, dealing magic damage and revealing them for the same duration.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Self / Ally Cast:</span> Lulu sends Pix to the target ally for 6.25 seconds. If the target is a champion, they are granted a shield for 2.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      blurb:
        "Active:  Lulu enchants herself or the target allied champion,  knocking up surrounding enemies.",
      castTime: "none",
      cooldown: "120 / 100 / 80",
      cost: "100",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lulu enlarges herself or the target allied champion, knocking up nearby enemies for 1 second. For the next 7 seconds, the target gains bonus health and 40% increased size and slows nearby enemies, which lingers for 0.25 seconds.</p>',
          leveling: [
            {
      ...
      maxCharges: -1,
      notes:
        "Wild Growth's size increase scales additively with other size increases.",
      resource: "Mana",
      spellshieldable: "True",
      targeting: "Unit",
      targetRange: "900",
