...
<template>
    <div class="carousel relative w-full justify-center py-2">
        <div ref="elForm" class="carousel-item w-full min-w-full">
            <form
                ref="form"
                class="flex w-full min-w-full gap-16 py-4 [&_label]:text-base"
                ...
                <div class="flex flex-col">
                    <div class="flex flex-col gap-1">
                        ...
                        <button
                            ...
                            class="mb-3 mt-1 aspect-square size-14 self-center rounded-lg p-4 ring-neutral/80 hover:ring-1 hover:ring-offset-4">
                            <icon
                                :icon="selectedIcon"
