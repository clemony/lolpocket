...
const sidebarState = computed(() => {
    gs.sidebarState = ref(sidebar.state)
})
</script>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child class="py-3">
                        <SidebarMenuButton
                            variant="ghost"
                            size="md"
                            class="flex h-full flex-nowrap items-center gap-3 !border-0 pr-2.5 !ring-0 focus:!border-0 focus:!outline-0 focus:!ring-1 focus:!ring-base-200 data-[state=open]:shadow-sm data-[state=open]:!ring-1 data-[state=open]:!ring-base-300/40">
                            <div
                                class="flex aspect-square size-8 shrink-0 items-center justify-center rounded-md bg-neutral text-neutral-content/90 data-[state=collapsed]:-ml-1">
                                <h4>LP</h4>
                            </div>
