...
<template>
    <div class="grid grid-cols-[1fr_3fr] w-full gap-6 p-6 pl-10">
        ...
        <div class="grid grid-cols-1">
            <h1 class="font-semibold prose-lg divider divider-start">
                Interface
            </h1>
            ...
            <form
                ...
                <input
                    ...
                    :id="framework.name"
                    name="ui-framework"
                    class="shadow-inner radio radio-xs"
                    @change="handleFrameworkChoice" />
                <label :for="framework.name" class="w-24 m-1 rounded-lg">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="grid w-full h-10 grid-cols-5 grid-rows-3 rounded-btn">
                                <div
        ...
        <div
            ...
            <div class="mockup-browser-toolbar -ml-1.5">
                <div
                    class="input !bg-base-100 text-xs text content-center before:w-3 before:-mt-0.5 after:-mt-0.5 !ml-2">
        ...
        <div class="grid grid-cols-1 col-start-1 gap-y-4">
            <form
                ...
                class="items-center"
                @change="handleThemeChoice()">
                <div
                    class="content-center grid grid-cols-[1fr_5fr] justify-start col-start-1">
                    <input
                        type="radio"
                        v-model="themeChoice"
                        :value="theme.key"
                    ...
                    <label :for="theme.name">
                        <div
                            ...
                            <div
                                :data-theme="settings.dataMode + theme.key"
                                ...
                                <div
                                    class="bg-primary ring-offset-primary/60"></div>
                                <div
                                    class="bg-secondary ring-offset-secondary/60"></div>
                                <div
                                    class="bg-accent ring-offset-accent/60"></div>
                                <div
                                    class="bg-neutral ring-offset-neutral/60"></div>
