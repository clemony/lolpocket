...
<template>
    ...
    <div class="w-full py-4 pl-6 grid gap-y-3  m-0 !z-0">
        ...
        <div
            class="flex w-[110%]  overflow-x-scroll h-64 content-center items-center gap-5 scrollbar-hide left-0 !z-1 -ml-12 -mr-8 pl-12 transition-all duration-700 delay-200 news-after">
