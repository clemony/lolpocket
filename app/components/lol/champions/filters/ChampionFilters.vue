  ...
  >
    <div class="flex items-center gap-10">
      <div class="relative flex grow items-center gap-6">
        ...
        >
          <input v-model="filters.query" type="text" class="size-full" />
        </ExpandSearch>

        <h1 class="mr-1 text-9! tracking-tight">Champions</h1>

        <ChampionQuote
          as="p"
          class="flex items-center px-2 pt-1 font-serif text-3 tracking-wide text-nowrap dst"
        />
      </div>
