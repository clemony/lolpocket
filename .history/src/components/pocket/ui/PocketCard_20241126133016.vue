...
<template>
    <label class="swap swap-flip relative h-[300px] w-[250px] backdrop-blur-md">
        ...
        <Card
            class="swap-off relative grid h-inherit w-inherit justify-center overflow-hidden rounded-xl bg-transparent px-2">
            <div
            ...
            <CardContent
                ...
                <div class="size-full px-3">
                    ...
                    <div class="relative flex h-1/2">
                        <div
                            class="z-20 ml-4 mt-11 flex items-center justify-center [&_first-child]:!rounded-tl-full">
                            <Keystone :pocket="pocket" />
                        </div>
                        <div
                            class="ml-px h-fit flex-col items-center justify-start pl-8 pt-6">
                            <div
                                :class="
                                    cn(
                            ...
                            <div :class="cn('z-0 ml-7 mt-2 flex gap-3')">
                                <!--    <div
                                    v-if="set.secondary != ''"
                                    :class="
