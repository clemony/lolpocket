                ...
                <template #header>
                    ...
                    <div
                        ...
                        <InputEditable
                            ...
                            class="font-cursive hidden w-fit items-center truncate border-transparent text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200 @[230px]/set:flex">
                            <Button
                                variant="simple"
                                size="xs"
