...
export async function fetchSpells() {
  ...
  const patch = await import(resolve('./layers/patch/server/misc/raw/patch-index.json'))
  const outputPath = resolve('./layers/patch/server/spells/raw/spells-raw.json')
  const updatedPath = resolve('./layers/patch/server/spells/raw/spells-updated.ts')
