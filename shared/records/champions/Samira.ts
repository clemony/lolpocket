  ...
  abilities: [
    {
      ...
      blurb:
        "Innate:  Samira's different  basic attacks and damaging  abilities against enemy  champions generate a Style  stack, up to a cap.",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Samira\'s damaging basic attacks and abilities against at least one enemy champion different from the previous damaging hit made against champions generate a stack of Style for 6 seconds, refreshing on subsequent hits and stacking up to 6 times.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Style:</span> For each stack, Samira gains 2.75% / 3% / 3.25% / 3.5% (based on level) bonus movement speed, up to a maximum of 16.5% / 18% / 19.5% / 21% (based on level). At maximum stacks, Samira can cast Inferno Trigger.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Samira\'s basic attacks against targets within 200 units of her use her blade, becoming non-projectile. Blade attacks post-hit, Blade Whirl, Wild Rush, and the slash and explosives of Flair deal 2 - 19 (based on level) (+ 3.5% - 10.5% (based on level) AD) bonus magic damage, increased by 0% - 100% (based on target\'s missing health).</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Samira fires a shot in the target direction that deals physical damage to the first enemy hit.</p>',
          leveling: [
            {
        ...
        {
          description:
            "Flair can critically strike for (125% + 40%) damage and will apply life steal at 80% effectiveness.",
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Samira briefly spins her blade twice, dealing physical damage to nearby enemies each time. During this time, she destroys all incoming enemy  projectiles.",
      castTime: "0.1",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Samira spins her blade over 0.75 seconds, destroying all hostile non- turret projectiles within the area for the duration.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Self, Enemies",
      blurb:
        "Active:  Samira  dashes at the target enemy or enemy structure, dealing magic damage to enemies she passes through. She also gains  bonus attack speed for a short time.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Samira dashes a fixed distance in the direction of the target enemy or enemy structure, dealing magic damage to enemies she passes through. She also gains bonus attack speed for 5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Samira unleashes a torrent of shots, reducing her  movement speed and rapidly firing shots that deal physical damage to nearby enemies.",
      castTime: "none",
      cooldown: "5",
      cost: "0",
      damageType: "Physical damage",
