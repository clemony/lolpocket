                ...
                <DropdownMenu>
                    <DropdownMenuTrigger>
                        <SidebarMenuButton
                            ...
                            <div
                                class="text-4 grid flex-1 text-left leading-none">
                                <span class="text-5 truncate font-semibold">
                                    {{ userData.user.name }}
                                </span>
                                <span class="truncate">
                                    {{ userData.user.tag }}
                    ...
                    <DropdownMenuContent
                        class="shadow-standard! *:text-4 w-(--radix-dropdown-menu-trigger-width) min-w-56 rounded-lg backdrop-brightness-[97%]"
                        side="bottom"
                        align="end"
                        :side-offset="6">
                        <DropdownMenuLabel class="p-0 font-normal">
                            <div
                                class="text-2 flex items-center gap-2 px-1 py-1.5 text-left">
                                ...
                                <div
                                    class="text-2 grid flex-1 pt-[2px] text-left">
