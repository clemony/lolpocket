            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <Card
                        ...
                        <CardContent
                            class="relative h-full w-inherit items-center bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30% pt-1">
                            <CardHeader class="relative flex px-3 pb-1">
                                <CardTitle
                                    class="z-10 pb-0 !text-lg italic leading-none">
