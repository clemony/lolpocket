    ...
    <ListboxContent class="w-full space-y-3">
      ...
      >
        <CollapsibleTrigger as-child>
          <Button as="button" variant="ghost" class="w-full" size="md">
            <span
              class="grow text-4 font-semibold tracking-normal capitalize opacity-40 duration-0"
            >
              Tags
            </span>
            <CaretRotate />
        ...
        <CollapsibleContent menu class="CollapsibleContent space-y-1">
          <ListboxGroup class="relative flex flex-col justify-start gap-y-1">
            ...
            >
              ...
              <Button
                v-tippy="'Delete Tag'"
                variant="ghost"
                class="btn-square h-9 opacity-0 duration-0 not-hover:**:text-bc/60 group-hover/tag:opacity-100"
          ...
          <Button
            ...
            variant="base"
            hover="outline"
            class="group flex w-full flex-nowrap items-center gap-3! justify-self-center px-3 py-0 text-2 duration-0 focus-within:border-neutral/60 focus-within:[&_input]:placeholder:opacity-0"
          >
            <span class="z-1 grid h-full w-4.5 place-items-center bg-b1">
              <icon name="tag" class="size-4.5 opacity-50" />
            </span>
            <input
              v-model="newTag"
