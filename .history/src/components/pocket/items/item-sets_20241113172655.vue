    ...
    <VueDraggable
        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-1"
                :cardClass="{
                    'relative w-[calc(100%-48px)]  inset-0 before:absolute before:bg-transparent before:border  before:w-full before:h-full  before:pointer-events-none before:border-transparent before:z-50  mx-[24px] before:rounded-box':
                        set,
                ...
                <template #header>
                    ...
                    <div
                        ...
                        <InputEditable
                            ...
                            class="w-fit items-center truncate border-transparent text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200">
                            <Button
                                variant="simple"
                                size="xs"
                    ...
                    <label
                        class="ml-3 aspect-square shrink-0 rounded-full ring-base-300 hover:ring-1 focus:ring-1">
                        <input
                            type="radio"
                            name="itemset"
                        ...
                        <img
                            ...
                            class="aspect-square size-5.5 shrink-0 opacity-20" />
                    </label>
                </template>
