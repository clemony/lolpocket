    ...
    <SidebarHeader>
        <SidebarMenu
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            variant="ghost"
                            size="lg"
                            class="group/lol [&] flex size-full shrink-0 flex-nowrap items-center gap-3 rounded-none !border-0 pb-2 pt-3 ring-0 hover:bg-transparent focus:!border-0 focus:!outline-0 active:!bg-transparent active:hover:!bg-transparent"
                            ...
                            <span
                                class="mt-px text-lg font-semibold underline-offset-4 opacity-80 group-hover/lol:underline group-[data-state=open]:underline">
                                lolpockets
                            </span>
                            <icon
            ...
            <SidebarMenuItem class="mx-2">
                <SidebarMenuButton
                    class="hover-ring-neutral/60 relative h-9 w-full items-center justify-start border border-base-300/80 bg-base-100/50 px-2 hover:border-base-300 hover:bg-base-100/60 hover:ring-1"
                    :class="{
