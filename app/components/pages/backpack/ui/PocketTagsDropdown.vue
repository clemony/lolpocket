...
<template>
  ...
  <Popover v-model:open="open">
    ...
    <LazyPopPopoverContent
      ...
      <div
        class="relative pt-2 w-54 px-3 h-10 group gap-3 flex items-center w-full">
        <icon
          name="lucide:tags"
      ...
      <Separator />
      <div
        class="max-w-54 overflow-x-hidden max-h-55 pb-2 px-0.5 pt-1 overflow-y-auto grid">
        <!-- tags -->
        <Label
