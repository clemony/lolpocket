    ...
    <PopoverPortal>
        <PopoverContent
            ...
            <PopoverClose
                ...
                <PopoverContent
                    class="relative h-fit max-h-fit rounded-box! border-none bg-transparent p-0 px-7 py-5 shadow-xs"
                    align="start"
                    :align-offset="-34"
                    side="bottom"
                    :side-offset="-146"
                        ...
                        <InfoCard
                            ...
                            <div
                                ...
                                <ItemsetModel
                                    :pocket="props.pocket"
                                    :model="props.model"
                                    class="-ml-2.5 w-fit rounded-box border border-b2 p-2 shadow-xs">
                                    <input
                                        type="checkbox"
                                        :checked="true"
                                ...
                                <TransitionGroup name="fade">
                                    <label
                                        v-for="set in filter"
                                        v-close-popper
                                        class="sets -ml-2.5 flex w-fit cursor-pointer items-center gap-4 overflow-hidden rounded-box border border-transparent p-2 hover:border-b3 hover:shadow-xs"
                                        :key="set.key">
