    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <div
                ...
                <InfoCard
                    cardClass=" h-[350px] w-[250px]  bg-transparent backdrop-blur-none animate-in slide-in-from-top delay-400 transition-all duration-400
                    
                    before:bg-gradient-to-b  before:from-base-100/40  before:from-0%  before:via-base-100/70  before:to-base-100 to-30% before:w-full before:h-200% before:absolute before:top-0 before:left-0 before:z-10"
                    :class="{
                        '': flip,
                        '': !flip,
                    }">
