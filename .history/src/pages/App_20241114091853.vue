...
<template>
    ...
    <div 
        ...
        @shortkey="gs.toggleModalState(commandModal)" class="open-command">
    </div>

    <Modal v-model:open="gs.modalState" v-model:modal="gs.modal" />
    <Titlebar />
    <Toaster />
    <SidebarProvider>
        <Sidebar collapsible="icon" class="justify-center">
            <MainSidebarHeader
                ...
                v-model:modal="gs.modal"
                @update:state="gs.toggleModalState(gs.modal)" />
            ...
            <div
                ...
                <router-view v-slot="{ Component }">
                    <KeepAlive
                        ...
                        <component :is="Component" ref="currentComponent" @update:modalState="(modal) => gs.toggleModalState(modal)"/>
                    </KeepAlive>
                </router-view>
            </div>
        </SidebarInset>
