...
<template>
  ...
  <div data-tauri-drag-region
    class="titlebar top-0 left-0 h-[36px] w-full backdrop-blur-md bg-base-100/60 grid grid-cols-3 fixed z-20 p-[0px] items-center  border-b-[1px] border-base-content/10 shadow-xl">
    ...
    <div
      ...
      <label
        class="place-content-center swap swap-flip w-10 text-base-content/80 tooltip tooltip-bottom before:text-xs before:font-normal before:left-[75%] "
  ...
  <div ref="menuRef" id="menu"
    ...
    <News v-if="isHome" class="pl-[300px] !overflow-x-scroll" />
    ...
    <div class="w-full h-screen m-0 p-0 z-0 pt-14 col-start-2 overflow-scroll pointer-events-none">
