                    ...
                    <img
                        ...
                        :src="
                            pocket.runes[0].runeSets[pocket.runes[0].starred]
                                .keystone.img
                        "
                        class="mask absolute h-auto w-1/2 rounded-full opacity-95 mask-b-2 mask-l-24 mask-r-6 mask-t-20" />

                    <div class="flex" v-if="set">
                        <template v-for="rune in runes">
                            <div class="c grid items-center justify-center">
                                <LoadRune
                                    v-if="rune.name != 'none'"
                                    :url="rune.img"
                                    class="size-[35px]" />
                                <PlCircle v-else :size="35" />
                            </div>
                        </template>
                    </div>
                </div>
