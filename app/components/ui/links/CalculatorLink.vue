...
<template>
  <NuxtLink to="/calculator">
    <Btn v-tippy="!us.sidebarExpanded ? 'Calculator' : null">
      <IconWrapper name="teenyicons:calculator-outline" class="size-4 -top-px" :class="{ 'top-0 left-0.5': !us.sidebarExpanded }" />
