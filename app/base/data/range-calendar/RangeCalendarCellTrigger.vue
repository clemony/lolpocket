  ...
  <RangeCalendarCellTrigger
    :class="cn(
      ...
      `
        ...
        data-[selection-end]:hover:bg-neutral data-[selection-end]:hover:text-nc
        data-[selection-end]:focus:bg-neutral data-[selection-end]:focus:text-nc
      `,
      // Outside months
      `
        data-[outside-view]:text-bc/50 data-[outside-view]:opacity-50
        [&[data-outside-view][data-selected]]:bg-b2/50
