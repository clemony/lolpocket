...
const baseVariants = tv({
  variants: {
    ...
    /* base */
    base: {
      btn: 'btn focus:outline-0 focus-visible:outline-0 focus-visible:ring-0 data-[state=active]:btn-active data-[state=checked]:btn-active group-data-[state=open]:btn-active data-[state=open]:btn-active has-[first:[&_svg]]:gap-3 has-not-[span:empty]:gap-2 text-start data-[state=open]:btn-active has-[span:empty]:gap-0  [&_svg]:inline-flex align-middle text-3 font-normal items-center disabled:opacity-80 flex',
