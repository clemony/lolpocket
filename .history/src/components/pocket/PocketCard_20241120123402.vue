...
<template>
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            class="swap-off relative grid h-[320px] w-[230px] max-w-[230px] justify-center overflow-hidden rounded-box bg-transparent px-2">
            <div
            ...
            <CardContent
                ...
                <div class="flex w-full gap-2">
                    <div
                        class="-mt-5 w-[47%] max-w-[47%] items-center justify-center space-y-3">
                        <div class="size-fit justify-self-center">
                        ...
                        <div class="flex h-fit w-full justify-center gap-2">
                            <ShardSet :pocket="pocket" />
                        </div>
                    </div>
                    <div class="flex w-[53%] max-w-[53%] flex-col gap-3">
