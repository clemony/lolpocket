...
<VueDraggable v-if="pocket" tag="div" v-model="pocket.items[0].itemSets" :delay="0" :animation="300"
    ...
    <Card
        class='h-[60px] items-center grid justify-center bg-base-200/10 opacity-60 !shadow-inner transition-all duration-500 cursor-pointer hover:opacity-100 hover:!shadow-sm hover:bg-transparent '
        @click="">
