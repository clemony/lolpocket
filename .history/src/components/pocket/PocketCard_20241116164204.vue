                    ...
                    <div
                        ...
                        <template v-for="(item, index) in items" :key="item.id">
                            <Item
                                ...
                                :item="item"
                                :pocket="pocket"
                                class="size-14 rounded-box shadow-warm" />
                        </template>
                    </div>

                    <div
                        v-if="set"
                        class="col-start-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-items-center gap-x-1 gap-y-2">
                        <div class="max-size-full max-h-[40px]">
                            <img
                                ...
                                "
                                class="-mt-1.5 size-[55px] object-cover object-top" />
                        </div>
                        <template v-for="rune in runes">
                            <div class="rounded-full shadow-warm">
                                <LoadImg
                                    v-if="rune.name != 'none'"
                                    :url="rune.img"
                                    class="col-start-1 size-[45px] rounded-full" />
                                <PlCircle
                                    v-else
                                    :size="45"
