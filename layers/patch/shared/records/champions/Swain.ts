  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: '<p class="ability-effect"><span class="ability-header">Recast:</span> Swain pulls the rooted champions over 290 units and collects a Soul Fragment from each of them, revealing himself for 5 seconds. If the targets would be pulled past Swain, they rebound off of him instead, knocking them back the excess distance.</p>'
        }
      ]
    },
    {
      ...
      effects: [
        ...
        {
          description: 'After 2 seconds, Swain gains the ability to cast Demonflare, up to 100 times, and does so automatically when Demonic Ascension expires if Demonflare is not on cooldown.'
        },
        {
