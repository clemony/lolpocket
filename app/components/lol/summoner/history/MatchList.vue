...
<template>
  <div class="flex w-full flex-col overflow-visible py-24">
    ...
    <div v-else class="grid h-64 w-220 place-items-center font-medium">
    ...
    >
      <PaginationContent v-slot="{ items }">
        ...
        <PaginationPrev size="sm" class="btn-square disabled:hidden" />
        ...
        <PaginationNext size="sm" class="btn-square disabled:hidden" />
