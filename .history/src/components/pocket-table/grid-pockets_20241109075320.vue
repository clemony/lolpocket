...
<template>
<div class='w-full top-32 h-10 bg-base-100/90 backdrop-blur-md absolute z-10'>
    <ag-grid-vue :theme="pocketTheme" class="h-full items-center !rounded-none bg-transparent " ref="headerGrid"
        @grid-ready="onHeaderReady" :columnDefs="columnDefs" :gridOptions="headerOptions" :rowData="noData"
        ...
        :isFullWidthRow="isFullWidthRow" :pinnedTopRowData="pinnedPinnedTopRowData" :fullWidthCellRenderer="TableHeader"
