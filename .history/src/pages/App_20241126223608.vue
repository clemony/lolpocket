...
<template>
    ...
    <main
        ...
        :key="state"
        :class="{
            'backdrop-brightness-50 before:absolute before:left-0 before:top-0 before:h-screen before:w-screen before:bg-red-700 before:transition-all before:duration-500 before:animate-in before:fade-in-0':
                state == 'open',
        }">
        <div
            v-if="state == 'open'"
        ...
        <label>
            ...
            <SidebarProvider
                ...
                :class="{
                    'scale-75 overflow-hidden rounded-xl bg-base-100/90':
                        state == 'open',
                }">
                <Sidebar
                    collapsible="icon"
