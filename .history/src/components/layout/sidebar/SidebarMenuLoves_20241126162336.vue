...
let previousFavoritesChamps = [...toRaw(cs.favoriteChamps)] // Initial copy of the champions array
...
let previousFavoritesItems = [...toRaw(is.favoriteItems)] // Initial copy of the array
