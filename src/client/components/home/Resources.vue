...
<template>
    <Collapsible class="group" :default-open="true">
        <ul
            ...
            <CollapsibleTrigger class="flex justify-start gap-4" as-child ref>
                ...
                <li v-for="link in group.links">
                    <Button
                        ...
                        <a
                            ...
                            <div
                                class="grid size-6 place-items-center overflow-hidden">
                                <div
                                ...
                                <div
                                    ...
                                    class="size-6">
                                    <logo-league
                                        class="absolute top-0.5 left-5 size-8" />
                                </div>
                                    ...
                                    <icon
                                        ...
                                        :class="{
                                            '-mt-px size-7':
                                                link.name == 'Wiki',
                                            'size-6.25':
                                                link.name == 'Dev Updates',
                                            'size-5.5 !overflow-hidden rounded-t-md rounded-b-sm object-center':
                                                link.name == 'League of Graphs',
                                        }" />
                                </div>
                            </div>
