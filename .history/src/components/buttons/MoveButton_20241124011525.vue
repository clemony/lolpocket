...
<template>
    <Button
        ...
        class="join-item relative w-14">
        <slot />

        <div
            v-if="ps.selectedRows.length"
            class="pointer-events-none absolute grid aspect-square size-3.5 place-content-center place-items-center rounded-full bg-neutral text-neutral-content">
            {{ selectedCount }}
        </div>
    </Button>
</template>
