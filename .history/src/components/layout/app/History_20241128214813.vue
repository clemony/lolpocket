    ...
    <div
        ...
        <div
            ...
            <label
                ...
                <SidebarProvider
                    class="page relative size-full overflow-hidden rounded-2xl bg-base-100/95 transition-all duration-300 animate-in animate-out zoom-in-[0.75] zoom-out-0 slide-in-from-top-0 [animation-fill-mode:forwards]"
                    :class="
                        cn({
                            /*base */
