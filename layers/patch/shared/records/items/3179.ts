// Updated Patch 16.1 - 02/13/2026 11:21:52 PM CST
  ...
  "passives": [
    ...
    },
    {
      ...
      "mythic": false,
      "name": "Nightstalker",
      "effects": "After being not <img src=\"/img/icons/sight.webp\" class=\"tip-icon light:invert\" />visible to enemies for at least 1 second, your next basic attack against a champion is empowered to deal 50 (+1.5 per 1 Lethality) <b>bonus</b> true damage on-hit. The empowered attack lasts for 4 seconds after being seen by an enemy."
    }
  ],
  "stats": {
    "attackDamage": 60,
