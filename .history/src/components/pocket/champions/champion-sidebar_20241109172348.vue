        ...
        <CardHeader class='flex flex-row gap-8 items-center'>
            ...
            <div class="flex flex-col w-full h-full *:shrink-0">
                ...
                <Button variant="outline" size="icon"
                    class="group/liked absolute right-6 top-5 shadow-md [&_svg]:absolute !apsect-square rounded-full [&_svg]:transition-all [&_svg]:duration-500 [&_svg]:pt-px [&_svg]:size-4.5"
