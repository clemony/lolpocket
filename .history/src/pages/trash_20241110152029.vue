...
<div class="h-full w-full px-3 py-4">
    <div class="mb-4 grid h-fit w-full gap-4 px-4">
        <div class="flex items-center gap-3">
            ...
            <button class="btn btn-neutral btn-sm relative  hover:opacity-80">
                <icon v-if="ps.trashPockets.length > 0" icon="ant-design:fire-outlined" class="size-6" />
                <icon v-else icon="ant-design:fire-outlined" class="size-4" />
