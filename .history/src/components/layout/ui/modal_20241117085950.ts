...
export const editPocketModal:modal = {
        ...
        id: 'editPocket',
        title: 'Edit Pocket',
description: 'Some mistakes you <em>can</em> make twice. For those trying times of pure necessity and through intense struggle, you can <strong>update</strong> your Pocket information here.',
submitText: 'Finish',
}