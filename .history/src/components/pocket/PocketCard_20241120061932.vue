        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        class="relative col-start-2 row-start-2 flex h-full flex-col items-end justify-center gap-1.5 px-2 [&_:nth-child(2)]:absolute [&_:nth-child(2)]:right-5">
                        <div
                            v-for="shard in set.shards"
                            :key="shard.name + shard.slotID"
                            class="size-9 rounded-full border border-base-200/95 p-1 shadow-sm"
                            :class="
