        ...
        <Card class="shadow-smooth">
            <CardContent class="h-36 overflow-hidden rounded-lg p-0">
                ...
                <div
                    ...
                    <p
                        class="items-center whitespace-pre-line text-pretty px-12 align-middle font-serif text-lg italic tracking-wide [text-align-last:right] first-letter:font-bold first-letter:not-italic">
                        {{ formattedQuote() }}
                    </p>
                </div>
            </CardContent>
