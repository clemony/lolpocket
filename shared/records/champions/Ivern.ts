...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Ivern throws a vine in the target direction that deals magic damage and  roots the first enemy hit.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ivern throws a vine in the target direction, dealing magic damage to the first enemy hit and rooting them for a duration, during which they are also revealed. Rootcaller can be recast while the target is rooted.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Ivern dashes to the rooted target.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Self, Allies",
      blurb:
        "Passive: While  Ivern is in  brush, his basic attacks deal bonus magic damage.",
      castTime: "0.25",
      cooldown: "0.5",
      cost: "30",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> While Ivern is in brush, his basic attacks are empowered to deal bonus magic damage on-hit. This bonus persists for 3 seconds after leaving brush.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ivern grows a patch of brush at the target location for 45 seconds, granting sight of the area within and around it for 8 seconds. Brushes despawn instantly after allied vision of them is lost. Spawning brush near terrain or other brush increases its radius.</p>',
        },
        {
          description:
            "While allied champions are in any brush when Ivern is within 1000 units, their basic attacks are empowered to deal bonus magic damage on-hit. This bonus persists for 1.5 seconds after leaving brush.",
          leveling: [
            {
    ...
    },
    {
      ...
      blurb:
        "Active:  Ivern can target an ally champion,  Daisy, or himself to  shield them for a short time.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ivern places a seed on the target allied champion, Daisy, or himself, granting the target a shield for 2 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "None",
      blurb:
        "Active:  Ivern summons his Sentinel friend  Daisy to fight with him.",
      castTime: "0.5",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ivern summons his sentinel friend Daisy to his side, who lands 350 units away from him in the target direction and remains on the field for up to 45 seconds as a controllable pet.</p>',
        },
        {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast - Daisy, wait!:</span> Ivern commands Daisy to move to the target location. If cast on Ivern, Daisy will follow him.</p>',
        },
        {
          description:
