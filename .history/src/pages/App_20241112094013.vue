                            ...
                            <SidebarMenuButton tooltip="Pockets" class='gap-4 group/pocket'
                                ...
                                <SidebarMenuBadge>
                                    <Badge variant="primary" size="sm" v-if="ps.pockets && ps.pockets.length"
                                        class='absolute right-2 group-hover/pocket:opacity-60 px-1.5'>
                                        {{ ps.pockets.length }}
                                    </Badge>
                                </SidebarMenuBadge>
                                            ...
                                            <div class='flex items-center'>
                                                ...
                                                <SidebarMenuBadge>
                                                    <Badge variant="secondary" size="sm"
                                                        ...
                                                        class='absolute px-1.5 right-0 group-hover/pocket:opacity-60'>
                                                        {{ item.array.length }}
                                                    </Badge>
                                                </SidebarMenuBadge>
                    ...
                    <SidebarMenuItem class='mt-1'>
                        <SidebarMenuButton as-child>
                            <a @click="sn.navigateTo('/loved')" class='gap-4 py-5'>
                                <icon icon="qlementine-icons:heart-16" class='!size-5' />
