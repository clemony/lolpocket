...
<template>
    <VueDraggable
                ...
                <template #header>
                    ...
                    <div
                        ...
                        <InputEditable
                            ...
                            class="focus-within:border-base-200 hover:border-base-200 hidden w-fit items-center truncate border-transparent text-start align-baseline text-base! font-medium capitalize transition-all duration-300 @[230px]/set:flex">
                            <Button
                                variant="simple"
                                size="xs"
        ...
        <Card
            class="bg-base-200/10 mb-12 grid h-[60px] w-[calc(100%-48px)] cursor-pointer items-center justify-center opacity-60 shadow-none transition-all duration-500 hover:bg-transparent hover:opacity-100 hover:shadow-xs!"
...
.ghost {
    @apply bg-base-200 m-4 w-[96%] rounded-xl;
}
</style>
