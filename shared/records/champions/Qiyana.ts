  ...
  abilities: [
    {
      ...
      affects: 'Enemies',
      blurb:
        'Innate:  Qiyana\'s  basic attacks and  basic abilities deal bonus physical damage.',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Qiyana\'s basic attacks and basic abilities deal 15 - 83 (based on level) (+ 30% bonus AD) (+ 30% AP) bonus physical damage. This effect cannot occur on the same target more than once every few seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Qiyana slashes forward in the target direction, dealing physical damage to enemies in a line, reduced to 75% damage against targets beyond the first. Edge of Ixtal deals 175% damage against monsters.</p>',
          leveling: [
            {
      ...
      notes:
        'If cast during  Audacity and the target uses a dash or blink or is no longer in vision, Edge of Ixtal will aim at the target\'s last location prior to them starting the dash or blink or being in vision.\nThis ability will cast from wherever the caster is at the end of the cast time.',
      projectile: 'FALSE',
      resource: 'Mana',
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Qiyana hurls her blade in the target direction that blasts in a line upon hitting an enemy or maximum range, consuming the current Element to empower the blade with an additional effect.</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Brush:</span> The blade creates a grass field around Qiyana that lasts for up to 3 seconds, granting her invisibility and 20% bonus movement speed until she attacks, casts an ability other than Terrashape, or exits the field.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">River:</span> The blast roots enemies hit for 0.5 seconds, then slows them by 20% for 1 second.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Terrain:</span> The blast deals 60% increased damage against enemies below 50% of their maximum health. Subsequent targets beyond the closest that are below the threshold take 35% increased damage instead.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Passive: While holding an Element,  Qiyana gains bonus  attack speed and  attack range, as well as bonus magic damage on her basic attacks and basic abilities. Qiyana gains  bonus movement speed speed while moving near the current Element.',
      castTime: 'none',
      cooldown: '7',
      cost: '25 / 30 / 35 / 40 / 45',
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Qiyana dashes up to 300 units towards the target location to gather the Element of the nearest Brush, River or Terrain she targeted.</p>',
        },
        {
    ...
    },
    {
      ...
      affects: 'Enemies, Self',
      blurb:
        'Active:  Qiyana  dashes toward the target enemy and deals physical damage upon arrival.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Qiyana dashes a fixed distance in the direction of the target enemy. If they are in range upon arrival, she deals physical damage.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
    ...
    },
    {
      ...
      blurb:
        'Active:  Qiyana sweeps a windblast in the target direction that  knocks back enemies hit and stops upon hitting Terrain.',
      castTime: '0.25',
      cooldown: '120',
      cost: '100',
      damageType: 'Physical damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Qiyana sweeps a windblast in the target direction that knocks back enemies hit by 375 units, though not through terrain, and stops upon hitting Terrain.</p>',
        },
        {
          description:
