 export const Vladimir: Champion =  {
  "id": 8,
  "key": "Vladimir",
  "name": "Vladimir",
    ...
    "Q": [
      {
        ...
        "effects": [
          ...
          {
            "description": "At 2 points of Crimson Rush, Vladimir surges, gaining 10% / 20% / 30% / 40% (based on level) bonus movement speed for 0.5 seconds while the Crimson Rush depletes over 2.5 seconds. Crimson Rush depletes 75% slower during Sanguine Pool, Tides of Blood, or stasis."
          },
          {
