  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Evelynn shrouds herself in Demon Shade after not performing actions that break stealth for 4 seconds. Attacking or casting abilities ends Demon Shade immediately and places it on a 4-second static cooldown, reduced to 1.25 seconds from casting Last Caress. Taking damage from champions or turrets interrupts Demon Shade and places it on a 1.5-second static cooldown.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Demon Shade:</span> While below 250 - 590 (based on level) (+ 250% AP) health, Evelynn heals herself for 15 - 150 (based on level) every second. From level 6 onward, Demon Shade also grants camouflage.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Evelynn fires her Lasher, dealing magic damage to the first enemy hit and marking them. Evelynn\'s next few attacks against the marked target will deal bonus magic damage.',
      castTime: '0.3',
      cooldown: '4',
      cost: '40 / 45 / 50 / 55 / 60',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Evelynn launches a dart in the target direction, dealing magic damage to the first enemy hit and marking them for 4 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Evelynn unleashes a line of deadly spikes in the direction of the nearest visible enemy that deals magic damage to all enemies struck.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Evelynn curses the target enemy, causing her next attack against the target to expunge the curse,  slowing the target and refunding the  mana cost.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Evelynn curses the target enemy champion or medium or large monster for 5 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Evelynn whips the target enemy, dealing magic damage based on the target\'s maximum health and applying  on-hit effects. She then gains  bonus movement speed for a short time.',
      castTime: '0.25',
      cooldown: '8',
      cost: '40 / 45 / 50 / 55 / 60',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Evelynn whips the target enemy with her lashers, dealing magic damage and applying on-hit effects.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Evelynn casts Whiplash,  dashing to the target enemy and dealing  increased damage to them and enemies she passes through.',
      cooldown: '8',
      cost: '40 / 45 / 50 / 55 / 60',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Evelynn dashes toward the target enemy with her lashers, dealing increased damage to them upon completion as well as to all enemies within her path.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            'Last Caress is empowered to deal 240% damage against enemies below 30% of their maximum health.',
          leveling: [
            {
