...
<template>
    ...
    <main
        ...
        class="wrapper size-full overflow-hidden"
        :key="state"
        :class="{
            '': state == 'open',
        }">
        <div
            data-tauri-drag-region
            v-if="state == 'open'"
            class="command margin-auto z-[100] mt-24 overflow-hidden rounded-lg delay-100 animate-in animate-out fade-in-0 slide-in-from-bottom-2/3">
            <Command />
        </div>
