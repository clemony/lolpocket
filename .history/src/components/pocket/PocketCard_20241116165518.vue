        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        v-if="set"
                        class="col-start-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-center justify-items-center gap-x-2 gap-y-2">
                        ...
                        <template v-for="rune in runes">
                            <div class="rounded-full">
                                ...
                                <PlCircle
                                    v-else
                                    :size="40"
                                    class="pl bg-base-200/60 shadow-inner" />
                            </div>
                        </template>
                    </div>
                </div>
