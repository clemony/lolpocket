...
<template>
    <div
        ...
        <InfoCard
            cardClass="card h-[350px] w-[250px]  before:absolute before:size-full bg-transparent backdrop-blur-none bg-gradient-to-b from-transparent from-0% to-base-100 to-25%">
            <template #header>
