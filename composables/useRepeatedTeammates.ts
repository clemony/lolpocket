...
export function useRepeatedTeammates(currentName: string, options?: { delayUntilReady?: Ref<boolean> }): {
  repeatedTeammates: Ref<Teammate[]>
  topBayesianTeammates: Ref<Teammate[]>
} {
