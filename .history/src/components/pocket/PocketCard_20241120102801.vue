    ...
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    class="max-w-inherit mt-2 grid w-full grid-cols-[2.5fr_1fr] items-center gap-x-3 gap-y-5 px-2">
                    <div
                        class="mt-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-between gap-1 pr-2">
                        <MiniItemGrid :pocket="pocket" />
                    </div>
                    <div
                        class="mt-1 grid h-fit w-full items-start justify-between gap-3 pr-2">
                        <SpellDisplay :pocket="pocket" />
                    </div>
                    <div
                        class="flex h-fit w-full flex-row items-center justify-items-center gap-x-2.5 gap-y-2 p-1.5">
                        <RuneSet :pocket="pocket" class='flex flex-row'>
                    </div>
