...
<template>
    <div class="mt-48 size-full pl-4">
        <Collapsible v-model:open="pinIsOpen" class="w-full">
            <CollapsibleTrigger
                class="group flex w-full items-center gap-3 pl-3 text-start">
                <icon
        ...
        <Collapsible v-model:open="genIsOpen" class="w-full">
            <CollapsibleTrigger
                class="flex w-full items-center gap-3 pb-3 pl-3 text-start">
                <icon icon="teenyicons:right-small-outline" class="size-6" />
