    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <div
                ...
                <InfoCard
                    cardClass=" h-[350px] w-[250px]  bg-transparent backdrop-blur-none bg-gradient-to-b from-base-100/40 from-0% to-base-100 via-base-100/70 to-30% animate-in fade-in-0 animate-out duration-500 fade-out-0">
                    <template #header>
                        <h2 class="mt-6">
                            {{ pocket.name }}
                        </h2>
