    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <Card
                ...
                <div
                    class="duration-400 h-200% transition-translate absolute left-0 z-10 h-[200%] w-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100 to-30% delay-700"
                    :class="{
                        '-top-[100%]': flip,
                        '-top-[30%]': !flip,
                    }" />
