                ...
                <label
                    ...
                    <Card
                        ...
                        <CardContent
                            ...
                            <div
                                class="relative flex w-full justify-center !overflow-hidden ring-1 ring-base-300 ring-offset-2 ring-offset-base-100">
                                <div
                                    class="masking"
                                    :class="
                                        cn(
                                            'z-0 h-60 w-[94%] !overflow-hidden rounded-lg',
                                            {
                                    ...
                                    <div
                                        class="size-full bg-[55%_0%] bg-no-repeat [background-size:200%]"
                                        :style="layer1" />
                                </div>
                            </div>
                            <CardRuneset
