    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <Card
                ...
                <div
                    v-if="!flip"
                    class="h-200% duration-400 absolute left-0 z-10 h-[200%] w-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100 to-30% transition-all delay-200 animate-in slide-in-from-top-24" />
                <CardContent v-if="!flip" class="z-20">
                    <CardHeader
        ...
        <Transition
            ...
            <Card
                v-if="flip"
                class="absolute h-[350px] w-[250px] overflow-hidden"></Card>
        </Transition>
    </label>
</template>
