...
const pageStyles = computed(() => {
    return gs.commandOpen ? pageStyle : ''
})
</script>
<template>
    <div
    ...
    <div
        ...
        :style="targetStyle"
        v-show="gs.commandOpen"
        class="absolute top-[38%] size-full items-end justify-center">
        <div
            :style="containerStyle"
            class="inset-0 m-0 flex size-full flex-col items-center justify-center -space-y-[42%]">
            <div
    ...
    <label class="flex justify-center overflow-hidden rounded-xl">
        <input
            type="checkbox"
        ...
        <SidebarProvider
            class="page overflow-hidden rounded-2xl bg-base-100/95 animate-in zoom-in-[0.75] slide-in-from-bottom-3/4"
            :class="{
                'absolute z-10 bg-base-100 shadow-[rgba(0,_0,_0,_0.2)_0px_30px_90px,_2px_1px_1px_2px_rgba(221,_221,_221,_0.4),_0_2px_5px_rgba(204,_204,_204,_0.4)] animate-out zoom-out-[0.75] slide-out-to-bottom-1/2 after:absolute after:z-50 after:size-full after:bg-black/5':
                    gs.commandOpen,
            }">
            <slot />
        </SidebarProvider>
