  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Yunara\'s critical strikes deal 10% (+ 10% per 100 AP) bonus magic damage.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yunara launches a spinning prayer bead in the target direction that briefly grants sight of its surroundings as it travels. The bead slows down significantly while colliding with an enemy, lingering as it travels and resetting its remaining duration; upon reaching maximum range, it will expand and linger in place for 1 second regardless of enemies hit.The initial hit against each enemy before the bead\'s expansion deals magic damage and slows them by 99% decaying over 1.5 seconds. While lingering, the bead deals magic damage to nearby enemies every 0.25 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            'Arc of Judgment deals 50% / 75% / 100% (based on level) damage against minions and executes them if they would be killed by 6 more damage instances from the linger effect.',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yunara fires a beam of spirit magic in the target direction that deals 50 / 200 / 350 (based on Transcend One\'s Self\'s Rank) (+ 175% AD) (+ 75% AP) magic damage to enemies hit and slows them by 99% decaying over 1 second, as well as granting sight of the surrounding area.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Yunara briefly becomes  ghosted and gains decaying  bonus move speed, increased while facing an enemy  champion.',
      castTime: 'none',
      cooldown: '9',
      cost: '40',
      effectRadius: '2000',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yunara becomes ghosted and gains bonus movement speed decaying over a few seconds. The movement speed is 50% more effective while facing a nearby visible enemy champion.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yunara dashes in the target direction.Untouchable Shadow resets Yunara\'s basic attack timer. Arc of Ruin can be cast during the dash. This ability benefits from ultimate ability effects and is the upgraded version of Kanmei\'s Steps during Transcendent State.</p>',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/Yunara/ability-icon/e',
      maxCharges: -1,
      notes:
        'Untouchable Shadow does not trigger ultimate cast effects, such as  Experimental Hexplate\'s Overdrive,  Zeke\'s Convergence\'s Frostfire Tempest and  Cloud Dragon Soul\'s increased movement speed. This is intended.',
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Arc of Ruin\'s base damage and Untouchable Shadow\'s dash speed scale with Transcend One\'s Self\'s rank.</p>',
          leveling: [
            {
