            ...
            <CardContent
                ...
                <div class="size-full px-3">
                    <div class="mt-1">
                        ...
                        <div class="relative mt-4 flex h-fit items-end">
                            <div
                                class="first relative left-4 top-16 z-20 flex grow items-center justify-center first:absolute">
                                <Keystone :pocket="pocket" />
                            </div>
                            <div
                                class="flex w-full flex-row flex-wrap justify-end gap-1 justify-self-end pl-24">
                    ...
                    <div class="">
                        <div
                            class="ml-px h-fit flex-col items-center justify-start pl-6 pt-6">
                            <div
                                :class="
                                    cn(
                            ...
                            <div :class="cn('z-0 mt-2 flex gap-2')">
                                ...
                                <div :class="cn('flex gap-3 pl-3.5 pt-3')">
