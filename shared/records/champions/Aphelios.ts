// Updated Patch 25.21 - 11/05/2025 05:09:36 PM CST
  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Aphelios has access to an arsenal of 5 Moonstone Weapons, created by his sister Alune. He equips two weapons at any one time, one as his main weapon and one as his off-hand. Each weapon has a unique basic attack and effect.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        'Aphelios has  bonus range while Calibrum is his main weapon. Abilities will mark targets, and he may attack them from far away with the current off-hand weapon, consuming all marks and dealing bonus physical damage for each mark consumed.',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            'Aphelios gains 100 bonus attack range while Calibrum is his main weapon. Enemies damaged by Calibrum through an ability are marked for 4.5 seconds, during which they are revealed. Aphelios\' next basic attack against a marked target uses the current off-hand weapon and has 1800 range, increased missile speed, and a brief cast time that lasts shorter based on Aphelios\' proximity to the target.',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Aphelios\' basic attacks will  heal him, and create a  shield from excess healing.',
      damageType: 'Physical damage',
      effects: [
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Aphelios\' basic attacks will hit all enemies in its trajectory, dealing increased damage to the main target and less damage to other targets. The attack will then spread into a cone behind his main target.',
      damageType: 'Physical damage',
      effects: [
        {
          description:
        ...
        {
          description:
            'Critical strikes instead spray 6 missiles in a 50% wider cone. Secondary targets hit count as being critically struck but do not take any additional damage.',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/Aphelios/ability-icon/p',
      notes:
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            'Attacks with Crescendum are empowered to deal 0% - 138.5% (based on number of Chakrams) AD bonus physical damage and have a lower windup of 10.67%, further decreased to 6.67% when critically striking. The bonus damage from Chakrams is affected by critical strike modifiers.',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/Aphelios/ability-icon/p',
      notes:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Aphelios fires a bolt of energy in the target direction that deals 70 - 160 (based on level) (+ 42% - 60% (based on level) bonus AD) (+ 100% AP) physical damage to the first enemy hit.</p>',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/Aphelios/ability-icon/q',
      maxCharges: -1,
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Active: Aphelios gains bonus  movement speed and quickly attacks a nearby enemy with  Severum and his current off-hand weapon, dealing physical damage. The number of attacks is increased based on his bonus attack speed.',
      castTime: 'none',
      cooldown: '9',
      cost: '60',
      damageType: 'Physical damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Aphelios enters an onslaught for 1.75 seconds, gaining 25% (+ 10% per 100 AP) bonus movement speed and automatically performing up to 6 (+ 2 per 100% bonus attack speed) attacks over the duration against the nearest visible enemy, prioritizing enemy champions.</p>',
        },
        {
          description:
            'Attacks alternate between Severum and his current off-hand weapon, each dealing 10 - 40 (based on level) (+ 22% - 40% (based on level) bonus AD) physical damage, affected by critical strike modifiers, and applying on-hit effects, with on-hit damage reduced to 25% effectiveness.',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active: Aphelios deals magic damage and  roots all targets that are  slowed by  Gravitum.',
      castTime: '0.3',
      cooldown: '9',
      cost: '60',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Gravitum - Active:</span> Aphelios expunges all enemies with Gravitum\'s slow debuff, dealing 50 - 140 (based on level) (+ 32% - 50% (based on level) bonus AD) (+ 70% AP) magic damage and rooting them for 1 second.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Aphelios deploys a lunar sentry at the target location that arms after 0.35 seconds, lasting for up to 20 seconds, during which it is inactive and untargetable. The sentry activates if an enemy is within range of it, reducing its duration to 4 seconds and becoming targetable. Sentries have 6 health and take 3 damage per ranged basic attack and 4 damage per hit by abilities. Turret attacks destroy sentries instantly.</p>',
        },
        {
          description:
            'The sentry grants sight of its surroundings and autonomously attacks the nearest visible enemy in range with a replica of Aphelios\' current off-hand weapon, dealing 35 - 125 (based on level) (+ 42% - 60% (based on level) bonus AD) (+ 50% AP) physical damage per hit. The sentry can critically strike for (175% + 40%) damage and benefits from both Aphelios\' attack speed and critical strike chance at 100% effectiveness.',
        },
        {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Aphelios switches between his main weapon and off-hand weapon over 0.25 seconds.</p>',
        },
      ],
    ...
    },
    {
      ...
      blurb:
        'The icon of this ability reflects the next weapon that is the next in  Aphelios\' weapon queue.',
      cooldown: '0',
      cost: '0',
      effects: [
        {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Aphelios receives a text prompt of the weapon Alune will create next.</p>',
        },
      ],
