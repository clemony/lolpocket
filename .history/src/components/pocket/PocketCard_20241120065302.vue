...
<template>
    <label
        ...
        <Card
            class="swap-off h-[320px] w-[250px] max-w-[250px] overflow-hidden rounded-box bg-base-100/95">
            <div
                class="mask absolute h-[200px] w-full self-start bg-[20%_-125%] bg-no-repeat mask-b-12 [background-size:200%]"
                :style="{
