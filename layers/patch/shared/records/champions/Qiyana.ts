...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        {
          description: '<p class="ability-effect"><span class="ability-header">Active:</span> Qiyana slashes forward in the target direction, dealing physical damage to enemies in a line, reduced to 75% damage against targets beyond the first. Edge of Ixtal deals 155% damage against monsters.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: 'Enemies hit are dealt Edge of Ixtal\'s damage, reduced to 75% against subsequent enemies beyond the closest. Elemental Wrath deals 155% damage against monsters.',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
