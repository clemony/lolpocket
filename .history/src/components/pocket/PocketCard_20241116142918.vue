    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <Card
                ...
                <div
                    class="h-200% absolute -top-[100%] left-0 z-10 h-[200%] w-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100 to-30%"
                    :class="{
                        'duration-400 transition-all delay-700': flip,
                        'duration-400 -top-[30%] transition-all delay-700':
                            !flip,
                    }" />
                <CardContent class="">
                    <CardHeader
            ...
            <Card v-else class="absolute h-[350px] w-[250px] overflow-hidden">
                <p
