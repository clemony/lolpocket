  ...
  <div class="flex w-full px-3">
    <div
      ...
      <Placeholder
        ...
        :key="set.name"
        class="
          hover:ringneutral/40 items-between pointer-events-auto flex size-20
          cursor-pointer flex-wrap justify-between gap-0.75! border
          border-b3/50! p-1.5 hover:ring-2
        "
