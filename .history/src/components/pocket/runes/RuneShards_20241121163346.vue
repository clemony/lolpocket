            ...
            <Tooltip
                ...
                <label
                    :class="
                        cn(
                            /* b4 */
                            'absolute size-full bg-gradient-to-br from-base-100/60 to-base-200/50 backdrop-blur-sm'
                        )
                    "
                    class="group/shard shard size-fit rounded-full transition-all duration-300"
                    :alt="shard.stats"
                    ...
                    <div
                        :class="
                            cn(
                                /* b4 */
                                'before:absolute before:size-full before:bg-gradient-to-br before:from-base-100/60 before:to-base-200/50 before:backdrop-blur-sm',
                                /* border */
                                ...
                                /* struct  */
                                'grid size-14 shrink-0 place-items-center rounded-full p-3.5',
                        ...
                        "
                        :style="{
                            backgroundImage: 'url(/img/ui/asphalt-dark.png)',
                        }">
                        <icon
