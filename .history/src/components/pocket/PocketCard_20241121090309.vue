...
<template>
    <label class="swap swap-flip relative h-[300px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                class="relative flex h-inherit w-inherit items-center bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30%">
                ...
                <div class="relative w-1/2 pl-3">
                    <div
                        class="z-10 mt-8 flex size-fit items-center justify-center rounded-full">
