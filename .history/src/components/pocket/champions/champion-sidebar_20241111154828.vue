    ...
    <Card class='relative'>
        ...
        <CardHeader class='flex flex-row gap-8 items-center '>
            ...
            <div class='relative w-fit'>
                ...
                <loadImg
                    class=" size-[75px] max-size-[75px]  scale-[115%]  mr-1  overflow-hidden aspect-square object-center shrink-0 rounded-lg border border-transparent  bg-clip-content"
