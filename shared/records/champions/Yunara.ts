  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        ...
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Active:</span> Yunara unleashes for 5 seconds: gaining bonus attack speed, dealing additional bonus magic damage on-hit, and augmenting her basic attacks to have increased missile speed, a 40% lower windup time, and an uncancelable windup. Her basic attacks are also empowered to spread to each enemy near the target, dealing 30% AD physical damage.Each spread attack applies life steal and on-hit effects, with on-hit damage reduced to 30% effectiveness, and will critically strike if the triggering attack does. Spread attacks deal 250% damage against minions below 30% maximum health.</p>",
          "leveling": [
            {
        ...
        {
          "description": "Cultivation of Spirit resets Yunara's basic attack timer. Targets do not have to be visible to be hit by the spread attacks."
        }
      ],
      ...
      "effects": [
        {
          ...
          "leveling": [
            ...
            },
            {
              ...
              "modifiers": [
                {
                  "values": "8.25 / 14.25 / 20.25 / 26.25 / 32.25"
                },
                {
                  "unit": "% bonus AD",
                  "values": "12.75"
    ...
    },
    {
      ...
      "name": "Kanmei's Steps",
      "affects": "Self",
      "blurb": "Active:  Yunara briefly becomes  ghosted and gains  bonus move speed, increased while facing an enemy  champion.",
      "castTime": "none",
      "cooldown": "9",
      "cost": "40",
      "effectRadius": "2000",
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Active:</span> Yunara becomes ghosted and gains bonus movement speed for 1.5 seconds. The movement speed is 50% more effective while facing a nearby visible enemy champion.</p>",
          "leveling": [
            {
