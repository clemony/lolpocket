    ...
    <Collapsible
      ...
      <LazyCollapsibleContent class=" CollapsibleContent w-full !px-0">
        ...
        <Tabs v-model:model-value="modelValue" class="relative">
          <IndicatorTabsList class=" grid-flow-col rounded-none justify-start auto-cols-min w-full  bg-b3/36 border border-b3 ">
          ...
          <TabsContent value="Scoreboard" class="px-0 ">
