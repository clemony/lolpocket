...
<div class="h-full w-full px-3 py-4">
    <div class="mb-4 grid h-fit w-full gap-4 px-4">
        <div class="flex items-center gap-3">
            ...
            <Button variant="ghost" size="lg" class='bg-domination text-white text-base justify-start shadow-sm px-5'>
                <icon v-if="ps.trashPockets.length > 0" icon="ant-design:fire-outlined" class="size-6 -ml-1" />
