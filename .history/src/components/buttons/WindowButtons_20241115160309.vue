...
const size = 'icon'
const classObject = [
    'p-1 hover:stroke-[1.5]  [&_svg]:shrink-0 shadow-inner hover:shadow-base-300 size-4.5 rounded-full border-neutral/15 bg-base-200/20 [&_svg]:opacity-0 group-hover:[&_svg]:opacity-100',
]
</script>
<template>
    <div
