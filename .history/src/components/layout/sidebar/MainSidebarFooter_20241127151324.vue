                ...
                <DropdownMenu>
                    <DropdownMenuTrigger>
                        <SidebarMenuButton
                            variant="ghost"
                            size="default"
                            class="focus:ring-b2! data-[state=open]:ring-base-300/40! flex h-16 flex-nowrap items-center gap-2 border-0! pr-2.5 ring-0! focus:border-0! focus:ring-1! focus:outline-0! data-[state=open]:ring-1! data-[state=open]:shadow-xs">
                            <Avatar
                                class="mt-0.5 size-10 rounded-lg border border-1 border-transparent shadow-xs">
                                <AvatarImage
                    ...
                    <DropdownMenuContent
                        class="shadow-standard! w-(--radix-dropdown-menu-trigger-width) min-w-56 rounded-lg backdrop-brightness-[97%] *:text-base"
                        side="bottom"
                        align="end"
                        :side-offset="6">
                        ...
                        <DropdownMenuGroup
                            class="mr-0.5 font-medium [&_>div]:gap-4 [&_svg]:size-5">
                            <DropdownMenuItem>
                                <icon icon="ph:at" />
                                Account
