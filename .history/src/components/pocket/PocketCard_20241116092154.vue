...
<template>
  ...
  <input type="checkbox" />
    <div 
        ...
        <InfoCard
            cardClass="swap-on card h-[350px] w-[250px]  before:absolute before:size-full bg-transparent backdrop-blur-none bg-gradient-to-b from-base-100/40 from-0% to-base-100 via-base-100/70 to-30%">
        </InfoCard>
    </label
</template>
