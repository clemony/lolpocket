                ...
                <div class="size-full px-3">
                    <div class="mt-1">
                        ...
                        <div class="relative mt-4 flex h-fit items-end">
                            <div
                                class="flex w-full flex-row flex-wrap justify-end gap-1 justify-self-end pl-24 first:!rounded-tl-full">
                    ...
                    <div class="relative flex">
                        <div
                            class="z-20 ml-4 mt-11 flex items-center justify-center">
