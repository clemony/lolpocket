  ...
  "abilities": [
    {
      ...
      "effects": [
        ...
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Innate - Temper:</span> Ornn's basic attacks against Brittle enemies knock them back a short distance. Ornn's and allies' immobilizing effects against Brittle enemies will consume the debuff to deal bonus magic damage equal to 10% - 18% (based on Ornn's level) of the target's maximum health, capped at 260 - 500 (based on level) against monsters, and cause the crowd control to last 30% longer (if applicable).</p>"
        },
        {
