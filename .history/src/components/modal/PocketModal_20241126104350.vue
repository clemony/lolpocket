...
<template>
    <div class="carousel relative w-full justify-center py-2">
        <div ref="elForm" class="carousel-item w-full min-w-full">
            <form
                ref="form"
                class="grid w-full min-w-full grid-cols-[4.5fr_1.5fr_2fr] gap-10 py-4 [&_label]:text-base"
                @submit.prevent.stop="submitForm">
                <div class="ml-px flex w-3/4 flex-col gap-2">
                ...
                <div class="flex flex-col">
                    <div class="flex flex-col gap-1">
                        ...
                        <button
                            ...
                            class="mt-4 aspect-square size-14 self-center rounded-lg p-4 ring-neutral/80 hover:ring-1 hover:ring-offset-4">
                            <icon
                                :icon="selectedIcon"
            ...
            <div ref="elIcon" class="carousel-item grid w-3/4 justify-end">
                <!--          <div class="pointer-events-none">
                    <Button
                        variant="outline"
                        size="icon"
                        @click="scrollToSection(elForm)"
                        class="pointer-events-auto aspect-square size-14">
