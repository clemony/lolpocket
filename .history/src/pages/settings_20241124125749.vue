...
const Appearance = useTemplateRef('AccountSettings')

const Account = useTemplateRef('AccountSettings')

const Hotkeys = useTemplateRef('AccountSettings')

const Storage = useTemplateRef('AccountSettings')
