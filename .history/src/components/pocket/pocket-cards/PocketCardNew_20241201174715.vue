                    ...
                    <Card
                        ...
                        <CardContent
                            ...
                            <div class="grid w-full px-3">
                                ...
                                <div
                                    class="z-20 flex size-14 items-center justify-center rounded-full bg-gradient-to-br from-transparent to-75% shadow-sm"
                                    ...
                                    <img
                                        ...
                                        class="size-14 object-center drop-shadow-md" />
                                    <ShadowedPlaceholder
                                        v-else
