  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Vayne gains  bonus movement speed while facing a nearby enemy champion, significantly increased during  Final Hour.",
      effectRadius: "2000",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Vayne gains 30 bonus movement speed while facing a nearby visible enemy champion, increased to 90 while under the effects of Final Hour.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Vayne  dashes in the target direction. Her next basic attack within a few seconds will deal bonus physical damage.",
      castTime: "none",
      cooldown: "6 / 5 / 4 / 3 / 2",
      cost: "30",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Vayne dashes a fixed distance in the target direction, though not through terrain, and empowers her next basic attack within 3 seconds to have an uncancelable windup and deal bonus physical damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Vayne\'s basic attacks on-hit and Condemn apply a stack of Silver Bolts for 3.5 seconds, refreshing on subsequent applications, expiring upon attacking a new enemy, and stacking up to 3 times.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Vayne fires a heavy bolt at the target enemy that deals physical damage and  knocks them back.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Vayne fires a heavy bolt at the target enemy that deals physical damage and knocks them back 475 units, though not through terrain.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Vayne equips her crossbow, gaining bonus attack damage for a duration.</p>',
          leveling: [
            {
