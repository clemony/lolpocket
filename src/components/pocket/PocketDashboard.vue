...
import DashboardOverview from '@components/Pocket/Dashboard/DbOverview.vue'
...
const Overview = defineAsyncComponent({
    loader: () => import('@/components/Pocket/Dashboard/DbOverview.vue'),
})
    ...
    <Layout3 :key="pocketKey" col2Class="px-6">
        <template #col1>
            <div class="grid grid-cols-[20px_auto] gap-y-5">
                <h1 class="col-start-2 mb-3">Build</h1>
                ...
                <div class="row-span-4 mt-0.5 justify-start">
                    <icon
                        ...
                        :class="{
                            ...
                            'translate-y-[66px]':
                                currentVisible == 'Core Items',
                            'translate-y-[99px]':
                                currentVisible == 'Final Build',
                        }" />
                </div>
                ...
                <label
                    ...
                    <span
                        class="opacity-50 transition-opacity duration-300 peer-checked:font-medium peer-checked:opacity-100">
                        {{ el.name }}
                    </span>
                </label>
            </div>
        ...
        <template #col3>
            <DbSidebar :pocketKey="pocketKey" :key="pocketKey" />
        </template>
    </Layout3>
</template>
