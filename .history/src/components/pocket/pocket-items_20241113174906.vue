...
<template>
    <Layout2 class="max-h-inhhert h-inherit" scroll :panel1Min="14">
        <template #panel1>
            <ScrollArea
                ...
                <template #header>
                    <div class="join">
                        ...
                        <Label
                            variant="outline"
                            size="icon"
                            class="join-item swap swap-flip relative shrink-0 has-[:disabled]:cursor-default has-[:checked]:!bg-base-200"
                            alt="Filter Likes">
                            <input
                                type="checkbox"
                                name="viewLoved"
