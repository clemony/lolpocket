...
<template>
  ...
  <div
    class="relative sticky -top-55 z-1 flex w-full flex-col items-center gap-4 pt-4 before:absolute before:top-0 before:-left-1 before:box-content before:size-full before:border-4 before:border-b1 before:bg-b1/96 before:backdrop-blur"
  >
    <div
    ...
    >
      ...
      >
        {{ is().filters.rank }}
        <icon name="x" class="size-4 **:stroke-[2.1]" />
      </Button>
