...
<template>
    <main class="w-full">
        ...
        <div class="grid w-full grid-cols-3 gap-6 *:size-full">
            <DisplayCard
                ...
                <label
                    ...
                    <div
                        class="border-base-300 bg-base-100 text-base-content shadow-warm h-20 w-full cursor-pointer overflow-hidden rounded-xl border"
                        :data-theme="theme.name + 'minimalist'">
                        <div class="grid h-full w-full grid-cols-[1fr_4fr]">
                            <div class="h-full flex-col">
                                <div class="bg-base-200 h-2/3"></div>
                                <div class="bg-base-300 h-1/3"></div>
                            </div>
                            <div
                                class="flex h-full items-center gap-2 px-5 font-medium">
                                <div class="grow px-1 text-lg font-semibold">
                                    Aa
                                </div>
                                <div
        ...
        <div class="border-t-base-200 mt-8 flex border-t pt-6">
