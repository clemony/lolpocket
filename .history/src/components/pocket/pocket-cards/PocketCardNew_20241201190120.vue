                        ...
                        <CardContent
                            ...
                            <div class="flex w-full justify-center">
                                <div
                                    :class="
                                        cn(
                                            'border-box z-0 h-36 w-[90%] overflow-hidden rounded-md',
                                            {
                                    ...
                                    ">
                                    <div
                                        class="size-full bg-[50%_10%] bg-no-repeat [background-size:200%] after:absolute after:-left-4 after:-top-8 after:size-18 after:rounded-full after:border after:bg-base-100"
                                        :style="layer1" />
                                </div>
                            </div>
