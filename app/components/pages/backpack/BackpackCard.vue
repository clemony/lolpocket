...
<template>
  <div class="max-h-[22.5rem] min-h-[17.5rem] w-full max-w-100 min-w-[22rem]">
    ...
    >
      <ContextMenuTrigger
        as="div"
        class="relative h-inherit min-h-inherit w-inherit min-w-inherit cursor-pointer gap-3 overflow-hidden rounded-xl border border-b2 shadow-warm-soft drop-shadow-sm drop-shadow-black/5 **:select-none hover:border-b3 hover:shadow-warm hover:ring-1 hover:ring-b2"
        @click="navigateTo(`/pocket/${pocket.key}`)"
      >
        ...
        >
          <div
            class="inset-shadow pointer-events-none relative grid size-full px-4 py-3"
          >
