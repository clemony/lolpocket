...
<template>
    ...
    <ContextMenu class="context-menu [&_>span]:size-full flex items-center">
        <ContextMenuTrigger
            class="relative flex items-center justify-center gap-4 size-full opacity-95 group">
            <div class="flex items-center justify-center gap-3 size-full">
                <div
                    v-if="keystone && keystone.name != 'none' && runeSet"
                    ...
                    :class="{
                        'via-resolve border-resolve':
                            keystone.path == 'resolve',
                        'via-sorcery border-sorcery':
                            keystone.path == 'sorcery',
                        'via-inspiration border-inspiration':
                            keystone.path == 'inspiration',
                        'via-domination border-domination':
                            keystone.path == 'domination',
                        'via-precision border-precision':
                    ...
                    <div
                        ...
                        <KinesisContainer
                            ...
                            <KinesisElement
                                type="depth"
                                :strength="5"
                                class="flex items-center size-full group">
                                <img
                                    :src="keystone.img"
                ...
                <div
                    ...
                    @click.stop="
                        sn.navigateTo(
                            `/pocket/${pocket.key}/pocket-runes`,
                            pocket.name,
                            pocket.icon
                        )
                    "
                    ...
                    <ContextMenuSubContent>
                        <ContextMenuItem
                            ...
                            <label class="flex items-center gap-0.5">
                                <icon
                                    v-if="pocket.runes[0].starred == index"
