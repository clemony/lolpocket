...
<template>
    <div class="overflow-hidden">
        ...
        <form
            v-else
            ref="form"
            class="grid grid-cols-[4fr_1.5fr_2fr] gap-10 py-4 duration-500 animate-in animate-out fade-in-0 fade-out-0 slide-in-from-left-0 slide-out-to-left-full [&_label]:text-base"
