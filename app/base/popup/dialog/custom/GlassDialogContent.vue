    ...
    <DialogContent
      ...
      <DialogClose
        ...
        class="
          ...
          transition-opacity focus:ring-ring focus:ring-1 focus:ring-offset-1
          focus:outline-none hover:opacity-100 disabled:pointer-events-none
          data-[state=open]:text-b1/50
        ">
        <icon
          name="x"
          class="size-4.5" />
