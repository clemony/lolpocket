        ...
        <div class="mb-4 grid h-fit w-full gap-4 px-4">
            <div class="flex items-center gap-3">
                ...
                <Button
                    variant="ghost"
                    size="lg"
                    class="border-error bg-error hover:bg-error disabled:border-inspiration disabled:bg-inspiration disabled:text-base-content justify-center border px-5 text-base text-white shadow-xs hover:opacity-80"
