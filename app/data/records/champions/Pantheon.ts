 export const Pantheon: Champion =  {
  "id": 80,
  "key": "Pantheon",
  "name": "Pantheon",
    ...
    "P": [
      {
        ...
        "blurb": "Innate:  Pantheon generates stacks of Mortal Will whenever he lands a basic attacks or casts an ability. At max stacks, his next basic ability consumes them to become empowered with an additional effect."
      }
    ],
    "Q": [
      {
        ...
        "effects": [
          ...
          {
            "description": "Comet Spear's total damage is increased to 105% against monsters and reduced to 70% against minions."
          },
          {
