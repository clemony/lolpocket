...
const icon = computed(() => {
    const i = location[0] ? : 0
    return i
})

const minimizeIcon = computed(() => {
    const i = location[0] && location[1] ? 'mynaui:x-circle-solid' :  location[0] ? 'mynaui:x-circle' :  'mynaui:circle'
    return i
})

const maximizeIcon = computed(() => {
    const i = icon && location[2] ? 'mynaui:x-circle-solid' : 'mynaui:x-circle'
    return i
})

const closeIcon = computed(() => {
    const i = icon && location[3] ? 'mynaui:x-circle-solid' : 'mynaui:x-circle'
    return i
})
</script>
<template>
