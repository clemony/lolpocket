  ...
  abilities: [
    {
      ...
      targeting: 'Passive',
      targetRange: '650 / 725 / 800 / 875 / 950 (based on level)',
      effects: [
        {
          description: '<p class="ability-effect"><span class="ability-header">Innate:</span> Samira\'s damaging basic attacks and abilities against at least one enemy champion unique from the previous damaging hit made against champions generate a stack of Style for 6 seconds, refreshing on subsequent unique or non-unique hits and stacking up to 6 times.</p>'
        },
        {
        ...
        {
          description: '<p class="ability-effect"><span class="ability-header">Innate:</span> Samira\'s basic attacks against targets within 200 units of her use her blade, becoming non-projectile. Blade attacks, Blade Whirl, Wild Rush, and the slash and explosives of Flair deal 2 - 19 (based on level) (+ 3.5% - 10.5% (based on level) AD) bonus magic damage, increased by 0% - 100% (based on target\'s missing health).</p>'
        },
        {
          description: 'Samira\'s basic attack against an immobilized target is empowered to have an uncancellable windup and fire 6 bolts over 0.5 seconds, each dealing 17% AD physical damage and applying life steal. If the target is a monster or is airborne, the attack also knocks them up for 0.5 seconds.'
        },
        {
        ...
        {
          description: 'If the target is further away from Samira\'s attack range, initiating an attack against the immobilized target while within valid range of them will first cause her to dash toward them up to her attack range, then automatically cast the bolts.'
        }
      ]
    },
    {
      ...
      effects: [
        ...
        {
          description: 'Flair can critically strike for (150% + 15%) damage and will apply life steal at 80% effectiveness.'
        }
      ]
    },
    {
