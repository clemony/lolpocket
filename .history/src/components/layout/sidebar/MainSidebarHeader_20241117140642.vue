...
<template>
    <SidebarHeader>
        <SidebarMenu
            class="w-full"
            :class="{
                'items-center pt-3': collapsed,
                'px-0.5 pt-0': !collapsed,
            }">
            <SidebarMenuItem>
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            ...
                            <div
                                class="flex aspect-square size-full shrink-0 items-center justify-center rounded-md bg-neutral text-neutral-content/90 shadow-sm">
