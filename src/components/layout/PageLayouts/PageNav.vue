...
<template>
<div class='grid  mt-0.5 w-full ml-4 h-full  items-center'>
    ...
    <div class="flex gap-8">
        ...
        <div v-for="el in els" :key="el.name">
            ...
            <VDropdown v-else theme="hoverdd" :delay="{ show: 300, hide: 100 }" placement="bottom-start" class=''>
                ...
                <template #popper>
                    ...
                    <HvPocket v-if="props.pocket" :type="el.type" :data="el.data" :pocket="props.pocket" />
                </template>
            </VDropdown>
