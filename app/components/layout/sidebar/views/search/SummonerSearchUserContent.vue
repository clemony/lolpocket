...
<template>
  ...
  <!--   <Collapsible
    ...
    <CollapsibleTrigger class=" px-3 border-y border-y-b3/90 py-2  group/collapse flex  px-3 !gap-2 font-medium items-center text-bc/70 text-sm hover:underline ">
      <icon
        name="star"
        class="dst size-3.75 opacity-80 " />
    ...
    <CollapsibleContent class="CollapsibleContent px-5.25 py-4   w-full flex flex-col gap-6">
      <SummonerFriend
        v-for="i in 4"
        :key="i" />
    </CollapsibleContent>
