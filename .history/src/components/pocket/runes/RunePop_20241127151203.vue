    ...
    <div
        ...
        <div
            ...
            <a
                ...
                <div
                    class="link-icon border-b1 bg-neutral group-hover/link:border-primary absolute bottom-0 z-30 flex size-8 items-center justify-center rounded-full border-2 transition-all duration-500 group-hover/link:rotate-180">
                    <Icon
