...
console.log(
    ps.pockets[pocketIndex.value].runes[0].runeSets[runeIndex.value].shards
        .shard1
)
</script>
        ...
        <div
            ...
            <label
                ...
                <input
                    ...
                    :value="shard"
                    v-model="
                        ps.pockets[pocketIndex].runes[0].runeSets[runeIndex]
                            .shards.shard1
                    "
