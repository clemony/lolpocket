...
<template>
    <div v-if="pocket" :key="pocket.key" class="flex flex-col">
        ...
        <ul
            class="mt-6 flex h-9 items-center px-1 before:absolute before:h-9 before:w-[55px] before:rounded-md before:border before:border-base-200 before:bg-base-100 before:opacity-80 before:shadow-md [&_li]:z-10 [&_li]:w-20 [&_li]:px-2">
            <li>
                <label>Spells</label>
            </li>
            <li>
