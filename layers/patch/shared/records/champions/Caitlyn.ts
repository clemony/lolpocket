  ...
  "abilities": [
    {
      ...
      "effects": [
        ...
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Headshot:</span> Caitlyn's basic attack is empowered to have an uncancellable windup and deal 60% / 80% / 100% (based on level) (+ (148.75% + 25.5%) critical strike chance) AD bonus physical damage, increased to 110% (+ (148.75% + 25.5%) critical strike chance) AD against non-champions.</p>"
        },
        {
