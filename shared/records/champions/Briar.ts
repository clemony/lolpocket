...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: "Enemies, Self",
      blurb:
        "Active:  Briar  leaps to the target unit. If the target is an enemy, she deals magic damage,  stuns them briefly, and additionally reduces their  armor and  magic resistance for a few seconds.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Briar leaps to the target unit. If the target is an enemy, she deals magic damage, applies on-hit effects, triggers on-attack effects, stuns them for 0.85 seconds, and reduces their armor and magic resistance for 5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies, Self",
      blurb:
        "Active:  Briar  dashes and senses her surroundings. If there is a nearby enemy upon her arrival, she gains Blood Frenzy for a few seconds, during which she can cast  Snack Attack.",
      castTime: "none",
    ...
    },
    {
      ...
      affects: "Enemies, Self",
      blurb:
        "Active:  Briar empowers her next attack during  Blood Frenzy to take a bite out of the target enemy. The attack gains increased  range, deals bonus physical damage based on the target's missing health and  heals Briar for a portion of the damage dealt.",
      castTime: "none",
      cooldown: "14 / 13 / 12 / 11 / 10",
      cost: "0",
      damageType: "Physical damage",
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Briar prepares to unleash a scream in the target direction, charging for up to 1 second, during which she increases Chilling Scream\'s damage and range, and gains 35% damage reduction and heals herself every 0.25 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Briar unleashes the scream in the direction she targeted at the time of cast, dealing magic damage to enemies hit and slowing them by 80% for 0.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Briar kicks her pillory\'s hemolith in the target direction, briefly granting sight of its surroundings as it travels and marking the first enemy champion hit as her prey. The mark\'s application disrupts the target\'s ongoing channels. While the target is marked, they are revealed.</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Hematomania:</span> Briar gains all effects of Blood Frenzy as well as bonus armor and bonus magic resistance equal to 20% AD, life steal, and additional bonus movement speed.</p>',
          leveling: [
            {
