...
const isElIconVisible = computed(() => {
    return useElementVisibility(elIcon)
})
...
<template>
    <div class="carousel relative w-full justify-center py-2">
        <div ref="elForm" class="carousel-item w-full min-w-full">
            <form
                ref="form"
                class="flex w-full min-w-full py-4 [&_label]:text-base"
                @submit.prevent.stop="submitForm">
                <div class="ml-px flex w-3/4 flex-col gap-2 pl-4 pr-18">
