            ...
            <div class='relative w-fit'>
                ...
                <VTooltip theme="tt"
                    ...
                    <a :href="champion.wiki" target="_blank"
                        class="badge relative z-10  flex aspect-square size-10 cursor-alias overflow-hidden rounded-full border-none bg-base-content object-cover p-[3px] text-base-100 ring-[3px] ring-base-100 hover:ring-transparent">
