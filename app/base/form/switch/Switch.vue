  ...
  <SwitchRoot
    ...
    :class="
      cn(
        `
          ...
          rounded-full border border-transparent shadow-sm transition-colors
    ...
    <SwitchThumb
      ...
      :class="
        cn(
          `
            pointer-events-none block grid h-4 w-4 place-items-center
            rounded-full bg-b1 shadow-lg ring-0 transition-transform
