    ...
    <SidebarProvider>
        ...
        <SidebarInset class="relative">
            <div
                ...
                class="absolute inset-0 left-0 top-[5px] m-0 h-[calc(100%-10px)] w-[calc(100%-5px)] overflow-y-clip rounded-box border border-base-300 !bg-base-100/90 !p-0 !shadow-[inset_-12px_-8px_40px_#00000020,inset_-1px_-1px_2px_1px_#00000024] first:flex">
