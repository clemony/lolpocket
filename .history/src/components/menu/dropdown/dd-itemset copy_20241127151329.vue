        ...
        <Popover>
            <DialogTrigger>
                <PopoverTrigger>
                    <Button
                        variant="ghost"
                        class="ring-b2 relative -ml-3 h-fit justify-start hover:bg-transparent hover:ring-1">
                        <template
                            ...
                            <LoadImg
                                ...
                                class="border-base-300 size-[55px] overflow-hidden rounded-md border shadow-xs" />
                        </template>
                        <template
            ...
            <PopoverPortal>
                <PopoverContent @openAutoFocus.prevent>
                    <PopoverClose
                        class="absolute -top-96 -left-96 h-screen w-screen scale-150 bg-black/20">
                        <PopoverContent
                            ...
                            <InfoCard
                                ...
                                <div
                                    class="max-h-inherit w-inherit grid auto-rows-min flex-col justify-center gap-2 overflow-y-auto">
                                    <div
                                    ...
                                    <label
                                        ...
                                        <template
                                            ...
                                            <LoadImg
                                                v-if="index < 6"
                                                :url="`/img/items/${item.id}.webp`"
                                                class="size-[55px] rounded-md border-1 border-transparent shadow-xs" />
                                        </template>
