        ...
        <div
            ...
            <label
                ...
                <SidebarProvider
                    ...
                    :class="cn({
                                     /*base */
                            'top-1/2 z-0 size-3/4 overflow-hidden rounded-2xl bg-base-100': gs.commandOpen,

                    /* animation */
                            'animate-in animate-out zoom-out-[0.75] slide-in-from-bottom-1/2 slide-out-to-bottom-1/2',

                         /* styling */
                      'shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px,_2px_1px_0px_1px_rgba(221,_221,_221,_0.4),_0_2px_0px_rgba(204,_204,_204,_0.4)] after:absolute after:z-50 after:size-full after:bg-black/5': gs.commandOpen},
                    )">
                    <slot />
                </SidebarProvider>
            </label>
