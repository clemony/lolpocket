                ...
                <label
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="col-start-1 h-full flex-col">
                                <div class="h-2/3 bg-base-200"></div>
                                <div class="h-1/3 bg-base-300"></div>
                            </div>
                            <div
                                class="col-start-2 row-span-3 row-start-1 flex place-content-center items-center gap-3 bg-base-100 px-3">
                                <div class="flex-grow font-semibold">Aa</div>
                            </div>
                        </div>
                    </div>
                </label>
