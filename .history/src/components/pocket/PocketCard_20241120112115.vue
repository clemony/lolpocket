    ...
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    class="mt-2 grid w-full grid-cols-[2.5fr_1fr] items-center gap-x-3 gap-y-5 px-4 [&_>div]:justify-between">
                    ...
                    <div
                        ...
                        <div
                            class="col-start-1 -mt-3 ml-4 grid w-full justify-center">
