<script setup lang="ts">
  ...
  import { provideDrawerRootContext } from './src/context';
  import { CLOSE_THRESHOLD, type DrawerRootEmits, type DrawerRootProps, SCROLL_LOCK_TIMEOUT, useDrawer } from './src/controls';
