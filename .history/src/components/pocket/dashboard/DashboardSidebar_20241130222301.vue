...
<template>
    <div v-if="pocket" :key="pocket.key" class="flex flex-col">
        <Card class="shadow-smooth">
            <CardContent class="h-36 overflow-hidden rounded-lg p-0">
                ...
                <div
                    ...
                    <p
                        class="items-center whitespace-pre-line text-pretty px-12 align-middle font-serif text-xl tracking-wide [text-align-last:right]">
                        {{ formattedQuote() }}
                    </p>
                </div>
            </CardContent>
        ...
        <Tabs default-value="spells">
            <TabsList class="mb-2 mt-5 [&_button]:rounded-md">
