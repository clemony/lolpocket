        ...
        <Popover>
            <PopoverTrigger
                ...
                <Button
                    ...
                    size="icon"
                    v-else-if="model"
                    class="size-16 overflow-hidden rounded-lg border-neutral/30 p-0 shadow-standard transition-all duration-300 hover:border-neutral/70 hover:ring-1 hover:ring-neutral/80">
                    <img
