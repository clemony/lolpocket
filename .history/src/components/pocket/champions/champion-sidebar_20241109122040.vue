            ...
            <div class='relative w-fit'>
                ...
                <VTooltip theme="tt"
                    ...
                    <a :href="champion.wiki" target="_blank"
                        class="badge relative z-10  flex aspect-square size-9 p-1 cursor-alias overflow-hidden rounded-full border-none bg-neutral ring-[3px] ring-base-100 hover:ring-transparent text-neutral">
