...
<template>
  <div
    ...
    <div
      ...
      <div class="w-40% z-1 flex size-full grow flex-col items-start justify-center pt-16 pl-68 *:z-1">
        <slot name="header" />
      </div>
    </div>
    ...
    <div class="fixed top-15  left-2.5 z-13 grid  w-16 auto-rows-fr items-center gap-2">
      <slot name="menu" />
    </div>
    ...
    <div
      ...
      <div
        class="pointer-events-none sticky -top-70 z-13 flex h-15 min-h-15 w-full items-end gap-4 overflow-hidden pl-66">
