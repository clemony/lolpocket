...
<template>
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            class="swap-off relative h-[320px] w-[230px] max-w-[230px] overflow-hidden rounded-box bg-transparent">
            <div
            ...
            <CardContent
                ...
                <div
                    class="mt-2 grid w-full shrink-0 grid-cols-[2.5fr_1fr] items-center gap-x-3 gap-y-5 px-2 [&_>div]:justify-between">
                    ...
                    <div
                        class="col-span-full grid w-full grid-cols-[1fr_2.5fr] items-center gap-2 pl-1 pr-5">
                        <div
