  ...
  abilities: [
    {
      ...
      blurb: 'Innate: Every few seconds,  Gangplank\'s next basic attack  on-hit will burn the target, continually dealing bonus true damage and granting him  bonus movement speed.',
      ...
      effects: [
        {
          description: '<p class="ability-effect"><span class="ability-header">Innate:</span> Periodically, Gangplank empowers his next basic attack on-hit to set the target on fire, dealing them[ 50 - 250 (based on level) (+ 100% bonus AD) (+ 2 per 1% critical strike chance) bonus true damage over 2.5 seconds. ][ 5 - 25 (based on level) (+ 10% bonus AD) (+ 0.2 per 1% critical strike chance) bonus true damage every 0.25 seconds over 2.5 seconds. ] Turrets are dealt 50% damage.</p>'
        },
        {
        ...
        {
          description: 'Trial by Fire cannot be applied with Parrrley, Powder Keg, nor by Guinsoo\'s Rageblade\'s Seething Strike.'
        }
      ]
    },
    {
      ...
      effects: [
        {
          description: '<p class="ability-effect"><span class="ability-header">Active:</span> Gangplank fires a shot at the target enemy that deals physical damage, applies on-hit effects as a ranged attack, and triggers on-attack effects. Parrrley can critically strike for (175% + 30%) damage.</p>',
          leveling: [
            {
