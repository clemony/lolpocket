...
<template>
  <PopoverPortal>
    <PopoverContent
      ...
      <PopperScrollUpButton :class="{ 'opacity-0 pointer-events-none tldr-30': arrivedState.top == true }" />
      <div
        ref="el"
      ...
      <PopperScrollDownButton :class="{ 'opacity-0 pointer-events-none tldr-30': arrivedState.bottom == true }" />
    </PopoverContent>
  </PopoverPortal>
</template>