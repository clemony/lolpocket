  ...
  abilities: [
    {
      ...
      blurb:
        'Innate: Scoring a champion  takedown within a short time of damaging them  reduces the current cooldowns of  Katarina\'s abilities.',
      damageType: 'Magic damage',
      effectRadius: '340',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Scoring a champion takedown within 3 seconds of damaging them will reduce the current cooldowns of Katarina\'s abilities by 15 seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Sinister Steel:</span> Whenever Katarina retrieves a Dagger, she slashes around herself to deal 68 - 240 (based on level) (+ 60% bonus AD) (+ 70% / 80% / 90% / 100% (based on level) AP) magic damage to nearby enemies, apply on-hit effects to enemy champions hit, and reduce Shunpo\'s current cooldown by 78% / 84% / 90% / 96% (based on level) of its total cooldown.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Katarina throws a Dagger at the target enemy that can bounce to up to two additional nearby enemies, dealing magic damage.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Katarina throws a Dagger at the target enemy that deals magic damage and can bounce to up to two additional visible nearby enemies.</p>',
          leveling: [
            {
        ...
        {
          description:
            'The Dagger lands 1.023 seconds after striking the first target, about 350 units opposite from their position when it struck them.',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Katarina briefly gains  ghosting and a burst of  movement speed, tossing a Dagger into the air directly above herself.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Katarina tosses a Dagger into the air above her current location and gains bonus movement speed that decays until it lands after 1.25 seconds, becoming ghosted for the same duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Katarina blinks to a target location near the unit or Dagger closest to the cursor, dealing magic damage to the nearest enemy in range and applying on-hit effects.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
