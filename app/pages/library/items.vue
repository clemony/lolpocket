...
<template>
  <SeparatorLayout :description="quote">
    <LayoutAsideSplit full-width>
      ...
      <ItemRankFilter
        class="sticky top-38 -mt-2 mb-0 -ml-[5px] w-[calc(100%+10px)] bg-b1 pt-5 pb-6"
      />
      <LazyNuxtPage />
    </LayoutAsideSplit>
    ...
    <template #right>
      ...
      >
        <TabsList base="indicator" class="grid h-10 w-80 max-w-120 grid-cols-2">
          <TabsTrigger value="/library/items"> Grid </TabsTrigger>

          <TabsTrigger value="/library/items/list"> List </TabsTrigger>
