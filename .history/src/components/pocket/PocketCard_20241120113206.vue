...
<template>
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                class="max-w-inherit relative grid size-full items-center justify-center bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30% pt-2">
                ...
                <div
                    class="mt-2 grid w-full shrink-0 grid-cols-[2.5fr_1fr] items-center justify-center gap-x-3 gap-y-5 px-2 [&_>div]:justify-between">
                    ...
                    <div
                        class="col-span-full grid w-full grid-cols-[1fr_2.5fr] items-center gap-2">
                        <div
                            class="col-start-1 -mt-4 ml-4 grid w-full justify-center">
