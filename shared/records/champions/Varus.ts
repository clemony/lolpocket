  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate: When  Varus kills an enemy, he gains  bonus attack speed,  bonus attack damage, and  ability power for a few seconds. The amount is based on his other sources of  bonus attack speed, and is increased on an enemy  champion  takedown.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> When Varus kills an enemy, he gains 10% / 15% / 20% (based on level) bonus attack speed as well as bonus attack damage and ability power equal to 10% bonus attack speed for 5 / 7 / 9 / 11 (based on level) seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Varus charges while being slowed by 20% for up to 4 seconds to increase Piercing Arrow\'s range over the first 1.5 seconds and its effects over the first 1.25 seconds of the channel.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Passive:  Varus\'  basic attacks deal bonus magic damage and apply a  stack of Blight, up to 3. His  abilities detonate all Blight stacks on enemies hit to apply new effects.',
      castTime: 'none',
      cooldown: '40',
      cost: '0',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Varus\' basic attacks are empowered to deal bonus magic damage and apply a stack of Blight on-hit for 6 seconds, refreshing on subsequent applications and stacking up to 3 times. Varus\' abilities detonate all Blight stacks on enemies hit.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Varus\' next Piercing Arrow within 5.5 seconds is empowered to deal additional bonus magic damage, increased by 0% - 50% (based on Piercing Arrow\'s charge time). This damage is capped at 360 against monsters.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Varus ends Blighted Quiver and places it on a 1-second cooldown.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Varus fires a hail of arrows to the target location that deals physical damage to enemies hit.',
      castTime: '0.2419',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Varus fires a hail of arrows at the target location that land after 0.5 seconds, dealing physical damage to enemies hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Varus unleashes a tendril in the target direction that infects the first enemy champion hit, dealing magic damage and  rooting them for a short time. They are also  revealed and rapidly inflicted with  Blight stacks.',
      castTime: '0.2419',
      cooldown: '100 / 80 / 60',
      cost: '100',
      damageType: 'Magic damage',
