    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <div
                ...
                <InfoCard
                    cardClass=" h-[350px] w-[250px]  bg-transparent backdrop-blur-none bg-gradient-to-b from-base-100/40 from-0% to-base-100 via-base-100/70 delay-400 transition-all duration-400"
