...
<template>
    <div
        ...
        <Tooltip content="Open Pocket" align="bottom" dark>
            <Button class="grid place-items-center" :style="layer0" as-child>
        ...
        <Dropdown
            ...
            <template #1>
                <Tooltip content="More..." align="bottom" :sideOffset="15" dark>
                    <icon
            ...
            <div
                ...
                <Button @click="deletePocket(pocket.key)" :variant="variant">
