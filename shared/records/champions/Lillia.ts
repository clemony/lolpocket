  ...
  abilities: [
    {
      ...
      affects: 'Enemies',
      blurb:
        'Innate:  Lillia\'s abilities apply Dream Dust to enemies hit, which continually deals magic damage based on the target\'s maximum health over a short time, and  heals her for the same duration.',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Lillia\'s abilities apply Dream Dust to enemies hit, which deals[ 5% (+ 1.25% per 100 AP) of the target\'s maximum health total magic damage over 3 seconds, capped at 65 against monsters. ][ 0.83% (+ 0.2083% per 100 AP) of the target\'s maximum health magic damage every 0.5 seconds over 3 seconds, capped at 10.83 per tick against monsters. ]</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        'Passive: Whenever  Lillia\'s  abilities hit at least one enemy, she generates a  stack of Prance, up to a cap.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Whenever Lillia\'s abilities hit at least one enemy, she generates a stack of Prance for 6.5 seconds, refreshing on subsequent hits and stacking up to 4 times. Stacks expire by one every 1.5 seconds when the duration ends.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Prance:</span> For each stack, Lillia gains bonus movement speed.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lillia swings her censer around her, dealing magic damage to nearby enemies. Enemies hit within the outer edge of the area additionally take the same amount as bonus true damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lillia  dashes toward the target area and smashes her censer, dealing magic damage to enemies hit. Enemies hit within the epicenter are dealt  increased damage.',
      castTime: 'None',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lillia dashes to 150 units in front of the target location over 0.759 seconds, though not through terrain, and deals magic damage in an area around the target spot. Enemies hit within the epicenter are dealt 200% increased damage.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
      ...
      maxCharges: -1,
      notes:
        'Lillia dashes to her target location over 0.627 to 0.759 seconds, but cannot move before the strike goes off at 0.759 seconds, regardless.\nLillia can hop over the edges of certain walls despite the ability being unable to traverse terrain.',
      resource: 'Mana',
      spellEffects: 'aoe',
      spellshieldable: 'true',
      targeting: 'Location',
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lillia lobs a seed at the target area that rolls forward indefinitely. The seed detonates upon hitting an enemy or terrain, dealing magic damage to enemies in a cone,  slowing and  revealing them for a short time.',
      castTime: '0.4',
      cooldown: '12',
      cost: '70',
      damageType: 'Magic damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lillia lobs a seed at the target location that rolls forward indefinitely. The seed detonates upon hitting an enemy or terrain while on the ground, dealing magic damage to enemies in a cone, slowing them by 40% for 3 seconds and revealing them for 2 seconds.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lillia casts a magical lullaby over all enemy  champions affected by  Dream Dust, making them  drowsy before falling  asleep for a few seconds.',
      castTime: '0.4',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lillia casts a magical lullaby over all enemy champions affected by Dream Dust, which arrives after 0.3 seconds and renders them drowsy for 1.5 seconds, slowing them by 10%. After the duration, they fall asleep for 2 seconds.</p>',
        },
        {
          description:
