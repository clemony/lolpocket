...
<template>
    <LayoutSpacer />
    <Card
        class="relative size-full max-h-[84.5%] max-w-[98%] overflow-hidden pl-12">
        <div>
            <ag-grid-vue
                :theme="pocketTheme"
        ...
        <div
            class="rounded-top-lg absolute left-0 top-0 z-10 h-10 w-full bg-base-100/80 backdrop-blur-md before:absolute before:size-10 before:bg-base-200/20">
            <ag-grid-vue
                :theme="pocketTheme"
