                ...
                <template #header>
                    ...
                    <div
                        ...
                        <InputEditable
                            ...
                            class="w-fit items-center truncate border-transparent text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200 @xs/set:hidden">
                            <Button
                                variant="simple"
                                size="xs"
