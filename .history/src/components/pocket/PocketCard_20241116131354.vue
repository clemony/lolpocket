        ...
        <Transition
            ...
            <div
                ...
                <InfoCard
                    ...
                    <template #header>
                        <h2
                            class="mt-6 transition-all duration-200 animate-in animate-out fade-in-100 fade-out-0">
                            {{ pocket.name }}
                        </h2>
                    </template>
                    <template #description>
                        <p
                            ...
                            class="text-base font-medium transition-all duration-200 animate-in animate-out fade-in-100 fade-out-0">
                            {{ tag }}
                        </p>
                    </template>
