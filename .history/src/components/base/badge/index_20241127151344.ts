...
export const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-sm  transition-colors focus:outline-hidden focus:ring-2 focus:ring-b2 focus:ring-offset-2 ',
  {
    variants: {
      variant: {
                default:
          'border-transparent bg-b2 text-base-content hover:bg-b2/80',
        primary:
