        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div class="z-10 col-start-1 size-full">
                        <div
                            class="col-start-1 grid w-full grid-flow-row auto-rows-auto grid-cols-3 justify-items-center gap-1 gap-y-2 last:col-start-3 [&_:nth-child(4)]:col-start-2"
                            v-if="set">
                ...
                <img
                    ...
                    :src="
                        pocket.runes[0].runeSets[pocket.runes[0].starred]
                            .keystone.img
                    "
                    class="mask absolute -bottom-10 -left-10 z-0 h-auto w-1/2 rounded-full mask-b-2 mask-l-14 mask-r-6 mask-t-[40px]" />
            </CardContent>
        </Card>
