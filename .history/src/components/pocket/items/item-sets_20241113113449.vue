    ...
    <VueDraggable
        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-1"
                :cardClass="{
                    'relative max-w-[95%] before:absolute before:bg-transparent before:border  before:w-full before:h-full  before:pointer-events-none before:border-transparent before:z-50  before:shadow-inner before:rounded-box':
                        set,
                    ' before:border-neutral/70': set == is.selectedSet,
                }">
                <template #header>
                    ...
                    <div class="-mt-1 flex w-fit items-center gap-1">
                        <InputEditable
                            ...
                            class="items-center border-transparent text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200">
                            <div class="join h-inherit">
                                <Button
                                    variant="simple"
                                    size="xs"
                                    class="join-item aspect-square h-full rounded-l-none">
                                    <icon
                                ...
                                <Button
                                    variant="simple"
                                    class="join-item aspect-square h-full"
                                    size="xs"
                                    @click.stop="
