        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                <template #header>
                    ...
                    <label
                        class="group absolute right-0 top-0 h-full w-7 shrink-0">
                        <input
                            type="radio"
                            name="itemset"
                        ...
                        <img
                            ...
                            class="top-2/5 absolute size-5.5 shrink-0 group-hover:opacity-0" />

                        <img
                            src="/img/ui/caret.gif"
                            class="top-2/5 absolute size-7 shrink-0 opacity-0 transition-all duration-500 group-hover:opacity-40" />
                    </label>
                </template>
