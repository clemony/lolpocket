  ...
  >
    ...
    >
      ...
      <div class="relative grid size-full place-items-center">
        ...
        >
          ...
          <div
            ...
            role="progressbar"
          >
            <span v-if="entry" class="font-medium text-bc dst">
      ...
      >
        ...
        <p class="text-4 font-semibold capitalize">{{ entry?.lp ?? 0 }} LP</p>

        <p
          v-tippy="`${entry ? entry?.wins + entry?.losses : 0} total`"
          class="flex items-center justify-end gap-1 text-end text-1 text-nowrap decoration-dotted underline-offset-2 hover:underline"
        >
