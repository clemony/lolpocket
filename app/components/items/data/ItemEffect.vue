...
<template>
  <div
    ...
    <div
      v-if="data.cooldown" class="w-full mt-2 ml-6 flex gap-1 items-center ws-no-wrap text-nowrap">
      <Img img="/img/icons/manaless.webp" alt="cooldown-icon" class="size-4 mt-px" />
      <!-- &nbsp;Cooldown:&nbsp; -->
      <span
        class=""
        v-html="data.cooldown" />second cooldown
    </div>
  </div>
</template>
