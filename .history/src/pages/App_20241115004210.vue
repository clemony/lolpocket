...
<template>
    ...
    <Toaster />
    <SidebarProvider>
        <Sidebar collapsible="icon" class="justify-center border-r-transparent">
            <MainSidebarHeader />
                                        ...
                                        <SidebarMenuBadge>
                                            <Badge
                                                ...
                                                v-if="
                                                    ...
                                                    ps.pockets.length
                                                "
                                                class="absolute -right-px -top-[11px] flex min-w-8 items-center justify-center px-1.5 group-hover/pocket:opacity-60">
                                                {{ ps.pockets.length }}
                                            </Badge>
                                        </SidebarMenuBadge>
                                    </SidebarMenuButton>
                                                            ...
                                                            <Badge
                                                                ...
                                                                v-if="
                                                                    ...
                                                                    item.array
                                                                        .length
                                                                "
                                                                class="absolute -right-[7px] -top-[11px] flex min-w-8 items-center justify-center px-1.5 group-hover/pocket:opacity-60">
                                                                {{
                                                                    item.array
                                                                        .length
                                                                }}
        ...
        <SidebarInset class="relative">
            ...
            <div
                ...
                class="absolute inset-0 left-0 top-0 m-0 h-full w-full max-w-full overflow-y-clip rounded-tl-box border border-base-300 !bg-base-100/90 object-contain !p-0 !shadow-[inset_-12px_-8px_40px_#00000020] first:flex first:contain-inline-size">
