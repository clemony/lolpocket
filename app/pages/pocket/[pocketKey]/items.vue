    ...
    <ResizablePanelGroup
      ...
      <TabResizeBar class="">
        <RadioGroup
          ...
          class="tabs absolute top-8 flex  flex-row-reverse flex-nowrap tabs-lift tabs-xl w-full grow pb-13.25 ">
          <label class="aspect-square has-disabled:pointer-events-none has-disabled:opacity-60 size-13 grid place-items-center ">
            ...
            <div class="rounded-full size-6 grid place-items-center peer-checked:shadow-sm peer-checked:drop-shadow-sm peer-checked:bg-n1/90 peer-checked:stroke-[1.5] hover:stroke-[1.4] tldr-20  peer-checked:*:text-nc">
              <icon
                ...
                class="dst rotate-90 shrink-0 size-3.75 " />
            </div>
          </label>
      ...
      <ResizablePanel
        :min-size="35"
        class="shadow-warm-2 relative  overflow-hidden flex flex-col z-0 justify-end">
        <Field
          class="size-full  relative  transition-all duration-500 justify-center overflow-y-auto  max-h-screen "
          :style="{
