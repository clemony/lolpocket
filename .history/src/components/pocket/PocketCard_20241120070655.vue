    ...
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    class="max-w-inherit col-start-1 mt-2 grid w-full grid-cols-[2.5fr_1fr] gap-x-3 gap-y-5 px-2">
                    <div
                    ...
                    <div
                        v-if="set"
                        class="col-start-2 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-center justify-items-center gap-x-2.5 gap-y-2 p-1.5">
