...
<template>
    <div class="flex justify-center">
        <div
            class="grid grid-cols-3 max-w-64 gap-y-7 gap-x-12 place-items-center">
            <label
                v-for="shard in ds.shards"
                :class="shard.slotName"
                class="rounded-full group/shard shard"
                :alt="shard.stats"
                :title="shard.stats"
                ...
                <input
                    ...
                    :value="shard.name"
                    v-model="
                        rs.shardModels['v' + rs.selectedSetKey + shard.slotName]
                    "
                    class="hidden peer"
