  ...
  >
    <div class="flex items-center gap-2">
      <HoverBtnSm :tip="isPlaying ? 'Pause' : 'Play'">
        <icon v-if="isPlaying" name="pause" class="shrink-0 opacity-60" />

        <icon v-else name="play" class="size-4 shrink-0 opacity-60" />
      </HoverBtnSm>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          <HoverBtnSm tip="Options">
            <icon name="gear-solid" class="size-4 shrink-0 opacity-50" />
          </HoverBtnSm>
        </DropdownMenuTrigger>
        ...
        >
          ...
          >
            ...
            <Switch
              ...
              class="scale-85 justify-self-end border-b4/50 from-lime-400/90 to-ah/90 to-60% inset-shadow-xs data-[state=checked]:bg-linear-to-br data-[state=unchecked]:bg-b3/40"
            />
          </div>
        </ContrastDropdownContent>
      </DropdownMenu>
