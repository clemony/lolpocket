        ...
        <Card
            ...
            <CardContent
                ...
                <div class="flex w-full gap-3">
                    <div
                        class="-mt-6 h-full w-[47%] max-w-[47%] items-center justify-center space-y-1">
                        <div
                            class="relative ml-14 mt-14 flex h-full w-fit items-center justify-center rounded-full">
                            <!--                 <div
                            ...
                            <div
                                class="z-0 size-full [&_:first-child]:-right-[4rem] [&_:first-child]:-top-[0.3rem] [&_:last-child]:-bottom-[2.8rem] [&_:last-child]:-right-[3.3rem]">
