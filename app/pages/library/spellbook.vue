      ...
      <Transition
        ...
        <div :key="selectedSpell" class="flex flex-col gap-14 w-160 transition-all duration-300">
          ...
          <div class="bg-black/90 w-full  rounded-xl shadow-pretty ">
            <video-background
              :src="`https://raw.communitydragon.org/latest/plugins/rcp-fe-lol-collections/global/default/video/spells/spells_${spells[selectedSpell].id}.webm`"
