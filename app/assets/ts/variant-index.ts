...
export const variantStyle = cva('data-[state=active]:btn-active text-start data-[state=open]:btn-active has-[span:empty]:gap-0 ', {
  variants: {
    variant: {
      'default': '',
      ...
      'shadow': 'btn shadow-xs shadow-black/6 hover:shadow-black-2 drop-shadow-black/2 drop-shadow-xs hover:inset-shadow-xs hover:drop-shadow-none hover:inset-shadow-black/6 border-b3/80 bg-b1 btn-extras hover:bg-tint-b2/20 noise-sm [&.btn-active]:bg-tint-b2/20 ',
