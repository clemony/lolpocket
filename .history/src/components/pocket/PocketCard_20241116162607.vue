...
<template>
    <label class="swap swap-flip relative h-[300px] w-[250px]">
        <input type="checkbox" />

        <Card
            class="swap-off h-[300px] w-[250px] max-w-[250px] overflow-hidden rounded-box bg-[20%_-125%] bg-no-repeat [background-size:200%]"
            :style="{
            ...
            <CardContent
                ...
                <div
                    class="max-w-inherit col-start-2 mt-2 grid w-full grid-cols-[2.5fr_1fr] gap-x-3 gap-y-5 px-2">
                    <div
                        class="col-start-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-items-center gap-1">
                    ...
                    <div
                        v-if="set"
                        class="z-10 col-start-1 size-full grid-flow-col auto-rows-auto">
                        <img
                            v-if="
                        ...
                        <template v-for="rune in runes">
                            <div class="shadow-sm">
                                <LoadImg
                                    v-if="rune.name != 'none'"
                                    :url="rune.img"
                                    class="col-start-1 size-[40px] rounded-full" />
        ...
        <Card class="swap-on h-[300px] w-[250px]"></Card>
    </label>
</template>
