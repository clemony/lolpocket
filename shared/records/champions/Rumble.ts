  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Rumble generates 20 Heat to activate his flamethrower for 3 seconds, dealing magic damage every 0.25 seconds to enemies hit in a frontal cone, reduced to 70% against minions.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Danger Zone Bonus:</span> Flamespitter\'s damage is increased by 50%.</p>',
          leveling: [
            {
        ...
        {
          description:
            "Flamespitter's total damage based on the target's health is capped at 65 - 300 (based on level) against monsters.",
        },
      ],
      icon: "https://cdn.communitydragon.org/latest/champion/Rumble/ability-icon/q",
      maxCharges: -1,
      notes:
        "Flamespitter will deal an additional tick of damage to a minion if it would die to its per-tick damage.\nRumble will instantly turn to face the cursor if he is not moving when Flamespitter is cast.",
      projectile: "FALSE",
      spellEffects: "AoeDoT",
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Rumble briefly  shields himself and gains  bonus movement speed.",
      castTime: "none",
      cooldown: "6",
      cost: "0",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Rumble generates 20 Heat to grant himself a shield for 1.5 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Danger Zone Bonus:</span> Scrap Shield\'s shield strength and bonus movement speed are increased in effectiveness by 50%.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Rumble shoots a harpoon in the target direction that deals magic damage and briefly  slows the first enemy hit, reducing their  magic resist for a few seconds. These effects can stack with multiple harpoons.",
      castTime: "0.25",
      cooldown: "0.5",
      cost: "0",
      damageType: "Magic damage",
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Danger Zone Bonus:</span> Electro Harpoon\'s effects are increased by 50%.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Rumble deploys a barrage of rockets along the target path that land in a line over 0.75 seconds, creating a field of fire for 4.5 seconds after the last rocket lands.</p>',
        },
        {
          description:
