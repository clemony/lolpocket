                        ...
                        <CardContent
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    ">
                                    <div
                                        class="size-full bg-[50%_10%] bg-no-repeat [background-size:200%] after:absolute after:-left-2 after:top-2 after:isolate after:z-10 after:size-16 after:rounded-full after:ring-1 after:ring-neutral"
                                        :style="layer1" />
                                </div>
                            </div>
