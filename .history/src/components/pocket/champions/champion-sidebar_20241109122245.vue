            ...
            <div class='relative w-fit'>
                ...
                <VTooltip theme="tt" placement="bottom"
                    ...
                    <a :href="champion.wiki" target="_blank"
                        class="badge relative z-10  flex aspect-square size-8 p-2 cursor-alias overflow-hidden rounded-full border-none bg-neutral ring-[3px] ring-neutral-content hover:ring-transparent text-neutral-content">
