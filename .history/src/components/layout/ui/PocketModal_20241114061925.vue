...
<template>
        ...
        <form ref="form" class="grid grid-cols-[4fr_1.5fr_2fr] gap-10 py-4 [&_label]:text-base" @submit.prevent.stop="submitForm">
            <div class="flex flex-col gap-2">
                ...
                <div class="join ">
                    <Input
                        ...
                        class="h-10 join-item text-base border-r-0" />
                    
                            <Button
                                variant="outline"
                                size="sm"
                                class="h-10 group overflow-hidden join-item aspect-square !border-l-0">
                                <icon
                                    icon="qlementine-icons:close-16"
                                    class="size-6 shrink-0 object-cover opacity-60 group-hover:opacity-100" />
                            </Button>
                    <Button
                        variant="outline"
                        size="sm"
            ...
            <div class="flex flex-col gap-1 ">
                ...
                <Label for="pocket-tags" class="">Colors</Label>
                    <DropdownMenu class="w-full">
                        <DropdownMenuTrigger
                            class="mt-1.5 rounded-md data-[state=open]:bg-base-200/60 w-full">
                            <Button variant="ghost" size="sm" class='text-base w-full justify-start '>
                                <span
