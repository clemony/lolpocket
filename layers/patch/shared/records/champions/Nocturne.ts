  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description: 'Umbra Blades can critically strike against the primary target, modifying the physical damage dealt to[ (192.5% + 33%) AD. ][ 110% AD × total critical damage. ]'
        },
        {
