...
<template>
    <div
        ...
        <div :rune="rune" :key="rune.name" class="h-full">
            ...
            <label
                :key="rune.name + '1'"
                class="frost border-b-base-300 sticky top-0 left-0 z-50 flex h-fit! w-full flex-wrap items-center justify-end gap-4 rounded-t-xl border-b px-4 py-1">
            ...
            <div
                ...
                <div
                    id="runeStats"
                    :key="rune.name + '3'"
                    class="mt-1 text-justify font-serif text-[0.76rem] whitespace-pre-line first-letter:float-left first-letter:mr-1.5 first-letter:text-3xl first-letter:font-[700] first-line:font-[700] first-line:tracking-widest first-line:uppercase">
                    {{ rune.stats }}
                </div>
            </div>
        </div>
...
[data-tier='3'] {
    ...
    #runeImg {
        @apply ring-base-200 ring-offset-base-300 size-14 ring-1 shadow-[inset_0px_0px_2px_3px_#00000099,_1px_2px_1px_2px_#00000018] ring-offset-1;
    }
