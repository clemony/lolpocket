        ...
        <ContextMenuTrigger
            ...
            <div class="flex size-full items-center justify-center gap-3">
                <template v-if="keystone && keystone.name != 'none' && runeSet">
                    ...
                    <div
                        v-show="isImageLoaded"
                        class="relative flex aspect-square size-10! shrink-0 cursor-pointer items-center rounded-full bg-linear-to-br from-transparent to-75% shadow-xs"
                        :class="{
                            ...
                            'to-bg-b2': !runeSet.secondary,
                        }">
                        <div
                            class="flex size-full items-start justify-center gap-2 rounded-full bg-linear-to-br from-b1/90 to-b1/40 p-1 backdrop-blur-md">
                            <KinesisContainer
                    ...
                    <div
                        ...
                        <KinesisContainer
                            ...
                            <KinesisElement
                                ...
                                class="group flex size-full items-center">
                                <div
                                    class="aspect-square! size-10! cursor-pointer text-clip rounded-full bg-b1/70 p-2.5 backdrop-blur-md group-hover:scale-90">
                                    <img
