    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-8 items-center'>
            <div class='relative w-fit'>
                <div class='join join-vertical w-[70px] overflow-hidden'>
                    <loadImg
                        class="join-item size-[70px] scale-110 mr-2px border-base-300 border shadow-sm aspect-square object-center shrink-0"
                        :url="`/img/champions/${clean(champion.name)}.webp`" />
                    <div class='join-item join join-horizontal w-full'>

                        <VTooltip theme="tt" placement="bottom" class="w-1/2 " alt="view on Wiki">

                            <a :href="champion.wiki" target="_blank">
                                <Button variant="neutral" class="items-center justify-center join-item    group">
                                    <Icon icon="ph:link-simple"
                                        class=" size-full duration-500 transition-all  group-hover:rotate-180" />
                                </Button>
                            </a>
                        ...
                        <Button variant="outline" size="icon"
                            class="group/liked w-1/2 join-item [&_svg]:absolute !apsect-square rounded-full [&_svg]:transition-all [&_svg]:duration-500 [&_svg]:pt-px [&_svg]:size-4.5"
