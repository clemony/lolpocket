...
<template v-if="set">
    <template v-for="rune in this1">
        <div
            class="absolute shrink-0 rounded-full border border-base-300/70 bg-base-100/50 p-1.5 shadow-[0_3px_10px_rgb(0,0,0,0.2),inset_-1px_-1px_2px_2px_#00000024] backdrop-blur-sm">
