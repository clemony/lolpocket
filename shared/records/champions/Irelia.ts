  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Irelia's  abilities generate a  stack of Ionian Fervor for each enemy champion hit, as well as one stack if she hits at least one non-champion.  Basic attacks against enemy  champions and large  monsters will also refresh the duration.",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Irelia generates a stack of Ionian Fervor for each enemy champion hit by her abilities, or if she hits at least one non-champion, lasting for 6 seconds, refreshing on basic attacks and ability hits against enemy champions, large monsters, and structures, and stacking up to 4 times.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Ionian Fervor:</span> For each stack, Irelia gains 10% - 25% (based on level) bonus attack speed, up to a maximum of 40% - 100% (based on level). At maximum stacks, Irelia\'s basic attacks are empowered to deal 10 - 61 (based on level) (+ 20% bonus AD) bonus magic damage on-hit, reduced to[ 50% ][ 5 - 30.5 (based on level) (+ 10% bonus AD) ]against structures.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Unsteady:</span> Enemy champions and large monsters hit by Flawless Duet and Vanguard\'s Edge\'s initial barrage are marked as Unsteady for 5 seconds. The mark can be consumed by Bladesurge.</p>',
        },
      ],
    ...
    },
    {
      ...
      blurb:
        "Active:  Irelia  dashes through the target enemy, dealing physical damage, applying  on-hit effects, and  healing herself.",
      castTime: "none",
      cooldown: "10 / 9 / 8 / 7 / 6",
      cost: "15",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Irelia dashes 100 units through the target enemy\'s location, and upon collision or dash completion, she deals physical damage, applies on-hit effects, and heals herself. Bladesurge deals 50 - 237 (based on level) bonus physical damage to minions.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Irelia charges for up to 1.5 seconds, during which she increases Defiant Dance\'s damage over the first 0.75 seconds of the channel and reduces incoming physical damage by 40% - 70% (based on level) (+ 7% per 100 AP) and incoming magic damage by 20% - 35% (based on level) (+ 3.5% per 100 AP).</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Irelia swipes her blades in the target direction, dealing physical damage to enemies around her and within a line, increased by 0% - 200% (based on channel time). She also retains the damage reduction for 0.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Irelia sends a blade to the target location for 3.5 seconds. Flawless Duet can be recast after 0.15 seconds while the blade is active, and does so automatically at the end of its duration, though not if she is unable to cast abilities.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Irelia sends a second blade to the target location, or to her current position if Flawless Duet was recast automatically.</p>',
        },
        {
          description:
        ...
        {
          description:
            "Flawless Duet's recast can be used during Bladesurge and the cast time of Vanguard's Edge. Each of the blades' travel times are 0.264 seconds.",
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Irelia launches a barrage of blades in the target direction that expand outward upon hitting an enemy champion, dealing magic damage to enemies hit.",
      castTime: "0.4",
      cooldown: "125 / 105 / 85",
      cost: "100",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Irelia launches a barrage of blades in the target direction, expanding outward upon hitting an enemy champion, dealing magic damage to all enemies hit and revealing them for 1 second.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
