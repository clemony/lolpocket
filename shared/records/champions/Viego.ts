  ...
  abilities: [
    {
      ...
      blurb:
        "Innate: Scoring an enemy champion  takedown will spawn a Mist Wraith for a period.  Viego can consume the Mist Wraith to briefly become  untargetable and  blink to it, which  heals him for a portion of the target's maximum health and grants Possession.",
      effects: [
        {
          description:
    ...
    },
    {
      ...
      blurb:
        "Passive:  Viego's basic attacks deal bonus physical damage based on the target's current health. Additionally, Viego's damaging abilities apply a mark to enemies hit. His next basic attack will consume the mark to strike twice, dealing additional modified physical damage and  healing him.",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Viego\'s basic attacks are empowered to deal bonus physical damage on-hit. This damage is affected by critical strike modifiers, has a minimum threshold and is capped at 80 against monsters.</p>',
          leveling: [
            {
        ...
        {
          description:
            "Additionally, his damaging abilities apply a mark to enemies hit for 4 seconds. Viego's next basic attack against a marked target is empowered to consume the mark on-hit to strike a second time, dealing 20% AD (+ 15% AP) physical damage; and also healing himself for 135% of the post-mitigation damage dealt, modified to 145% against monsters and 50% against minions.",
        },
        {
          description:
            "The second strike applies on-hit effects and can critically strike for (175% + 40%) damage.",
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Viego stabs in a line in the target direction that deals physical damage to enemies hit, plus 15 bonus physical damage against monsters. The stab\'s damage is increased by 0% - 100% (based on critical strike chance).</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Viego charges while being slowed by 10% for up to 3 seconds to increase Spectral Maw\'s missile range and stun duration over the first second of the channel.</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Viego hurls a blast of mist in the target direction and dashes a fixed distance in the same direction, though not through terrain. The mist deals magic damage to the first enemy hit and stuns them for 0.25 - 1.25 (based on channel time) seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Viego sends a spectre in the target direction that creates a trail of mist in its wake for a period. If it hits terrain, the mist is spread further around either side.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Viego sends a spectre in the target direction that creates a trail of mist in its wake which lasts 8 seconds. If it hits terrain, the mist will spread further around either side.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Self, Enemies",
      blurb:
        "Active:  Viego  blinks with  displacement immunity to the target location and attacks the most wounded enemy champion nearby, which briefly  slows them, applies  on-hit effects, and deals bonus physical damage by a portion of their missing health.",
      castTime: "0.5",
      cooldown: "120 / 100 / 80",
      cost: "0",
      damageType: "Physical damage",
      ...
      effects: [
        ...
        {
          description:
            "All targets hit are dealt 120% - 240% (based on critical strike chance) AD physical damage.",
        },
        {
          description:
