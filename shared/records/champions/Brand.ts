  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description:
            "Brand cannot stack Ablaze more than once on enemies that have had a ring explode from them in the last 4 seconds.",
        },
        {
          description:
            "The ring will form even if the target dies to the ability applying the third stack, and will still trigger the explosion if the target dies before it.",
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Brand launches a fireball in the target direction that deals magic damage to the first enemy hit.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Ablaze Bonus:</span> The target is stunned for 1.5 seconds.</p>',
        },
      ],
      icon: "https://cdn.communitydragon.org/latest/champion/Brand/ability-icon/q",
      maxCharges: -1,
      notes:
        "With an ability haste value of 81 / 70 / 58 / 47 / 36 to 162 / 145 / 129 / 113 / 96 based on the ranges of applications from the target, it is possible to apply the stun without having to use other abilities. Sear will apply before the duration of the pre-applied  Blaze times out.\nThe needed ability haste value if you remained at the same range from the target for both casts would be 114 / 100 / 87 / 74 / 60.\nThis ability will cast from wherever the caster is at the end of the cast time.",
      projectile: "TRUE",
      resource: "Mana",
      speed: "1600",
      spellEffects: "spell",
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> After a 0.627 seconds delay, Brand erupts a pillar of flame at the target location that deals magic damage to enemies hit.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Ablaze Bonus:</span> The target takes 25% increased damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Brand sets the target enemy aflame, which creates a blast that deals magic damage to them and causes the flame to spread from the target to nearby enemies, dealing them the same damage.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Ablaze Bonus:</span> Conflagration\'s spread range is doubled.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Brand launches a fireball at the target enemy that bounces between nearby enemies and Brand up to four times, dealing magic damage to enemies each time and having a 0.15-second delay between bounces.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Ablaze Bonus:</span> The target is slowed for 0.25 seconds. This can affect the same enemy more than once.</p>',
          leveling: [
            {
              attribute: "Slow",
              modifiers: [
