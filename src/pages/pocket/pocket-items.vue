...
<template>
    <Splitpanes
        ...
        <Pane size="55" min-size="18" max-size="82" class="relative z-0 h-full">
            <div
                class="items-start flex w-full gap-2.5 !h-9 flex-wrap pl-1.5 pr-3.5">
                <h2 class="text-xl font-semibold tracking-tight">Item Sets</h2>

                <button
                    :class="{ click: animated == true }"
                    @animationend="animated = false"
                    @click="handleClick"
                    class="relative mt-[4px] self-start grid size-5 group/add *:size-full"
                    title="add set"
                    alt="add set">
                    <Icon
        ...
        <Pane
            ...
            <div
                ...
                <div
                    class="flex content-center justify-end w-full gap-1.5 px-2 mb-[5px] h-6">
                    <label
                        alt="Filter Likes"
                        :title="likeText"
                        ...
                        <input
                            type="checkbox"
                            v-model="is.viewLiked"
                            class="hidden"
                            :disabled="is.likedItems.length == 0" />

                        <icon
                            v-if="is.likedItems.length > 0"
                        ...
                        <icon
                            ...
                            class="mb-[4px] text-base-content/30 size-5" />
                    </label>
            ...
            <div
                class="relative z-[2] overflow-auto h-full px-3 shadow-inset rounded-b-box">
