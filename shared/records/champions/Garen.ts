  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate:  Garen continually  regenerates a portion of his  maximum health.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Garen regenerates an additional[ 1.5% - 10.1% (based on level) of his maximum health every 5 seconds. ][ 0.15% - 1.01% (based on level) of his maximum health every 0.5 seconds. ]</p>',
        },
        {
          description:
            'Perseverance is lost for 8 seconds if Garen takes damage from champions, epic monsters, or turrets, or if he is hit by an enemy ability or affected by an enemy summoner spell, refreshing on subsequent damage and hits taken from them.',
        },
      ],
    ...
    },
    {
      ...
      blurb:
        'Active:  Garen gains  bonus movement speed and  cleanses from  slows.',
      castTime: 'none',
      cooldown: '8',
      cost: '0',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Garen cleanses himself of all slows and gains 35% bonus movement speed for a duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Passive:  Garen permanently gains bonus  armor and  magic resist by killing enemies, up to a cap. Upon reaching the cap, he gains another permanent boost to these defenses.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Whenever Garen kills an enemy, he generates a stack of Courage, stacking up to 150 times.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Courage:</span> For each stack, Garen gains 0.2 bonus armor and 0.2 bonus magic resistance, up to a maximum of 30 bonus resistances each.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Garen reduces incoming damage for 4 seconds. For the first 0.75 seconds, Garen additionally grants himself a shield and 60% tenacity.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Garen rapidly spins with his sword for a short time while  ghosted, continually dealing physical damage to nearby enemies. He spins more based on his  bonus attack speed.',
      castTime: 'none',
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Garen ends Judgment.</p>',
        },
        {
          description:
            'Judgment can critically strike for[ (140% + 32%) damage. ][ 80% total critical damage. ]',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Garen calls upon the might of Demacia onto the target enemy champion, dealing them true damage as well as revealing them for 1 second at the start of the cast time.</p>',
          leveling: [
            {
      ...
      maxCharges: -1,
      notes:
        'The target will die if they\'re at least under 20 / 21.57 / 23.08 / 24.53 / 25.93% maximum health + 120 / 156.86 / 192.31 / 226.42 / 259.26 flat health on top of that. This does not count effects that mitigate true damage, such as  shields.\nIf the target becomes  untargetable,  dies, or is too far away or no longer in  sight during the cast time, this ability will cancel but does not go on  cooldown nor pay its cost (if applicable).',
      spellEffects: 'spell',
