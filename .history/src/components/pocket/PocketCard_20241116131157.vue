    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <div
                ...
                class="absolute rounded-box bg-[20%_-45%] bg-no-repeat transition-all duration-1000 animate-in animate-out fade-in-0 fade-out-100 [background-size:200%]">
                <InfoCard
        ...
        <Transition
            ...
            <Card
                v-if="flip"
                class="absolute h-[350px] w-[250px] transition-all duration-1000 animate-in animate-out fade-in-100 fade-out-0">
                hi
            </Card>
        </Transition>
    </label>
