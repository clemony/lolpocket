...
<template>
<div v-if="champion" class="grid !max-h-full grid-cols-1 grid-rows-[min-content_1fr_min-content] gap-4">
    <div
        ...
        <div class="col-span-2 grid grid-cols-3 gap-1 p-1">
                ...
                <div class="justify-content-center z-0 my-auto grid h-16 w-16 rounded-full object-contain">
                    <svg role="none" class="z-10 h-full w-full">
                        ...
                        <g mask="url(#circle)">
                            <image x="-6px" y="-6px" height="115%" width="115%" class="max-w-[115%]"
                                :href="`/img/champions/${clean(champion.name)}.webp`">
                            </image>
                    ...
                    <VTooltip theme="tt"
                        ...
                        <a :href="champion.wiki" target="_blank"
                            class="badge relative z-10  flex aspect-square size-[22px] cursor-alias overflow-hidden rounded-full border-none bg-base-content object-cover p-[3px] text-base-100 ring-[3px] ring-base-100 hover:ring-transparent">
            ...
            <div class="relative col-span-2 col-start-2 -ml-1 -mt-1 antialiased">
                <h2 class="mb-0.5 pb-0 !tfont-semibold tracking-tight antialiased">
                    {{ champion.name }}
                </h2>
