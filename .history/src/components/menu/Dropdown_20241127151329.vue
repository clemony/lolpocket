    ...
    <DropdownMenu>
        <DropdownMenuTrigger as-child>
            <Button
                :class="
                    cn(
                        'focus:ring-b2! data-[state=open]:ring-base-300/40! flex h-full w-full flex-nowrap items-center rounded-lg border-0! px-3 text-base ring-0! focus:border-0! focus:ring-1! focus:outline-0! data-[state=open]:ring-1! data-[state=open]:shadow-xs',
                        props.class
                    )
                "
