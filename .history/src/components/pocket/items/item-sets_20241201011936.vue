...
<template>
    <VueDraggable
        ...
        <Card
            class="mb-12 grid h-[60px] w-full cursor-pointer items-center justify-center border-base-200 bg-base-200/10 opacity-80 !shadow-sm transition-all duration-300 hover:bg-base-200/40 hover:opacity-100 hover:shadow-inset"
