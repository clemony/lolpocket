                ...
                <DropdownMenu>
                    <DropdownMenuTrigger
                        ...
                        <SidebarMenuButton
                            variant="ghost"
                            size="md"
                            class="flex aspect-square h-full shrink-0 flex-nowrap items-center gap-3 !border-0 !ring-0 focus:!border-0 focus:!outline-0 focus:!ring-1 focus:!ring-base-200">
                            <div
