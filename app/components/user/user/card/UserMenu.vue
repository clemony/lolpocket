...
<template>
  ...
  >
    ...
    <template #content>
      <div
        class="tippy-content pointer-events-auto z-100 mb-1 w-64 max-w-88 py-2 *:first:pt-1 [&_button]:px-2"
      >
        <div class="mt-2 flex items-center gap-3 px-2 py-2">
          <UserAvatar :comment class="size-12" />
          <div class="inline flex-wrap justify-between space-x-2 align-middle">
            ...
            >
              <icon name="hash" class="inline size-3.5 pb-0.5" />{{
                comment.author.tag
              }}
            </span>
          </div>
        ...
        <div class="flex flex-col gap-1 px-1">
          <PopoverItem class="pl-7.5!"> View Profile </PopoverItem>
          <PopoverItem>
            <AIcon name="heart" class="size-4" />
            Follow
          </PopoverItem>
        </div>
        <Separator :size="1" />
        <div class="flex flex-col gap-1 px-1">
          ...
          <PopoverItem>
            <AIcon name="lucide:bell-ring" class="size-4!" />
            Report
          </PopoverItem>
        </div>
