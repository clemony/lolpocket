                            ...
                            <div
                                ...
                                <TransitionGroup name="fade">
                                    <label
                                        v-for="set in filter"
                                        v-close-popper
                                        class="sets hover:border-base-300 -ml-2.5 flex w-fit cursor-pointer items-center gap-4 overflow-hidden rounded-xl border border-transparent p-2 hover:shadow-xs"
                                        :key="set.key">
