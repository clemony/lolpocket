 export const Katarina: Champion =  {
  "id": 55,
  "key": "Katarina",
  "name": "Katarina",
    ...
    "Q": [
      {
        ...
        "effects": [
          ...
          {
            "description": "The Dagger then lands onto the ground after 1 second, about 350 units opposite from where it struck the first target."
          },
          {
            "description": "The target does not have to be visible for the Dagger to bounce to them."
          }
        ],
        "cost": [
          0
