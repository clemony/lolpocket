// Updated Patch 16.1 - 01/29/2026 04:27:18 PM CST
  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Active:</span> Zeri fires a burst of 7 rounds in the target direction over the cast time, each dealing physical damage to the first enemy hit.</p>",
          "leveling": [
            {
