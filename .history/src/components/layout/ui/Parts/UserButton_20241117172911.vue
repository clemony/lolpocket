...
<template>
    <MenubarMenu>
        <MenubarTrigger
            ...
            <Avatar
                class="border-1 mt-0.5 size-9 rounded-full border border-transparent shadow-sm">
                <AvatarImage
        ...
        <MenubarContent>
            ...
            <MenubarItem>
                <icon icon="ph:at" />
                Account
                <MenubarShortcutt class="flex gap-1">
            ...
            <MenubarSeparator />
            <MenubarItem class="gap-4 !text-sm font-medium">
                <icon
                    icon="qlementine-icons:on-off-16"
                    class="size-5 stroke-2" />
                Quit
                <MenubarShortcutt>⌘ Q</MenubarShortcutt>
            </MenubarItem>
        </MenubarContent>
    </MenubarMenu>
</template>
