...
<template>
    <div
        class="grid h-[250px] max-h-[250px] w-full auto-rows-min grid-cols-[1fr_3fr] overflow-hidden duration-500 animate-in animate-out slide-in-from-right-full slide-out-to-right-full">
        <div>
            <label class="">
        ...
        <ScrollArea
            class="col-start-2 flex h-full !justify-evenly justify-self-center overflow-y-auto rounded-md">
            <label
