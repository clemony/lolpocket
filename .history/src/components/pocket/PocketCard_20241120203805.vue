        ...
        <Card
            ...
            <CardContent
                ...
                <div class="flex w-full gap-3">
                    <div
                        class="absolute top-0 -mt-6 h-full w-[47%] max-w-[47%] items-center justify-center space-y-1">
                        <div
                            class="relative flex h-full w-fit items-center justify-center rounded-full">
                            <!--                 <div
