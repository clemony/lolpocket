    ...
    <div
        ...
        <div
            ...
            <label
                ...
                <SidebarProvider
                    class="page ease-[cubic-bezier(1,.1,.71,.97)] relative size-full overflow-hidden rounded-2xl bg-base-100/95 transition-all duration-1000 animate-in animate-out zoom-in-100 zoom-out-75 slide-in-from-top-0"
                    :class="
                        cn({
                            /*base */
                            ...
                            /* animation */
                            'transition-all duration-1000 animate-in zoom-in-75 slide-in-from-top-36':
                                gs.commandOpen,
