...
export const labelVariants = cva(
    'text-2 font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70',
    {
        variants: {
            button: {
                true: 'inline-flex gap-2 items-center justify-center whitespace-nowrap rounded-md text-2 font-medium ring-offset-b1 transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-accent/80 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50',
            },
            variant: {
