...
const item: Item = {
  ...
  passives: [
    ...
    {
      effects:
        'Granting yourself or an ally a <img src="/img/icons/heal.webp" class="tip-icon" />heal, <img src="/img/icons/shield.webp" class="tip-icon" />shield, or ability-sourced buff reduces the cooldown of <i>Pull Their Strings</i> by 5 seconds, once per cast.',
      unique: true,
    },
  ],
  rank: 'Special',
