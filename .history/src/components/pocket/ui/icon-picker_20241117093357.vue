...
<template>
    <div
        class="grid h-[333px] max-h-[333px] w-full grid-cols-[1fr_3fr] overflow-hidden duration-500 animate-in animate-out slide-in-from-right-full slide-out-to-right-full">
        <div>
            <label class="">
