  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Sylas'  ability casts generate  stacks of Unshackled that stack up to a cap. While he has stacks, he gains tremendous  bonus attack speed.",
      damageType: "Magic damage",
      effectRadius: "300",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Sylas casts an ability, he generates a stack of Unshackled for 4 seconds, refreshing on subsequent casts and stacking up to 3 times.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Unshackled:</span> Sylas\' next basic attack gains 125% bonus attack speed and is empowered to consume a stack to whirl his chains around him, which has an uncancellable windup and deals 130% AD (+ 30% AP) magic damage to the primary target and 40% AD (+ 20% AP) magic damage to nearby enemies.</p>',
        },
        {
          description:
        ...
        {
          description:
            "Petricite Burst can critically strike for (175% + 40%) damage only against the primary target.",
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Sylas lashes out two chains that converge at the target location, dealing magic damage to enemies hit and  slowing them for a brief moment.",
      castTime: "0.4",
      cooldown: "10 / 9 / 8 / 7 / 6",
      cost: "55",
      damageType: "Magic damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Sylas lashes out two chains that converge to the target location and extend beyond it up to a maximum range, dealing magic damage to enemies hit and slowing them for 1.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Sylas dashes to the front of the target enemy\'s location then strikes them to deal magic damage.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Sylas dashes to the target location. Within 3.5 seconds, he can cast Abduct after a 0.2-second delay from casting Abscond.</p>',
        },
        {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active: Sylas whips his chains in the target direction that deal magic damage and briefly  stun the first enemy hit,  revealing them. He will then  dash to the target and briefly  knock them up upon arrival.",
      castTime: "0.25",
      cooldown: "13 / 12 / 11 / 10 / 9",
      cost: "65",
      damageType: "Magic damage",
    ...
    },
    {
      ...
      blurb:
        "Active:  Sylas launches his chains at the target enemy champion, gaining a copy of their ultimate ability and briefly  revealing them. He cannot steal from the same champion again for a while, and can hold the hijacked ability for some time, during which he can recast Hijack.",
      castTime: "0.25",
      cooldown: "80 / 55 / 30",
      cost: "75",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Sylas launches his chains at the target enemy champion, gaining a copy of their ultimate ability and revealing them for 0.825 seconds at the start of the cast time. Sylas cannot select the same champion again for a set duration, and can hold the hijacked ultimate for up to 90 seconds, during which he can recast Hijack.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Sylas casts his hijacked ultimate ability at no cost, scaling based on Hijack\'s rank and his own statistics.</p>',
        },
        {
          description:
