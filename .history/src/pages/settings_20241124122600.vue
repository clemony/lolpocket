...
<template>
    <main class="grid size-full grid-cols-[250px_1fr]">
        <div class="flex-co. mx-auto mt-12 flex w-full max-w-6xl gap-2">
            <h1 class="!text-3xl font-semibold">Settings</h1>

            <nav class="flex flex-col gap-4 text-sm text-base-content/80">
