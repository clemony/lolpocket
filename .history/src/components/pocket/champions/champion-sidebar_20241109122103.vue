    ...
    <Card>
        ...
        <CardHeader class='flex flex-row'>
            <div class='relative w-fit'>
                ...
                <VTooltip theme="tt"
                    class="group/glow glow absolute -bottom-[4px] -right-[5px] grid size-9 items-center justify-center rounded-full  transition-all duration-500 before: hover:rotate-180"
                    alt="view on Wiki">
                    <!--     <div class="group-hover/glow:animate-ping size-[22px] absolute top-1 left-1 glow"> 
                                                                </div>-->
                    <a :href="champion.wiki" target="_blank"
                        class="badge relative z-10  flex aspect-square size-9 p-2 cursor-alias overflow-hidden rounded-full border-none bg-neutral ring-[3px] ring-neutral-content hover:ring-transparent text-neutral-content">
