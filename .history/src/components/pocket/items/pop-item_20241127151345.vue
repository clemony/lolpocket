...
<template v-if="props.item">
    <div class="relative grid w-72 max-w-96 min-w-60! overscroll-none p-4">
        <div
            class="border-b3 grid w-full grid-cols-[1fr_2fr] gap-2 border-b pb-3">
 ...
 -->
        ...
        <div
            ...
            "
            class="border-b3 grid grid-cols-1 gap-2 self-start border-b py-2 text-sm whitespace-pre-line">
            <p
                v-html="item.stats"
                v-if="item.stats"
                class="text-sm leading-5 capitalize"></p>
