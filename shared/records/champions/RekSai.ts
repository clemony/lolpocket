  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate:  Rek\'Sai\'s basic attacks and ability hits generate  Fury, which continually expires after a few seconds out of combat.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Rek\'Sai basic attacks and ability hits generate 25 Fury. After 8 seconds of being out of combat, she loses 20 Fury per second. Fury gain is reduced[ by 80% ][ to 5 per hit ]against minions, wards, and plants. Prey Seeker will not generate Fury against non- champions.</p>',
        },
        {
          description:
            'When Rek\'Sai becomes Burrowed, she consumes her current Fury over 3 seconds to heal for up to 10% - 20% (based on level) maximum health at 100 Fury, stopping once fully consumed or she reaches full health. If she starts generating Fury while Burrowed, the consumption occurs after 5 seconds.',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/RekSai/ability-icon/p',
      notes:
        'Fury bar changes from Yellow to Red when full.\nWhen Rek\'Sai automatically consumes Fury while Burrowed (no transformation), the healing buff will refresh every second while she has/maintains over 25 Fury.(note) This causes the healing to last 6 seconds at 100 Fury.',
      targeting: 'Passive',
    },
    {
      key: 'Q',
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Rek\'Sai empowers her next 3 basic attacks within a few seconds to gain a moderate amount of  attack speed and deal bonus physical damage to the target and surrounding enemies.',
      castTime: 'none',
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Rek\'Sai fires a void bolt in the target direction that detonates on the first enemy hit, dealing magic damage to all nearby enemies and  revealing them for a short time.',
      castTime: '0.1',
      cooldown: '4 / 3.5 / 3 / 2.5 / 2',
      cost: '0',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Rek\'Sai fires a void bolt in the target direction that detonates on the first enemy hit, dealing magic damage to all nearby enemies and revealing them for 5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Rek\'Sai becomes Burrowed, reducing her  attack range and her  sight radius while gaining access to her Burrowed abilities. She also becomes  ghosted and gains  bonus movement speed, as well as Tremor Sense.',
      castTime: 'none',
      cooldown: '4',
      cost: '0',
      effectRadius: '1500',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Rek\'Sai becomes Burrowed, reducing her attack range by 50 and her sight radius to 385 units, while gaining access to her Burrowed abilities. She also becomes ghosted and gains bonus movement speed, as well as Tremor Sense.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Tremor Sense:</span> Rek\'Sai and her allies gain obscured vision of nearby enemy units that are moving at a rate of once every second.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        'Active:  Rek\'Sai becomes Un-Burrowed, gaining access to her Un-Burrowed abilities. Additionally, she deals magic damage to nearby enemies and  knocks them up. The enemies and cannot be affected again by Unburrow for some time.',
      castTime: 'none',
      cooldown: '4',
      cost: '0',
      damageType: 'Magic damage',
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Rek\'Sai bites the target enemy, dealing physical damage. At maximum  Fury, Furious Bite\'s deals true damage.',
      castTime: '0.25',
      cooldown: '6',
      cost: '0',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Rek\'Sai bites the target enemy, dealing physical damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Rek\'Sai  dashes in the target direction and creates a Tunnel in her wake that lasts for a while. Rek\'Sai can travel through the Tunnel in either direction, which becomes disabled afterwards for a few seconds.',
      castTime: 'none',
      cooldown: '6',
      cost: '0',
      effects: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Rek\'Sai applies Marked as Prey to enemy champions she damages, lasting for 5 seconds.</p>',
        },
        {
          description:
