...
<template>
    <Layout2 :panel2Size="30" panel1class="">
        <template #panel1>
            <InfoCard
            ...
            <Card
                class="mt-9 h-[calc(100%-300px)] max-h-[calc(100%-300px)] overflow-hidden">
                <CardHeader
                ...
                <CardContent class="!h-full !max-h-full w-full pb-0 pl-5 pr-0">
                    <ScrollArea
