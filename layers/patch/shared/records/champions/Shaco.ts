  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: '<p class="ability-effect"><span class="ability-header">Backstab Bonus:</span> The attack will critically strike for (155% + 30%) damage, increased to (175% + 30%) if a critical strike was rolled.</p>'
        }
      ]
    },
    {
