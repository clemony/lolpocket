...
<template>
  ...
  <Splitter>
    ...
    <SplitterPanel class=" m-0 p-0 transition-all duration-700 delay-200 z-0 shadow-lg">
    ...
    <SplitterPanel class="w-full h-screen m-0 p-0 pt-14 overflow-scroll bg-base-200">
