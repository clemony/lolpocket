...
<template>
    <label class="swap swap-flip relative h-[350px] w-[250px]">
        ...
        <Card
            class="swap-off h-[310px] w-[250px] max-w-[250px] overflow-hidden rounded-box bg-[20%_-125%] bg-no-repeat [background-size:200%]"
            :style="{
            ...
            <CardContent
                ...
                <div
                    class="max-w-inherit z-10 mt-2 grid w-full grid-cols-[2.5fr_1fr] gap-x-3 gap-y-5 px-2">
                    <div
                    ...
                    <div class="col-start-1 size-full">
                        <div
                ...
                <img
                    ...
                    :src="
                        pocket.runes[0].runeSets[pocket.runes[0].starred]
                            .keystone.img
                    "
                    class="mask absolute -bottom-3 -left-5 z-0 h-auto w-1/2 rounded-full mask-b-2 mask-l-14 mask-r-6 mask-t-10" />
            </CardContent>
        </Card>
