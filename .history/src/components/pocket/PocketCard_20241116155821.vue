...
<template>
    <label class="swap swap-flip relative h-[350px] w-[250px]">
        ...
        <Card
            class="swap-off h-[350px] w-[250px] max-w-[250px] overflow-hidden rounded-box bg-[20%_-45%] bg-no-repeat [background-size:200%]"
            :style="{
                backgroundImage: champImage,
            }">
            <CardContent
                class="max-w-inherit size-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100 to-30% px-2 pt-2">
                ...
                <div
                    class="max-w-inherit mt-2 grid w-full grid-cols-[2.5fr_1.5fr] gap-3">
                    <div
                    ...
                    <div class="relative col-start-1 size-full">
                        <img
                            ...
                            "
                            class="mask absolute hidden h-auto w-1/2 rounded-full opacity-95 mask-b-2 mask-l-24 mask-r-6 mask-t-20" />
