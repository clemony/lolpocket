...
<template>
    ...
    <div class="*:scrollbar-hide h-full w-full">
        ...
        <div
            class="border-b-base-300 bg-b1/90 absolute top-0 left-0 z-10 flex h-fit! w-full flex-wrap items-center justify-end gap-4 border-b px-4 py-1 backdrop-blur-md">
        ...
        <div
            ...
            <div
                ...
                class="">
                <button
                    class="item-wrapper__item ring-base-300 ring-offset-b1 hover:ring-offset-primary has-checked:ring-offset-secondary pointer-events-auto flex aspect-square max-w-[70px] min-w-[60px] grow basis-14 place-items-center overflow-hidden rounded-md bg-cover ring-1 ring-offset-1 drop-shadow-sm has-checked:ring-offset-2">
        ...
        <div
            class="border-b-base-300 bg-b1/80 shadow-warm absolute top-0 left-0 z-10 flex h-fit! w-full flex-wrap items-center justify-end gap-4 border-b px-4 py-1 backdrop-blur-md">
        ...
        <div
                ...
                <label class="drag-label overflow-hidden!">
                    <div class="drag-wrapper overflow-hidden!">
                        ...
                        <div
                            ...
                            class="bg-primary text-primary-content shadow-warm absolute -top-1.5 -right-1.5 z-30 flex size-6 place-content-center place-items-center overflow-hidden rounded-full font-mono text-sm opacity-0">
                            {{ item.count }}
                        </div>
                    </div>
                </label>
            ...
            <VDropdown
                theme="default"
                alt="Quick Search"
                class="ghosty drag-label group/qs hover:after:text-neutral relative z-0 flex basis-16 cursor-zoom-out p-0! after:absolute after:grid after:h-full after:w-full after:place-content-center after:opacity-50 after:content-['+'] hover:after:opacity-60">
                <div
