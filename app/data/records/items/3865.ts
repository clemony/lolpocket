const item: Item = {
  ...
  noEffects: false,
  removed: false,
  icon: 'https://raw.communitydragon.org/15.11/plugins/rcp-be-lol-game-data/global/default/assets/items/icons2d/3865_worldatlas.png',
  passives: [
    {
      name: 'Support Quest',
      unique: true,
      effects: 'Earn <img src="/img/icons/gold-coin.webp" class="inline-icon" />400 through <i>Shared Riches</i> to automatically upgrade to <img src="/img/icons/runic-compass.webp" class="tip-icon" />Runic Compass, gaining the <i>Ward</i> active with 3 wards in stock.',
    },
    {
      name: 'Shared Riches',
      unique: true,
    ...
    {
      unique: true,
      effects: 'Receives <img src="/img/icons/lane-swap-detector.webp" class="tip-icon" />Lane Swap Detector penalties if detected within the top or middle lanes early in the game.',
    },
  ],
  stats: {
    goldPer10: 3,
