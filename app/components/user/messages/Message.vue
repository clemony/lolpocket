...
<template>
  <div>
    <LazyDialogContentPop
      class="grid h-160 w-220 grid-rows-[28px_80px_1fr] gap-1 bg-b1/86 p-0 backdrop-blur-lg"
      :auto-focus="false"
    ...
    >
      ...
      >
        ...
        <DialogClose as="button" class="btn btn-square btn-ghost btn-sm">
          <icon name="x-sm" />
        </DialogClose>
      </DialogHeader>
      <form class="flex w-full flex-col gap-4 px-6 pt-1 pb-6">
        <label
          class="grid grid-cols-[60px_1fr] items-center gap-2 **:text-3 **:font-normal"
        >
          <span>Subject:</span>
        ...
        <label class="grid grid-cols-[60px_1fr] items-center gap-2 **:text-3">
          <span>From:</span>
          <span class="btn input h-11 w-full bg-b1/40 backdrop-blur-lg">
            <span
      ...
      <article class="size-full p-4 pt-6">
        <textarea
          ...
          readonly
          class="btn textarea size-full bg-b1/40 text-start text-3 backdrop-blur-lg"
        />
      </article>
    </LazyDialogContentPop>
  </div>
