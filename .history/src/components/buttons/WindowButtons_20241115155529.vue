...
const classObject = [
    'p-1 hover:bg-base-300 hover:stroke-[1.5]  shadow-inner hover:[&_svg]:opacity-1000 [&_svg]:opacity-0 hover:shadow-base-300 size-4.5 rounded-full border border-neutral/20',
]
</script>
<template>
    <div
