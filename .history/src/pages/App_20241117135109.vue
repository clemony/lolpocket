...
<template>
    ...
    <SidebarProvider>
        <Sidebar
            collapsible="icon"
            class="justify-center before:absolute before:top-0 before:size-full before:rounded-2xl before:border-y-[6px] before:border-l-[6px] before:border-base-100/70"
            variant="floating">
            <MainSidebarHeader />
