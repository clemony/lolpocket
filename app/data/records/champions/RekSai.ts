    ...
    "W": [
      ...
      },
      {
        ...
        "effects": [
          ...
          {
            "description": "Rek'Sai can also trigger Unburrow by issuing an attack command, casting the ability once she is in attack range of the target and applying the knock up against them instead of the nearest enemy."
          }
        ],
        "cost": [
          0
    ...
    "E": [
      {
        ...
        "blurb": "Active:  Rek'Sai bites the target enemy, dealing physical damage. At maximum  Fury, Furious Bite's deals additional damage based on their maximum health.",
        "castTime": "0.25",
        "targetRange": "225",
        "maxCharges": -1
      },
      {
        ...
        "effects": [
          ...
          {
            "description": "An Un-Burrowed Rek'Sai will automatically Burrow before entering the Tunnel and automatically Unburrow after exiting it. This does not put Burrow on cooldown nor trigger Fury of the Xer'Sai, but does trigger other Burrow effects and Unburrow."
          },
          {
