        ...
        <Card class="relative">
            ...
            <CardHeader class="flex flex-row items-center gap-8">
                <div class="relative w-fit">
                    <div
                        class="join-item grid size-[70px] content-start items-start overflow-y-hidden rounded-lg border border-base-300">
                        <loadImg
                            class="mr-1 aspect-square size-[70px] shrink-0 scale-[108%] !rounded-none"
