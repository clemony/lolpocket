        ...
        <template #header>
            ...
            <div class='w-fit -mt-1 -ml-2.5'>
                <InputEditable v-model:modelValue="set.name" :defaultValue="set.name"
                    class='!text-base font-medium text-start items-center align-baseline capitalize  border-transparent focus-within:border-base-200 hover:border-base-200 transition-all duration-300 pr-8'>
