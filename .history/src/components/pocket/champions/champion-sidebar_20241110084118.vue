...
<div v-if="champion" class="flex-col w-full gap-6 max-w-inherit h-full pr-[3px]">
    ...
    <TabListPocket :modelName="cTabs" defaultTab="abilities" first="stats" class='mt-8 relative'>
        <!----------------------⟢ stats ⟣---------------------------->

        <Tab value="abilities" class='ability max-w-inherit w-inherit'>
            <template #header>
