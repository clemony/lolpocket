    ...
    <VueDraggable
        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-1"
                :cardClass="{
                    'relative max-w-[95%] before:absolute before:bg-transparent before:border  before:w-full before:h-full before:scale-y-110 before:pointer-events-none before:border-transparent before:z-50  before:rounded-box':
                        set,
