...
<template>
    ...
    <main class="grid size-full grid-cols-[1fr_3fr] pr-12">
        <div class="mx-auto flex w-full flex-col items-center gap-10">
            <h1 class="!text-3xl font-semibold">Settings</h1>

            <nav class="flex flex-col gap-4 pl-6 text-base-content/80">
