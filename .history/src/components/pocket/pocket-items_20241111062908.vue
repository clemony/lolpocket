...
<ResizablePanelGroup direction="horizontal" class=" h-[calc(100%-425px)] max-h-[calc(100%-30px)] w-full px-4  ">
    <ResizablePanel class="relative z-0 h-full">
        ...
        <div class="h-full overflow-y-scroll scrollbar-hide">
            <LayoutSpacer />
            <Card class='mb-8 bg-transparent border-none shadow-none'>
                <CardHeader>
                    <CardTitle>
                        <h1>Item Sets</h1>
                    </CardTitle>
                    <CardDescription class='flex'>
                        Drag items from the list at the right. Items are draggable and reorderable within sets and
                        between them. Select a set and <span><Label>⌘ +
                                <icon icon="ph:mouse-left-click-fill" />
                            </Label></span> an item from the main list to quick add.
                    </CardDescription>
                </CardHeader>
            </Card>
