                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            variant="ghost"
                            size="lg"
                            class="group/lol flex size-full shrink-0 flex-nowrap items-center gap-3 rounded-none !border-0 pb-2 pt-3 ring-0 hover:bg-transparent focus:!border-0 focus:!outline-0 active:bg-transparent"
