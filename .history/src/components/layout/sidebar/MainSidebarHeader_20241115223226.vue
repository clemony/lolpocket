    ...
    <SidebarHeader>
        <SidebarMenu
            ...
            <SidebarMenuItem class="mx-2.5 mt-1">
                <SidebarMenuButton
                    size="xs"
                    class="hover-ring-neutral/60 !max-h-87!min-h-6 relative h-6 w-full items-center justify-start border border-base-300/80 bg-base-100/50 px-2 hover:border-base-300 hover:bg-base-100/60 hover:ring-1"
                    :class="{
