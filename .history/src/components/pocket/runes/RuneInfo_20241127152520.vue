        ...
        <div :rune="rune" :key="rune.name" class="h-full">
            ...
            <div
                ...
                <div
                    id="runeStats"
                    :key="rune.name + '3'"
                    class="first-letter:text-9 mt-1 text-justify font-serif text-[0.76rem] whitespace-pre-line first-letter:float-left first-letter:mr-1.5 first-letter:font-[700] first-line:font-[700] first-line:tracking-widest first-line:uppercase">
                    {{ rune.stats }}
                </div>
            </div>
        </div>
