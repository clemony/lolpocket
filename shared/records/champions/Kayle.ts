...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Kayle summons a celestial sword that travels forward and expands upon hitting a target, dealing magic damage,  slowing, and reducing the  armor and  magic resist of all targets struck.",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayle conjures a portal in front of her that faces the target direction, from which a celestial sword launches forward.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self, Allies",
      blurb:
        "Active:  Kayle  heals herself and an allied champion. Additionally, both of them gains  move speed for a brief time.",
      castTime: "0.25",
      cooldown: "15",
      cost: "70 / 75 / 80 / 85 / 90",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayle and the target allied champion are healed and gain bonus movement speed for 2 seconds.</p>',
          leveling: [
            {
              attribute: "Heal",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Kayle deals bonus magic damage on-hit.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayle kindles her blade, empowering her next basic attack within 6 seconds to have an uncancellable windup and deal additional bonus magic damage on-hit that is capped at 400 against monsters. If Kayle is not yet Arisen, this attack becomes ranged with 525 range.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Aflame Bonus:</span> The attack explodes upon the target, dealing its damage to surrounding enemies and applying on-hit effects. This is affected by critical strike modifiers.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Allies, Self",
      blurb:
        "Active:  Kayle grants herself or an allied champion  invulnerability for the next few seconds, and conjures flaming swords around herself.",
      castTime: "0.5",
      cooldown: "160 / 120 / 80",
      cost: "100 / 50 / 0",
      damageType: "Magic damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayle grants herself or a target allied champion invulnerability for 2.5 seconds and conjures swords of fire.</p>',
        },
        {
          description:
