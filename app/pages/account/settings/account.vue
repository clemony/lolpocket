...
<template>
  <form class="flex w-full flex-col gap-6" @submit.prevent>
    <!-- username -->
    <FormItem>
    ...
    <FormItem>
      ...
      <InputGroup class="px-3">
        ...
        <InputGroupAddon
          ...
          size="6"
        >
          <Icon class="absolute size-4.25 **:stroke-[3.3]" name="tick" />
        </InputGroupAddon>
        <InputGroupAddon
          v-else
          v-tippy="{
          ...
          variant="base"
        >
          <icon class="size-3.5" name="refresh" />
          pending...
        </InputGroupAddon>
      </InputGroup>
