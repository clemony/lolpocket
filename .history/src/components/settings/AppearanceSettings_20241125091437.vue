        ...
        <div class="grid w-full grid-cols-3 gap-6 [&_>*]:size-full">
            <DisplayCard
                ...
                <label
                    ...
                    <input
                        type="checkbox"
                        :checked="gs.dataTheme == theme"
                        class="checkbox-neutral padding-1 checkbox checkbox-lg" />

                    <div
                        class="! h-full w-full cursor-pointer overflow-hidden rounded-xl border border-base-300 bg-base-100 text-base-content shadow-warm"
