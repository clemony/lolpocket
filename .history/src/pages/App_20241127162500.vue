    ...
    <main
        ...
        <label>
            ...
            <SidebarProvider
                ...
                :class="{
                    'absolute shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] animate-out zoom-out-[0.75] slide-out-to-bottom-1/3 after:absolute after:z-50 after:size-full after:bg-black/0 after:shadow-[inset_0px_0px_250px_90px_#00000080]':
                        state == 'open',
                }">
                <MainMenubar
