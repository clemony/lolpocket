  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate: Whenever  Jayce switches between  Hammer Stance and  Cannon Stance, he briefly gains  bonus movement speed and  ignores unit collision.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Jayce switches between either Hammer Stance or Cannon Stance, he gains ghosting and 40 bonus movement speed for 0.75 seconds.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Jayce leaps to the target enemy\'s location and smashes his hammer to the ground, dealing physical damage and  slowing nearby enemies.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Jayce leaps to the target enemy\'s location over 0.5 seconds. Upon arrival, he smashes his hammer to the ground to deal physical damage to all enemies within an area and slow them for 2 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Jayce fires an electric bolt in the target direction that detonates upon hitting an enemy or reaching maximum range, dealing physical damage to nearby enemies and granting sight of the area for 1.25 seconds.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">If the bolt passes through Acceleration Gate, it becomes supercharged:</span> increasing its damage by 40% as well as its speed, range and explosion radius.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Jayce\'s basic attacks restore mana on-hit.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Jayce surrounds himself with an electric field for 4 seconds that deals magic damage every second to nearby enemies.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Jayce empowers his next 3 basic attacks within 4 seconds to deal modified physical damage and gain 360% bonus attack speed.Hyper Charge\'s total damage is affected by critical strike modifiers.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Jayce swings his hammer at the target enemy, dealing magic damage based on the target\'s maximum health and  knocking them back.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Jayce roots the target enemy over the cast time, then swings his hammer at them to deal magic damage, capped against monsters, and knock them back 600 units.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Jayce deploys an energy gate centered at the target location, lasting for 4 seconds and granting sight of its surroundings. Jayce and all allied champions can move through it to gain bonus movement speed that decays over 3 seconds.</p>',
          leveling: [
            {
      ...
      maxCharges: -1,
      notes:
        'The Gate grants the bonus in an area  750 units wide and  100 units thick.',
      resource: 'Mana',
      targeting: 'Location',
      targetRange: '650',
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Jayce transforms into  Cannon Stance, becoming  ranged with greater  attack range and gaining new abilities.',
      castTime: 'none',
      cooldown: '6',
      cost: '0',
      effects: [
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Jayce transforms into  Hammer Stance, becoming  melee and gaining new abilities.',
      castTime: 'none',
      cooldown: '6',
      cost: '0',
      effects: [
