...
export const badgeVariants = cva(
    'inline-flex items-center rounded-full border px-2.5 py-0.5 font-size-2  transition-colors focus:outline-hidden focus:ring-2 focus:ring-b2 focus:ring-offset-2 ',
    {
        variants: {
            variant: {
                default:
                    'border-transparent bg-b2 font-size-4-content hover:bg-b2/80',
                primary:
                ...
                outline: 'font-size-4-300',
            },
            size: {
                sm: 'font-size-2 h-6 px-2',
            },
        },
        defaultVariants: {
            variant: 'default',
