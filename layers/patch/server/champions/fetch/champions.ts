...
const dataPath = resolve('./layers/patch/server/misc/raw/patch-index-raw.json')
const loadPatch = JSON.parse(fs.readFileSync(dataPath, 'utf-8'))
const outputD = resolve('./layers/patch/server/champions/raw/champions-raw-data-dragon.json')
