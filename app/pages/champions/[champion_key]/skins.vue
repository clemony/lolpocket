...
<template>
  <div class="-ml-10 size-full gap-14 overflow-hidden pr-22">
    <Carousel
      ...
      <CarouselContent
        class="-ml-6 scrollbar-hidden flex pt-22 pb-6">
        <CarouselItem
          ...
          <div
            ...
            `, index === selectedIndex ? 'opacity-100 ring ring-bc/40 pointer-events-none ring-offset-5 ring-offset-b1' : 'opacity-80')">
            <Card
              class="
