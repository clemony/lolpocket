        ...
        <div class="grid w-full grid-cols-3 gap-6 [&_>*]:size-full">
            <DisplayCard
                ...
                <label
                    ...
                    <div
                        class="! h-full w-full cursor-pointer overflow-hidden rounded-lg bg-base-100 text-base-content shadow-warm ring-1 ring-base-300 peer-checked:ring-1 peer-checked:ring-neutral/80 peer-checked:ring-offset-4 peer-checked:ring-offset-neutral-content"
