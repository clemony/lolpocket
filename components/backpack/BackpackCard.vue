...
<template>
  <div :class="cn('size-full   hover:border-b3 hover:ring-1 hover:ring-b2 hover:shadow-pretty relative border group border-transparent  rounded-xl transition-all shadow-warm duration-300 gap-3 justify-center overflow-hidden **:select-none', props.class)">
    <NuxtLink :to="`/pocket/${pocket.key}`" class="absolute grid inset-0 items-center rounded-xl overflow-hidden">
      <div
        ...
        <div class="py-3 px-4 size-full bg-radial-[at_75%_0] from-[#FFFFFF]/2 from-16% via-[#FFFFFF]/88 via-48% to-[#FFFFFF] to-80% inset-shadow grid relative">
          <BackpackMenu :pocket="pocket" />
