...
<template>
    <div
        class="absolute right-2.5 top-0 z-10 h-56 w-12 flex-col items-center justify-end space-y-1 rounded-lg ring-1 ring-offset-1 ring-offset-base-100/40">
        <template v-for="rune in runes1.concat(runes2)">
            <div
                class="grid w-fit place-items-center rounded-full shadow-inner ring-base-300"
                :class="{
