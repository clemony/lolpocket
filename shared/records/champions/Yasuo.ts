  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        ...
        {
          "description": "If Steel Tempest is cast during Sweeping Blade, it will instead affect enemies around Yasuo at the end of the dash, or doing so immediately at his landing location after blinking while ending the dash prematurely. Steel Tempest's cast time is not incurred in this case, but Yasuo will become unable to declare basic attacks for 0.5 seconds after the dash ends."
        }
      ],
