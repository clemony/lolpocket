    ...
    <div :style="wrapperStyle" ref="wrapper" class="">
        <div :style="containerStyle">
            <div
                ...
                class="border !border-neutral/40 transition-all duration-300 ease-out">
                <label
                    class="swap swap-flip relative rounded-lg shadow-smooth backdrop-blur-md">
                    <input type="checkbox" class="hidden" />

                    <Card
                        class="swap-off relative grid h-[260px] w-[210px] justify-center overflow-hidden rounded-xl bg-transparent bg-right-bottom px-2"
                        :style="{ backgroundImage: champImage }">
                        <CardContent
