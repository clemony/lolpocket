    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-6'>
            ...
            <div class="flex flex-col w-full h-full">
                ...
                <div
                    class="justify-content-end w-full  right-3 col-start-2 flex gap-2 justify-self-end pb-1 text-center ">
                    <code v-for="(tag, index) in champion.tags" :key="index"
                        class="badge f flex-nowrap text-center font-mono text-sm font-medium lowercase tracking-normal"
                        :data-tag="tag">#{{
                            tag }}</code>
                </div>
