...
// 🔧 Helpers
export function FixedArray<T extends v.BaseSchema<any, any, any>>(
  schema: T,
  length: number
) {
...
export function MinMaxArray<T extends v.BaseSchema<any, any, any>>(
  schema: T,
  min: number,
  max: number
) {
...
export function getDeepDefaults<T extends v.BaseSchema<any, any, any>>(
  schema: T
): v.InferOutput<T> {
