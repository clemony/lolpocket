...
<template>
    <Button
        ...
        <div
            ...
            class="pointer-events-none absolute right-1 top-[1px] grid aspect-square !size-10 place-content-center place-items-center rounded-full bg-neutral !px-3 text-neutral-content">
            {{ selectedCount }}
        </div>
    </Button>
</template>
