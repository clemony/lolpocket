...
<Layout2 :panel2Size="30">
    <template #panel1>
        ...
        <Card class='mt-9 max-h-[calc(100%-300px)] overflow-hidden'>
            ...
            <CardHeader
                ...
                <Grow />
                <div class='join mr-1.5'>
                    <Button variant="outline" size="icon" class='join-item'>
                        <icon icon="teenyicons:heart-outline" class="size-5 opacity-70" />
                    </Button>
                    <DdCheckbox :data="ds.uniqueClass" v-model:dataValue="dataValue" text="Class / Role"
                        class='join-item'>
                        <Button variant="outline" size="icon" class="join-item">

                            <icon icon="teenyicons:filter-outline" class='size-5 opacity-70' />
                        </Button>
                    </DdCheckbox>
                </div>
