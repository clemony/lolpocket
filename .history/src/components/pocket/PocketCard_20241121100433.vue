            ...
            <CardContent
                ...
                <div class="flex w-full">
                    ...
                    <div class="relative w-1/2 pl-3">
                        ...
                        <div
                            class="z-0 mt-8 flex size-fit flex-col items-center justify-center rounded-full">
                            <div
                                class="z-0 -mr-5 flex flex-col -space-y-3 [&_:first-child]:z-20 [&_:last-child]:z-0 [&_:nth-child(2)]:z-10">
