  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Noxian Might:</span> Darius gains 30 - 230 (based on level) bonus attack damage and instantly applies 5 Hemorrhage stacks through his usual means.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Darius becomes ghosted for 1 second and hefts his axe for 0.75 seconds, afterward swinging it around himself to deal physical damage to nearby enemies. Enemies within the inner radius take 35% damage.</p>',
          leveling: [
            {
        ...
        {
          description:
            'Against champions and large monsters hit, Darius heals for 17% - 51% (based on number of targets hit by the outer radius) of his missing health. Enemies hit by the inner radius do not refresh the duration of or gain a new stack of Hemorrhage.',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        'Active:  Darius\' next basic attack within a few seconds deals increased physical damage and  slows the target.',
      castTime: 'none',
      cooldown: '5',
      cost: '40',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Darius empowers his next basic attack within 4 seconds to have an uncancellable windup, gain 25 bonus range, deal bonus physical damage and slow the target by 90% for 1 second. This damage is affected by critical strike modifiers.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Darius gains armor penetration.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Darius sweeps his axe in a cone in the target direction, granting sight of the area for 1 second while pulling enemies hit towards him. Upon arrival, they rebound 150 units off of him, remaining airborne and becoming slowed by 40% for 1 second.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Darius  leaps to an enemy champion and strikes a lethal blow, dealing true damage based on the target\'s current  Hemorrhage stacks.',
      castTime: '0.3667',
      cooldown: '120 / 100 / 80',
      cost: '100 / 100 / 0',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Darius attempts to execute the target enemy champion, leaping towards them to deal true damage, increased by 0% - 100% (based on target\'s Hemorrhage stacks), and granting sight of the area around them for 2.5 seconds from the start of the cast time.</p>',
          leveling: [
            {
