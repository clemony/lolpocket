...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Kayn  dashes in the target direction, dealing physical damage to enemies he passes through. He then swings his scythe, dealing the same damage to surrounding enemies.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayn dashes in the target direction, dealing physical damage to enemies he passes through. He then swings his scythe, dealing the same damage to nearby enemies.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Darkin Bonus:</span> Reaping Slash\'s damage is modified to deal 65% AD (+ 6% (+ 3.5% per 100 bonus AD) of the target\'s maximum health) physical damage with each hit, for a total of 130% AD (+ 12% (+ 7% per 100 bonus AD) of the target\'s maximum health). This damage has a cap against monsters that does not include the bonus damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayn swings his scythe in the target direction, dealing physical damage to enemies hit and slowing them by 90% decaying over 1.5 seconds.</p>',
          leveling: [
            {
              attribute: "Physical Damage",
              modifiers: [
        ...
        {
          description:
            "<p class=\"ability-effect\"><span class=\"ability-header\">Shadow Assassin Bonus:</span> Blade's Reach's radius is extended by 200 units. Kayn conjures an untargetable shadow at the casting position to perform Blade's Reach's sweep over 0.55 seconds in his stead, removing the ability's cast time.</p>",
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Darkin Bonus:</span> Blade\'s Reach knocks up enemies hit for 1 second.</p>',
        },
      ],
      icon: "https://cdn.communitydragon.org/latest/champion/Kayn/ability-icon/w",
      maxCharges: -1,
      notes:
        "The shadow is considered an allied champion and can interact with effects such as  World Atlas' and  Runic Compass' Quest and local reward from structures.(bug)\nBlade's Reach's indicator is visible to enemies while cast inside terrain and towards enemy champions.\nThis ability will cast from wherever the caster is at the start of the cast time.\n\n\nType\n\nCast time\n\n\nAttacking\n\nDisabled\n\n\nAbilities\n\nDisabled\n\n\nMovement\n\nDisabled\n\n\nItems\n\nUsable\n\nN/A\n\n\nDisabled\n\nAll items are disabled\n\n\nInterrupted by\n\nN/A\n\n\nConsumables\n\nDisabled\n\n\nSpells\n\nUsable\n\n Barrier  Clarity  Cleanse  Exhaust  Ghost  Heal  Ignite  Smite\n\n\nDisabled\n\n Flash  Teleport  Recall  Hexflash\n\n\nInterrupted by\n\nN/A\n\n\nInterrupted by\n\nDeath, unless protected by  Resurrection",
      projectile: "FALSE",
      resource: "Mana",
      spellEffects: "Area of effect",
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Kayn gains  bonus movement speed,  ghosting and the ability to enter terrain for a duration. If he has recently been in combat with enemy champions, the duration is dramatically reduced.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayn gains 40% bonus total movement speed, ghosting and the ability to ignore terrain collision for a duration. If he has been in combat with enemy champions within the last 3 seconds, Shadow Step will instead last 1.5 seconds.</p>',
          leveling: [
            {
              attribute: "Duration",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Shadow Assassin Bonus:</span> Shadow Step\'s cooldown is reduced to 10 seconds at all ranks. Kayn gains 100% slow resist while active and, upon entering terrain, the bonus total movement speed is increased to 70% for the remaining duration.</p>',
        },
      ],
    ...
    },
    {
      ...
      blurb:
        "Passive:  Kayn marks enemy champions he damaged for a short time.",
      castTime: "none",
      cooldown: "120 / 100 / 80",
      cost: "100",
      damageType: "Physical damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Kayn marks enemy champions he damaged in the last 3.15 seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kayn vanishes and dashes to a marked enemy champion over 0.25 seconds, attaching himself to them at the end of the dash. After 0.5 seconds of his arrival, he channels for up to 2 seconds, during which the target is revealed. Umbral Trespass can be recast during the channel after 0.1 seconds have elapsed, and does so automatically after the duration or if it is interrupted.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> After a delay of 0.5 seconds to 0.75 seconds, Kayn deals physical damage to the target and dashes out from their body in the target direction, detaching himself from them and becoming targetable again at the end of the dash.</p>',
          leveling: [
            {
              attribute: "Physical Damage",
              modifiers: [
