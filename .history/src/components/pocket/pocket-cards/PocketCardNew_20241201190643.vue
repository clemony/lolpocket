                ...
                <label
                    ...
                    <Card
                        ...
                        <CardContent
                            ...
                            <div class="n flex w-full justify-center">
                                <div
                                    class="z-0 size-fit h-36 w-[90%] overflow-hidden rounded-md">
                                    <div
                                        :class="
                                            cn(
                                                'border-box size-full after:absolute after:-left-4 after:-top-4 after:size-18 after:rounded-full after:border after:bg-base-100',
                                                {
