    ...
    <Card class='relative'>
        ...
        <CardHeader class='flex flex-row gap-8 items-center '>
            ...
            <div class='relative w-fit'>
                ...
                <div
                    class='size-[70px]  join-item border-base-300 border grid place-items-center  overflow-y-hidden rounded-lg'>
                    <loadImg class=" size-[70px] scale-[108%] mr-1   aspect-square object-center shrink-0 !rounded-none"
            ...
            <div class="flex flex-col w-full h-full *:shrink-0 ">
                <p class=" font-semibold font-cursive scale-x-105 !not-italic !text-2xl">
                    {{ champion.name }}
                </p>
