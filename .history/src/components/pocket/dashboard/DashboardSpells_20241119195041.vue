...
<template>
    <DisplayCard class="relative" ref="el">
        <div class="grid grid-cols-3 px-5 pb-4">
            <div>
            ...
            <div class="items-center justify-self-end">
                <SpellPicker
                    v-model:model="pocket.spells.spell1"
                    @update:model="(v) => (pocket.spells.spell1 = v)"
                    :target="el" />
            </div>
            <div class="items-center justify-self-end">
                <SpellPicker
                    v-model:model="pocket.spells.spell2"
                    @update:model="(v) => (pocket.spells.spell2 = v)"
                    :target="el" />
            </div>
        </div>
    </DisplayCard>
