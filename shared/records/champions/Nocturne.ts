  ...
  abilities: [
    {
      ...
      affects: 'Enemies',
      blurb:
        'Innate: Periodically,  Nocturne\'s next basic attack causes him to slash in a circle that deals increased physical damage to the target and nearby enemies,  healing him for each enemy hit.',
      ...
      effects: [
        ...
        {
          description:
            'Umbra Blades can critically strike against the primary target, modifying the physical damage dealt to[ (192.5% + 44%) AD. ][ 110% AD × total critical damage. ]',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nocturne casts out a shadow blade in the target direction that leaves a Dusk Trail in its wake, dealing physical damage to enemies hit. Enemy champions and large monsters hit will leave a Dusk Trail behind while moving. Dusk Trails last 5 seconds and will slowly disappear afterwards.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Nocturne gains bonus attack speed.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nocturne gains a spell shield for 1.5 seconds. Upon successfully blocking a hostile effect, Shroud of Darkness\' bonus attack speed is doubled for 5 seconds.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Passive:  Nocturne gains  bonus movement speed while moving towards  feared targets.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Nocturne gains 90% bonus movement speed while facing nearby feared targets.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nocturne torments the target, forming a tether between himself and the target for 2 seconds, during which the target takes magic damage every 0.5 seconds over the duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Nocturne terrorizes all enemy champions,  nearsighting them for a few seconds. He can recast Paranoia during this time.',
      castTime: 'none',
      cooldown: '140 / 115 / 90',
      cost: '100',
      damageType: 'Physical damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nocturne terrorizes all enemy champions, nearsighting them for 6 seconds. He can recast Paranoia for the same duration after 0.25 seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Nocturne dashes with displacement immunity to the target enemy champion, dealing physical damage upon arrival.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
