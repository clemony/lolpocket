                ...
                <label
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex h-full items-center gap-2 px-5">
                                <div
                                    class="flex-grow px-1 text-lg font-semibold">
                                    Aa
                                </div>
                                <div
                                    class="flex aspect-square size-8 items-center justify-center rounded-md bg-base-200 text-base-content">
                                    Bb
                                </div>
                                <div
                                    class="flex aspect-square size-8 items-center justify-center rounded-md bg-base-300 text-base-content">
                                    Cc
                                </div>
                                <div
