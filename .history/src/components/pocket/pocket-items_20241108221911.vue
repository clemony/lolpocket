...
<template>
<ResizablePanelGroup direction="horizontal" class=" h-[calc(100%-25px)] max-h-[calc(100%-30px)] w-full px-4  ">
    ...
    <ResizablePanel class="mt-24 max-h-inherit h-full" id="itemGrid">
        <LayoutSpacer />
