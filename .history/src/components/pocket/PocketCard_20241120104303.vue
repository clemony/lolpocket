    ...
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    class="max-w-inherit mt-2 grid w-full grid-cols-4 items-center gap-x-3 gap-y-5 px-2">
                    <MiniItemGrid
                        :pocket="pocket"
                        class="col-span-3 col-end-3 row-span-2 grid-cols-subgrid" />
                    <SpellDisplay
                        :pocket="pocket"
                        class="col-span-1 col-start-4 row-span-2" />
