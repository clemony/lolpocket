    ...
    <div
        ...
        <label
            ...
            <VDropdown
                ...
                :disabled="rune.path == 'none'"
                id="imgwrap"
                class="shine h-[inherit] w-[inherit] opacity-80 brightness-90 transition-all duration-500 hover:opacity-100 peer-checked:opacity-100 peer-checked:brightness-100 [&_img]:grayscale hover:[&_img]:grayscale-0 peer-checked:[&_img]:grayscale-0">
    ...
    <div
        ...
        <label
            ...
            <VDropdown
                ...
                <div class="shine overflow-hidden rounded-full">
                    <loadImg
                        :url="`/img/runes/${rune.path.toLowerCase()}/${rune.name.replace(/\s+/g, '')}.webp`"
                        :alt="rune.name"
                        @error="onImageError" />
