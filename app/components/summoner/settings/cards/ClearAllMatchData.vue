      ...
      Remove<tippy
        ...
        <template #content>
          <ul class="p-3 list-disc not-first:mt-2">
            <li>
              Match data is cached in your browser's internal database to limit strain on Riot's API servers.
            </li>
            <li>This data is not permanent.</li>
            <li>
              Most modern browsers automatically clear data as it becomes stale or unused over time.
            </li>
          </ul>
        </template>
      </tippy> from your browser's cache. If you're having issues updating
      matches, try this button ↘︎ or
      <ResponsiveDialog>
