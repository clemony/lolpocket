...
import { backpackLinks } from '~/routes'
...
<template>
  <LazyNavigationMenuContent
    ...
    <TwoColNav class="overflow-hidden grid-rows-1 gap-4 size-full min-h-90 max-h-90 min-w-160 grid-cols-[0.75fr_1fr]">
      ...
      <div class="size-full overflow-hidden relative before:h-[calc(100%-16px)] before:border-l before:w-px  before:left-0 before:top-[10px]  before:absolute before:border-b4/40 grid-rows-[26px_1fr] grid  pl-3">
        <!-- titlebar -->
