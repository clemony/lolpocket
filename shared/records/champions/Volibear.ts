  ...
  abilities: [
    {
      ...
      blurb:
        'Innate:  Volibear\'s  basic attacks and  ability hits generate a  stack of The Relentless Storm, which stacks up to 5 times. At 5 stacks, he gains Lightning Claws.',
      damageType: 'Magic damage',
      effectRadius: '450',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Volibear damages at least one enemy with a basic attack or ability, he generates a stack of The Relentless Storm for 6 seconds, refreshing on subsequent damage and stacking up to 5 times. At 5 stacks, Volibear gains Lightning Claws.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">The Relentless Storm:</span> For each stack, Volibear gains 5% (+ 4% per 100 AP) bonus attack speed, up to 25% (+ 20% per 100 AP).</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Lightning Claws:</span> Volibear\'s claws ignite with lightning, empowering his basic attacks on-hit to deal 11 - 60 (based on level) (+ 50% AP) bonus magic damage to the target and the nearest visible enemy within 450 units of the target, chaining up to 4 subsequent targets.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Active:  Volibear becomes  ghosted and gains  bonus movement speed for a few seconds, increased while facing an enemy champion.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Volibear drops on all fours, becoming ghosted and gaining bonus movement speed for 4 seconds, doubled while facing a nearby visible enemy champion.</p>',
          leveling: [
            {
        ...
        {
          description:
            'During this time, Volibear\'s next basic attack is empowered to have an uncancellable windup, gain 25 bonus range, and pounce on the target, dealing bonus physical damage and stunning them for 1 second. This damage applies life steal at 100% effectiveness.',
          leveling: [
            {
    ...
    },
    {
      ...
      blurb:
        'Active:  Volibear strikes the target enemy to deal physical damage based on his bonus health, apply  on-hit and  on-attack effects, and mark them Wounded for a period.',
      castTime: '0.25',
      cooldown: '5',
      cost: '30 / 35 / 40 / 45 / 50',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Volibear slashes the target enemy with his claws to deal physical damage, apply on-hit effects, trigger on-attack effects, and mark the target Wounded for 8 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Wounded Bonus:</span> If the target is already Wounded, Volibear takes a bite out of them instead, dealing 50% (+ 15% per 100 bonus AD) increased damage and healing himself. The heal is halved against minions.</p>',
          leveling: [
            {
              attribute: 'Heal',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies, Self',
      blurb:
        'Active:  Volibear conjures a lightning bolt that shortly strikes the target location to deal magic damage to enemies hit based on their maximum health,  slowing them for a short time.',
      castTime: 'none',
      cooldown: '14',
      cost: '60',
      damageType: 'Magic damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Volibear summons a lightning bolt to strike at the target location after a 2-second delay, granting sight of the area for 1 second after the first second of the delay. If Volibear is within the strike, he gains a shield equal to 14% of his maximum health (+ 75% AP) for 3 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies, Self',
      blurb:
        'Active:  Volibear gains Stormbringer and  leaps with  Cc-immunity to the target location. The impact deals physical damage to enemies hit in the epicenter, and briefly  slows nearby enemies.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Volibear gains Stormbringer for 12 seconds and leaps to the target location with displacement immunity over 1 second, granting sight of the area in a 500 radius during the travel.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Stormbringer:</span> Volibear gains ghosting, bonus health, 50 bonus attack range, 25 increased range on Frenzied Maul, and 35% increased size.</p>',
          leveling: [
            {
