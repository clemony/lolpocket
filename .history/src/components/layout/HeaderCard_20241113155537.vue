...
<template>
    <Card
        ...
        <CardHeader
            :class="
                cn(
                    'absolute z-20 w-full bg-base-100/95 px-10 pt-0 backdrop-blur-md transition-all duration-200',
                    {
                        'pb-5 pt-6': isAnchorVisible,
                        'border-b border-b-base-200 py-2': !isAnchorVisible,
                    },
                    props.headerClass
                )
            ">
            <Collapsible
                ...
                <CollapsibleContent class='shadow-smooth border-b border-b-base-200'
