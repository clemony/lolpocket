  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Mist:</span> For each stack of Mist, Senna gains 0.75 bonus attack damage. For every 20 stacks, she also gains 20 bonus attack range and 10% critical strike chance. Additionally, every 1% critical strike chance in excess of 100% is converted into 0.35% life steal.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Relic Cannon:</span> Senna\'s basic attacks on-hit deal 20% AD bonus physical damage and grant her 10% / 15% / 20% (based on level) of the target\'s movement speed as bonus movement speed for 0.5 seconds. This damage applies life steal at 100% effectiveness.</p>',
        },
      ],
    ...
    },
    {
      ...
      blurb:
        'Active:  Senna fires a spectral laser toward the target unit,  healing herself and allied  champions hit while dealing physical damage and  slowing enemies hit for a short time.',
      ...
      effects: [
        ...
        {
          description:
            'Upon being hit, enemy turrets, wards, jungle plants, Mist Wraiths and any other attack-interactive units are considered basic attacked once, while champions and turrets* are applied on-hit effects.',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Senna throws a globule of Black Mist in the target direction that deals physical damage to the first enemy hit and sticks onto them.',
      castTime: '0.25',
      cooldown: '11',
      cost: '50 / 55 / 60 / 65 / 70',
      damageType: 'Physical damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Senna throws a globule of Black Mist in the target direction that deals physical damage to the first enemy hit and attaches to them for 1 second.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Senna creates an aura of mist and gains  camouflage for a few seconds. She will quickly regain camouflage after breaking stealth.',
      castTime: '1',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Senna surrounds herself with an aura of mist and gains camouflage for a duration. If Senna breaks the camouflage, she regains it after 1.75 seconds without performing actions that break stealth.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Wraith Form:</span> Gain camouflage. Enemies will have obscured vision of camouflaged Wraiths moving outside of the mist. Wraith Form can be regained if lost by breaking the camouflage after 1.75 seconds without performing actions that break stealth. Wraith Form ends immediately upon Senna\'s death.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        'Active:  Senna fires two waves of spectral light in the target direction. The center wave deals physical damage to enemy champions hit and  reveals them for a short time.',
      castTime: '1',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Senna fires two waves of spectral light in the target direction, granting sight of the area briefly along the path. The center wave deals physical damage to enemy champions hit and reveals them for 3 seconds, as well as hits all Mist Wraiths.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
