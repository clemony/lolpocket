    ...
    <VueDraggable
        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-1"
                :cardClass="{
                    '@container relative w-[calc(100%-48px)]  inset-0 before:absolute before:bg-transparent before:border  before:w-full before:h-full  before:pointer-events-none before:border-transparent before:z-50  mx-[24px] before:rounded-box':
                        set,
                ...
                <template #header>
                    ...
                    <div
                        class="-mt-1 flex w-fit items-center gap-1 overflow-hidden @container">
                        <InputEditable
                            v-model:modelValue="set.name"
                            :defaultValue="set.name"
                            class="w-fit items-center truncate border-transparent text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200 @[230px]:hidden">
                            <Button
                                variant="simple"
                                size="xs"
