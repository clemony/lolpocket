...
<template>
  <motion.div
    class="relative z-1 w-full border-t border-b2/30 bg-b1 px-18 pt-46 pb-6 [&_hr]:mx-16 [&_hr]:bg-b2"
    ...
    <ul class="timeline timeline-vertical timeline-snap-icon">
      ...
      >
        ...
        >
          ...
          >
            <icon name="check-fill" class="size-5 text-bc/80" />
          </Motion>
        </div>
        ...
        <motion.div
          ...
          "
        >
          <p class="py-2 font-mono text-4 italic dst">Step {{ i }}</p>
          ...
          <div
            class="relative mt-10 h-90 w-full overflow-hidden rounded-xl bg-b2/40 shadow-warm-2 shadow-black/4 drop-shadow-sm"
          >
