...
<template>
  <MenubarCheckboxItem
    v-bind="forwarded"
    :class="
      cn('focus:bg-b2 focus:text-bc relative flex cursor-default items-center gap-2.5 rounded-sm px-2 py-1.5 text-sm font-medium outline-none select-none data-disabled:pointer-events-none data-disabled:opacity-50',
