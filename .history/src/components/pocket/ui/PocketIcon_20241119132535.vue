...
<template>
    <div
        ...
        :class="
            cn(
                'shadow-warm, pointer-events-none relative grid size-12 place-items-center border border-base-300 transition-all duration-300',
                props.class
            )
        ">
        <div
            :class="cn('overflow-hidden rounded-full', props.iconClass)"
            :style="{
