    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <Card
                ...
                <div
                    class="delay-400 duration-400 h-200% mask absolute left-0 z-10 h-[200%] w-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 to-base-100 to-30% transition-all"
                    :class="{
                        '-top-[100%]': flip,
                        '-top-[30%]': !flip,
                    }" />
