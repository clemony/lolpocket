    ...
    <SidebarHeader>
        <SidebarMenu
            ...
            <SidebarMenuItem class="mx-2.5 mt-1 flex flex-row gap-3">
                <SidebarMenuButton
                    size="xs"
                    class="hover-ring-neutral/60 relative h-8 !min-h-6 w-full items-center justify-start border border-base-300/80 bg-base-100/50 !py-1 px-2 hover:border-base-300 hover:bg-base-100/60 hover:ring-1"
                    :class="{
                ...
                <SidebarMenuButton class="m-0 max-w-fit p-0" as-child>
                    <Button
                        variant="outline"
                        size="icon"
                        class="size-8 border-base-300">
                        <icon
