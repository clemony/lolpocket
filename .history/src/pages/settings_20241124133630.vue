...
type genType = InstanceType<typeof GeneralSettings>
type accType = InstanceType<typeof AccountSettings>

const generalRef = useTemplateRef<genType>('GeneralSettings')

const appearanceRef = useTemplateRef<HTMLBaseElement>('AppearanceSettings')
