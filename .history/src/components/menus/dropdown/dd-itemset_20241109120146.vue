            ...
            <PopoverContent
                ...
                <Transition name="ah" appear>
                    ...
                    <InfoCard title=" Starter Items" :key="props.pocket.key"
                        ...
                        cardClass="relative overflow-hidden w-full !h-full" class='' noPadding :style="{
                            width: props.cardWidth + 'px'
                        }">

                        <div class='flex flex-col max-h-inherit overflow-y-auto  mt-0 gap-5 px-7'>
                            <ItemsetModel :pocket="props.pocket" :model="props.model"
                                class='rounded-box  p-2 -ml-2.5  shadow-sm w-fit border border-base-200'>
                            ...
                            <TransitionGroup name="fade">
                                <label v-for="set in filter" v-close-popper
                                    class="sets flex gap-4 items-center  overflow-hidden w-fit cursor-pointer border border-transparent hover:border-base-300 rounded-box  p-2 -ml-2.5  hover:shadow-sm "
                                    :key="set.key">
