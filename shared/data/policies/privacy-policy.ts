...
export const privacyPolicy: PolicyItem[] = [
  ...
  },
  {
    ...
    sections: [
      {
        title: 'We use third-party authentication providers for all account creation and login:',
        description: [
          'Google',
          'Discord',
          'Riot Games',
      ...
      {
        title: 'These providers handle your credentials directly. lolpocket never stores or processes your passwords.'
      },
      {
      ...
      {
        title: 'You can revoke access or remove permissions through your provider at any time.'
  ...
  },
  {
    ...
    sections: [
      {
        title: 'We only collect the minimum data required to operate core features.',
        sections: [
          {
            title: 'a. Player Data',
            description: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'All partners comply with data protection laws and operate under their own privacy terms.'
      }
    ]
  },
  {
...

  {
    ...
    sections: [
      ...
      {
        title: `To make a request, contact: ${contactLP.privacy}`
      }
    ]
  },
  {
