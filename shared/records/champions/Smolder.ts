  ...
  abilities: [
    {
      ...
      blurb:
        "Innate:  Smolder generates a  stack of Dragon Practice from damaging champions with abilities, or when  Super Scorcher Breath kills  minions and  monsters. His  basic abilities deal bonus magic damage based on stacks.",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Smolder generates a stack of Dragon Practice each time he hits an enemy champion with an ability, or whenever Super Scorcher Breath kills a minion or monster. His basic abilities deal bonus magic damage based on stacks.</p>\n<p class="ability-effect"><span class="ability-header"> Super Scorcher Breath:</span> Deals bonus magic damage equal to 40% - 70% (+ 0% - 16%) (based on critical strike chance) of Dragon Practice stacks.</p>\n<p class="ability-effect"><span class="ability-header"> Achooo!:</span> Explosions deal bonus magic damage equal to 55% of Dragon Practice stacks.</p>\n<p class="ability-effect"><span class="ability-header"> Flap, Flap, Flap:</span> Attacks each deal bonus magic damage equal to 12% of Dragon Practice stacks.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Super Scorcher Breath becomes empowered with new effects based on the number of Dragon Practice stacks:</span></p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Tier 1 - 25 stacks:</span> The fireball explodes upon collision to deal the same physical damage to nearby enemies. The explosion benefits from life steal at 50% effectiveness and applies on-hit effects.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Tier 2 - 125 stacks:</span> The fireball sends forth 2 (+ 0.8 per 100 Dragon Practice stacks) bolts of fire in an arc upon collision that explode at maximum range, dealing 50% of the same damage to enemies hit. The bolts benefit from life steal at 50% effectiveness and apply on-hit effects.</p>',
          leveling: [
            {
              attribute: "Physical Damage",
              modifiers: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Smolder sneezes forth a glob that deals physical damage to enemies hit and  slows them. Hitting an enemy  champion creates an explosion that deals physical damage to nearby enemies.",
      castTime: "0.35",
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Smolder shouts for his mother to attack from above, causing her to exhale a wave of fire from behind him and towards the target direction, granting sight of its surroundings as it travels. The wave heals Smolder and deals physical damage to enemies hit, with those in the center taking 50% increased damage and becoming slowed by 40% for 2 seconds.</p>',
          leveling: [
            {
              attribute: "Self Heal",
              modifiers: [
