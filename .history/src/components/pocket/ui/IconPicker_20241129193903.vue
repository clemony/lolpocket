...
<template>
    <ScrollArea
        class="mb-10 flex h-full max-h-64 flex-wrap justify-self-end overflow-y-scroll">
        <label
            v-for="icon in iconStore"
            class="btn btn-ghost btn-sm m-1 aspect-square size-12 self-center border-transparent p-3 has-[:checked]:bg-base-200/60 has-[:checked]:shadow-standard">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
        ...
        <Label
            ...
            class="m-1 grid aspect-square size-16 place-items-center self-center overflow-hidden rounded-lg border border-transparent has-[:checked]:bg-base-200/60 has-[:checked]:shadow-standard">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
