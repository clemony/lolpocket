    ...
    <div
        ...
        <div
            ...
            <label
                ...
                :class="{
                    'absolute animate-in slide-in-from-top-0': gs.commandOpen,
                }"
                ...
                <SidebarProvider
                    class="page relative size-full overflow-hidden rounded-2xl bg-base-100/95 transition-all duration-300 [animation-fill-mode:forwards]"
                    :class="
                        cn({
                            /*base */
