...
const onHeaderReady = (params) => {
    ...
    // Retrieve and set the column definitions
    columns.value = headerApi.value.getColumnDefs()

    // Optional: Log the simplified version for debugging
    console.log('Columns:', columns.value.map(col => ({
        headerName: col.headerName,
        isVisible: col.isVisible(col),
