    ...
    <main
        ...
        <label>
            ...
            <SidebarProvider
                ...
                :class="{
                    'absolute shadow-[rgba(0,_0,_0,_0.2)_0px_30px_90px,_2px_1px_1px_2px_rgba(221,_221,_221,_0.4),_0_2px_5px_rgba(204,_204,_204,_0.4)] animate-out zoom-out-[0.75] slide-out-to-bottom-1/3 after:absolute after:z-50 after:size-full after:bg-black/20 after:backdrop-blur-xl':
                        state == 'open',
                }">
                <MainMenubar
