  ...
  abilities: [
    {
      ...
      blurb:
        "Innate: Every few seconds,  Gangplank's next basic attack will burn the target, continually dealing bonus true damage and granting him  bonus movement speed.",
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Gangplank fires a shot at the target enemy that deals physical damage, applies on-hit effects as a ranged attack, and triggers on-attack effects. Parrrley can critically strike for (175% + 40%) damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Gangplank consumes a large quantity of citrus fruit, cleansing himself from all crowd control and healing himself.</p>',
          leveling: [
            {
              attribute: "Heal",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Gangplank consumes a charge to place a powder keg at the target location that lasts for 25 seconds and will connect to other kegs with overlapping connection radius through a trail of black powder. The keg starts with 3 health and loses 1 every 2 / 1 / 0.5 (based on level) seconds until it is left with 1 health.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Gangplank orders a cannon bombardment to the target location, each blast deals magic damage and  slows enemies within.",
      castTime: "0.25",
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Gangplank can purchase upgrades for his ship in the store at the cost of 500 Silver Serpents each, which improve Cannon Barrage:</span></p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Death\'s Daughter:</span> A large cannonball lands in the center of the barrage after the first cluster of waves occur, dealing a cluster\'s worth of true damage to enemies within the impact and slowing them by 75% for 1 second.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Fire at Will:</span> Cannon Barrage fires[ 6 additional waves ][ 2 additional clusters ] over its duration; 18 waves of cannonballs are called down in clusters of 3 every 1.33 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Raise Morale:</span> Cannon Barrage grants Gangplank and all allies within the area 40% bonus movement speed, lingering for 2 seconds.</p>',
        },
      ],
