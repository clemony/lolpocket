...
<template>
    <Tabs default-value="Icons" class="-mt-12">
        <TabsList>
        ...
        <TabsContent value="Icons">
            <ScrollArea as-child>
                <div
                    class="scroll mb-10 flex h-full max-h-72 w-full flex-row flex-wrap justify-evenly gap-2 overflow-y-scroll p-1">
                    <Label
                        variant="ghost"
        ...
        <TabsContent value="Champions">
            <ScrollArea as-child>
                <div
                    class="scroll mb-10 flex h-full max-h-96 w-full flex-row flex-wrap justify-evenly gap-2 overflow-y-scroll p-1">
                    <Label
                        variant="outline"
