// Updated Patch 25.21 - 11/05/2025 05:09:38 PM CST
...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      blurb:
        'Claw Stance:  Udyr first two basic attacks deal bonus physical damage equal to a portion of the target\'s maximum health. Additionally, he gains  attack speed and bonus on-hit physical damage for a few seconds.',
      castTime: 'none',
      cooldown: '6',
      cost: '20',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - Stance:</span> Udyr enters Claw Stance, empowering his next two basic attacks to gain 50 bonus range and deal bonus physical damage, capped at 15 (+ 100% bonus AD) (+ 50% AP) against monsters.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Mantle Stance:  Udyr gains a  shield and his next two basic attacks gain  life steal and  heal him.',
      castTime: 'none',
      cooldown: '6',
      cost: '40',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - Stance:</span> Udyr enters Mantle Stance, empowering his next two basic attacks to gain life steal and heal him for 1.2% of his maximum health (+ 8% AP) on-hit.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast - Awaken:</span> Udyr increases the shield\'s strength, stacking with the remaining shield from the first cast, and heals every 0.25 seconds over the next 4 seconds, as well as causes the empowered attacks to instead gain doubled life steal and heal him for 2.4% of his maximum health (+ 16% AP) on-hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Stampede Stance:  Udyr gains  ghosting and a burst of  movement speed that decays over a few seconds. His attacks in this stance briefly  stun his target, but this cannot affect them more than once every few seconds.',
      castTime: 'none',
      cooldown: '6',
      cost: '40',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - Stance:</span> Udyr enters Stampede Stance, empowering his basic attacks to have an uncancellable windup and pounce on the target to stun them for 0.75 seconds. This cannot affect the same target more than once every few seconds.</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast - Awaken:</span> Udyr gains 75 bonus attack range and an additional 30% - 40% (based on level) bonus movement speed. He also gains immunity to crowd control for 1.5 seconds.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Storm Stance:  Udyr summons a blizzard around himself for a few seconds that continuously deals magic damage and  slows enemies inside. His next two basic attacks each cause the blizzard to deal a burst of additional magic damage to enemies inside it.',
      castTime: 'none',
      cooldown: '6',
      cost: '40',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - Stance:</span> Udyr enters Storm Stance, empowering his next two basic attacks to deal 10 - 40 (based on level) (+ 35% AP) magic damage to nearby enemies.</p>',
        },
        {
          description:
            'Additionally, Udyr summons a blizzard around himself for 4 seconds that deals magic damage every 0.5 seconds to nearby enemies and slows them while they remain within. Minions take 50% / 60% / 70% / 80% (based on level) damage.',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast - Awaken:</span> Udyr ends the blizzard if it is active and unleashes a glacial storm for 4 seconds that is able to move on its own, as well as causes the empowered attacks to instead deal their damage to enemies within that storm. The storm applies the same effects as the blizzard but deals bonus magic damage equal to[ 1% - 1.75% (based on level) (+ 0.4375% per 100 AP) of the target\'s maximum health per tick ][ 8% - 14% (based on level) (+ 3.5% per 100 AP) of the target\'s maximum health over the duration ]and slows by an additional 5%. Against monsters, the storm deals a minimum of [ 5 - 35 (based on level) per tick, and is capped at 10 - 50 (based on level) ][ 40 - 280 (based on level) over the duration, and is capped at 80 - 400 (based on level) ].</p>',
          leveling: [
            {
        ...
        {
          description:
            'The storm grants sight of its surroundings and prioritizes following the last enemy Udyr attacked while it was active, then enemy champions, then non-champions, then Udyr. The storm can only follow visible enemies.',
        },
      ],
