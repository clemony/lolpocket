            ...
            <CardContent
                ...
                <CardHeader class="relative flex pl-28 pr-4">
                    ...
                    <CardDescription>
                        ...
                        <h4
                            class="font-cursive z-10 ml-3 scale-x-110 pt-0 !text-base font-semibold !not-italic">
                            #{{ pocket.tags[0] }}
                        </h4>
                    </CardDescription>
                </CardHeader>
                ...
                <div
                    class="max-w-inherit mt-2 grid w-full grid-cols-[1fr_3fr] gap-x-3 gap-y-5 px-2">
                    <div
                        v-if="set"
                    ...
                    <div class="col-start-2">
                        <div
                            class="grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-between gap-1 px-3 py-1">
                            <template
                        ...
                        <div
                            class="relative flex h-full flex-col items-start justify-between gap-4 px-0 py-2">
                            <div
