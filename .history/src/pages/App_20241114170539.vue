                                        ...
                                        <SidebarMenuBadge>
                                            <Badge
                                                ...
                                                v-if="
                                                    ...
                                                    ps.pockets.length
                                                "
                                                class="absolute right-0 min-w-5 px-1.5 group-hover/pocket:opacity-60">
                                                {{ ps.pockets.length }}
                                            </Badge>
                                        </SidebarMenuBadge>
                                    </SidebarMenuButton>
                                                            ...
                                                            <Badge
                                                                ...
                                                                v-if="
                                                                    ...
                                                                    item.array
                                                                        .length
                                                                "
                                                                class="absolute -right-[7px] -top-3.5 flex min-w-8 items-center justify-center px-1.5 shadow-sm group-hover/pocket:opacity-60">
                                                                {{
                                                                    item.array
                                                                        .length
                                                                }}
