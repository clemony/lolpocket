                ...
                <div
                    ...
                    <div>
                        <div
                            ...
                            "
                            class="size-[38px] overflow-hidden rounded-lg p-0 shadow-standard ring-1 ring-transparent ring-offset-2 transition-all duration-300 hover:ring-neutral/60 data-[state=open]:ring-neutral/60">
                            <img
                    ...
                    <div
                        ...
                        <div
                            ...
                            class="size-[22px] rounded-full border border-base-300 p-1 shadow-sm"
                            :class="
                                cn(getShardClass(shard), {
                                    'bg-base-200/25 opacity-70':
                                        shard.name == 'none',
                                })
                            ">
                            <icon
