...
<VueDraggable v-if="pocket" tag="div" v-model="pocket.items[0].itemSets" :delay="0" :animation="300"
    ...
    <Card
        class='h-[60px] items-center grid justify-center bg-transparent opacity-70 shadow-inset transition-all duration-300 hover:opacity-100 hover:bg-base-100/90'>
