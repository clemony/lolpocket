...
<template>
    <label class="relative size-fit">
        ...
        <Transition
            enter-active-class="flip-x-right-front"
            leave-active-class="flip-x-left-front">
            <div
                v-if="!flip"
                :style="{
                    backgroundImage: champImage,
                }"
                class="absolute rounded-box bg-[20%_-45%] bg-no-repeat transition-all duration-1000 animate-in animate-out spin-in-0 spin-out-0 [background-size:200%]">
                <InfoCard
        ...
        <Transition
            leave-active-class="flip-x-right"
            enter-active-class="flip-x-left-back">
            <Card
                v-if="flip"
                class="absolute h-[350px] w-[250px] transition-all duration-1000 animate-in animate-out spin-in-0 spin-out-0">
                hi
            </Card>
        </Transition>
    </label>
