                ...
                <div class="flex w-full">
                    ...
                    <div class="w-1/2 pl-3">
                        <div
                            ...
                            <div class="absolute right-12 top-0 z-20">
                                <Keystone :pocket="pocket" />
                            </div>
                            <div
                                class="z-0 mt-8 flex size-fit items-center justify-center rounded-full">
                                <div
                                    class="z-10 -mr-1 flex flex-col -space-y-3 [&_:first-child]:z-20 [&_:last-child]:z-0 [&_:nth-child(2)]:z-10">
                                    <RuneSet :pocket="pocket" type="runes1" />
                                </div>
                                <div
                                    class="absolute -top-2 right-0 z-0 [&_:last-child]:z-0">
