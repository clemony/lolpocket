...
<template>
    <div
        ...
        :data-tier="rune.tier">
        <div
            class="border-base-300 grid w-full grid-cols-[1fr_2fr] gap-1 border-b px-2 pb-3">
            <a
                :href="rune.wiki"
                target="_blank"
                ...
                <div
                    class="link-icon border-base-100 bg-neutral group-hover/link:border-primary absolute bottom-0 z-30 flex size-8 items-center justify-center rounded-full border-2 transition-all duration-500 group-hover/link:rotate-180">
                    <Icon
                        icon="teenyicons:link-outline"
                        class="text-neutral-content size-5" />
                </div>
            </a>
            ...
            <div class="grid h-full grid-cols-1">
                <div class="text-middle flex">
                    <h3
                        class="flex flex-wrap text-sm leading-4 font-bold tracking-tight">
                        {{ rune.name }}
                    </h3>
                </div>
...
[data-tier='3'] {
    ...
    .runeImg {
        @apply ring-base-200 ring-offset-base-300 size-12 ring-1 shadow-[inset_0px_0px_2px_3px_#00000099,_1px_2px_1px_2px_#00000018] ring-offset-1;
    }
}
</style>
