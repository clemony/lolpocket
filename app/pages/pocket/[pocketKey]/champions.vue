  ...
  <div class="size-full  pt-26 ">
    ...
    <div class="  grid grid-flow-row auto-cols-auto  grid-cols-[repeat(auto-fill,minmax(80px,1fr))]  px-14 w-full pb-3 inset-0   gap-3 ">
      <ChampionIcon
        ...
        :id="champion.id"
        :key="champion.id" :class="{ ' not-[.checkbox]:**:contrast-110 not-[.checkbox]:**:opacity-65 not-[.checkbox]:**:grayscale border scale-90 border-neutral/60 relative': pocket.champions.includes(champion.key) }" class="hover-ring  rounded-lg size-26 ">
        <slot />
