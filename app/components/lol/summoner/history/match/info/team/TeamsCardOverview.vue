...
<template>
  <div
    class="grid max-w-74 grid-flow-col grid-cols-2 grid-rows-5 gap-4 gap-y-px justify-self-end overflow-hidden"
  >
    <BtnLink
    ...
    >
      <div class="flex gap-2 overflow-hidden">
        ...
        <a
          ...
          class="h-full w-full truncate text-1 font-medium tracking-tight text-nowrap"
        >
