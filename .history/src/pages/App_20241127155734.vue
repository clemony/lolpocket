...
<template>
    ...
    <main
        ...
        <label>
            ...
            <SidebarProvider
                class="page bg-b1/95 animate-in zoom-in-[0.75] slide-in-from-bottom-1/3 overflow-hidden rounded-xl"
                :class="{
...
@import url('daisyui/components/carousel.css');
@import url('daisyui/utilities/join.css');
@import url('daisyui/components/checkbox.css');
.page,
.command {
