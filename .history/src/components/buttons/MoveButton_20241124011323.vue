...
<template>
    <Button
        ...
        <div
            ...
            class="! pointer-events-none absolute right-1 top-[1px] grid aspect-square place-content-center place-items-center rounded-full bg-neutral px-2 text-neutral-content">
            {{ selectedCount }}
        </div>
    </Button>
</template>
