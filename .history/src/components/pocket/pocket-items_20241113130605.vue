    ...
    <Layout2 class="max-h-inhhert h-inherit" scroll :panel1Size="45">
        ...
        <template #panel2>
            <InfoCard
                ...
                cardClass="inset-0 w-fit justify-self-end h-[calc(100%-135px)] max-h-[calc(100%-135px)] overflow-hidden pt-4 ml-6 mr-2 pr-0"
                headerClass="py-5">
                <template #header>
                    <div class="join">
                        <SearchBox
                ...
                <ScrollArea
                    class="h-full max-h-full overflow-auto pb-10 pl-1 pr-5">
