    ...
    <div class="flex justify-center" :key="set.key">
        <div
            ...
            <label
                ...
                <div
                    class="grid size-14 shrink-0 place-items-center rounded-full border border-base-300 bg-gradient-to-br from-base-100/70 to-base-200/40 p-3.5 shadow-[0_3px_10px_rgb(0,0,0,0.2),inset_-1px_-1px_0px_1px_#00000008] backdrop-blur-sm"
                    :class="
                        cn(
                            getShardClass(shard)
                                .toString()
