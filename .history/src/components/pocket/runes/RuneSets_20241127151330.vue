...
<template>
    <div
        v-if="pocket"
        class="bg-b2/20 h-full w-full overflow-y-scroll overscroll-none pt-8">
        <!-------------------------------- HEADER --------------------------------->
        ...
        <div class="z-0 flex flex-col overflow-y-scroll">
            <VueDraggable
                ...
                <label
                    ...
                    <div
                        class="group border-b2 z-20 flex h-full w-full items-center gap-4 border-b bg-clip-padding bg-right p-2 transition-all duration-200">
                        <input
                            type="radio"
                            :value="index"
                            id="runeSets"
                        ...
                        <!--   
                          <div
              class="grid grid-cols-3 *:aspect-square *:size-5 *:rounded-btn *:text-base-content/80 *:transition-all *:flex *:justify-center *:items-center *:duration-300 gap-1.5">  <button class="hover:bg-b2" alt="Clear Items" title="Clear Items" @click="rs.resetRunes()">
