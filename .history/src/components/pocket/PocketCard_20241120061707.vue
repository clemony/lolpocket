        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        class="relative col-start-2 row-start-2 flex h-full flex-col items-center justify-center gap-1.5 [&_(:nth-child(2))]:absolute">
                        <div
                            v-for="shard in set.shards"
                            :key="shard.name + shard.slotID"
                            class="size-[22px] rounded-full border border-base-200/95 p-1 shadow-sm"
                            :class="
