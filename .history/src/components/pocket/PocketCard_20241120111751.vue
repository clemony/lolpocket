            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            class="col-start-1 -ml-1 -mt-3 grid justify-center">
                        ...
                        <div
                            class="col-start-1 flex max-w-full flex-row items-end overflow-visible">
                            <div class="flex w-28 items-end justify-between">
