                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="flex items-center px-5">
                                ...
                                <div
                                    class="flex aspect-square items-center rounded-md bg-neutral p-3">
                                    <div class="text-neutral-content">Dd</div>
                                </div>
                            </div>
                            <div
                                class="flex h-full w-full items-center justify-center p-3"></div>
                        </div>
                    </div>
                </label>
            </DisplayCard>
