    ...
    <template #panel2>
        ...
        <Card :open="false" class='h-[calc(100%-115px)] max-h-[calc(100%-115px)] overflow-hidden pt-4'>
            ...
            <CardHeader>
                ...
                <Grow />
                <Button variant="outline" size="icon" class='[&_input]:hidden'
                    @click="sortAZ++; sortAZ == 3 ? sortAZ = 0 : ''" :class="{ 'ring-1 ring-base-300': sortAZ }">

                    <icon v-if="sortAZ == 2" icon="iicon-park-outline:alphabetical-sorting-two" class='size-6 ' />
                    <icon v-else icon="icon-park-outline:alphabetical-sorting" class='size-6 ' />
