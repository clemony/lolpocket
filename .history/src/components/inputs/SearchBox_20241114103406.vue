...
<template>
    <div class="group/search peer relative flex items-center gap-2 self-center hover:ring-1 hover:ring-neutral/5 focus-within:outline-none focus-within:ring-1 focus-within:ring-neutral/40">
        <Icon
            ...
            class="pointer-events-none absolute left-0 p-1 h-full w-auto aspect-square shrink-0 opacity-60" />
        ...
        <input
            ...
            @input="handleInput"
            spellcheck="false"
            :class="cn('border-input flex h-10 w-full rounded-md border bg-transparent py-2 pl-9 pr-3 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus:ring-0 placeholder:text-base-content/60  disabled:cursor-not-allowed disabled:opacity-50', props.class)"
