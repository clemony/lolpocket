  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Ryze increases his maximum mana by (10% per 100 AP).</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Passive:  Ryze's other  basic ability casts  reset Overload's cooldown and generate a  Rune stack, stacking up to 2 times.",
      castTime: "0.25",
      cooldown: "5",
      cost: "40 / 38 / 36 / 34 / 32",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Ryze\'s other basic ability casts reset Overload\'s cooldown and charge a Rune stack for 4 seconds, refreshing on subsequent casts and stacking up to 2 times.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ryze unleashes a runic blast in the target direction that deals magic damage to the first enemy hit and consumes all Rune stacks.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Flux Bonus:</span> Overload deals 25% / 50% / 75% / 100% (based on Realm Warp\'s Rank) increased damage and spreads to surrounding Fluxed enemies.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Ryze seizes the target enemy, dealing magic damage and briefly  slowing them.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ryze seizes the target enemy, dealing magic damage and slowing them by 50% for 1.5 seconds.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Flux Bonus:</span> The target is rooted instead of slowed.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Flux Bonus:</span> Spell Flux spreads farther.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Overload\'s Flux empowered damage is increased.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ryze channels for 2 seconds to open a portal beneath him, marking the target location as its destination and granting sight of its area. Ryze is able to act while channeling, but the portal will cancel if he is interrupted.</p>',
        },
        {
          description:
