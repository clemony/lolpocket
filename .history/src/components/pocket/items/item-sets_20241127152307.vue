                ...
                <template #header>
                    ...
                    <div
                        ...
                        <InputEditable
                            ...
                            class="focus-within:border-b2 hover:border-b2 text-4! hidden w-fit items-center truncate border-transparent text-start align-baseline font-medium capitalize transition-all duration-300 @[230px]/set:flex">
                            <Button
                                variant="simple"
                                size="xs"
