...
<template>
  <div v-if="pocket" class="flex flex-1 flex-col">
    ...
    <div class="border-y border-y-b4 bg-black">
      <div
        class="relative z-1 h-70 w-full bg-size-[88%] bg-fixed bg-[170%_55%] bg-no-repeat inset-shadow-sm inset-shadow-black/20 before:z-0"
        :style="bg"
      />
    </div>
    <div class="flex-1 p-4 text-2 whitespace-pre-wrap"></div>
  ...
  <div v-else class="grid size-full justify-center text-center text-bc/60">
