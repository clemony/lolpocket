            ...
            <SidebarMenuItem
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger
                        ...
                        <SidebarMenuButton variant="ghost" size="md" class="0">
                            <div
                                class="items-center justify-center rounded-md bg-neutral text-neutral-content/90">
                                <h4 class="shrink-0">LP</h4>
                            </div>
                            <div
                                class="flex text-left leading-tight"
                                :class="{
                                    hidden: (gs.sidebarState = 'collapsed'),
                                }">
                                <h2>lolpockets</h2>
                            </div>
                            <icon
