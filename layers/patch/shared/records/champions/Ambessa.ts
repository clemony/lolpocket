  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description: '<p class="ability-effect"><span class="ability-header">Medarda Maxim:</span> Ambessa\'s next basic attack on-attack is empowered to have an uncancellable windup, gain 75 bonus range and 50% bonus attack speed, deal 5 - 30 (based on level) (+ 25% bonus AD) bonus physical damage, and restore 40 / 55 / 70 (based on level) energy.</p>'
        }
      ]
    },
    {
      ...
      effects: [
          ...
          leveling: [
            {
              ...
              modifiers: [
                ...
                {
                  tooltip: 'Scaling per rank:\n1 / 1.5 / 2 / 2.5 / 3% (+ 1.5% per 100 bonus AD) of target\'s maximum health',
                  unit: '% (+ 1.5% per 100 bonus AD) of target\'s maximum health',
                  values: '1 - 3'
                }
              ]
            },
            {
              ...
              modifiers: [
                ...
                {
                  tooltip: 'Scaling per rank:\n2 / 3 / 4 / 5 / 6% (+ 3% per 100 bonus AD) of target\'s maximum health',
                  unit: '% (+ 3% per 100 bonus AD) of target\'s maximum health',
                  values: '2 - 6'
                }
              ]
            }
        ...
        {
          description: 'Against monsters, Cunning Sweep deals 150 bonus physical damage and the damage based on their health ratio is capped at 100 - 300 (based on level).'
        }
      ]
    },
    {
