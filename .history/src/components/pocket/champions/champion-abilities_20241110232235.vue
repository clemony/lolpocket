...
<Accordion default-value="Q" collapsible class='  overflow-hidden' v-model:modelValue="modelValue"
    ...
    <TransitionGroup name="component">
        <template v-for="(ability, key) in champion.abilities" :key="key" :value="key">
            <AccordionItem v-if="modelValue && modelValue == key || !modelValue"
                ...
                <AccordionContent class=''>
                    ...
                    <div class='flex flex-col gap-3 py-3'>
                        <div v-for="(value, key) in filteredData(
                            ...
                            class='flex flex-nowrap w-full bg-base-200/60 rounded-md px-2 py-1'>
