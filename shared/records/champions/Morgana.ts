  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Morgana  heals herself for a portion of the damage dealt by her abilities against  champions, large  minions, and medium and large  monsters.",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Morgana heals herself for 18% of the post-mitigation damage dealt by her abilities against champions, large minions, and medium and large monsters.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        'Active:  Morgana throws a sphere of dark magic in the target direction that deals magic damage to the first enemy hit and  roots them for a "short time".',
      castTime: "0.25",
      cooldown: "10",
      cost: "50 / 55 / 60 / 65 / 70",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Morgana throws a sphere of dark magic in the target direction that deals magic damage to the first enemy hit and roots them for a duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Passive: Tormented Shadow's current cooldown is  reduced whenever  Soul Siphon triggers.",
      castTime: "0.25",
      cooldown: "12",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Tormented Shadow\'s current cooldown is reduced by 5% of its total cooldown whenever Soul Siphon triggers. Simultaneous triggers from multiple targets will stack the cooldown reduction.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Morgana torments the soil at the target location, causing the area to become desecrated for 5 seconds. Enemies within take magic damage on-cast and every 0.5 seconds, increased by 0% - 170% (based on target\'s missing health). Tormented Shadow deals 170% damage against monsters.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self, Allies",
      blurb:
        "Active:  Morgana  shields the target allied champion or herself for a few seconds, which absorbs magic damage and grants  crowd control immunity while the shield holds.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Morgana grants a shield to the target allied champion or herself for 5 seconds, which absorbs incoming magic damage and grants crowd control immunity while it holds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Morgana latches chains of energy onto nearby enemy champions, dealing magic damage and forming a  tether between herself and each target for a short time, during which the targets are  revealed and  slowed, and Morgana gains  bonus movement speed.",
      castTime: "0.35",
      ...
      effects: [
        ...
        {
          description:
            "An enemy champion within 575 units is required to cast this ability. The target does not have to be visible to be tethered by this ability.",
        },
      ],
