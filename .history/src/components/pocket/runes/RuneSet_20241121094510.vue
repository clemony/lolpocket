...
<template v-if="set">
    <template v-for="rune in this1">
        <div
            class="shrink-0 rounded-full border border-base-300/70 bg-base-100/50 p-2 shadow-[0_3px_10px_rgb(0,0,0,0.2),inset_-1px_-1px_0px_1px_#00000008] backdrop-blur-sm">
