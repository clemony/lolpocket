    ...
    <div class="mb-4 grid h-fit w-full gap-4 px-4">
        <div class="flex items-center gap-3">
            ...
            <Button variant="ghost" size="lg"
                class='bg-gradient-to-b  from-transparent via-domination to-transparent text-white text-base justify-start shadow-sm px-5 border border-error rounded-md'>
