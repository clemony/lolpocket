            ...
            <VueDraggable
                ...
                <label
                    ...
                    <div
                        ...
                        <!--   
                          <div
              class="grid grid-cols-3 *:aspect-square *:size-5 *:rounded-btn *:text-4-content/80 *:transition-all *:flex *:justify-center *:items-center *:duration-300 gap-1.5">  <button class="hover:bg-b2" alt="Clear Items" title="Clear Items" @click="rs.resetRunes()">
