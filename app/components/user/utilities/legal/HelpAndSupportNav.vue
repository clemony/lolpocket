...
<template>
  <Collapsible :default-open="false">
    <CollapsibleTrigger
      class="text-bc/50 hover:text-bc! flex h-10 w-full flex-nowrap items-center justify-start gap-3.25! overflow-hidden pr-1 pl-1.5 font-medium text-nowrap capitalize duration-0! hover:underline"
    >
