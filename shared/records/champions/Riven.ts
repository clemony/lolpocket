  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Riven can activate Broken Wings three times before the ability goes on cooldown, with a 0.3125-second static cooldown between casts. If Riven does not recast the ability within 4 seconds of the previous cast, it goes on cooldown.</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">First Cast:</span> Riven dashes 225 units in the direction she is currently facing, or up to 225 units towards the target enemy, striking enemies in the target area 100 units away. This cast cannot cross terrain.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Second Cast:</span> Riven mimics the first cast\'s effects.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Third Cast:</span> Riven mimics the first cast\'s effects in a larger area while also knocking back enemies hit 75 units over 0.5 seconds. This cast can cross terrain.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Riven emits a flash of runic energy, dealing physical damage and briefly  stunning nearby enemies.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Riven emits a flash of runic energy from the start of the cast time, dealing physical damage to nearby enemies and stunning them for 0.75 seconds.</p>',
          leveling: [
            {
              attribute: "Physical Damage",
              modifiers: [
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Riven  dashes in the target direction and gains a brief  shield.",
      castTime: "none",
      cooldown: "10 / 9 / 8 / 7 / 6",
      cost: "0",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Riven dashes in the target direction, though not through terrain, while granting herself a shield for 1.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Riven empowers her blade for some time, gaining  bonus attack damage and increased  range on her  basic attacks,  Broken Wings and  Ki Burst.",
      castTime: "0.25",
      cooldown: "120 / 90 / 60",
      cost: "0",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Riven empowers her blade for 15 seconds, gaining 25% AD bonus attack damage, 75 bonus attack range, and increased range on Broken Wings and Ki Burst. After 0.5 seconds, she can cast Wind Slash within the duration.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Riven unleashes a wave of energy in a cone in the target direction that deals physical damage to enemies hit, increased by 0% - 200% (based on target\'s missing health).</p>',
          leveling: [
            {
