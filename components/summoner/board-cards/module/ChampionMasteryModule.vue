        ...
        <div
          ...
          <div
            ...
            <div
              class="size-full "
              :style="
                { backgroundImage: `url(/img/champion-centered/${ds.champions.find((c) => c.key == i.championId.toString()).id}_0.webp)`,
                  backgroundSize: '363%',
        ...
        <div class="size-full z-30">
          ...
          <div class="z-10 items-center flex flex-col gap-1 justify-end h-full pb-6">
            ...
            <p class="text-5 font-semibold font-serif f-tt dst">
              {{ ds.champions.find((c) => c.key == i.championId.toString()).name }}
            </p>
            <p class="font-medium">
