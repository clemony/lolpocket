...
<template>
    <VueDraggable
        ...
        :fallbackOnBody="true"
        @remove=""
        class="drag-draggable h-full max-h-full content-start items-start justify-around py-4 pr-6 scrollbar-hide">
        ...
        <div v-for="index in 7" class="drag-label" :key="index">
            <div class="drag-label">
                <div class="drag-img aspect-square size-[52px] opacity-0"></div>
            </div>
        </div>
    </VueDraggable>
</template>
