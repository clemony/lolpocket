...
<div class="z-0 w-full bg-clip-border transition-all duration-500">
    <div
        ...
        <label v-for="(path, index) in ds.uniquePaths" :key="index"
            ...
            <div
                class="mx-2 flex aspect-square size-14 items-center justify-center brightness-75 drop-shadow-sm grayscale hover:brightness-100 hover:grayscale-0 peer-checked:brightness-100 peer-checked:grayscale-0">
                <img :src="'/img/runes/' + path + '.webp' ||
                    '/img/runes/RunesIcon.svg'
                    " class="drop-shadow-softest h-14 w-auto" />
            </div>
            <div
...
<div v-if="props.set == 1" class="my-9 grid grid-cols-3 place-items-center justify-center gap-x-2 gap-y-9 px-7">
    <label v-for="(rune, index) in filter" :key="rune.name"
        ...
        <VDropdown v-if="rune.tier == 0" theme="default" :triggers="['hover']" :popperTriggers="['hover']"
            :delay="{ show: 1000, hide: 0 }" :disabled="rune.path == 'none'" id="imgwrap"
            class="h-[inherit] w-[inherit] opacity-80 [&_img]:grayscale transition-all duration-500 hover:opacity-100 hover:[&_img]:grayscale-0 peer-checked:opacity-100  peer-checked:[&_img]:grayscale-0 mask mask-3">
        ...
        <VDropdown v-else theme="default" :triggers="['hover']" :popperTriggers="['hover']"
            :delay="{ show: 1000, hide: 0 }" :disabled="rune.path == 'none'" id="imgwrap"
            class="h-[inherit] w-[inherit] opacity-80 brightness-90 [&_img]:grayscale transition-all duration-500 hover:opacity-100 hover:[&_img]:grayscale-0 peer-checked:opacity-100 peer-checked:brightness-100 peer-checked:[&_img]:grayscale-0">
