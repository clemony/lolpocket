        ...
        <Popover>
            <PopoverTrigger
                ...
                <Button
                    ...
                    size="icon"
                    v-else-if="model"
                    class="size-18 overflow-hidden rounded-lg p-0 shadow-standard ring-1 ring-transparent transition-all duration-300 hover:border-neutral/60 hover:ring-neutral/60 data-[state=open]:border-neutral/60 data-[state=open]:ring-neutral/60">
                    <img
