...
<template>
    <form class="text-center justify-items-center rounded-lg z-0">
        ...
        <div class="relative max-w-[470px]">
            <div
                class=" w-full  shadow-inner bg-base-200/60 border-base-content/30 text-base-content/60 shadow-base-content/20  rounded-[10px]  z-20 focus:*:text-base-content focus:*:not-italic">
