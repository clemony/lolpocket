    ...
    <VueDraggable
        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-1"
                :cardClass="{
                    'relative w-min box-border inset-0 before:absolute before:bg-transparent before:border  before:w-full before:h-full  before:pointer-events-none before:border-transparent before:z-50  mr-6 before:rounded-box':
                        set,
