...
<template>
    ...
    <Transition name="command">
        <main class="wrapper size-full" :key="state">
            <div
                v-if="state == 'open'"
                class="command h-1/3 animate-in fade-in-0 slide-in-from-bottom-8">
                <Command />
            </div>
            <label>
                <input
                ...
                <SidebarProvider class="page overflow-hidden">
                    <Sidebar
                        collapsible="icon"
...
.command-enter-to .command-leave-from {
}
