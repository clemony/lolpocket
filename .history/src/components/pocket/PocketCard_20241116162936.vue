    ...
    <label class="swap swap-flip relative h-[300px] w-[250px]">
        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    class="max-w-inherit mt-2 grid w-full grid-cols-[2fr_2.5fr] gap-x-3 gap-y-5 px-2">
                    <div
                        class="col-start-2 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-items-center gap-1">
                    ...
                    <div
                        v-if="set"
                        class="col-start-1 w-fit grid-flow-col justify-start overflow-hidden">
                        <img
                            v-if="
