...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Active:  Akshan throws a boomerang that deals physical damage to enemies hit, extending the boomerang range and briefly  revealing them. If this hits an enemy  champion, Akshan gains a brief burst of  move speed.',
      castTime: '0.25',
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Passive: Enemy  champions that kill allied champions are marked as a Scoundrel for a long time. When  Akshan scores a  takedown on a Scoundrel, he gains  bonus gold, all allies killed by the Scoundrel are resurrected, and Scoundrel status is removed from all other enemies.',
      castTime: '0.5',
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Third Cast:</span> Akshan ends the swing by jumping to the target location and fires one last shot at a nearby visible enemy.</p>',
        },
        {
          description:
            'Scoring an enemy champion takedown reduces Heroic Swing\'s current cooldown to 0.5 seconds. The shots can critically strike for[ (157.5% + 36%) damage ][ 90% total critical damage ]and apply life steal at 100% effectiveness.',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Self, Enemies',
      blurb:
        'Active:  Akshan locks onto the target enemy champion and begins  channeling power into his gun to store bullets,  revealing them as well as  revealing himself. Comeuppance will recast after the channel, or can recast early.',
      castTime: 'none',
      cooldown: '100 / 85 / 70',
      cost: '100',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Akshan locks onto the target enemy champion and begins channeling for 2.5 seconds, revealing them as well as revealing himself. He gradually stores bullets into his weapon over the duration.</p>',
          leveling: [
            {
