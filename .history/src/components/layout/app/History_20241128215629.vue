...
<template>
    ...
    <div
        ...
        <div
            ...
            <label
                class="flex size-full justify-center overflow-hidden rounded-2xl transition-all duration-300 [animation-fill-mode:forwards]"
                :class="{
                ...
                <SidebarProvider
                    class="page relative size-full overflow-hidden rounded-2xl bg-base-100/95 transition-all duration-1000 animate-in animate-out zoom-in-100 zoom-out-100 slide-in-from-top-0 slide-out-to-bottom-36 [animation-fill-mode:forwards]"
                    :class="
                        cn({
                            /*base */
                            ...
                            /* animation */
                            'ease-[cubic-bezier(1,.1,.71,.97)] transition-all duration-1000 animate-in zoom-in-75 slide-in-from-top-36':
                                gs.commandOpen,
