                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="flex-grow px-1 text-lg font-semibold"></div>
                                <div
                                    class="flex aspect-square size-9 items-center justify-center rounded-md bg-base-200 text-base-content"></div>
                                <div
                                    class="flex aspect-square size-9 items-center justify-center rounded-md bg-base-300 text-base-content"></div>
                                <div
                                    class="flex aspect-square size-9 items-center justify-center rounded-md bg-neutral text-neutral-content"></div>
                            </div>
                        </div>
                    </div>
                </label>
