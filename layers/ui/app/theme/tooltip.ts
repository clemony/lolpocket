...
export const tooltipTheme = defineUiTheme({
  slots: {
    arrow:
      "fill-neutral/75 stroke-n5/60 stroke-1 group-data-[side=bottom]/tt:group-data-[align=start]/tt:-translate-x-4",
    content: [
  ...
  variants: {
    color: {
      neutral: {
        arrow: "",
        content:
          "border-n1 bg-neutral/82 font-medium text-nc ring-n5/60 inset-shadow-white/10 backdrop-blur-sm"
      },
      primary: {
        arrow: "fill-p0/90",
        content:
