...
<template>
  <div
    id="menu"
    class="!overflow-y-scroll mx-0.5">
    <div
      data-tauri-drag-region
      class="grid grid-cols-1 col-start-1 justify-self-start self-base ml-4 select-none gap-4 content-center items-center">
      ...
      <h1 class="font-semibold text-base">lolpocket</h1>

      <!--      <input type="checkbox" class="toggle toggle-xs rounded-[5px] bg-neutral opacity-80 ml-1" /> -->
    </div>

    <ul class="menu border-none mt-2 [&_svg]:size-4 space-y-3 text-xs [&_a]:flex [&_a]:gap-3 [&_a]:-ml-1 [&_a]:font-medium [&_ul]:before:opacity-20 [&_ul]:ml-5">
      <li>
        <a
          @click="sn.navigateTo('/home')"
      ...
      <li id="builds">
        <span
          :class="{ 'menu-dropdown-show': showDropdowns[0] }"
          @click="toggleShow(0)"
      ...
      <li id="faves">
        <span
          :class="{ 'menu-dropdown-show': showDropdowns[1] }"
          @click="toggleShow(1)"
          class="menu-dropdown-toggle">
          <a>
        ...
        <ul
          ...
          class="menu-dropdown">
          <li>
            <a @click="sn.navigateTo('Champions')"> <Icon icon="teenyicons:ghost-outline" /><span>Champions</span> </a>
          </li>
          <li>
            <a @click="sn.navigateTo('/items')"> <Icon icon="teenyicons:wand-outline" /><span>Items</span> </a>
          </li>
        </ul>
      </li>
      <li id="browse">
        <span
          :class="{ 'menu-dropdown-show': showDropdowns[2] }"
          @click="toggleShow(2)"
          class="menu-dropdown-toggle">
          <a>
        ...
        <ul
          ...
          class="menu-dropdown">
          <li>
            <a @click="sn.navigateTo('/champions/champions')"> <Icon icon="teenyicons:ghost-outline" /><span>Champions</span> </a>
          </li>
          <li>
