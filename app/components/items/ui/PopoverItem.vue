...
<template>
  <div>
    <Popover
      v-model:open="isOpen">
      <PopoverTrigger
        ref="trigger" v-bind="$attrs" :class="cn({ 'hover:ring-1 !pointer-events-auto !cursor-pointer shadow-sm drop-shadow-sm hover:ring-n1 hover:ring-offset-2 hover:ring-offset-b1 data-[state=open]:ring-1 aspect-square  data-[state=open]:ring-offset-2 data-[state=open]:ring-n1 data-[state=open]:ring-offset-b1': loaded }, className)" class=" relative  overflow-hidden  group/item ">
