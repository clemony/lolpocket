...
const General = useTemplateRef('@/components/settings/GeneralSettings.vue')

const Appearance = useTemplateRef(
    defineAsyncComponent(
        () => import('@/components/settings/AppearanceSettings.vue')
    )
)

const Account = useTemplateRef(
    defineAsyncComponent(
        () => import('@/components/settings/AccountSettings.vue')
    )
)

const Hotkeys = useTemplateRef(
    defineAsyncComponent(
        () => import('@/components/settings/HotkeySettings.vue')
    )
)

const Storage = useTemplateRef(
    defineAsyncComponent(
        () => import('@/components/settings/StorageSettings.vue')
    )
)
defineExpose({
    General,
