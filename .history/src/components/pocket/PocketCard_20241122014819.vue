                ...
                <div class="size-full px-3">
                    <div class="mt-1 h-1/2">
                        ...
                        <div class="mt-4 flex items-end">
                            <div
                                class="z-20 flex grow items-center justify-center">
                                <Keystone :pocket="pocket" />
                            </div>
                            <div
                                class="flex w-2/3 flex-row flex-wrap justify-end gap-1 justify-self-end">
...
'[&_:last-child]:left-8 [&_:last-child]:top-22 [&_:last-child]:z-0'*/
                                ...
                                <div
                                    ...
                                    :class="
                                        cn(
                                            'z-20 size-12 rounded-full p-2'
                                            /* ' border border-base-200 bg-base-100/60 shadow-pretty backdrop-blur-sm mb-3 '*/
                                        )
                                    ">
                                    <img
