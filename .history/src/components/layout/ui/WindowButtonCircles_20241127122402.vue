...
const size = 'icon'
const classObject = [
    'stroke-[1.5] [&_svg]:object-center shadow-xs [&_svg]:size-5 [&_svg]:shrink-0 [&_svg]:shadow-inner hover:shadow-base-300 size-4.5 rounded-full [&_svg]:absolute group/button',
]
</script>
<template>
    <div
