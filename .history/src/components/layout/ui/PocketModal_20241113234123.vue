...
<template>
        ...
        <form ref="form" class="flex gap-4 py-4" @submit.prevent.stop="submitForm">
            <div class="flex w-1/2 flex-col gap-1">
                ...
                <TagsInput v-model="tags" class="flex-col">
                    <div
                        class="flex w-full flex-row flex-wrap justify-start gap-2 *:text-sm">
                    ...
                    <DropdownMenu class="w-1/2">
                        <DropdownMenuTrigger
                            ...
                            <Button variant="ghost" size="sm">
                                <span
                                    class="size-5 justify-start rounded border border-base-300"
                                    :style="{
                                        backgroundColor: bgColor,
                                    }"></span>
                                Backdrop
