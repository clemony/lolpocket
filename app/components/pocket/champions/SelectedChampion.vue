...
<template>
  <div
    class="
      h-30 shrink-0 basis-1/3 overflow-hidden
      @3xl:basis-1/4
      @7xl:basis-1/6
    ">
    <Popover
      v-model:open="open">
      <CarouselItem
        class="group/all relative h-30 overflow-hidden p-1.5">
        <PopoverTrigger
          class="
          ...
          <div
            :class="cn(`
              group embla__slide pointer-events-none relative z-0 grid size-full
              shrink-0 place-items-center overflow-hidden rounded-lg border-0
              p-0 shadow-sm shadow-black/15 drop-shadow-sm
            `,
                       `
                         after:pointer-events-none after:absolute after:inset-0
                         after:z-2 after:bg-radial-[at_75%_25%]
                         after:from-transparent after:from-45% after:to-black/70
                       `,
            )">
            <AspectRatio
              :ratio="16 / 9"
        ...
        <button
          ...
          class="
            ...
            duration-300
            **:text-white
            group-has-open/all:pointer-events-auto
          ...
          <icon
            ...
            class="
              mb-2 rotate-180 opacity-0
              group-open/wrap:opacity-70
            " />
        </button>
      </CarouselItem>
      <!--       <PocketChampionMenu
