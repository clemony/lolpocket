...
<template>
  <Sheet
    ...
    <button
      ref="trigger"
      :class="cn(' opacity-0 hover:opacity-0 fixed group/trigger hover:border-l-3 hover:border-l-neutral transition-all duration-200 h-[calc(100vh-45px)] z-30 w-10 top-15 left-0', { 'pointer-events-none hidden': ui().sidebarOpen })">
    </button>
    ...
    <SheetPortal>
      ...
      <SheetContent
        ...
        <div
          ref="layout"
          class="absolute h-screen inset-0 px-3   scrollbar-hidden  scrollbar-none  pt-3 flex flex-col ">
          ...
          <!-- summoner linkies -->
          <div class="space-y-1 mb-4.5 mt-7">
            <SidebarBtnLink
              item="nexus"
          ...
          <DropdownMenuSeparator class="-mx-3 mb-5" />
          <PocketPanel />
          <NavPanel />
          <!-- summoner menu -->
