    ...
    <Card class='relative'>
        ...
        <CardHeader class='flex flex-row gap-8 items-center '>
            ...
            <div class='relative w-fit'>
                ...
                <img class=" size-[75px] scale-[108%] mr-1 mask mask-heart  aspect-square object-center shrink-0 !rounded-none "
                    :src="`/img/champions/${clean(champion.name)}.webp`" v-cosha />
                <!--  </div> -->
