...
const icon = computed(() => {
    const i = location[0] ? 'mynaui:circle' : 1
    return i
})

const minimizeIcon = computed(() => {
    const i = icon && location[1] ? 'mynaui:x-circle-solid' : 'mynaui:x-circle'
    return i
})

const maximizeIcon = computed(() => {
    const i = icon && location[2] ? 'mynaui:x-circle' : 'mynaui:x-circle-solid'
    return i
})

const closeIcon = computed(() => {
    const i = icon && location[3] ? 'mynaui:x-circle' : 'mynaui:x-circle-solid'
    return i
})
</script>
<template>
