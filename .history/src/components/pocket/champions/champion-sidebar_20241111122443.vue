                ...
                <div class='join join-vertical'>
                    ...
                    <div class='join-item join join-horizontal'>
                        ...
                        <VTooltip theme="tt" placement="bottom"
                            class=" grid size-7 items-center justify-center join-item  transition-all duration-500 before: hover:rotate-180"
                            alt="view on Wiki">

                            <a :href="champion.wiki" target="_blank"
                                class=" z-10  flex aspect-square size-7 p-1.5 cursor-alias overflow-hidden  border-none bg-neutral ring-[3px] ring-neutral-content  text-neutral-content">
