        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        v-if="set"
                        class="col-start-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-center justify-items-center gap-x-2 gap-y-2 rounded-box border border-base-200/80 bg-base-200/50 p-1.5 shadow-sm">
                        ...
                        <template v-for="rune in runes">
                            <div class="rounded-full">
                                <LoadImg
                                    v-if="rune.name != 'none'"
                                    :url="rune.img"
                                    class="col-start-1 size-[43px] overflow-auto rounded-full shadow-warm ring-1 ring-base-300" />
                                <PlCircle
                                    v-else
                                    :size="43"
                                    class="border-base-300 bg-base-300/40 shadow-inset-sm" />
                            </div>
                        </template>
                    </div>
                </div>
