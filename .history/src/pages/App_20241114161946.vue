...
<template>
    ...
    <SidebarProvider>
        <Sidebar collapsible="icon" class="justify-center">
            ...
            <SidebarRail
                class="!bottom-0 h-[calc(100%-50px)] rotate-180 items-end justify-end self-end justify-self-end before:block before:size-[50px] before:bg-red-700 after:bottom-0" />
        </Sidebar>
