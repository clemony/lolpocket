...
<template>
  <Button
    ...
    :hover
    :class="
      cn('cursor-text gap-2! overflow-hidden bg-b1/60 pr-2 ring-b1 transition-all duration-300 hover:ring',
         className,
      )
    "
    ...
    <Kbd
      v-once
      class="
        inline-flex w-min! items-center justify-center gap-0.5! text-sm!
        text-bc/60
      ">
      <icon
        :name="getMetaIcon()"
