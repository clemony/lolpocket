...
<template>
  <Popover
    ...
    <LazyPopoverContent
      ...
      align="start"
      :side-offset="4">
      <div class="bg-b2/30 grid h-16  w-full shrink-0 grid-cols-4 gap-1.5 px-2.5 pt-2.5 pb-3 bg-blend-screen">
        <Button
      ...
      <article class="size-full overflow-y-auto">
        <section class="z-auto">
          <div class="bg-b1/30 sticky top-0 z-1 w-full bg-blend-darken backdrop-blur ">
