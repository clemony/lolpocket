...
<template>
<SidebarProvider>
    <Sidebar collapsible="icon" side="right" variant="floating" class='max-h-[calc(100%-200px)] mt-40 right-8 '>
        <SidebarHeader>
            <SidebarMenu>
                <SidebarMenuItem>
                </SidebarMenuItem>
        ...
        <SidebarContent class='bg-base-100/80 backdrop-blur-md border-bg-base-200'>
            <SidebarGroup>
