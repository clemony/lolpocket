        ...
        <div :style="containerStyle">
            <div
                ...
                <label
                    ...
                    <Card
                        class="swap-off relative grid h-[280px] w-[230px] justify-center overflow-hidden rounded-xl border border-neutral/20 !bg-transparent bg-right-bottom px-2 before:absolute"
                        :style="{
