...
const sv = {
  lg: ' h-12 grid aspect-square place-items-center ',
  md: ' size-10 grid aspect-square place-items-center ',
  sm: 'size-9 text-2  grid aspect-square place-items-center ',
  xl: ' size-14 grid aspect-square place-items-center ',
  xs: 'size-8 text-2  grid aspect-square place-items-center ',
  xxs: 'size-6 text-2  grid aspect-square place-items-center ',
}
...
export const variantVariants = {
  ...
  btn: 'px-3  bg-tint-b2/60 border-b3/60 font-medium',
  ...
  none: 'bg-transparent border-0 shadow-none inset-shadow-none drop-shadow-none',
  outline: ' btn-outline px-3 !bg-transparent shadow-xs font-medium border-b3',
...
export const tabListVariants = tv({
  base: 'inline-flex items-center justify-center rounded-lg bg-b2 p-1 text-bc',
  extend: baseVariants,
  variants: {
    orientation: {
      vertical: '!size-full',
