...
<template>
    <label class="swap swap-flip relative h-[320px] w-[240px] backdrop-blur-md">
        <input type="checkbox" />

        <Card
            class="swap-off relative h-[320px] w-[240px] max-w-[240px] overflow-hidden rounded-box bg-transparent">
            <div
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="col-start-1 row-span-2 grid">
                            <Keystone :pocket="pocket" />
                        </div>
                        <div class="flex gap-2.5">
                            <RuneSet1 :pocket="pocket" />
                        </div>
                        <div class="col-start-2 flex gap-2.5">
