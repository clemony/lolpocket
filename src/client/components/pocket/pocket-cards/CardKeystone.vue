...
import { runeColors } from '@/client/utils/GetColor'
...
<template>
    <div
        class="bg-neutral shadow-warm ring-neutral/20 absolute top-3 left-3 z-20 flex size-16 items-center justify-center rounded-full ring-1 backdrop-blur-xs"
        :style="{
