        ...
        <template #header>
            ...
            <div class='w-fit'>
                <InputEditable v-model:modelValue="set.name" :defaultValue="set.name" @click.stop
                    class='!text-base font-medium text-start items-center align-baseline capitalize  border-transparent focus:border-base-200 hover:border-base-200 transition-all duration-300'>
