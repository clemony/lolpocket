...
<template>
    <Button
        ...
        <div
            ...
            class="! pointer-events-none absolute right-1 top-[1px] grid aspect-square !h-10 !w-14 place-content-center place-items-center rounded-full bg-neutral text-neutral-content">
            {{ selectedCount }}
        </div>
    </Button>
</template>
