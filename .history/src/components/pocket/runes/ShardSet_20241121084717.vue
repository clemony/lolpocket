...
<template>
    <div
        ...
        class="absolute grid size-9 shrink-0 place-items-center rounded-full border border-base-200 bg-base-100/70 p-1.5 shadow-[0_3px_10px_rgb(0,0,0,0.2),inset_-1px_-1px_0px_1px_#00000008] backdrop-blur-sm"
        :class="
            cn(
                getShardClass(shard)
                    .toString()
