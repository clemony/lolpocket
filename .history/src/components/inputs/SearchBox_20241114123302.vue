...
<template>
    <div
        class="group/search peer relative flex items-center gap-2 self-center rounded-md border border-base-200 focus-within:outline-none focus-within:ring-1 focus-within:ring-neutral/40 hover:ring-1 hover:ring-neutral/5">
        <Icon
