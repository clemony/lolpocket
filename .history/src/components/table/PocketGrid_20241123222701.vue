...
<template>
    <Collapsible v-model:open="pinIsOpen" class="mt-96 w-full">
        ...
        <CollapsibleContent>
            <ag-grid-vue
                :theme="pocketTheme"
                class="top-grid l items-center !rounded-none !bg-transparent"
                ref="pinnedGrid"
    ...
    <Collapsible v-model:open="genIsOpen" class="w-full">
        ...
        <CollapsibleContent>
            <ag-grid-vue
                :theme="pocketTheme"
                class="bottom-grid items-center !rounded-none !bg-transparent"
                ref="pocketGrid"
