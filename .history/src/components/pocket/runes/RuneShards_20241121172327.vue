            ...
            <Tooltip
                ...
                <label
                    ...
                    <div
                        ...
                        :style="{
                            backgroundImage:
                                'url(/img/ui/concrete-wall.png),linear-gradient(135deg,oklch(var(--b1) / 0.4) 50%, oklch(var(--b2)) 100%)',
                        }">
                        <icon
                            :icon="getShardIcon(shard)"
                            class="size-full rounded-full opacity-90 brightness-95 drop-shadow-md"
                            :class="
