    ...
    <ListboxContent as-child>
      <TransitionSlideLeft
        ...
        :class="
          cn(
            `
          relative z-1 flex max-h-64 w-9/10 w-full flex-col flex-wrap
          items-center items-start gap-2 gap-y-3 py-0
        `,
            className,
          )
        "
      >
        ...
        <BaseListboxItem
          ...
          as-child
        >
          <RoleBadge as="label" :variant :size="size[1]" :role> </RoleBadge>
        </BaseListboxItem>
      </TransitionSlideLeft>
    </ListboxContent>
  </Listbox>
