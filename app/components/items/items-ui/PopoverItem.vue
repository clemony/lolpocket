...
<template>
  <Popover v-model:open="isOpen">
    ...
    <LazyCustomPopoverContent :side-offset="8" class="!w-110 @container/item-data max-h-160">
      <CustomPopoverArrow />
