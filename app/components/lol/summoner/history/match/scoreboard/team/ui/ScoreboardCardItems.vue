...
<template>
  <!-- items -->
  <div :class="cn('@min-700:gap-4 @min-700:px-4 flex w-fit gap-1 px-2', className)">
    <div
    ...
    <div class="flex w-full max-w-16 items-center -space-x-2">
      <div class="bg-b1 z-0 grid size-9.5 shrink-0 place-items-center rounded-full">
        <Item
      ...
      <div class="bg-b1 relative z-1 grid size-9.5 shrink-0 place-items-center rounded-full">
        <Item
