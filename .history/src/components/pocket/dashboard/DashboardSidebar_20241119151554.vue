...
<template>
    <div v-if="pocket" :key="pocket.key" class="flex flex-col">
        ...
        <Tabs default-value="spells" class="w-full">
            ...
            <ul
                class="flex h-9 items-center before:absolute before:h-9 before:w-[65px] before:rounded-md before:border before:border-base-300 before:bg-base-100 [&_li]:w-20">
                <li>
                    <label>Spells</label>
                </li>
                <li>
