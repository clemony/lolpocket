...
import AccountSettings from '@/components/settings/GeneralSettings.vue'
import HotkeySettings from '@/components/settings/AccountSettings.vue'
import AppearanceSettings from '@/components/settings/HotkeySettings.vue'
...
const generalRef = useTemplateRef<HTMLDivElement>('GeneralSettings')

const appearanceRef = useTemplateRef('AppearanceSettings')

const accountRef = useTemplateRef('AccountSettings')

const hotkeyRef = useTemplateRef('HotkeySettings')

const storageRef = useTemplateRef('StorageSettings')
