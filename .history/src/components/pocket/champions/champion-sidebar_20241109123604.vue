...
<div v-if="champion" class="">
    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-6'>
            ...
            <div class="flex flex-col">
                ...
                <p
                    class="mt-0 flex place-items-center text-pretty pb-1 pl-[10px] pr-3 pt-0 -indent-[11px] text-sm font-medium uppercase tracking-wide ">
                    @{{ champion.title }}
                </p>
                ...
                <div
                    class="justify-content-end relative right-3 col-start-2 flex gap-2 justify-self-end pb-1 text-center ">
