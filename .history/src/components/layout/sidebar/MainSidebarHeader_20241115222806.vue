...
<template>
    <SidebarHeader>
        <SidebarMenu
            ...
            <SidebarMenuItem class="mx-2.5 mt-1 py-2">
                <SidebarMenuButton
                    class="hover-ring-neutral/60 relative w-full items-center justify-start border border-base-300/80 bg-base-100/50 px-2 hover:border-base-300 hover:bg-base-100/60 hover:ring-1"
                    :class="{
