                        ...
                        <CardContent
                            ...
                            <div
                                ...
                                <div
                                    :class="
                                        cn(
                                            'z-10 h-36 w-[90%] overflow-hidden rounded-md after:absolute after:left-2 after:top-3 after:z-0 after:size-18 after:rounded-full after:border after:border-neutral after:bg-base-100 after:shadow-warm',
                                            {
