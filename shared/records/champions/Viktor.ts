// Updated Patch 15.23.1 - 11/30/2025 12:24:10 PM CST
...
const champion: Champion = {
  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Active:</span> Viktor throws a draining device at the target enemy that deals magic damage. He also grants himself a shield for 40 - 115 (based on level) (+ 18% AP) for 2.5 seconds and gains Discharge for 4 seconds.</p>",
          "leveling": [
            {
