...
<template>
  ...
  >
    ...
    <div
      ...
      class="slide-in-from-right animate-in text-bc/50 absolute right-0 z-0 inline pr-1.5 text-sm!"
    >
      {{ items[0].text }}
    </div>
