...
<template>
    <Splitpanes
        ...
        <Pane max-size="100" size="73" min-size="73">
            <div v-if="selected" class="flex justify-end gap-10 px-10">
                ...
                <div
                    ...
                    :class="primary">
                    <div
                        class="bg-gradient-to-b from-base-100/10 via-base-100/90 via-25% to-base-100 h-full">
                ...
                <div>
                    <div
                        ...
                        <div
                            class="bg-gradient-to-b from-base-100/10 via-base-100/90 via-35% to-base-100 h-full px-2">
                    ...
                    <div
                        class="relative mt-6 border shadow-warm rounded-box border-base-300 h-fit max-h-fit">
        ...
        <Pane size="27" max-size="27" min-size="27" class="relative max-h-full">
            <div
                class="rounded-box !bg-base-100/90 border border-base-300 shadow-warm relative overflow-hidden">
