    ...
    <div
        ...
        <div
            ...
            <label
                ...
                <SidebarProvider
                    class="page relative size-full overflow-hidden rounded-2xl bg-base-100/95 transition-all duration-500 animate-in zoom-out-100 slide-in-from-top-0 [animation-fill-mode:forwards]"
                    :class="
                        cn({
                            /*base */
