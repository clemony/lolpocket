...
<template>
  <LazyIconPopover
    ...
    <PopoverAnchor class="z-2">
      <icon
        name="images"
        :class="cn('text-nc size-7 opacity-60 transition-opacity duration-500  group-hover/pop:opacity-100', { 'opacity-100': isOpen })" />
    </PopoverAnchor>
  </LazyIconPopover>
</template>