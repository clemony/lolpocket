  ...
  abilities: [
    {
      ...
      blurb:
        'Innate:  Azir periodically can summon the Disc of the Sun from the ruins of allied or enemy  turrets.',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever a turret outside the enemy team\'s base is destroyed, a marker is placed above its ruins which can be targeted by Azir.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Disc of the Sun:</span> Azir can select a marker to construct the Sun Disc above the ruins after a 0.5-second cast time. The Sun Disc will activate after being assembled over 5 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Azir orders all Sand Soldiers to dash toward the target location, dealing magic damage to all enemies they pass through as well as those in front of them upon arrival, and slowing them by 25% for 1 second.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Azir summons a Sand Soldier to attack nearby targets for him, replacing his  basic attacks against enemies within their range. Their attacks deal magic damage to enemies in a line.',
      castTime: '0.25',
      cooldown: '1.5',
      cost: '40 / 35 / 30 / 25 / 20',
      damageType: 'Magic damage',
    ...
    },
    {
      ...
      blurb:
        'Active:  Azir  shields himself and  dashes to the target Sand Soldier, dealing magic damage to enemies he passes through.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Azir grants himself a shield for 1.5 seconds and dashes to the Sand Soldier closest to the cursor, dealing magic damage to enemies within his path.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Azir summons a wall of soldiers that charges forward, dealing magic damage and  knocking back enemies hit.',
      castTime: '0.5',
      cooldown: '120 / 105 / 90',
      cost: '100',
      damageType: 'Magic damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Azir calls forth a phalanx of soldiers from 175 units behind him, catching enemies from up to 325 units behind him and charging forward 575 units in the target direction.</p>',
          leveling: [
            {
              attribute: 'Width',
              modifiers: [
