    ...
    <template #panel2>
        ...
        <Card :open="false" class='h-[calc(100%-115px)] max-h-[calc(100%-115px)] overflow-hidden pt-4'>
            ...
            <CardHeader>
                ...
                <div class="join">
                    <Button :variant="is.sortAZ ? 'neutral' : 'outline'" size="icon"
                        class='join-item [&_input]:hidden relative'
                        @click="is.sortAZ++; is.sortAZ == 3 ? is.sortAZ = 0 : ''" :class="{ '': is.sortAZ }">

                        <icon v-if="is.sortAZ == 2" icon="qlementine-icons:sort-alpha-desc-16"
                            class='size-6 absolute' />
                        <icon v-else icon="qlementine-icons:sort-alpha-asc-16" class='size-6 absolute'
                            :class="{ 'opacity-60': !is.sortAZ }" />

                        <input type="radio" v-model="is.sortAZ" value="0" state="off" />
                        <input type="radio" v-model="is.sortAZ" value="1" state="AZ" />
                        <input type="radio" v-model="is.sortAZ" value="2" state="ZA" />
                    </Button>

                    <icon icon="hugeicons:sorting-19" class='size-6' />
