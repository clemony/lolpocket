...
<template>
  <div
    class="relative grid w-full items-center overflow-hidden bg-b1 px-30 pt-40 pb-40"
  >
    <Carousel
      :opts="{
        loop: true,
    ...
    >
      <CarouselContent class="size-full">
        ...
        >
          ...
          >
            <h1 class="font-serif leading-9 font-black dst">“{{ r.title }}”</h1>
    ...
    <div class="flex w-full items-center justify-center gap-1 pt-10">
      ...
      >
        ...
        <div
          class="tldr-20 btn pointer-events-none btn-circle size-2 bg-b3 ring-neutral ring-offset-2 group-hover:bg-b4 group-hover:ring-1"
