  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description: 'Talon\'s next basic attack against an enemy with 3 Wound stacks is empowered to consume them all to cause the target to bleed, dealing[ 80 - 280 (based on level) (+ 210% bonus AD) total physical damage over 2 seconds ][ 5 - 17.5 (based on level) (+ 13.125% bonus AD) physical damage every 0.125 seconds over 2 seconds ]. The target cannot gain Wound stacks during this time.'
        }
      ]
    },
    {
