  ...
  active: [
    {
      ...
      unique: true,
      effects:
        'Summon a black hole at the target location after a 0.5-second delay that lasts for 2 (+0.1 per 100 <b>bonus</b> health) seconds. Enemies within are dealt 30 – 100 (based on level) magic damage (+6.5% of user\'s <b>maximum</b> health) magic damage every second, <img src="/img/icons/slow.webp" class="tip-icon" />slowed by 35%, and <img src="/img/icons/kinematics.webp" class="tip-icon" />dragged inward until they reach the horizon at the center. Additionally, for each enemy champion inside the black hole, generate 1 stack of <i>Accretion</i> per second.',
    },
  ],
  stats: {
    health: 900,
