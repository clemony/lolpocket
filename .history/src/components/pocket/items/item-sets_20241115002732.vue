                ...
                <template #header>
                    ...
                    <label
                        ...
                        <img
                            ...
                            class="absolute top-1/2 size-5.5 shrink-0 group-hover:opacity-0" />

                        <img
                            src="/img/ui/caret.gif"
                            class="absolute top-1/2 size-7 shrink-0 opacity-0 transition-all duration-500 group-hover:opacity-40" />
                    </label>
                </template>
