            ...
            <div class='relative w-fit'>
                <div class='join join-vertical w-[65px] overflow-hidden'>
                    ...
                    <div class='join-item join join-horizontal w-full'>
                        ...
                        <VTooltip theme="tt" placement="bottom" class="" alt="view on Wiki">

                            <a :href="champion.wiki" target="_blank">
                                <Button variant="neutral"
                                    class=" grid  w-1/2 items-center justify-center join-item  transition-all duration-500 before: hover:rotate-180 overflow-hidden ">
