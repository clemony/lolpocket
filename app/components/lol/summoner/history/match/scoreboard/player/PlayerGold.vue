    ...
    <template #content>
      <ul>
        <li>
          <Icon
            name="lol:gold"
            class="mr-1 inline size-3.5 text-nc" /> {{ player.stats.goldEarned.toLocaleString() }} g
        </li>
        <li>
          <Icon
            name="clock"
            class="mr-1 inline size-3.5 -translate-y-px text-nc **:stroke-[3.2]" /> {{ player.stats.goldPerMin }} / min
        </li>
      </ul>
    </template>
  </Tooltip>
