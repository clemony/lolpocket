...
<template>
    <ScrollArea
        ...
        <label
            ...
            class="btn btn-ghost btn-sm has-checked:bg-b2/60 has-checked:shadow-standard m-1 aspect-square size-12 self-center border-transparent p-3">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
            ...
            <icon :icon="icon" class="text-base-content size-full shrink-0" />
        </label>
        <label
            v-for="champion in ds.champions"
            class="btn btn-ghost btn-sm has-checked:bg-b2/60 has-checked:shadow-standard m-1 aspect-square size-9 self-center border-1 border-transparent">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
