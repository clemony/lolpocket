            ...
            <div
                ...
                <InfoCard
                    ...
                    <template #header>
                        <h2
                            v-if="!flip"
                            class="mt-6 duration-500 animate-in animate-out fade-in-0 fade-out-0">
                            {{ pocket.name }}
                        </h2>
                    </template>
                    <template #description>
                        <p
                            ...
                            class="text-base font-medium duration-500 animate-in animate-out fade-in-0 fade-out-0">
                            {{ tag }}
                        </p>
                    </template>
