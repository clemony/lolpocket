...
<template>
    <ScrollArea class="flex h-full max-h-64 flex-wrap overflow-y-scroll">
        <label
            ...
            class="border-1 btn btn-ghost btn-sm m-1 aspect-square size-10 self-center border-transparent p-2 has-[:checked]:bg-base-200/60 has-[:checked]:shadow-standard">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
