...
<template>
    ...
    <SidebarProvider>
        <Sidebar
            collapsible="icon"
            class="from-[29px]to-base-100/80 from-tra<!-- -->nsparent justify-center bg-gradient-to-b to-[30px] backdrop-brightness-105">
            <!--  <MainSidebarHeader /> -->
        ...
        <SidebarInset class="relative">
            <div
                ...
                class="absolute inset-0 left-0 top-0 m-0 h-full w-full overflow-y-clip border border-y-base-300 border-l-transparent border-r-base-300 !p-0 !shadow-[inset_-12px_-8px_40px_#00000020]">
