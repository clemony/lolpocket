        ...
        <div class="relative max-w-[470px] border-0 outline-0 ring-0">
            <div class=" w-full h-[28px] shadow-inner shadow-base-content/15 bg-base-200/50 border border-base-content/10 
                ...
                <Input tabindex="0" role="" v-model="query" placeholder=""
                    class="italic h-full w-full text-xs !outline-0 !outline-transparent !outline-none rounded-[10px] ring-0 focus:outline-0 focus:ring-1 border-0 focus:border-0 focus:not-italic focus:ring-base-content/10 focus:text-base-content pt-[6px] "
