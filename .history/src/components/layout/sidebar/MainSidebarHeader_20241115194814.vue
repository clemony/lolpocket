    ...
    <SidebarHeader>
        <SidebarMenu
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            variant="ghost"
                            size="lg"
                            class="flex size-full shrink-0 flex-nowrap items-center gap-3 !border-0 pb-1 pt-3 ring-0 focus:!border-0 focus:!outline-0"
                            :class="{ 'px-3': !collapsed }">
                            <div
                                class="flex aspect-square w-[20px] shrink-0 items-center justify-center rounded-none bg-neutral text-neutral-content/90 shadow-sm">
                                <span class="mt-1px !text-xs font-bold">
                                    LP
                                </span>
                            </div>
                            <span
                                class="mt-px text-lg font-semibold opacity-80">
                                lolpockets
                            </span>
                            <icon
            ...
            <SidebarMenuItem class="mx-2">
                <SidebarMenuButton
                    class="relative h-8 w-full items-center justify-start border border-base-300/80 bg-base-100/60 px-2 hover:cursor-text"
                    :class="{
