...
<ResizablePanelGroup direction="horizontal" class=" h-[calc(100%-425px)] max-h-[calc(100%-30px)] w-full px-4  ">
    ...
    <ResizablePanel class=" max-h-inherit h-full" id="itemGrid">
        ...
        <InfoCard :open="false" class='h-[calc(100%-115px)] max-h-[calc(100%-115px)] overflow-hidden'>
            <CardHeader>
                <template #header>
                    ...
                    <div class=" flex h-6 w-full content-center justify-end gap-1.5 px-2">
                        <label alt="Filter Likes" :title="likeText"
                            ...
                            <icon v-else icon="fluent:heart-off-20-regular"
                                class="mb-[4px] size-5 text-base-content/30" />
                        </label>
                    </div>
            ...
            <CardContent class='h-full max-h-full'>


                <ScrollArea class="overflow-auto h-full max-h-full">
