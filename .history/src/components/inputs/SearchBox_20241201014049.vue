...
<template>
    <div :class="cn('relative m-0 p-0', props.class)">
        ...
        <input
            ...
            :class="
                cn(
                    'inset-0 mx-0 flex h-full w-full gap-2 self-center overflow-hidden border border-base-300 bg-transparent px-0 pb-0 pt-2px text-base shadow-inner transition-opacity duration-300 placeholder:text-base hover:ring-0 focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50',
                    props.inputClass
                )
            " />
