...
<template>
    <label class="swap swap-flip relative h-96 w-96 backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                class="relative grid h-inherit w-inherit items-center bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30%">
                ...
                <div
                    class="absolute top-24 flex size-fit items-center justify-center rounded-full">
                    <div
                        class="absolute size-full [&_:first-child]:-left-[0.7rem] [&_:first-child]:-top-[3.6rem] [&_:last-child]:-right-[2.4rem] [&_:last-child]:-top-[2.7rem] [&_:nth-child(2)]:-top-[4rem] [&_:nth-child(2)]:left-[2rem]">
                        <ShardSet :pocket="pocket" />
                    </div>
                    <Keystone :pocket="pocket" />
                    <div
                        class="size-full [&_:first-child]:-left-14 [&_:first-child]:-top-[2rem] [&_:last-child]:-bottom-[3.7rem] [&_:last-child]:-left-[1rem] [&_:nth-child(2)]:-bottom-[1rem] [&_:nth-child(2)]:-left-[4rem]">
                        <RuneSet :pocket="pocket" type="runes1" />
                    </div>
                    <div
                        class="z-0 size-full [&_:first-child]:-right-[4.3rem] [&_:first-child]:-top-[0rem] [&_:last-child]:-bottom-[3rem] [&_:last-child]:-right-[3.3rem]">
