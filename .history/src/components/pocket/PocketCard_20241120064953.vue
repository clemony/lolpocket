...
<template>
    <label
        ...
        <Card
            class="mask swap-off h-[320px] w-[250px] max-w-[250px] overflow-hidden rounded-box bg-base-100/95 mask-b-24">
            <div
                class="mask absolute size-full bg-[20%_-125%] bg-no-repeat mask-b-24 [background-size:200%]"
                :style="{
