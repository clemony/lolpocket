...
<div class="flex justify-center">
    <div class="grid max-w-64 grid-cols-3 place-items-center gap-x-12 gap-y-7">
        <label v-for="shard in ds.shards" :class="shard.name" v-tooltip="{
            ...
            <div
                class="shard-color shadow-standard flex size-12 items-center justify-center rounded-full border border-base-300 bg-gradient-to-br from-base-200/20 to-base-200/30 bg-clip-padding p-2.5 ring-1 ring-transparent ring-offset-2 ring-offset-transparent transition-all duration-300">
                <Icon :icon="shard.img" class="transition-all duration-300 size-7" />
            </div>
        </label>
    </div>
</div>
