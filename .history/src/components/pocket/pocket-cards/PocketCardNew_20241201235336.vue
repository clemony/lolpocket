        ...
        <div :style="containerStyle">
            <div
                ...
                <label
                    ...
                    <Card
                        class="swap-off relative grid h-[280px] w-[230px] justify-center rounded-xl border border-neutral/20 !bg-transparent bg-right-bottom px-2 before:absolute"
                        :style="{
                            backgroundImage: champImage,
                        }">
                        <CardContent
                            class="relative size-full w-inherit items-center rounded-xl bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30%">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    :class="
                                        cn(
                                            'z-0 h-44 w-[90%] !overflow-hidden rounded-md',
                                            {
                                    ...
                                    ">
                                    <div
                                        class="absolute -left-0 -top-7 isolate size-16 overflow-hidden rounded-full shadow-[2px_2px_0px_0px_#00000024]" />
                                    <div
                    ...
                    <div
                        ...
                        class="swap-on flex h-[280px] w-[230px] items-center justify-center !bg-transparent bg-center [background-size:230px_280px]">
                        <div
