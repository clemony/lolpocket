                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="flex aspect-square size-9 items-center justify-center rounded-md bg-base-200 text-base-content">
                                    Bb
                                </div>
                                <div
                                    class="flex aspect-square size-9 items-center justify-center rounded-md bg-base-300 text-base-content">
                                    Cc
                                </div>
                                <div
                                    class="flex aspect-square size-9 items-center justify-center rounded-md bg-neutral text-neutral-content">
                                    Dd
                                </div>
                            </div>
                        </div>
