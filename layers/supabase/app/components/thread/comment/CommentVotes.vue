...
<template>
  <ToggleGroup
    ...
    <label
      ...
      <ToggleGroupItem
        ...
        <icon
          ...
          class="
            group-on/toggle:opacity-100 group-on/toggle:group-not-disabled/toggle:stroke-[4] absolute size-3.5 -scale-y-100
            opacity-40 **:stroke-2
    ...
    <Element
      ...
      size="6"
      :class="
        cn('text-xxs relative grid place-items-center px-2 leading-3 lining-nums tabular-nums opacity-50 select-none',
    ...
    <label
      ...
      <ToggleGroupItem
        ...
        <icon
          name="mynaui:arrow-up"
          class="
            group-disabled-not-on/toggle:opacity-20 group-on/toggle:opacity-100 group-on/toggle:group-not-disabled/toggle:**:stroke-[4] absolute
            size-3.5 opacity-40
            **:stroke-2
          " />
      </ToggleGroupItem>
