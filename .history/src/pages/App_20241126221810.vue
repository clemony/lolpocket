...
<template>
    ...
    <main
        ...
        <div
            v-if="state == 'open'"
            class="command z-[1000] h-1/3 animate-in fade-in-0 slide-in-from-bottom-8 before:absolute before:left-0 before:top-0 before:h-screen before:w-screen before:bg-red-700">
            <Command />
        </div>
        <label>
            <input
