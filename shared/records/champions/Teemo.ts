...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Teemo shoots a dart at the target enemy that deals magic damage and  blinds them for a short time.',
      castTime: '0.25',
      cooldown: '7',
      cost: '70 / 75 / 80 / 85 / 90',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Teemo shoots a dart at the target enemy that deals magic damage and blinds them for a duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Passive:  Teemo gains  bonus movement speed after a few seconds without taking damage from enemy  champions or  turrets.',
      castTime: 'none',
      cooldown: '14',
      cost: '40',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Teemo gains bonus movement speed after 5 seconds without taking damage from enemy champions or turrets.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Teemo doubles the bonus movement speed for 3 seconds, preventing it from being removed for the duration.</p>',
          leveling: [
            {
      ...
      maxCharges: -1,
      notes:
        'When Move Quick\'s active bonus movement speed ends Teemo will not regain the passive one if he was damaged during the active\'s duration.\nMove Quick\'s passive will be disabled even if the damage is blocked with a  spell shield.',
      resource: 'Mana',
      targeting: 'Auto',
    },
    {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Teemo tosses a poisonous mushroom to the target location that becomes  stealthed and lasts for a while. It will bounce forward upon landing on another mushroom.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Teemo tosses a poisonous mushroom to the target location that becomes stealthed after arming over 1 second, lasting for up to 5 minutes and granting sight of its surroundings. If the mushroom lands on an already-placed one, it will bounce forward again for its cast distance, up to a cap, which can happen repeatedly.</p>',
          leveling: [
            {
        ...
        {
          description:
            'A mushroom has 6 maximum health and can only be damaged by champion basic attacks (2 damage from ranged and 3 from melee).',
        },
        {
