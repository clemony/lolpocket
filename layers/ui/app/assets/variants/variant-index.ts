...
export function createVariants() {
  const vv = {
    ...
    p2:
      'bg-tint-p3/40 fx-1 text-pc !border-p3  font-medium shadow-xs shadow-black/7 hover:inset-shadow-xs',
  }
  return vv
}
  ...
  return tv({
    variants: {
      ...
      hover: {
        ...
        p2:
          'px-3 hover:border-p3! hover:bg-tint-p3/45! hover:shadow-xs hover:inset-shadow-xs hover:shadow-black/5 hover:inset-shadow-black/2',
      },
      // active
      on: {
