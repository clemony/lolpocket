...
<template>
    ...
    <div
        ...
        <div
            ...
            <div
                data-sidebar="sidebar"
                class="flex h-full w-full flex-col bg-base-100/70 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-base-200 group-data-[variant=floating]:shadow">
