...
<template>
    <div
        ...
        <div
            ...
            class="inset-0 m-0 flex size-full flex-row-reverse items-end justify-center justify-items-center [&_nth-child(2)]:top-10">
            <template v-for="page in gs.routeHistory">
                <div
                    v-if=""
                    ref="page"
                    :style="pageStyle"
