  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Hold:</span> Warwick performs the bite, and then begins to charge for 0.5 seconds, extended if the target is under effects of a dash or displacement. During the charge, he leaps behind the target.</p>',
        },
      ],
    ...
    },
    {
      ...
      blurb:
        "Passive:  Warwick gains  attack speed against targets below 50% of their maximum health. Against champions, he also gains out of combat  movement speed. These bonuses are massively increased if the target is below 20% of their maximum health.",
      castTime: "0.5",
      ...
      effects: [
        ...
        {
          description:
            "The attack speed and movement speed bonuses granted by both passives are doubled against enemies who are below 25% of their maximum health.",
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Warwick senses the nearest enemy champion in the area at the start of the cast time, marking them with Blood Hunt for 8 seconds, gaining both passive bonuses against them regardless of their current health.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Warwick gains damage reduction for up to 2.5 seconds. Primal Howl can be recast after 1 second, and does so automatically after the duration.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Warwick howls, ending Primal Howl\'s effects and fearing nearby enemies for 1 second, slowing them by 90%.</p>',
        },
        {
          description:
