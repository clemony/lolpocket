  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Periodically, Illaoi spawns a Tentacle on the nearest terrain perpendicular to her location, if no other Tentacles are already nearby it. Tentacles fully spawn after a 2 second delay and are untargetable in the meantime.</p>',
        },
        {
          description:
            "Tentacles are commanded to attack by Illaoi's abilities, dealing 9 - 162 (based on level) (+ 105% AD) (+ 40% AP) physical damage to all enemies struck, increased by 0% - 30% (based on Tentacle Smash's rank).Enemies struck by multiple slams within 0.5 seconds of another, take 50% damage for the second and 25% damage for all other additional slams.",
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Tentacle damage is increased.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Illaoi slams down a Tentacle in the target direction.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Illaoi's next basic attack gains  bonus attack range and causes her to  leap to her target, dealing bonus physical damage and commanding nearby Tentacles to attack the target.",
      castTime: "none",
      cooldown: "4",
      cost: "30",
      damageType: "Physical damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Illaoi\'s next basic attack within 6 seconds gains 225 bonus range and causes her to leap to the target\'s location if they\'re beyond her normal basic attack range.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Illaoi reaches with a tendril in the target direction that stops upon the first enemy hit. If the target is a  champion, she rips their Spirit out from them to stand before her.",
      castTime: "0.25",
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Illaoi becomes  unstoppable before dealing physical damage to nearby enemies. For each enemy  champion hit, a Tentacle is summoned around her for a period.",
      castTime: "0.5",
      cooldown: "120 / 95 / 70",
      cost: "100",
      damageType: "Physical damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Illaoi gains displacement immunity and leaps into the air for the cast time. She then slams her idol into the ground, dealing physical damage to nearby enemies. For each enemy champion hit, a Tentacle is summoned for 8 seconds (up to a maximum of 6 summons).</p>',
          leveling: [
            {
