...
<template>
  <button
    :class="cn('rounded-lg-2  gap-2 ml-2   w-32  border-b4/80  hover:ring-neutral/50 flex h-9 !bg-b1 flex-nowrap text-nowrap cursor-text items-center  px-3 !py-0  hover:!bg-b1  hover:ring-1 group inset-shadow-xs group  border', props.class)"
