...
<template>
    ...
    <SidebarProvider>
        <Sidebar collapsible="icon" class="justify-center">
            ...
            <SidebarRail
                class="!bottom-0 order-1 h-[calc(100%-50px)] items-end justify-end self-end justify-self-end before:order-2 before:size-[50px] before:bg-red-700 after:bottom-0" />
        </Sidebar>
