...
<template>
  ...
  >
    <TabsList
      base="indicator"
      class="h-10 w-full grid-cols-[1fr_1fr_1.2fr_1fr_1fr_1.2fr] gap-1 bg-transparent"
    >
      ...
      <TabsTrigger
        ...
        :key="role.name"
        :value="role.role"
        class="z-1 place-items-center rounded-field not-disabled:opacity-100! hover:bg-b3/40 hover:inset-shadow-sm"
        :disabled="!role.games"
      >
        <component
