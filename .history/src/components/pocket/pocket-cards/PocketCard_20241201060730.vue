    ...
    <CardContent
        ...
        <CardHeader class="relative flex px-3 pb-4">
            ...
            <CardDescription class="h-7 pb-2">
                <h5 class="z-10 pt-0 !text-base font-semibold !not-italic">
        ...
        <div class="grid w-full px-3">
            <div class="flex h-fit justify-center gap-1 pb-3">
            ...
            <div class="relative flex pb-3">
                ...
                <div class="-ml-5 h-fit flex-col items-center justify-start">
                    <div
                        :class="
                            cn(
                    ...
                    <div :class="cn('z-0 ml-14 mt-2 flex gap-2')">
