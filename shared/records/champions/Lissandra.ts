  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lissandra launches a shard of ice in the target direction that deals magic damage and slows enemies hit for 1.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Lissandra freezes nearby enemies, dealing magic damage and briefly  rooting them.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lissandra freezes nearby enemies, dealing magic damage and rooting them for a duration.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lissandra sends a claw of ice in the target direction that deals magic damage to enemies it passes through, decelerating over 1.25 seconds. Glacial Path can be recast after 0.5 seconds while the claw is active.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Lissandra consumes the claw and blinks to its current location.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lissandra can cast Frozen Tomb on herself or an enemy champion.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Enemy Cast:</span> Lissandra freezes the target enemy champion, knocking them down and stunning them for 1.5 seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Self Cast:</span> Lissandra instantly entombs herself in ice, entering stasis for 2.5 seconds and healing herself every 0.25 seconds over the duration. The healing is increased by 0% - 100% (based on missing health at the time of cast).</p>',
          leveling: [
            {
