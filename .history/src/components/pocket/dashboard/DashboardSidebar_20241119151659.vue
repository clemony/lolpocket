...
<template>
    <div v-if="pocket" :key="pocket.key" class="flex flex-col">
        ...
        <Tabs default-value="spells" class="w-full">
            ...
            <ul
                class="flex h-9 items-center px-1 before:absolute before:h-9 before:w-[55px] before:rounded-md before:border before:border-base-300 before:bg-base-100 before:shadow-sm [&_li]:w-20">
                <li>
                    <label>Spells</label>
                </li>
                <li>
