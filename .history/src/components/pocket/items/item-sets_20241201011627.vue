...
<template>
    <VueDraggable
        ...
        <Card
            class="mb-12 grid h-[60px] cursor-pointer items-center justify-center bg-base-200/10 opacity-60 shadow-none transition-all duration-500 hover:bg-transparent hover:opacity-100 hover:!shadow-sm"
