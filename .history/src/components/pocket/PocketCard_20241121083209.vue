        ...
        <Card
            ...
            <CardContent
                ...
                <div class="relative w-1/2 pl-3">
                    ...
                    <div
                        class="relative h-2 w-24 flex-col content-end items-end gap-3 [&_:first-child]:-right-2.5 [&_:first-child]:-top-5 [&_:last-child]:-right-2.5 [&_:last-child]:top-6 [&_:nth-child(2)]:right-6 [&_:nth-child(2)]:top-1.5">
