                    ...
                    <Card
                        ...
                        <CardContent
                            ...
                            <div class="flex w-full items-center pl-16">
                                ...
                                <Grow />
                                <h4
                                    class="px-5 pt-2 text-right font-serif tracking-tight">
                                    {{ pocket.champions[0].starred }}
                                </h4>
                            </div>
                            <!-- ring-1 ring-base-300 ring-offset-2 ring-offset-base-100 -->
                            <div
                                ...
                                <div
                                    ...
                                    :class="
                                        cn(
                                            'z-0 h-52 w-[92%] !overflow-hidden rounded-lg',
                                            {
