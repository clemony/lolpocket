...
<template>
  <div class="flex h-full flex-col gap-8 py-4">
    ...
    <Collapsible v-slot="{ open }" :default-open="true">
      <CollapsibleTrigger
        class="flex w-full cursor-pointer items-center justify-between py-2 pl-1 font-semibold text-bc/50 underline-offset-2 hover:underline"
      >
        Statistics
    ...
    <Button size="12" variant="neutral" class="" @click="is().clearFilters()">
      Reset Filters
    </Button>
  </div>
</template>
