...
<template>
    <ScrollArea
        ...
        <Label
            ...
            class="m-1 grid aspect-square size-16 place-items-center self-center overflow-hidden rounded-lg border border-transparent shadow-warm has-[:checked]:bg-base-200/60">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
