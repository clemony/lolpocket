        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        class="relative col-start-2 row-start-2 flex h-full flex-col items-start justify-between gap-4 px-2 py-2 [&_:nth-child(2)]:absolute [&_:nth-child(2)]:right-0 [&_:nth-child(2)]:top-12">
                        <div
