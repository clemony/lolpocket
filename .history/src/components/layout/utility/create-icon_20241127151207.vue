...
<template>
    <div
        role="tablist"
        class="*: tabs tabs-lifted border-base-300 scrollbar-hide relative grid w-full overflow-y-scroll [&_.tab]:z-30! [&_.tab]:h-7 [&_.tab]:border-b-transparent! [&_.tab]:font-medium [&_.tab-content]:z-0!">
        <label
            role="tab"
        ...
        <div
            ...
            class="tab-content border-base-300 bg-b1 relative grid w-full rounded-xl rounded-tl-none">
            <div
                ...
                <label
                    ...
                    <icon :icon="icon" class="text-base-content size-full" />
                </label>
            </div>
        </div>
        ...
        <div
            ...
            class="tab-content w-inherit border-base-300 bg-b1 grid rounded-xl">
            <div
