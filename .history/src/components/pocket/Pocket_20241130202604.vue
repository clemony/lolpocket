...
const dashboardIsHovered = useElementHover(dashboard)
const championsdIsHovered = useElementHover(champions)
const itemsIsHovered = useElementHover(items)
const runesIsHovered = useElementHover(runes)
