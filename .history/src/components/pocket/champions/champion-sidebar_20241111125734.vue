    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-8 items-center'>
            <div class='relative w-fit'>
                <div class='join join-vertical rounded-lg border-2 border-base-300 overflow-hidden'>
                    <div
                        class='size-[70px]  join-item border-base-300 border-1 grid place-items-center !rounded-none overflow-y-hidden'>
                        <loadImg
                            class=" size-[70px] scale-[108%] mr-1   aspect-square object-center shrink-0 !rounded-none"
                            :url="`/img/champions/${clean(champion.name)}.webp`" />
                    </div>

                    <div class='join-item join join-horizontal w-[70px] h-9'>
