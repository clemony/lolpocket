...
<template v-if="set">
    <template v-for="rune in runes1">
        <div
            class="shrink-0 rounded-full border border-base-200 bg-base-100/50 p-1.5 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)] backdrop-blur-sm">
