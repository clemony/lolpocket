    ...
    <Card>
        ...
        <CardHeader class='flex flex-row'>
            <div class='relative w-fit'>
                ...
                <VTooltip theme="tt"
                    class="group/glow glow absolute -bottom-[4px] -right-[5px] grid size-10 items-center justify-center rounded-full bg-neutral transition-all duration-500 before: hover:rotate-180"
                    alt="view on Wiki">
