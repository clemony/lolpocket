...
const spell1 = ref(props.pocket.spells[0].spell1)
console.log(spell1)
const spell2 = ref(props.pocket.spells[0].spell2)
console.log(spell2)
const alt1 = ref(props.pocket.spells[0].alt1)
console.log(alt1)
const alt2 = ref(props.pocket.spells[0].alt2)
console.log(alt2)
