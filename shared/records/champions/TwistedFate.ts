  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate: Whenever  Twisted Fate kills an enemy, he generates a small amount of  bonus gold based on chance.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Twisted Fate kills an enemy, he generates 1 - 6 (based on probability). He also has a chance equal to his critical strike chance to generate an additional 1 - 6 (based on probability).</p>',
        },
        {
          description:
            'As you\'d expect, Twisted Fate plays with loaded dice. His initial dice roll is weighted to have an increased chance of granting 6, while his critical dice roll is weighted against him and has an increased chance of granting 1.',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/TwistedFate/ability-icon/p',
      notes:
        'The expected bonus gold gained per unit killed is  4.\nThe expected additional gold due to critical strike chance is  3.',
      targeting: 'Passive',
    },
    {
      key: 'Q',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Twisted Fate throws a fan of three cards in a cone in the target direction that each deal magic damage to enemies hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Twisted Fate cycles through three cards for 6 seconds, hovering each for 0.5 seconds at a time. Pick a Card can be recast within the duration, which selects the current card hovered.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Twisted Fate empowers his next basic attack within 6 seconds to have a 0.25-second cast time, deal modified magic damage, and apply an additional effect based on the card selected. This damage cannot critically strike but is increased based on critical strike chance.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Blue Card Bonus:</span> Deals magic damage, increased by 0% - 57.5% (based on critical strike chance), and restores mana.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Red Card Bonus:</span> Deals magic damage to the target and surrounding enemies, increased by 0% - 35% (based on critical strike chance). All targets hit are slowed for 2.5 seconds.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Gold Card Bonus:</span> Deals magic damage, increased by 0% - 25% (based on critical strike chance), and stuns the target for a duration.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies, Self',
      blurb:
        'Passive:  Twisted Fate gains  bonus attack speed. His  basic attacks  on-hit generate  stacks of Stacked Deck, which stacks up to a cap.',
      cooldown: '0',
      cost: '0',
      damageType: 'Magic damage',
      effects: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Twisted Fate marks all targetable enemy champions, revealing them for a duration. Destiny can be recast after 0.5 seconds within the duration.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast - Gate:</span> Twisted Fate channels for 1.5 seconds before blinking to the target location, destroying all projectiles targeting him in the process.</p>',
        },
      ],
