...
<template>
    <div class="mt-16 size-full pl-8">
        <Collapsible v-model:open="pinIsOpen" class="h-1/2 w-full">
            <CollapsibleTrigger
                class="group flex w-full items-center gap-3 text-start">
                <icon
                    icon="teenyicons:right-small-outline"
                    class="size-6 group-radix-state-open:rotate-90" />
                <h4 class="opacity-70">Pinned</h4>
            </CollapsibleTrigger>
            <CollapsibleContent class="items-start">
                <ag-grid-vue
                    :theme="pocketTheme"
                    class="top-grid l h-full w-full items-center !rounded-none !bg-transparent"
                    ref="pinnedGrid"
        ...
        <Collapsible v-model:open="genIsOpen" class="h-1/2 w-full">
            <CollapsibleTrigger
                class="group flex w-full items-center gap-3 pb-3 text-start">
                <icon
                    icon="teenyicons:right-small-outline"
                    class="size-6 group-radix-state-open:rotate-90" />
                <h4 class="opacity-70">Pinned Pockets</h4>
            </CollapsibleTrigger>
            <CollapsibleContent>
                <ag-grid-vue
                    :theme="pocketTheme"
                    class="bottom-grid h-full w-full items-center !rounded-none !bg-transparent"
                    ref="pocketGrid"
    ...
    <div
        class="absolute top-[105px] z-10 h-10 w-full bg-base-100/80 backdrop-blur-md before:absolute before:size-10 before:bg-base-200/20">
        <ag-grid-vue
            :theme="pocketTheme"
