...
const minimizeIcon = ['mynaui:x-circle', 'mynaui:x-circle-solid']
const maximizeIcon = ['mynaui:x-circle', 'mynaui:x-circle-solid']
const closeIcon = ['mynaui:x-circle', 'mynaui:x-circle-solid']

const value = computed(() => {
    const v = location[0] ? 'mynaui:circle' : 1
    return 'v'
})
</script>
<template>
