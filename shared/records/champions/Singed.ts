  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate: Whenever  Singed moves near a  champion, he gains  bonus movement speed for a short time, which refreshes on subsequent passes and  stacks up to a cap.",
      effectRadius: "225",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Singed moves near a champion, he gains a stack of Noxious Slipstream for 2 seconds, refreshing on subsequent passes and stacking up to 25 times.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Noxious Slipstream:</span> For each stack, Singed gains 25% bonus movement speed, up to a maximum of 625%.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Toggle:</span> Singed continually creates a toxic cloud in his wake that lingers for 3.25 seconds. The cloud inflicts poison to enemies within, and resets the duration every 0.5 seconds while they remain.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">poison:</span> The target takes magic damage every 0.25 seconds over 2 seconds. Subsequent inflictions refresh the duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Singed creates a field of adhesive at the target location for a short time that  grounds and  slows enemies within.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Singed spills a potent adhesive that lands at the target location after 0.375 seconds, creating a field for 3 seconds that grounds enemies within and slows them.</p>',
          leveling: [
            {
              attribute: "Slow",
              modifiers: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Singed  flings the target enemy, dealing magic damage based on their maximum health.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Singed flings the target enemy 550 units over himself over 0.693 seconds, dealing magic damage. The damage based on the target\'s health ratio is capped at 300 against minions and monsters.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Singed empowers himself for some time with  bonus ability power,  bonus armor,  bonus magic resist,  bonus movement speed,  bonus health regen, and  bonus mana regen.",
      castTime: "none",
      cooldown: "100",
      cost: "100",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Singed empowers himself for 25 seconds with ability power, bonus armor, bonus magic resistance, bonus movement speed, bonus health regeneration, and bonus mana regeneration.</p>',
          leveling: [
            {
