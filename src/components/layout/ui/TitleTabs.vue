        ...
        <div
            ...
            <template v-for="(tab, index) in sn.openTabs" :key="tab.id">
                <a
                    ...
                    <span
                        class="w-full min-w-0 max-w-36 grow justify-start truncate pr-3 text-start font-size-4">
                        {{ tab.title }}
                    </span>
...
.tabs > .tab-content {
    @apply rounded-box border-b3 bg-b1 p-6 shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px];
}
...
.tab-active {
    ...
    @apply !z-30 bg-b1/90 brightness-[99.5%];
}
</style>
