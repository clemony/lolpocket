  ...
  <div class="size-full items-center justify-center gap-15 px-27">
    ...
    <div class="flex w-full gap-[8%] px-3 py-24">
      <div class="flex w-114 flex-col gap-14">
        <div
          class="grid h-fit grid-cols-3 grid-rows-3 gap-4 rounded-box border-b3/80 px-9 py-8 shadow-smooth"
        >
          <div
          ...
          >
            <label
              class="btn size-27 cursor-pointer! px-2.5 py-2 btn-ghost hover:border-b3 hover:bg-b2 has-checked:border-b3 has-checked:bg-b3/70 has-checked:shadow-sm"
            >
              <img
                :alt="selectedSpell.name.toString()"
                :src="`/img/spells/${spell.id}.webp`"
                class="peer-checked:borderneutral/90 size-22 rounded-lg border border-b3 shadow-sm inset-shadow-sm shadow-black/20"
              />
      ...
      >
        ...
        >
          <div
            class="flex max-h-min w-full flex-col gap-6 rounded-xl border border-b3/80 px-9 pt-7 pb-8 shadow-smooth transition-all duration-300"
          >
