...
<template>
  <Dialog v-bind="forwarded">
    <DialogContent class="overflow-hidden p-0 shadow-pretty !rounded-[0.80rem] border border-b2  border border-b2 -b3 bg-b1/60 backdrop-blur-sm" :overlay-opacity="props.overlayOpacity">
      <CommandRoot
