  ...
  <UTheme
    ...
    :ui="{
      ...
      button: {
        ...
        trailingIcon: cn(
          'trailing-rotate pointer-events-none -ml-1 size-4! shrink-0 align-icon opacity-60 group-open/btn:-rotate-180 group-hover/btn:opacity-100 group-targetted/btn:text-nc group-targetted/btn:opacity-100'
        ),
        leadingIcon:
