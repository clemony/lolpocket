...
<template>
    <template v-if="set">
        <div
            class="size-18 relative z-0 shrink-0 self-center rounded-full border border-base-200 bg-base-100/60 p-1.5 shadow-smooth backdrop-blur-sm">
            <img
            ...
            <div
                v-if="set.secondary != ''"
                class="absolute -right-4 bottom-2 size-10 rounded-full border border-base-200 bg-base-100/70 p-1.5 shadow-smooth backdrop-blur-sm">
                <img
