                ...
                <template #header>
                    ...
                    <div
                        ...
                        <InputEditable
                            ...
                            class="@header-min/set:hidden w-fit items-center truncate border-transparent text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200">
                            <Button
                                variant="simple"
                                size="xs"
