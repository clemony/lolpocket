...
<Layout2 :panel2Size="30">
    <template #panel1>
        <ResizablePanelGroup direction="vertical">
            <ResizablePanel :default-size='35' class="h-full pb-0.5 ">
                <LayoutSpacer />
            ...
            <ResizablePanel :default-size='65' class="contain-strict">
                <Card class='h-full max-h-inherit '>
                    ...
                    <CardHeader
                        class=' absolute z-10 bg-base-100/90 backdrop-blur-md top-0 left-0 flex-row items-center  w-full  rounded-t-box  py-4 px-10'>
