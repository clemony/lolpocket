...
const itemImgClass = 'hover:ring-nc/90   hover:ring-offset-neutral/80 size-8 rounded-md  transition-all  duration-200 *:rounded-md  *:pointer-events-none hover:ring-1 hover:ring-offset-2'
</script>
  ...
  <div
    ...
    <div class="flex h-fit w-full gap-4 px-4">
      ...
      <div class="flex w-full flex-col text-4">
        <div class="flex w-full items-center justify-between gap-1">
          ...
          <a
            v-if="item.name"
            v-tippy="{ content: h(LinkTippy, { content: `Official LoL Wiki - ${item.name}` }), theme: 'neutral', placement: 'top-end', offset: [12, 8] }"
    ...
    <div class="relative grid auto-rows-auto overflow-y-auto px-4 pb-2">
      ...
      <template v-if="item.buildsInto?.length">
        ...
        <div
          :class="cn('group flex flex-wrap items-center gap-3 px-1',
