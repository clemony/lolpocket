...
<template>
    <label class="swap swap-flip relative backdrop-blur-md">
        ...
        <Card
            class="swap-off relative grid h-[270px] w-[220px] justify-center overflow-hidden rounded-xl bg-transparent px-2">
            <div
                ...
                <div class="grid w-full px-3">
                    <div class="flex h-fit gap-3 py-4">
                        <div class="relative flex items-end">
                            <div
                                class="flex w-full flex-row flex-wrap justify-start gap-1 justify-self-start pr-3">
                    ...
                    <div class="relative flex pb-3">
                        <div
                            class="z-20 flex-col items-start justify-center [&_first-child]:!rounded-tl-full">
                            <img
                                v-if="set.keystone.name"
                                :src="set.keystone.img"
                                class="size-16 drop-shadow-md" />
                            <img v-else src="/img/runes/RunesIcon.webp" />

                            <div :class="cn('flex gap-3 pt-3')">
                                <ShardSet :pocket="pocket" />
                            </div>
                        </div>

                        <div
                            class="ml-px h-fit flex-col items-center justify-start">
                            <div
                                :class="
                                    cn(
