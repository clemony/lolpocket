...
export const inputVariants = tv({
  base: 'input h-10 h-12 w-full items-center border-b3 text-2 inset-shadow-xs inset-shadow-black/4 ring-offset-b1 **:text-2 focus-within:ring-1 focus-within:ring-n1/50 focus-within:outline-0 focus-within:outline-offset-0 [&>svg]:size-4.5 [&>svg]:text-tint-bc/70 [&>svg]:**:stroke-[2.2]',
  defaultVariants: {
    hover: 'ring',
    size: 'default',
  },
  variants: {
    ...
    size: {
      ...
      default: 'text-2',
      header:
        'shrink-0 text-10 font-bold tracking-tight **:text-10 [&_input]:text-10 [&_input]:font-bold [&_input]:tracking-tight',
    },
    variant: {
      ...variantVariants,
...
export const inputGroupVariants = tv({
  base: cn('group/input-group relative flex w-full items-center rounded-field border inset-shadow-xs ring-bc/60 transition-[color,box-shadow] transition-all duration-200 outline-none focus-within:ring',
