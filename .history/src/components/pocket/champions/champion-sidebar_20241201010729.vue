    ...
    <div
        ...
        <Card class="relative">
            ...
            <CardHeader class="flex flex-row gap-8">
                <div class="relative w-fit pt-px">
                    <div
                        class="grid size-[70px] content-start items-start overflow-hidden rounded-lg border border-neutral shadow-warm">
                        <loadImg
                ...
                <div class="flex h-full w-full flex-col *:shrink-0">
                    <h1
                        class="scale-x-105 font-serif !font-extrabold leading-none">
                        {{ champion.name }}
                    </h1>
        ...
        <Tabs default-value="abilities" class="mt-8 w-full">
            ...
            <TabsContent value="abilities">
                <Card class="mt-2 overflow-hidden px-6 pb-3 pt-0">
                    <ChampionAbilities
                        :champion="champion"
