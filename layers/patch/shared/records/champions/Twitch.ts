  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        ...
        {
          "description": "The bolts deal 100% - 60% (based on enemies hit) of the triggering attack's damage, apply on-hit effects, and can critically strike for (175% + 30%) damage."
        }
      ],
