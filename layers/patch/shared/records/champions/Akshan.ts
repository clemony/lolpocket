  ...
  abilities: [
    {
      ...
      effects: [
        ...
        {
          description: 'The additional shot applies on-hit effects, triggers on-attack effects, and can critically strike[ for (22.5% + 9%) bonus damage. ][ 100% base damage + 30% bonus critical damage. ]'
        },
        {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: 'Scoring an enemy champion takedown reduces Heroic Swing\'s current cooldown to 0.5 seconds. The shots can critically strike for[ (157.5% + 27%) damage ][ 90% total critical damage ]and apply life steal.'
        },
        {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: 'Comeuppance can be recast after 0.5 seconds during the channel, and does so automatically afterwards. Comeuppance is placed on a 5-second cooldown if the channel is cancelled.'
        },
        {
        ...
        {
          description: 'Each bullet\'s damage applies life steal and executes minions.'
        },
        {
