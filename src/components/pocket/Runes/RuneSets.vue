            ...
            <VueDraggable
                ...
                <label
                    ...
                    <div
                        ...
                        <div
                            class="*:rounded-btn *:text-bc/80 grid grid-cols-3 gap-1.5 *:flex *:aspect-square *:size-5 *:items-center *:justify-center *:transition-all *:duration-300">
                            <button
                                class="hover:bg-b2"
                                alt="Clear Items"
                                title="Clear Items"
