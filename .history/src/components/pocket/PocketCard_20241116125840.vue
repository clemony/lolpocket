...
<template>
    <label class="relative size-fit">
        ...
        <Transition name="flip-front" :duration="500">
            <div
                v-if="!flip"
                :style="{
        ...
        <Transition name="flip-back" :duration="500">
            <Card key="back" v-if="flip" class="absolute h-[350px] w-[250px]">
                hi
            </Card>
        </Transition>
    </label>
