...
import { newPocketModal } from '@/components/modal/Modal'
...
<template>
    <PageLayout no-fade class="pb-4">
        <template #header>Pockets</template>

        <template #header-center>
            <Drawer type="addPocket">
                <template #trigger>
                    <button
                        class="flex items-center gap-3 underline-offset-2 opacity-70 hover:font-medium hover:underline hover:opacity-100">
                        New Pocket
                        <icon
                ...
                <PocketDrawer submitText="Create" />
            </Drawer>
