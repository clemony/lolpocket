    ...
    <VueDraggable
        ...
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-2"
                :cardClass="{
                    'relative before:absolute before:w-full before:h-full before:scale-110':
                        set,
                    ' before:border-base-300': set == is.selectedSet,
                }"
                :open="false"
                no-collapse>
                <template #header>
                    ...
                    <VDropdown
                        ...
                        <template #popper>
                            <div
                                ...
                                <div
                                    class="flex flex-col flex-nowrap items-center gap-1">
                                    <VDropdown theme="hoverdd-inner">
                                        <Button
                                            variant="ghost"
                                            size="xs"
                                            class="flex w-full items-center justify-start">
                                            <span class="ml-5">Set Type</span>
                                    ...
                                    <Button
                                        ...
                                        <icon
                                            ...
                                            class="-ml-1 size-4.5 object-center group-disabled/trash:opacity-0" />
                                        <icon
                                            icon="iconoir:bin"
