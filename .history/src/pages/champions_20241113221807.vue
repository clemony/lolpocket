...
<div class="h-full w-full px-6 *:scrollbar-hide">
    ...
    <Splitpanes id="buildSplit" class="default-theme h-[calc(100%-100px)] max-h-[calc(100%-100px)] w-full px-6 pb-4">
        <Pane size="70" min-size="60" max-size="72"
            ...
            <div
                ...
                <select class="align-self-end select select-bordered select-xs max-w-xs justify-self-end shadow-inner">
       ...
       /* -------------------------------------------------------------------------- */ -->
        ...
        <Pane size="30" max-size="40" min-size="28" class="relative max-h-full min-w-[105px]">
            <div class="max-h-full overflow-y-scroll rounded-box scrollbar-hide">
                <ChampionSidebar />
            </div>
        </Pane>
    </Splitpanes>
