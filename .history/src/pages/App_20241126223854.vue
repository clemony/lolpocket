...
<template>
    ...
    <main
        ...
        :key="state"
        :class="{
            'bg-black/30 backdrop-blur-md backdrop-brightness-50 before:absolute before:left-0 before:top-0 before:h-screen before:w-screen before:transition-all before:duration-500 before:animate-in before:fade-in-0':
                state == 'open',
        }">
        <div
            v-if="state == 'open'"
