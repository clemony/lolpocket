        ...
        <div class="mb-4 grid h-fit w-full gap-4 px-4">
            <div class="flex items-center gap-3">
                ...
                <Button
                    variant="ghost"
                    size="lg"
                    class="border-error bg-error hover:bg-error disabled:border-inspiration disabled:bg-inspiration disabled:text-4-content text-4 justify-center border px-5 text-white shadow-xs hover:opacity-80"
            ...
            <div class="flex w-full items-center">
                <h2 class="text-7 grow font-semibold tracking-tight">Trash</h2>
            </div>
        </div>
