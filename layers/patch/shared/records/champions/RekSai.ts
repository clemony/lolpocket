  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: '<p class="ability-effect"><span class="ability-header">Tremor Sense:</span> Rek\'Sai and her allies gain obscured vision of non-visible, moving enemies within range at a rate of once every second.</p>'
        },
        {
