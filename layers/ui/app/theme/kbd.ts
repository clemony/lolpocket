...
export const kbdTheme = defineUiTheme({
  base: "inline-flex w-fit shrink items-center justify-center rounded-sm px-1 align-baseline font-sans font-medium text-pc uppercase [&[square]]:aspect-square [&[square]]:gap-0 [&[square]]:p-0",
  variants: {
    variant: {
      solid: "",
      outline: "text-pc",
  ...
  compoundVariants: [
...

    {
      color: "primary",
      variant: "solid",
      class: "bg-p1! text-pc inset-ring inset-ring-p2",
    },
    {
      color: "secondary",
      variant: "solid",
      class: "bg-p2! text-pc inset-ring inset-ring-p3/80",
    },
  ],
  defaultVariants: {
    color: "base",
