  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate: Whenever  Cho\'Gath kills an enemy, it  heals and restores  mana.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Cho\'Gath kills an enemy, it heals for 18 - 52 (based on level) and restores 4.72 - 9.48 (based on level) mana.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Cho\'Gath ruptures the target location, dealing magic damage and  knocking up enemies within,  slowing them upon landing.',
      castTime: '0.5',
      cooldown: '6',
      cost: '50',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cho\'Gath ruptures the target location after a 0.627 seconds delay, granting sight of the area before dealing magic damage to enemies within and knocking them up for 1 second, and afterwards slowing them by 60% for 1.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      angle: '60°',
      blurb:
        'Active:  Cho\'Gath roars in a cone, dealing magic damage and  silencing enemies hit.',
      castTime: '0.5',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cho\'Gath roars in a cone in the target direction, dealing magic damage to enemies hit.</p>',
          leveling: [
            {
              attribute: 'Magic damage',
              modifiers: [
    ...
    },
    {
      ...
      blurb:
        'Active:  Cho\'Gath\'s next few basic attacks launch forth deadly spikes, dealing magic damage to enemies hit based on  Feast stacks and each target\'s maximum health, and  slowing them.',
      castTime: 'none',
      cooldown: '8 / 7 / 6 / 5 / 4',
      cost: '30',
      damageType: 'Magic damage',
      effects: [
        ...
        {
          description:
            'The width of the blast of spikes increases based on Cho\'Gath\'s character size modifier when they launch, including but not limited to the bonus from Feast stacks.',
        },
        {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cho\'Gath attempts to eat the target enemy, dealing them true damage. Against non- champions, the base damage is modified.</p>',
          leveling: [
            {
        ...
        {
          description:
            'Each stack of Feast increases the cast range of the ability by 2.5, for a maximum increase of 25 at 10 stacks, and grants Cho\'Gath bonus health as well as bonus attack range and increased size, capping at 75 bonus attack range and 100% increased size.',
          leveling: [
            {
