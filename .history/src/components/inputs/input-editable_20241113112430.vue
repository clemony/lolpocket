...
<template>
    <EditableRoot
        ...
        :class="
            cn(
                'border-input flex h-8 cursor-text overflow-hidden rounded-md border bg-transparent px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-base-content/60 hover:ring-1 hover:ring-neutral/5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral/40 disabled:cursor-not-allowed disabled:opacity-50',
                props.class
            )
        "
