...
<template>
    ...
    <main
        class="wrapper size-full bg-base-100/95"
        :key="state"
        :class="{
            'left-0 bg-transparent backdrop-blur-md transition-all animate-in fade-in-0 before:duration-500':
                state == 'open',
        }">
        <div
            v-if="state == 'open'"
        ...
        <label>
            ...
            <SidebarProvider
                class="page scale-75 overflow-hidden"
                :class="{
