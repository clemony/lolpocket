  ...
  "abilities": [
    {
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Innate:</span> Briar's basic attacks and abilities inflict a bleed against enemies for 5 seconds, refreshing on subsequent applications, stacking up to 5 times and dealing 25% damage for stacks beyond the first. The bleed deals[ 10 - 50 (based on level) (+ 50% bonus AD) total physical damage over the duration, increased by 2.5 - 12.5 (based on level) (+ 12.5% bonus AD) for each subsequent stack and up to a maximum of 20 - 100 (based on level) (+ 100% bonus AD). ][ 1 - 5 (based on level) (+ 5% bonus AD) physical damage every 0.5 seconds, increased by 0.25 - 1.25 (based on level) (+ 1.25% bonus AD) for each subsequent stack and up to a maximum of 2 - 10 (based on level) (+ 10% bonus AD) per tick. ]Briar heals herself equal to 25% of the pre-mitigation damage dealt. If a target dies while bleeding, she will heal herself equal to 125% of the remaining bleed damage.</p>"
        },
        {
