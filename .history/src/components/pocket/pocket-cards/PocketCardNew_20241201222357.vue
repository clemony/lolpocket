        ...
        <div :style="containerStyle">
            <div
                ...
                <label
                    ...
                    <Card
                        class="swap-off relative grid h-[260px] w-[210px] justify-center overflow-hidden rounded-xl border !border-neutral/20 !bg-transparent bg-right-bottom px-2"
                        :style="{
                        ...
                        <CardContent
                            ...
                            <div
                                class="mask-tl-1/2 transparent mask absolute z-40 h-24 w-24"></div>

                            <div
                                class="mask-tl-1/2 mask relative flex w-full justify-center !overflow-hidden">
                                <div
                                    :class="
                                        cn(
                                            'h mask-tl-1/2 mask z-0 h-36 w-[90%] !overflow-hidden rounded-md',
                                            {
                                    ...
                                    ">
                                    <div
                                        class="mask-tl-1/2 mask size-full bg-[50%_10%] bg-no-repeat [background-size:200%]"
                                        :style="layer1" />
                                </div>
                                <!-- <div
