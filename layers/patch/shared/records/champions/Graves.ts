  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        ...
        },
        {
          ...
          "leveling": [
            ...
            },
            {
              ...
              "modifiers": [
                {
                  "values": "130 / 200 / 270 / 340 / 410"
                },
                {
                  "tooltip": "Scaling per rank:\n120 / 135 / 150 / 165 / 180% bonus AD",
                  "unit": "% bonus AD",
                  "values": "120 - 180"
                }
              ]
        ...
        {
          "description": "Enemies can only be hit once per pass."
        }
      ],
    ...
    },
    {
      ...
      "effects": [
        ...
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">True Grit:</span> For each stack, Graves gains bonus armor, and bonus magic resistance equal to 50% of that amount. Subsequent casts of Quickdraw and damage versus non- minions will refresh the duration of True Grit.</p>",
          "leveling": [
            {
