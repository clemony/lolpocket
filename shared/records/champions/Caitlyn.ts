  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Caitlyn\'s basic attacks generate a stack of Count on-attack, doubled if she is within brush. At 5 stacks, or 4 while in brush, her next basic attack consumes all stacks on-attack to become a Headshot.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Headshot:</span> Caitlyn\'s basic attack is empowered to have an uncancellable windup and deal 60% / 90% / 120% (based on level) (+ (148.75% + 34%) critical strike chance) AD bonus physical damage, increased to 110% / 115% / 120% (based on level) (+ (148.75% + 34%) critical strike chance) AD against non-champions.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Caitlyn locks onto the target enemy champion and channels for 1 second, revealing them as well as revealing herself.</p>',
        },
        {
          description:
