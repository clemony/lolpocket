...
<template>
    <ScrollArea
        ...
        <Label
            ...
            class="m-1 aspect-square size-16 self-center overflow-hidden rounded-lg border border-transparent has-[:checked]:bg-base-200/60 has-[:checked]:shadow-standard">
            <input
                v-if="pocket"
                type="radio"
                name="iconPicker"
            ...
            <img
                ...
                class="size-16 scale-105 object-contain" />
        </Label>
    </ScrollArea>
</template>
