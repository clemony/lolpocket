    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <Card
                ...
                <div
                    class="h-200% duration-400 absolute left-0 z-10 h-[200%] w-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100 to-30% transition-all"
                    :class="{
                        '-top-[100%]': flip,
                        '-top-[30%]': !flip,
                    }" />
                <CardContent v-if="!flip" class="z02-">
                    <CardHeader
        ...
        <Transition
            ...
            <Card
                v-if="flip"
                class="absolute h-[350px] w-[250px] overflow-hidden bg-transparent"></Card>
        </Transition>
    </label>
</template>
