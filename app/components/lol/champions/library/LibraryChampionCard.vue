...
<template>
  <div
    ...
    :class="
      cn(
        `
          parallax group relative grid size-full cursor-pointer
    ...
    <div
      ...
      :class="
        cn(
          `
            group relative grid size-full cursor-pointer justify-center
            overflow-hidden rounded-lg bg-no-repeat
            **:select-none
          `,
          className,
        )
