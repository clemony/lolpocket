...
<template>
    <div
        ...
        class="shadow-pretty size-8 shrink-0 self-center rounded-full border border-base-200 bg-base-100/50 p-1.5 backdrop-blur-sm"
        :class="
            cn(getShardClass(shard).replace(), {
