...
<template>
  <div
    :class="cn(buttonVariants({ base: 'btn', variant: props.variant, size: props.size }), 'relative inset-0 grid shrink-0 cursor-default place-items-center overflow-hidden border-0 p-0 select-none',
               props.class)">
    <NuxtImg
