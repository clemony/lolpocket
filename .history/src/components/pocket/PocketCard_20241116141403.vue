    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <Card
                ...
                <div
                    class="delay-400 duration-400 h-200% absolute left-0 z-10 size-full w-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/80 to-base-100/95 to-30% backdrop-blur-md transition-all animate-in slide-in-from-top [background-size:200%]"
                    :class="{
                        '': flip,
                        '': !flip,
                    }" />
