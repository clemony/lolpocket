  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate - Goo:  Zac\'s abilities have a  health cost. Whenever Zac\'s abilities damage an enemy, he sheds a number of chunks on the ground that remain for a few seconds. Zac and enemy champions can collect the chunks; an enemy will destroy it, while Zac will  heal a portion of his maximum health.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - The Secret Weapon:</span> Zac gains increased percentage size equal to 1.5% of his bonus health, capped at 35% increased size at 2333.33 bonus health. Zac\'s size also reduces based on his missing health, down to 70% total size while at 0% health.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Goo:</span> Whenever Zac damages at least one enemy with an ability, he sheds a number of chunks of himself to a nearby location, landing towards nearby visible enemy champions and lasting for 6 seconds.</p>\n<p class="ability-effect"><span class="ability-header"> Stretching Strikes:</span> 1 chunk for each strike hit (excluding the collision) on different targets, up to 2</p>\n<p class="ability-effect"><span class="ability-header"> Unstable Matter:</span> 1 chunk if it hits at least one target</p>\n<p class="ability-effect"><span class="ability-header"> Elastic Slingshot:</span> 1 chunk for each enemy champion hit</p>\n<p class="ability-effect"><span class="ability-header"> Let\'s Bounce!:</span> 1 chunk for each bounce that hits an enemy champion, up to 4</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Both Zac and enemy champions can interact with a chunk by being within 50 units of it:</span> an enemy will destroy it, while Zac will consume it to heal for 4% - 8% (based on level) of his maximum health.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Cell Division:</span> Periodically, upon taking fatal damage, Zac enters resurrection for 8 / 7 / 6 / 5 / 4 (based on level) seconds, instantly restoring 50% of his maximum health and becoming untargetable and unable to act for the duration. Zac then splits into four uncontrollable bloblets away from his location, though stopping at terrain. After 1.5 seconds of the bloblets being untargetable, they start moving toward Zac\'s location over the remaining duration. Any damage the bloblets receive, excluding damage dealt in excess of each bloblet\'s total maximum health, is also redirected to Zac as true damage. While in resurrection, Zac cannot take damage from sources other than the redirected damage from his bloblets.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zac stretches his left arm in the target direction that catches the first enemy hit, dealing magic damage, slowing them by 40% for 0.5 seconds, and forming a tether between Zac and the target for 2 seconds, during which they are revealed.</p>',
          leveling: [
            {
        ...
        {
          description:
            'If the two Stretching Strikes affect different targets, both are rooted for 0.5 seconds while the secondary target is dealt the initial damage and applied the same slow. After a 0.4-second delay, Zac displaces them toward each other over 300-units, though not through terrain.',
        },
        {
          description:
            'If the two targets are near each other, they are instead slammed together through the displacement. Upon impact of each other, both targets are knocked up and stunned for 0.25 seconds and all enemies within the impact are dealt the initial magic damage and applied the same slow.',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Zac explodes to deal magic damage to nearby enemies hit based on their maximum health.',
      castTime: 'none',
      cooldown: '5',
      cost: '0',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zac explodes to deal magic damage to nearby enemies, capped against minions and monsters.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zac charges for up to 4.5 seconds to increase Elastic Slingshot\'s range over a cone in the target direction.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Zac leaps to the target location within the boundaries of the cone. Upon landing, he deals magic damage to nearby enemies and knocks them up and stuns them for 0.5 seconds, increased to 1 second if Elastic Slingshot was charged for more than 1 second.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      blurb:
        'Active:  Zac bounces four times, each impact deals magic damage to enemies hit and briefly  knocks back and  slows them.',
      castTime: '0.3',
      cooldown: '120 / 105 / 90',
      cost: '0',
      damageType: 'Magic damage',
