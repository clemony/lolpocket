  ...
  abilities: [
    {
      ...
      blurb:
        'Innate - Prowl: While in  brush,  Nidalee becomes  ghosted and gains  bonus movement speed for a short time, increased when facing a nearby enemy  champion. These bonuses briefly persist after exiting brush.',
      effectRadius: '3000 / 5500',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Prowl:</span> While in brush, Nidalee gains ghosting and 10% bonus movement speed, increased to 30% while facing a visible enemy champion within 1400 range. The bonuses persist for 2 seconds after leaving brush.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Hunt:</span> Hitting monsters or enemy champions with Javelin Toss or Bushwhack when Nidalee is nearby grants her ghosting and 10% bonus movement speed for 4 seconds and applies a Hunted mark to the target for the same duration, during which they are revealed as well as grant sight of a 300-unit radius around them. The bonus movement speed is increased to 30% while facing a Hunted target. Additionally, the first cast of both Takedown and Pounce against a Hunted target is enhanced.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Nidalee hurls a javelin in the target direction that deals magic damage to the first enemy hit based on distance travelled.',
      castTime: '0.25',
      cooldown: '6',
      cost: '50 / 55 / 60 / 65 / 70',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee hurls a javelin in the target direction that deals magic damage to the first enemy hit, increased by 0% - 225% (based on distance traveled).</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      blurb:
        'Active:  Nidalee\'s next basic attack within some time will gain  bonus range and deal magic damage based on the target\'s missing health.',
      castTime: 'none',
      cooldown: '6',
      cost: '50 / 55 / 60 / 65 / 70',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee empowers her next basic attack within 10 seconds to have an uncancellable windup, gain 75 bonus range and deal modified magic damage that is increased by an amount for every 1% of the target\'s missing health.Takedown can critically strike for (75% + 40%) AD bonus magic damage.</p>',
          leveling: [
            {
              attribute: 'Minimum Magic Damage',
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Hunt Bonus:</span> Hitting a Hunted target increases Takedown\'s damage by 30%.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Nidalee lays a  stealthed that will spring upon contact with an enemy, continually dealing magic damage over a few seconds.',
      castTime: '0.25',
      collisionRadius: '150',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee lays a trap at the target location that becomes stealthed after arming over 1.5 seconds, lasting for up to 120 seconds and granting sight within its radius. The trap will spring upon contact with an enemy, dealing magic damage every second over 4 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Passive: Killing an enemy or using Pounce\'s  Hunted bonus will  reduce Pounce\'s cooldown.',
      castTime: 'none',
      cooldown: '13 / 12 / 11 / 10 / 9',
      cost: '30 / 35 / 40 / 45 / 50',
      damageType: 'Magic damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Killing an enemy while in Cougar Form or using Pounce\'s Hunt bonus reduces Pounce\'s current cooldown to a minimum value.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee leaps a fixed distance in the target direction. Upon arrival, she deals magic damage to nearby enemies.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Hunted Bonus:</span> Nidalee can perform Pounce from an increased range on a Hunted enemy closest to the cursor. She will leap to the front of the target.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Self, Allies',
      blurb:
        'Active:  Nidalee revitalizes herself or the target allied champion, granting  bonus attack speed for a few seconds and  healing the target based on their missing health.',
      castTime: '0.25',
      cooldown: '12',
      cost: '50 / 55 / 60 / 65 / 70',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee revitalizes herself or the target allied champion, granting the target bonus attack speed for 7 seconds and healing them for an amount that is increased by 0% - 100% (based on target\'s missing health).</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee slashes in an arc in the target direction, dealing magic damage to enemies hit.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Nidalee switches between her Human Form and Cougar Form.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Cougar Form:</span> Nidalee transforms into a cougar, gaining melee attacks with 125 range and access to her cougar abilities.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Human Form:</span> Nidalee transforms into a human, gaining ranged attacks with 525 range and access to her human abilities. While in this form, applying a Hunted mark will reset Aspect of the Cougar\'s cooldown.</p>',
        },
        {
          description:
