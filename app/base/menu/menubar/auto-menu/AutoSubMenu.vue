    ...
    >
      ...
      >
        ...
        <span
          ...
          class="badge max-w-40 truncate badge-neutral badge-sm text-1! font-semibold! tracking-normal group-open/trig:badge-neutral group-hover/trig:badge-neutral"
        >
          {{ item.shortcut?.text }}
        </span>
      </MenubarShortcut>
