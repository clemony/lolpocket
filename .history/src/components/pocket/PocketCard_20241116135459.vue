        ...
        <Transition
            ...
            <div
                ...
                <InfoCard
                    ...
                    before:bg-gradient-to-b  before:from-base-100/40  before:from-0%  before:via-base-100/70  before:to-base-100 to-30% before:w-full before:h-200% before:absolute"
                    :class="{
                        '': flip,
                        '': !flip,
                    }">
