        ...
        <div :style="containerStyle">
            <div
                ...
                <label
                    ...
                    <Card
                        class="mask-tl-1/2 mask swap-off relative grid h-[260px] w-[210px] justify-center overflow-hidden rounded-xl border !border-neutral/20 !bg-transparent bg-right-bottom px-2"
                        :style="{
                            backgroundImage: champImage,
                            backgroundColor: 'transparent',
                        }">
                        <CardContent
                            class="mask-tl-1/2 mask relative h-full w-inherit items-center bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30%">
                            ...
                            <div
                                ...
                                <div
                                    :class="
                                        cn(
                                            'h z-0 h-36 w-[90%] !overflow-hidden rounded-md',
                                            {
