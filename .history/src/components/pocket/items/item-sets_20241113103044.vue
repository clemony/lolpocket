...
<template>
    <VueDraggable
        ...
        :fallbackOnBody="true"
        class="z-0 flex h-full w-full flex-col justify-center gap-8">
        <TransitionGroup name="pop">
            <DisplayCard
                ...
                headerClass="pb-1"
                :cardClass="{
                    'relative before:absolute max-w-[95%] before:w-full before:h-full before:scale-100 before:pointer-events-none before:z-50  before:rounded-box':
                        set,
