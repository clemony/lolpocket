...
const dashboardIsHovered = computed(() => {
    const { isOutside } = useMouseInElement(dashboardLink)
    return isOutside.value
})
const championsdIsHovered = useElementHover(championsLink)
const itemsIsHovered = useElementHover(itemsLink)
const runesIsHovered = useElementHover(runesLink)
    ...
    <PageLayout :key="pocket.key" nav>
            ...
            <div v-for="el in els" :key="el.name">
                ...
                <VDropdown
                    ...
                    <label
                        ...
                        <span
                            :ref="el.linkRef"
                            class="w-max min-w-max px-1 capitalize">
                            {{ el.name }}
                        </span>
        ...
        <template #indicator>
            <div
                ...
                :class="{
                    'translate-x-[11px]':
                        pocket.component == 'dashboard' || dashboardIsHovered,
