        ...
        <div class="menu bg-base-200 text-base-content min-h-full w-80 px-4 pt-8 shadow-inner shadow-neutral/20">
          ...
          <div v-if="selectedChampion" class="">
            ...
            <div role="tablist" class="tabs tabs-lifted mt-5">
              <input type="radio" name="ability-tabs" role="tab" class="tab"
                style="background-image: url('selectedChampion.pImg');" aria-label="p" checked="true" />
              <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6 
                ">
                Tab content 1
              </div>

              <input type="radio" name="ability-tabs" role="tab" class="tab" aria-label="Tab 2" />
              <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                Tab content 2
              </div>

              <input type="radio" name="ability-tabs" role="tab" class="tab" aria-label="Tab 3" />
              <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                Tab content 3
              </div>
            </div>
