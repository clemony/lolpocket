    ...
    <div class="pages-stack">
        ...
        <div class="page" id="page-manuals">
            <header class="bp-header cf">
                ...
                <p class="info">
                    "When you adopt a vegan diet we make a connection, you don't
                    go back, it is not a diet, it is a lifestyle." &mdash;
                    Freelee Frugivore
                </p>
            </header>
            <img class="poster" src="" alt="img02" />
        </div>
        <div class="page" id="page-software">
            <header class="bp-header cf">
                ...
                <p class="info">
                    "I decided to pick the diet that I thought would maximize my
                    chances of long-term survival." &mdash; Al Gore
                </p>
            </header>
            <img class="poster" src="" alt="img03" />
        </div>
        <div class="page" id="page-custom">
            <header class="bp-header cf">
                ...
                <p class="info">
                    "You have to make a conscious decision to change for your
                    own well-being, that of your family and your country."
                    &mdash;Bill Clinton
                </p>
            </header>
            <img class="poster" src="" alt="img04" />
        </div>
        <div class="page" id="page-training">
            <header class="bp-header cf">
                ...
                <p class="info">
                    "The moment I began to understand what was going on with the
                    treatment of animals, it led me more and more in the way of
                    the path I am [on] now, which is a complete vegan." &mdash;
                    Bryan Adams
                </p>
            </header>
            <img class="poster" src="" alt="img05" />
        </div>
        <div class="page" id="page-buy">
            <header class="bp-header cf">
                ...
                <p class="info">
                    "When people ask me why I don't eat meat or any other animal
                    products, I say, 'Because they are unhealthy and they are
                    the product of a violent and inhumane industry.'" &mdash;
                </p>
            </header>
            <img class="poster" src="" alt="img06" />
        </div>
        <div class="page" id="page-blog">
            <header class="bp-header cf">
                ...
                <p class="info">
                    ...
                    talk?' but rather, 'Can they suffer?" &mdash; Jeremy Bentham
                </p>
            </header>
            <img class="poster" src="" alt="img01" />
        </div>
