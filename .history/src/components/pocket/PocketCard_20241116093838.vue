...
<template>
    <label class="relative">
        <input type="checkbox" v-model="flip" />
        <div
            :style="{
                backgroundImage: champImage,
            }"
            class="swap-off absolute rounded-box bg-[20%_-45%] bg-no-repeat [background-size:200%]">
            <InfoCard
                cardClass=" h-[350px] w-[250px]   backdrop-blur-none bg-gradient-to-b from-base-100/40 from-0% to-base-100 via-base-100/70 to-30%">
                <template #header>
        ...
        <Card class="absolute h-[350px] w-[250px]">hi</Card>
    </label>
</template>
