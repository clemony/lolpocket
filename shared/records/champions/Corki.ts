  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Corki\'s basic attacks deal bonus true damage equal to 20% AD. This damage is affected by critical strike modifiers.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Corki fires a flash bomb at the target location, dealing magic damage to enemies hit and  revealing enemy  champions hit.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Corki launches a bomb at the target location that explodes upon impact, dealing magic damage to enemies hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Corki  flies a short distance to the target location, dropping bombs that create a trail of fire that deals magic damage continually to enemies within.",
      castTime: "none",
      collisionRadius: "100",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Corki dashes to the target location and drops bombs that leave up to 3 blazing patches along his path, depending on the distance traveled. Each patch lasts 2.5 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      angle: "35°",
      blurb:
        "Active:  Corki's gatling gun rapidly fires in a cone in front of him, continually dealing physical damage to enemies hit and applying  stacks of Gatling Gun.",
      castTime: "none",
      cooldown: "12",
      cost: "50 / 55 / 60 / 65 / 70",
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Corki fires a missile in the target direction that explodes upon the first enemy hit, dealing physical damage to enemies in an area.",
      castTime: "0.175",
      cooldown: "2",
      cost: "35",
      damageType: "Physical damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Basic attacks on-hit against champions reduce Missile Barrage\'s remaining recharge time by 2 - 4 (based on critical strike chance) seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Corki fires a missile in the target direction that explodes upon the first enemy hit, dealing physical damage to enemies within the area.</p>',
          leveling: [
            {
