  ...
  <div class="relative h-max">
    ...
    <button
      ...
      <Separator
        ...
        :class="
          cn('border-shade-b3/10 group-hover/tree:border-shade-b3/20 rounded-bl-lg border-l bg-transparent transition-colors duration-200',
    ...
    <Collapsible
      ...
      <CollapsibleTrigger
        ...
        :class="
          cn('border-b-b3 hover:border-shade-b3/20 pointer-events-none absolute -z-1 grid h-7 w-8 -translate-x-7 border-b',
      ...
      <CollapsibleTrigger
        ...
        size="8"
        class="
          text-bc/30 hover:text-bc relative ml-5 px-5 text-xs hover:underline
        "
        ...
        <span
          :class="
            cn('border-shade-b3/10 dst hover:border-shade-b3/20 absolute top-0 left-0 h-1/2 w-4 rounded-bl-lg border-b transition-colors duration-200',
