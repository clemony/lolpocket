    ...
    <div class="flex justify-center" :key="set.key">
        <div
            ...
            <label
                ...
                <div
                    class="shard-color flex size-12 shrink-0 items-center justify-center rounded-full border border-base-300 bg-gradient-to-br from-base-200/20 to-base-200/30 bg-clip-padding text-base-content/60 shadow-standard ring-1 ring-transparent ring-offset-2 ring-offset-transparent transition-all duration-300">
                    <Icon
                        :icon="
