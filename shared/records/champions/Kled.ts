...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Kled throws a bear trap in the target direction that deals physical damage to enemies hit and forms a  tether against the first  champion or  large monster hit,  revealing them.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kled throws a bear trap in the target direction that deals physical damage to enemies hit, increased to 150% against minions, small pets, and small monsters. The bear trap collides with the first enemy champion, large pet, or large monster hit, revealing them for 2.5 seconds, and forming a tether between Kled and the target for 1.75 seconds.</p>',
          leveling: [
            {
        ...
        {
          description:
            'The tether\'s radius shrinks over its duration, and if it is not broken before then, Kled pulls the target 150 units toward him, deals physical damage and slows them for 2.5 seconds.',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
    ...
    },
    {
      ...
      angle: '20°',
      blurb:
        'Active:  Kled sprays a cone of pellets in the target direction that deal physical damage to enemies hit, during which he also  recoils backward. Each pellet that hits an enemy  champion or epic  monster restores  Courage.',
      castTime: '0.25',
      cooldown: '11 / 10 / 9 / 8 / 7',
      cost: '0',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kled sprays a cone of five pellets in the target direction while recoiling 300 units in the opposite direction, dealing physical damage to enemies hit.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Kled periodically gains Violent Tendencies, which starts expiring upon his next basic attack.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Violent Tendencies:</span> Kled gains 150% bonus attack speed on his next 4 basic attacks within 4 seconds. The fourth attack deals bonus physical damage. The damage based on the target\'s health is capped at 200 against monsters.Violent Tendencies\' current cooldown is reduced by 0.5 seconds on-hit, increased to 1.5 against champions.</p>',
          leveling: [
            {
          ...
          leveling: [
            {
              ...
              modifiers: [
                {
                  values:
                    '62 / 63.75 / 65.5 / 67.25 / 69 / 70.75 / 72.5 / 74.25 / 76 / 77.75 / 79.5 / 81.25 / 83 / 84.75 / 86.5 / 88.25 / 90 / 91.75',
                },
                {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Skaarl  dashes in the target direction, dealing physical damage to enemies he passes through and marking enemy  champions hit. The mark  reveals the target for a short time, during which Jousting can be recast.',
      castTime: 'none',
      cooldown: '13 / 12 / 11 / 10 / 9',
      cost: '0',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Skaarl dashes in the target direction, though not through terrain, dealing physical damage to enemies he passes through and pulling minions, pets and small monsters hit towards them.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Skaarl consumes the mark to dash through the marked target, applying the same effects as the first cast though being able to dash through terrain.</p>',
          leveling: [
            {
              attribute: 'Total Physical Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active: Kled &  Skaarl become  ghosted and  unstoppably charge to a location, building up  bonus movement speed and  shield and leaving a draft in their wake that grants Mr. Kled\'s Wild Ride to allies that follow the draft.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kled & Skaarl charge toward the target location, automatically navigating terrain along the way, during which they are ghosted, immune to crowd control and revealed to enemy champions in a 1250 radius. If the charge does not complete within 15 seconds, it will end prematurely. The charge is interrupted instantly if Kled dismounts during it.</p>',
        },
        {
          description:
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Mr. Kled\'s Wild Ride:</span> While in champion combat, gain 40% bonus movement speed. After not being in champion combat for 3 seconds, if Kled is charging, gain bonus movement speed up to Kled\'s current movement speed; otherwise gain up to 650 total movement speed.</p>',
        },
        {
          description:
            'Kled & Skaarl will dash toward the first visible enemy champion in range of the charge, revealing the target during the dash and colliding with the first visible enemy champion in their path to deal magic damage, increased by 0% - 200% (based on charge time), knocking them back 150 units and ending the charge.',
          leveling: [
            {
