    ...
    <template #panel2>
        ...
        <Card :open="false" class='h-[calc(100%-115px)] max-h-[calc(100%-115px)] overflow-hidden pt-4'>
            ...
            <CardHeader>
                ...
                <div class="join">
                    <Button variant="outline" size="icon" class='join-item [&_input]:hidden relative'
                        @click="sortAZ++; sortAZ == 3 ? sortAZ = 0 : ''" :class="{ 'shadow-inset-sm': sortAZ }">

                        <icon v-if="sortAZ == 2" icon="icon-park-outline:alphabetical-sorting-two"
                            class='size-6 absolute opacity-60' />
                        <icon v-else icon="icon-park-outline:alphabetical-sorting" class='size-6 absolute opacity-60' />
