    ...
    <div v-else-if="state.data">
        <Popover>
            ...
            <PopoverContent
                ...
                <div
                    class="gap bg-b1 flex flex-wrap justify-end gap-x-8 gap-y-4 px-12 py-6 pb-8 backdrop-blur-md">
                    <PopoverClose
                        ...
                        <label
                            ...
                            <input
                                ...
                                :disabled="false" />
                            <div
                                class="border-neutral/10 size-[50px] overflow-hidden rounded-lg border">
                                <img
