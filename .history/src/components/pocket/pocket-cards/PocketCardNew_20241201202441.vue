    ...
    <div :style="wrapperStyle" ref="wrapper" class="">
        <div :style="containerStyle">
            <div
                ...
                <label
                    class="swap swap-flip relative rounded-lg shadow-smooth backdrop-blur-md">
                    ...
                    <Card
                        ...
                        <CardContent
                            ...
                            <div class="flex w-full items-center pl-12">
                                <div
                                    :class="cn('flex items-center gap-3 pt-3')">
                                    <ShardSet :pocket="pocket" />
                                </div>
                                <h5 class="px-4 py-2 text-right">
                            ...
                            <div
                                ...
                                <div
                                    :class="
                                        cn(
                                            'z-10 h-36 w-[90%] overflow-hidden rounded-md after:absolute after:left-1 after:top-2 after:z-0 after:size-16 after:rounded-full after:bg-base-100',
                                            {
                                                'border border-neutral after:shadow-smooth after:ring-1 after:ring-neutral':
                                                    pocket.champions[0].starred,
                                            }
                                        )
                                    ">
                            ...
                            <div
                                class="absolute right-0 top-0 z-10 h-fit flex-col items-center justify-end">
                                <div
                                    :class="
                                        cn(
