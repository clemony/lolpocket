...
<template>
    <VDropdown
        ...
        :class="
            cn(
                'no-drag search-drop ghosty drag-label group/qs border-box after:content-[ relative z-0 flex !cursor-pointer !p-0 after:absolute after:grid after:h-full after:w-full after:place-content-center after:text-md after:opacity-50 after:content-[\'+\'] hover:after:text-neutral hover:after:opacity-60',
                props.class
            )
        "
        :style="{
