...
<template>
  <Popover v-model:open="isOpen">
    ...
    <LazyPopoverContent
      ...
      <div
        class="
          from-b1 absolute top-0 z-1 w-full overflow-hidden bg-linear-to-b
          from-4% to-transparent to-80% px-2 pt-2 pb-1.5
        ">
        <InputGroup
          class="
            bg-brightness-104 border-b3/80 bg-b1/74! h-11 w-full rounded-xl
      ...
      <div
        class="
          from-b1 absolute bottom-0 w-full bg-linear-to-t from-4% to-transparent
          to-80% px-2 pb-2
        ">
        <Tabs
          ...
          as="div"
          class="
            bg-brightness-104 border-b3/80 bg-b1/70 flex h-9! w-full items-center
            rounded-xl border px-1 bg-blend-screen shadow-md shadow-black/4
            backdrop-blur-sm
          ">
          <TabsList
            variant="none"
            ...
            <TabsTrigger
              ...
              class="
                group/btn disabled:**:text-bc/40 on:*:opacity-100 on:**:text-nc! h-7
