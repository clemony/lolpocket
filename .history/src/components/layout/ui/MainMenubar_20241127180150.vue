...
const historyArr = [hs[0], hs[1], hs[2], hs[3], hs[4]]
</script>

<template>
    <Menubar
        class="absolute z-[199] grid w-full grid-cols-3 items-center rounded-t-xl bg-base-100/[97%] p-0 shadow-[inset_0px_0px_3px_2px_#00000006,inset_3px_3px_3px_2px_#00000007,rgba(0,_0,_0,_0.15)_0px_7px_10px_-12px] [&_>div]:-mt-px [&_>div]:flex [&_>div]:items-center"
        ...
        <div data-tauri-drag-region>
            ...
            <button @click="console.log(historya)">click</button>
        </div>
