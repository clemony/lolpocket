                ...
                <label
                    ...
                    <div
                        :class="
                            cn(
                                /* b4 */
                                'size-full bg-gradient-to-br from-base-100/60 to-base-300/50 backdrop-blur-sm',
                                /* border */
                        ...
                        :style="{
                            backgroundImage:
                                'url(/img/ui/asphalt-dark.png),linear-gradient(135deg,oklch(var(--b1) / 0.6) 50%, oklch(var(--n)) 100%)',
                            backgroundPosition: 'center',
                            backgroundSize: '12=30%',
                        }">
                        <icon
