  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Heimerdinger gains  bonus movement speed while near allied  towers and  turrets he deploys.",
      effectRadius: "300",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Heimerdinger gains 20% bonus movement speed while near an allied turret or a H-28G Evolution Turret or H-28Q Apex Turret deployed by him.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Heimerdinger deploys a rapid-fire turret that deals magic damage to his target, or a nearby enemy. The turret will become dormant while he leaves it alone.",
      castTime: "0.25",
      cooldown: "1",
      cost: "20",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Heimerdinger deploys a H-28G Evolution Turret at the target location, which lasts until destroyed.</p>',
        },
        {
          description:
        ...
        {
          description:
            "See Pets for more details about H-28G Evolution Turrets.",
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "UPGRADE:  Heimerdinger instead deploys a slow-fire turret that attacks a nearby enemy champion, dealing magic damage and  slowing nearby enemies.",
      castTime: "0.25",
      cooldown: "1",
      cost: "20",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">UPGRADE!!! - Active:</span> Heimerdinger deploys a H-28Q Apex Turret at the target location, which lasts for 8 seconds.</p>',
        },
        {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Heimerdinger fires a wave of rockets that converge to the target location and fan beyond it to max range, each dealing magic damage to the first enemy hit. Enemies take less damage from subsequent rockets that hit them.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Heimerdinger launches a wave of 5 rockets that converge upon the target location and fan beyond it up to a maximum range, with each one dealing magic damage to the first enemy it hits. Every rocket hitting an enemy champion grants 20% beam charge to all turrets within 1000 range, up to a maximum of 100% beam charge when hitting 5 rockets on an enemy champion.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "UPGRADE:  Heimerdinger now fires 4 waves of rockets, each rocket dealing magic damage to the first enemy hit. Enemies take less damage from subsequent rockets that hit them.",
      castTime: "0.25",
      cooldown: "11 / 10 / 9 / 8 / 7",
      cost: "50 / 60 / 70 / 80 / 90",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">UPGRADE!!! - Active:</span> Heimerdinger unleashes 4 waves of 5 rockets in quick succession that converge upon the target location. Each rocket deals magic damage to the first enemy hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Heimerdinger lobs a grenade to the target location that deals magic damage and  slows nearby enemies. Enemies hit at the epicenter are also  stunned.",
      castTime: "0.25",
      cooldown: "11",
      cost: "85",
      damageType: "Magic damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Heimerdinger hurls a grenade at the target location that detonates upon impact, dealing magic damage to nearby enemies and slowing them by 35% for 2 seconds. If the grenade hits an enemy champion, all turrets within 1000 range of the impact gain 100% beam charge.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "UPGRADE:  Heimerdinger's grenade now bounces 3 times, each dealing magic damage in a larger area.",
      castTime: "0.25",
      cooldown: "11",
      cost: "85",
      damageType: "Magic damage",
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Heimerdinger can empower his next ability to apply an additional effect. These empowered abilities have the same  cooldowns as their basic forms, deal modified damage, and do not cost mana.",
      castTime: "none",
      cooldown: "100 / 85 / 70",
      cost: "100",
      effects: [
