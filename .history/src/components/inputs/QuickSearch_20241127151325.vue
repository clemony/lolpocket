...
<template>
    <VDropdown
        ...
        :class="
            cn(
                'no-drag search-drop ghosty drag-label group/qs border-box after:content-[ hover:after:text-neutral relative z-0 flex cursor-pointer! p-0! after:absolute after:grid after:h-full after:w-full after:place-content-center after:text-lg after:opacity-50 after:content-[\'+\'] hover:after:opacity-60',
                props.class
            )
        "
        :style="{
            ...
            <div class="relative pt-1.5 pb-0">
                <div class="relative flex w-full justify-center px-2 pb-1">
                    <Icon
                        ...
                        class="text-neutral-content/50 pointer-events-none absolute top-[0.45rem] right-3.5 size-3.5" />

                    <button
                        v-else
                        class="text-neutral/40 hover:text-neutral/60 pointer-events-auto absolute top-[7px] right-3.5 z-10 size-3.5 transition-all duration-300"
                ...
                <div
                    v-if="quickSearch"
                    class="border-t-base-300 grid max-h-72 w-full overflow-y-scroll border border-transparent px-1 pt-2 transition-all duration-500">
                    <TransitionGroup
                        name="fade"
                        tag="div"
                        @enter="imageIn"
