...
<template>
    <VDropdown
        ...
        placement="bottom"
        :distance="8"
        class="no-drag search-drop ghosty drag-label group/qs border-box relative z-0 flex !cursor-pointer !p-0 after:absolute after:grid after:h-full after:w-full after:place-content-center after:opacity-50 after:content-['+'] hover:after:text-neutral hover:after:opacity-60"
        :style="{
