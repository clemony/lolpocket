                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child class="py-3">
                        <SidebarMenuButton
                            variant="ghost"
                            size="md"
                            class="flex h-full flex-nowrap items-center gap-3 !border-0 pr-2.5 !ring-0 focus:!border-0 focus:!outline-0 focus:!ring-1 focus:!ring-base-200"
                            :class="{
                                '!pl-0': gs.sidebarState == 'collapsed',
                                'data-[state=open]:shadow-sm data-[state=open]:!ring-1 data-[state=open]:!ring-base-300/40':
                                    gs.sidebarState == 'open',
                            }">
                            <div
