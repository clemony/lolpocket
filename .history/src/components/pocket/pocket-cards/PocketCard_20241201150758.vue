            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <Card
                        ...
                        <div
                            class="mask absolute top-0 h-[200px] w-full bg-local bg-[25%_80%] bg-no-repeat mask-b-52 [background-size:200%]"
                            :style="layer1"></div>
                        <CardContent
                            ...
                            <div class="grid w-full px-3">
                                ...
                                <div class="relative mt-2 flex pb-3">
                                    <div
                                    ...
                                    <div
                                        class="h-fit flex-col items-center justify-end">
                                        <div
                                            :class="
                                                cn(
                                                    'z-10 mt-1 flex h-fit w-fit gap-2',
                                        ...
                                        <div
                                            :class="
                                                cn(
                                                    'z-0 mt-2 flex justify-end gap-2'
                                                )
                                            ">
                                            <RuneSet
                                                :pocket="pocket"
                    ...
                    <div
                        ...
                        <div
                            class="flex gap-4 [&_>*]:grid [&_>*]:!aspect-square [&_>*]:size-11 [&_>*]:place-items-center [&_>*]:justify-start [&_>*]:rounded-full [&_>*]:bg-neutral/70 [&_>*]:text-neutral-content [&_>*]:shadow-standard [&_>*]:ring-1 [&_>*]:ring-offset-2 [&_>*]:ring-offset-neutral/20 [&_>*]:backdrop-blur-sm after:[&_>*]:absolute after:[&_>*]:size-full after:[&_>*]:scale-110 after:[&_>*]:rounded-full after:[&_>*]:border after:[&_>*]:border-base-100/50 hover:[&_>*]:bg-base-100/20 [&_svg]:mr-1">
                            <Tooltip
                            ...
                            <Tooltip content="Open Pocket" align="bottom" dark>
                                <Button
                                    ...
                                    <RouterLink :to="`pocket/${pocket.key}`">
                                        <icon icon="qlementine-icons:open-16" />
                                    </RouterLink>
                                </Button>
                            </Tooltip>
