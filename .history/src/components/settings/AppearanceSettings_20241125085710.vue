        ...
        <div class="grid w-full grid-cols-3 gap-6 [&_>*]:size-full">
            <DisplayCard
                ...
                <label
                    ...
                    <div
                        class="! h-full w-full cursor-pointer overflow-hidden rounded-lg border border-base-300 bg-base-100 text-base-content shadow-warm peer-checked:ring-1 peer-checked:ring-neutral/80 peer-checked:ring-offset-4 peer-checked:ring-offset-neutral-content"
                        :data-theme="theme + 'minimalist'">
                        <div
                            class="grid h-full w-full grid-cols-[1fr_4fr] rounded-btn">
