    ...
    <div class="*:scrollbar-hide h-full w-full">
        <div class="flex w-full items-end p-4">
            <div class="flex grow items-center">
                <h2 class="text-7 p-1.5 font-bold">Favorites</h2>
            </div>
        </div>
                ...
                <label class="drag-label overflow-hidden!">
                    <div class="drag-wrapper overflow-hidden!">
                        ...
                        <div
                            ...
                            class="bg-primary text-primary-content shadow-warm text-2 absolute -top-1.5 -right-1.5 z-30 flex size-6 place-content-center place-items-center overflow-hidden rounded-full font-mono opacity-0">
                            {{ item.count }}
                        </div>
                    </div>
                </label>
