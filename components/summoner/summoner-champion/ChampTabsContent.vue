...
const { bayesianChampions } = useMatchChampions(computed (() => ms.championTabsQueue))
</script>

<template>
  <TabsContent :value="ms.championTabsQueue" as="div">
    <Field slide class="grid h-fit gap-6  px-6 py-8">
      <template v-if="bayesianChampions.length">
        <div
