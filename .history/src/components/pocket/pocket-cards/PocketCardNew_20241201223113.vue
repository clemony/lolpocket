        ...
        <div :style="containerStyle">
            <div
                ...
                <label
                    ...
                    <Card
                        class="masking swap-off relative grid h-[260px] w-[210px] justify-center rounded-xl border border-neutral/20 !bg-transparent bg-right-bottom px-2 before:absolute"
                        :style="{
