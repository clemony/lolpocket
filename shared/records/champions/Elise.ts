  ...
  abilities: [
    {
      ...
      name: 'Spider Queen',
      blurb:
        'Innate: The rank of  Spider Form / Human Form affects the power of Spider Queen.',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Human Form:</span> Elise gains one dormant Spiderling whenever she hits an enemy with an ability, storing once per cast and up to 2 / 3 / 4 / 5 (based on Human Form\'s Rank) at a time. She stores the maximum number of Spiderlings when the game starts and upon respawning.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Spider Form:</span> Elise\'s basic attacks deal 12 / 22 / 32 / 42 (based on Spider Form\'s Rank) (+ 15% AP) bonus magic damage and heal her for 6 / 8 / 10 / 12 (based on Spider Form\'s Rank) (+ 8% AP) on-hit.</p>',
        },
        {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Elise fires a toxin at the target enemy that deals magic damage based on the target\'s current health.',
      castTime: '0.25',
      cooldown: '6',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Elise fires a toxin at the target enemy that deals magic damage, with the damage based on the target\'s health ratio being capped against monsters.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Elise  pounces at the target enemy and deals damage based on the target\'s missing health, applying  on-hit effects.',
      castTime: '0.25',
      cooldown: '6',
      cost: '80 / 85 / 90 / 95 / 100',
      damageType: 'Magic damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Elise pounces at the target enemy with her fangs and bites them, dealing magic damage and applying on-hit effects, as well as revealing them for 0.528 seconds from the start of the cast time. The damage based on the target\'s health ratio is capped against monsters.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Elise sends a Volatile Spiderling to the target location that chases down nearby enemies and explodes upon coming into contact with one or when it expires, dealing magic damage to nearby enemies.',
      castTime: '0.125',
      collisionRadius: '150',
      cooldown: '12',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Elise summons an untargetable venom-gorged spider that lasts for 3 seconds. The spider searches for nearby targets and crawls to them after a delay of 0.75 seconds and otherwise crawls to the target location before doing so without incurring a delay, navigating its path upon encountering terrain.</p>',
        },
        {
          description:
            'The spider gains bonus movement speed based on its proximity to the detected target. When the spider comes into contact with an enemy, or upon expiring otherwise, it instantly explodes to deal magic damage to nearby enemies.',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      blurb:
        'Passive:  Elise\'s Spiderlings gain permanent  bonus attack speed.',
      castTime: 'none',
      cooldown: '12',
      cost: '60 / 70 / 80 / 90 / 100',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Elise\'s Spiderlings gain bonus attack speed.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Elise and her Spiderlings gain bonus attack speed for 3 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Elise fires a web in the target direction, stunning the first enemy hit for a few seconds, during which they are also revealed.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Elise and her Spiderlings lift up into the air over 0.6 seconds, immediately becoming untargetable and unable to act, and afterwards vanishing for up to 1.95 seconds and granting sight of the surrounding 900 units for the duration.</p>',
        },
        {
          description:
            'Rappel can be recast instantly on a target enemy within the duration, or without a target after a delay for the duration, and does the latter automatically after the duration.',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Elise and her Spiderlings reappear and descend onto the ground over 0.4 seconds, becoming targetable and able to act again afterwards. Additionally, Spider Queen\'s bonuses are increased for 5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Spider Queen\'s bonuses are increased.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Toggle:</span> Elise switches between her Human Form and Spider Form.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Spider Form:</span> Elise transforms into a spider, gaining 25 bonus movement speed, melee basic attacks with 125 range, and access to her arachnid abilities. Additionally, she summons all stored Spiderlings and heals them to full health.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Human Form:</span> Elise transforms into a human, gaining ranged basic attacks, and access to her human abilities. Additionally, she stores all active Spiderlings.</p>',
        },
        {
          description:
