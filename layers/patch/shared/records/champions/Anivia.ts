// Updated Patch 16.1 - 01/29/2026 04:26:48 PM CST
  ...
  "abilities": [
    ...
    },
    {
      ...
      "name": "Glacial Storm",
      "affects": "Enemies",
      "blurb": "Passive:  Flash Frost's  slow is increased.",
      "castTime": "none",
      "cooldown": "4 / 3 / 2",
      "cost": "60",
      "damageType": "Magic damage",
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Passive:</span> Flash Frost's slow strength is increased.</p>",
          "leveling": [
            {
              "attribute": "Slow Strength Increase",
              "modifiers": [
                {
                  "unit": "%",
                  "values": "0 / 10 / 20"
        ...
        {
          "description": "Glacial Storm can be recast after 1 second, and does so automatically if Anivia is no longer in range or unable to pay the mana cost, or becomes affected by any form of cast-inhibiting crowd control."
        },
        {
