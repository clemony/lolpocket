                    ...
                    <Collapsible as-child :default-open="true" class="group/collapsible ">
                        <SidebarMenuItem>
                            ...
                            <SidebarMenuButton tooltip="Pockets" class='gap-4 group/pocket'
                                ...
                                <SidebarMenuBadge class='items-center' <Badge variant="primary" size="sm"
                                    v-if="ps.pockets && ps.pockets.length"
                                    class='absolute right-0 group-hover/pocket:opacity-60 px-1.5'>
                                    {{ ps.pockets.length }}
                                    </Badge>
                                </SidebarMenuBadge>
