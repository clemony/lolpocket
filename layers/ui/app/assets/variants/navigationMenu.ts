export default {
  navigationMenu: {
    slots: {
      ...
      childLink: 'group relative size-full flex items-start text-start text-sm before:absolute before:z-[-1] before:rounded-lg focus:outline-none focus-visible:outline-none dark:focus-visible:outline-none focus-visible:before:ring-inset focus-visible:before:ring-2',
      ...
      label: 'h-10 w-full flex text-pc items-center gap-1.5 font-semibold text-xs/5   px-3.5 py-1.5',
      ...
      viewport: 'bg-p0/90 relative overflow-hidden shadow-lg rounded-lg ring ring-p3 h-(--reka-navigation-menu-viewport-height) w-full    z-[1]',
