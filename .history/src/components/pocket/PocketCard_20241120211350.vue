        ...
        <Card
            ...
            <CardContent
                ...
                <div class="relative h-1/2 w-full">
                    <div
                        class="absolute left-1/4 top-2 flex size-fit items-center justify-center rounded-full">
                        <Keystone :pocket="pocket" />
                        <div
                            class="size-full [&_:first-child]:-bottom-[2.5rem] [&_:first-child]:-left-[3.5rem] [&_:last-child]:-bottom-[2.5rem] [&_:last-child]:-right-[3.5rem] [&_:nth-child(2)]:-bottom-[4rem] [&_:nth-child(2)]:left-[0.5rem]">
                            <RuneSet :pocket="pocket" type="runes1" />
                        </div>
                        <div
                            class="z-0 size-full [&_:first-child]:-bottom-[7.1rem] [&_:first-child]:-left-[3.5em] [&_:last-child]:-bottom-[7.1rem] [&_:last-child]:-right-[3.5rem]">
