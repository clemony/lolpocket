...
<template>
    <div
        v-if="pocket"
        class="w-full h-full pt-8 overflow-y-scroll bg-base-200/20 overscroll-none">
        <!-------------------------------- HEADER --------------------------------->
        ...
        <div
            ...
            <button
                class="relative items-center h-full font-normal border-none rounded-md btn btn-xs btn-outline"
        ...
        <div class="z-0 flex flex-col overflow-y-scroll">
            <VueDraggable
                ...
                <label
                    ...
                    :key="set.key"
                    :class="set.primary"
                    class="gradient cursor-pointer pointer-events-auto grid items-center overflow-hidden h-16 overlay z-0 relative transition-all duration-1000 after:z-10 after:h-full after:absolute after:w-[200%] after:right-0 after:bg-gradient-to-r after:from-base-200/30 after:via-base-200 after:via-55% after:to-base-200 odd:after:brightness-[108%] even:after:brightness-[106%] hover:after:-right-1/2 has-[#runeSets:checked]:after:-right-full">
                    <div
                        ...
                        <input
                            ...
                            :value="index"
                            id="runeSets"
                            v-model="pocket.runes[0].selected"
                            class="hidden peer"
                        ...
                        <div
                            ...
                            <img
                                ...
                                class="h-8 rounded-full ring-1 ring-base-300/90 opacity-70 group-hover:opacity-90"
                                id="blank" />
                            <img
                                v-if="
                                    set.secondary != 'none' &&
