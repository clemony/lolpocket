    ...
    <div class="mb-4 grid h-fit w-full gap-4 px-4">
        <div class="flex items-center gap-3">
            ...
            <Button variant="ghost" size="lg"
                class='bg-error text-white text-base justify-start shadow-sm px-5 border border-error hover:bg-error hover:opacity-80 w-40 disabled:bg-inspiration disabled:border-inspiration disabled:text-base-content'
