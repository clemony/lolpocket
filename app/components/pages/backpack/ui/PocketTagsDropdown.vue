...
<template>
  ...
  <Popover v-model:open="open">
    ...
    >
      ...
      >
        <icon name="lucide:tags" class="size-5 opacity-50" />
        <input
          v-model="newTag"
          placeholder="attach new tag"
          class="h-10 w-full pr-4 text-2 transition-all duration-200 placeholder:italic focus:placeholder:opacity-0"
          @keydown.stop
        ...
        <Button
          ...
          @click="newTag = ''"
        >
          <icon name="x-sm" class="size-4 **:stroke-[1.5]" />
        </Button>
      </div>
      <Separator />
      <div
      ...
      >
        ...
        >
          ...
          />
          <icon name="hash" class="size-3.75! text-bc/80" />
