...
<template>
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <div
                class="mask absolute top-0 h-[200px] w-full bg-[20%_25%] bg-no-repeat mask-b-52 [background-size:200%]"
                :style="{
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        class="grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-items-center gap-1 px-3 py-1">
