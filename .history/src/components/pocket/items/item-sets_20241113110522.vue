                ...
                <template #header>
                    ...
                    <div class="-mt-1 flex w-fit items-center gap-1">
                        <InputEditable
                            ...
                            class="items-center border-transparent pr-12 text-start align-baseline !text-base font-medium capitalize transition-all duration-300 focus-within:border-base-200 hover:border-base-200">
                            <div class="flex h-6 w-[35px] items-center gap-1.5">
                                <Button variant="ghost" size="" class="size-7">
                                    <icon
