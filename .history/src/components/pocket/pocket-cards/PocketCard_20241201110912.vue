            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <div
                        ...
                        <div
                            class="flex gap-2 backdrop-blur-sm [&_>*]:grid [&_>*]:!aspect-square [&_>*]:size-11 [&_>*]:place-items-center [&_>*]:justify-start [&_>*]:rounded-full [&_>*]:bg-neutral/70 [&_>*]:text-neutral-content [&_>*]:shadow-sm [&_span]:hidden [&_svg]:mr-px">
                            <Button
                                @click="
