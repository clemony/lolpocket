...
<template>
<ResizablePanelGroup direction="horizontal" class=" h-[calc(100%-125px)] max-h-[calc(100%-30px)] w-full px-4  ">
    ...
    <ResizablePanel class="mt-32 max-h-inherit h-full" id="itemGrid">


        <InfoCard :open="false" class='h-full max-h-inherit'>
            <template #header>
            ...
            <ScrollArea class="overflow-auto h-full max-inherit">
