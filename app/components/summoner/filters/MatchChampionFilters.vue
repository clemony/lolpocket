...
const { bayesianChampions } = state.useChampions()
    ...
    <ListboxContent class="w-full ">
      <transition-slide
        ...
        <ListboxItem
          ...
          :class="{ 'bg-b3/40 border-b3 shadow-xs  inset-shadow-sides bg-noise inset-shadow-b3/10': champion.champion == championModel }">
          <div
        ...
        <LilKrug v-if="!bayesianChampions.length" />
      </transition-slide>
    </ListboxContent>
  </ListboxRoot>
</template>