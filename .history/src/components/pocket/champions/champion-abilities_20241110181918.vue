...
<template>
<Accordion default-value="Q" collapsible class='max-h-min h-[calc(100%-100px)] overflow-hidden flex flex-col flex-1'>
    <AccordionItem v-for="(ability, key) in champion.abilities" :key="key" :value="key"
        ...
        <AccordionContent class='flex overflow-y-auto'>
