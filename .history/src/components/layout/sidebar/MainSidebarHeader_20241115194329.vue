...
<template>
    <SidebarHeader>
        <SidebarMenu class="mt-0 w-full" :class="{ 'items-center': collapsed }">
            <SidebarMenuItem>
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            variant="ghost"
                            size="lg"
                            class="flex size-full shrink-0 flex-nowrap items-center gap-3 !border-0 py-2 ring-0 focus:!border-0 focus:!outline-0"
