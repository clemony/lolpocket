    ...
    <SidebarHeader>
        <SidebarMenu
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            ...
                            <span
                                class="text-base-content mt-px text-lg font-semibold underline-offset-4 opacity-80 group-hover/lol:underline">
                                lolpockets
                            </span>
                            <icon
            ...
            <SidebarMenuItem class="mx-2.5 mt-3 flex flex-row gap-3">
                <SidebarMenuButton
                    size="xs"
                    class="hover-ring-neutral/60 border-base-300/80 bg-b1/50 hover:border-base-300 hover:bg-b1/60 relative h-9 min-h-6! w-full items-center justify-start border px-2 py-1! hover:ring-1"
                    :class="{
                    ...
                    <icon
                        ...
                        class="text-base-content/80 size-[12px]!" />

                    <span
                        class="align-end pt-2px text-base-content/80 grow px-1 text-left">
                        Search
                    </span>
                ...
                <!--                 <SidebarMenuButton class="m-0 mt-2px max-w-fit p-0!" as-child>
                    <Button
                        variant="outline"
                        size="icon"
                        class="m-0 size-8 border-base-300 bg-b1/40">
