...
<template>
    <div class="flex-col content-between justify-between space-y-2">
        <div class="">
            <div
                v-if="a && a.name"
            ...
            <div
                v-else
                class="size-12 shrink-0 rounded-lg border border-base-300/70 bg-base-200/30 p-0 opacity-70 shadow-inner" />
        </div>
        <div class="">
            <div
                v-if="b && b.name"
