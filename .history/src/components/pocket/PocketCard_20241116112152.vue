...
<template>
    <label class="relative size-fit">
        ...
        <div
            ...
            class="absolute rounded-box bg-[20%_-45%] bg-no-repeat animate-in animate-out spin-in-0 spin-out-0 [background-size:200%]">
            <InfoCard
        ...
        <Card
            v-if="flip"
            class="absolute h-[350px] w-[250px] animate-in animate-out spin-in-0 spin-out-0">
            hi
        </Card>
    </label>
</template>
