...
<template>
    <div
        id="icon"
        class="carousel-item grid h-[250px] max-h-[250px] w-full auto-rows-min grid-cols-[1fr_3fr] overflow-hidden duration-500 animate-in animate-out slide-in-from-right-0 slide-out-to-right-full">
        <div>
            <label class="">
