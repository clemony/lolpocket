        ...
        <Card
            ...
            <CardContent
                ...
                <div class="grid w-full px-3">
                    <div class="flex h-fit gap-1 py-4 pl-2">
                        <div class="relative flex items-end">
                            <div
                                class="flex w-full flex-row flex-wrap justify-start gap-x-1.5 gap-y-1 justify-self-start">
                                <MiniItemGrid :pocket="pocket" />
                            </div>
                        </div>

                        <SpellDisplay :pocket="pocket" class="pr-1.5" />
                    </div>
