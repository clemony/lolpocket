...
const spell1 = ref(pocket.spells[0].spell1 as spell) || null
const spell2 = ref(pocket.spells[0].spell2 as spell) || null
console.log(spell2)
const alt1 = ref(pocket.spells[0].alt1 as spell) || null
console.log(alt1)
const alt2 = ref(pocket.spells[0].alt2 as spell) || null
console.log(alt2)
