    ...
    <Card>
        ...
        <CardContent class='h-full pt-3 overflow-hidden'>
            ...
            <div role="tablist" class="tabs tabs-lifted w-[115%] -ml-6">
                <label role="tab" class="tab">Stats
                    <input type='radio' name='tabModel' v-model="tabModel" value="stats" />
                </label>
                <label role="tab" class="tab tab-active drop-shadow-[2px_-2px_1px_#00000005]">Abilties
                    <input type='radio' name='tabModel' v-model="tabModel" value="abilities" />
                </label>
