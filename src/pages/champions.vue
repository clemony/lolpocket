    ...
    <div class="drawer drawer-end">
      ...
      <div class="drawer-content z-10">
        ...
        <div id="" class="">
          ...
          <div class="font-mono italic text-xs text-end px-4 absolute">{{ getQuote }}</div>
          ...
          <div role="tablist" class="tabs layout !mr-0">
            ...
            <input type="radio" name="champ-tabs" role="tab" class="tab after:w-36 font-semibold" :aria-label="getQuote"
              disabled />
