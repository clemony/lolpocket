  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Hwei\'s damaging abilities mark enemies hit for 4 seconds. Subsequent damaging abilities against marked targets consume the mark to create an explosion beneath them, dealing 35 - 230 (based on level) (+ 30% AP) bonus magic damage to enemies in the area after a 0.85-second delay.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Hwei enters a disastrous mood, gaining access to its abilities as well as Wash Brush. He will exit the mood upon casting any of them.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active - QW:  Hwei strikes the target area with a lightning bolt, dealing magic damage to enemies within the area. Isolated or  immobilized enemies are dealt  increased damage based on their missing health.",
      castTime: "0.5",
      cooldown: "10 / 9 / 8 / 7 / 6",
      cost: "80 / 90 / 100 / 110 / 120",
      damageType: "Magic damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - QW:</span> Hwei calls upon a lightning bolt to strike at the target location after 1 second, dealing magic damage to enemies within the area.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active - QE:  Hwei marks a blazing path in a direction that erupts after a delay into explosions. Each explosion deals magic damage and leaves behind a volcanic fissure that continually deals magic damage and  slows enemies within.",
      castTime: "0.35",
      cooldown: "10 / 9 / 8 / 7 / 6",
      cost: "80 / 90 / 100 / 110 / 120",
      damageType: "Magic damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - QE:</span> Hwei marks a blazing path in the target direction. After 0.6 seconds, the path erupts into volcanic explosions every 0.2 seconds from the point of cast. Each explosion creates a shockwave that deals magic damage to nearby enemies.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Hwei enters a serene mood, gaining access to its abilities as well as Wash Brush. He will exit the mood upon casting any of them.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - WE:</span> Hwei surrounds himself in swirling flares that empower his next 3 basic attacks or ability hits within 9 seconds to each deal bonus magic damage and restore mana.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Hwei enters a tumultuous mood, gaining access to its abilities as well as Wash Brush. He will exit the mood upon casting any of them.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active - EQ:  Hwei launches a terrifying grin in the target direction that deals magic damage to the first enemy hit,  knocking them down and  fearing and  slowing them.",
      castTime: "0.25",
      cooldown: "13 / 12.5 / 12 / 11.5 / 11",
      cost: "50 / 55 / 60 / 65 / 70",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - EQ:</span> Hwei launches a terrifying grin in the target direction that deals magic damage to the first enemy hit, knocks them down, and fears them for a duration, as well as slows them by 60% for the same duration.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active - EE:  Hwei summons a jaw at the target location that snaps, dealing magic damage to all enemies in the area and applying a decaying  slow to them. Enemies that are not standing at the center of the jaw when it snaps are  pulled there.",
      castTime: "0.35",
      cooldown: "13 / 12.5 / 12 / 11.5 / 11",
      cost: "50 / 55 / 60 / 65 / 70",
      damageType: "Magic damage",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - EE:</span> Hwei conjures a jaw at the target location that snaps after 0.6 seconds, dealing magic damage to enemies in the area and slowing them by an amount that decays over 1.25 seconds. Enemies that are not standing at the center when the jaw snaps are pulled there.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Hwei launches a globule in the target direction that collides with the first enemy  champion hit, afflicting them with an aura that grows over a few seconds. Enemies within are continually dealt magic damage and gradually  slowed.",
      castTime: "0.25",
      cooldown: "140 / 115 / 80",
      cost: "100",
      damageType: "Magic damage",
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Despair:</span> For each stack, the target is slowed by 10% for 0.25 seconds, stacking up to 12 times.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active - QR, WR, ER:</span> Hwei exits his current mood without incurring its ability cost or cooldown.</p>',
        },
        {
          description:
