...
<template>
  <MenubarCheckboxItem
    v-bind="forwarded"
    :class="
      cn('relative flex cursor-default items-center gap-2.5 rounded-sm px-2 py-1.5 text-2 font-medium outline-none select-none focus:bg-b2 focus:text-bc data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
