        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        v-if="set"
                        class="col-start-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-center justify-items-center gap-x-2 gap-y-2 rounded-box border border-base-200/60 p-1.5 shadow-sm">
