    ...
    <div class="z-0 w-full bg-clip-border transition-all duration-500">
        <div
            ...
            <label
                ...
                :key="index"
                class="border-base-100 z-30 flex grow cursor-pointer items-center justify-center overflow-hidden border-b-0 border-b-transparent bg-clip-padding py-1 transition-all duration-500 disabled:hidden has-checked:-translate-y-2.5 has-disabled:absolute has-disabled:size-0 has-disabled:opacity-0"
                :ref="path">
                <input
                    v-if="props.set == 1"
                    class="peer hidden"
...
.none {
    ...
    [data-tier='3'] {
        ...
        #imgwrap {
            @apply border-neutral/15 bg-base-200/20 size-[2.8rem] rounded-full border shadow-[inset_1px_3px_2px_1px_#00000008] transition-all duration-500;
        }
        img {
            @apply aspect-square scale-110 rounded-full object-cover shadow-inner;
        }
