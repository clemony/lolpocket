...
<template>
  <Sheet>
    ...
    <SheetContent
      side="right"
      class="w-120 min-w-120  pt-9 !border-l-accent/30  flex flex-col  gap-6 h-full">
      <HiddenDialogHeader
      ...
      <template v-if=" account">
        ...
        <Field>
          <Btn
            class=" justify-start  btn-lg !font-medium"
            @click="navigateTo('')">
            <icon
              name="flowbite:clock-arrow-outline"
              class=" " />
            Match History
          </Btn>
        </Field>
        ...
        <AccountUtilities :account="account" />
      </template>
