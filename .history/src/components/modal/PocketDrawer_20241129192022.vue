...
<template>
    <div class="relative w-full justify-center py-2">
        <form
            class="flex w-full gap-12 py-4 [&_label]:text-base"
            @submit.prevent.stop="submitForm">
            <div class="flex w-1/2 gap-6">
                <div ref="elForm" class="ml-px flex w-full flex-col gap-2 pl-4">
            ...
            <DialogFooter class="absolute -bottom-12 left-0 w-full px-12 py-5">
                <DialogClose>
                    <Button
                        @click="submitForm"
                        v-if="!gs.modalPocket"
