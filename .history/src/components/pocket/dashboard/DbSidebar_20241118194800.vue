        ...
        <Card class="shadow-smooth">
            <CardContent class="h-36 overflow-hidden rounded-lg p-0">
                ...
                <div v-else class="size-full items-center justify-center">
                    <p
                        class="size-full items-center whitespace-pre-line px-12 text-right align-middle font-serif text-lg italic first-letter:font-bold first-letter:not-italic">
                        {{ formattedQuote() }}
                    </p>
                </div>
            </CardContent>
