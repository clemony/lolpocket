...
<template>
<div class='max-w-48 [&_Button]:gap-3 [&_Button]:justify-start [&_Button]:w-full *:text-sm'>
    ...
    <VDropdown theme="hoverdd" placement="right-start" :disabled="!ps.pockets.length">
        <Button variant="ghost" size="xs">
            ...
            <span class='-ml-[2px] capitalize'>Copy {{ props.type }}<span class='lowercase'>s to...</span></span>
