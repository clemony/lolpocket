...
<template>
  <div class="items-center w-screen h-screen pt-(--navbar-height) flex flex-col relative overflow-hidden">
    <slot name="backdrop" />
    ...
    <motion.div
      ...
      <Separator class="my-0 bg-linear-to-r from-b2 from-30% to-b3 h-[2px] absolute bottom-0 left-0 w-full" />
    </motion.div>
