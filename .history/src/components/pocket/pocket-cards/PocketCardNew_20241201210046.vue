                        ...
                        <CardContent
                            ...
                            <div
                                ...
                                <div
                                    :class="
                                        cn(
                                            'before:bg-base-100after:shadow-smooth z-0 h-36 w-[90%] !overflow-hidden rounded-md before:absolute before:left-1 before:top-2 before:isolate before:z-10 before:size-16 before:rounded-full after:ring-1 after:ring-neutral',
                                            {
