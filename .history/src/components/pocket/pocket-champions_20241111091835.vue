    ...
    <template #panel1>
        ...
        <Card class='mt-9 max-h-[calc(100%-300px)] h-[calc(100%-300px)]  overflow-hidden'>
            ...
            <CardHeader
                ...
                <Grow />
                <FilterButtons @update:dataValue="(v) => dataValue = v" :data="ds.uniqueClass" text="Class / Role"
                    @update:viewLoved="(v) => is.viewLoved == v" :loved="is.lovedItems" v-model:viewLoved="is.viewLoved"
