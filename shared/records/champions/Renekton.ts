  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Renekton's basic attacks and ability hits generate  Fury on-hit, which continually expires after a period without fighting. He generates bonus Fury while below half health.",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Renekton\'s basic attacks against any enemy except structures generate 5 Fury on-hit. After 12 seconds of not generating any Fury, he loses 1 Fury every 0.25 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        "Active:  Renekton cleaves around himself, dealing physical damage to nearby enemies. He also generates Fury and  heals for each enemy hit, increased against  champions.",
      castTime: "none",
      cooldown: "7",
      cost: "0",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Renekton cleaves around himself, dealing physical damage to nearby enemies and healing himself for each enemy hit, up to a cap.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Reign of Anger Bonus:</span> Cull the Meek has increased damage, tripled total healing, and a quadrupled healing cap.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies / Self",
      blurb:
        "Active:  Renekton's next basic attack within a few seconds will strike twice, dealing modified physical damage and briefly  stunning the target.",
      castTime: "none",
      ...
      effects: [
        ...
        {
          description:
            "Ruthless Predator's first strike can critically strike for (75% + 40%) AD bonus physical damage.",
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Reign of Anger Bonus:</span> Renekton instead strikes 3 times, completely destroying damage-mitigating shields on the target upon the first strike if they are not a monster, as well as increasing the stun duration to 1.5 seconds.</p>',
          leveling: [
            {
              attribute: "Total Physical Damage",
              modifiers: [
        ...
        {
          description:
            "Ruthless Predator resets Renekton's basic attack timer. After Ruthless Predator's standard and empowered attack cast time, Renekton cannot move nor cast Cull the Meek, Slice, nor Dice for 0.528 seconds. Casting Dominus ends this lockout prematurely.",
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Renekton  dashes in the target direction, dealing physical damage to enemies he passes through.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Renekton dashes a fixed distance in the target direction, dealing physical damage to enemies he passes through.</p>',
          leveling: [
            {
              attribute: "Physical Damage",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Renekton dashes a fixed distance in the target direction, dealing the same physical damage to enemies he passes through.</p>',
          leveling: [
            {
              attribute: "Total Physical Damage",
              modifiers: [
        ...
        {
          description:
            "Both Slice and Dice generate 2 Fury for each non-champion hit and 10 Fury for each champion hit, up to 30 total per cast.",
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Reign of Anger Bonus:</span> Dice deals bonus physical damage and inflicts armor reduction to enemies hit for 4 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies / Self",
      blurb:
        "Active:  Renekton empowers himself for some time, gaining Fury,  bonus health, bonus size,  bonus attack range, and increased area on  Cull the Meek.",
      castTime: "0.25",
      cooldown: "120 / 100 / 80",
      cost: "0",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Renekton empowers himself for 15 seconds, gaining bonus health, 20% increased size, 25 bonus attack range, and 20 Fury, as well as increasing Cull the Meek\'s effect radius.</p>',
          leveling: [
            {
