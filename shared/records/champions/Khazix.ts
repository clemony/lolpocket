...
const champion: Champion = {
  ...
  "abilities": [
    ...
    },
    {
      ...
      "affects": "Enemies",
      "blurb": "Passive: Isolated targets are marked by an indicator shown to Kha'Zix.",
      "castTime": "0.25",
      "cooldown": "4",
      "cost": "20",
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Passive:</span> Isolated targets are marked by an indicator shown to Kha'Zix.</p>"
        },
        {
      ...
      "notes": "The isolation indicator is independent of the actual effects and its timing may not be fully accurate.\nIf the target becomes  untargetable,  dies, or is too far away or no longer in  sight during the cast time, this ability will cancel but does not go on  cooldown nor pay its cost (if applicable).",
      "resource": "Mana",
    ...
    },
    {
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Passive:</span> Each rank in Void Assault allows Kha'Zix to evolve one of his abilities, granting it additional effects. Evolving an ability causes him to enter a 2-second cast time.Kha'Zix cannot evolve while he is affected by cast-inhibiting crowd control or a lockout that disables abilities.</p>"
        },
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Active:</span> Kha'Zix becomes invisible for 1.25 seconds, during which he gains 40% bonus movement speed. Attacking or casting abilities ends the stealth immediately.</p>"
        },
        {
