  ...
  abilities: [
    {
      ...
      blurb:
        'Innate:  Bel\'Veth\'s attack speed cap is greatly increased, but her  attack speed does not grow by  leveling up. The damage dealt by her  basic attacks (including  on-hit effects) is reduced.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Bel\'Veth attacks 36% faster than the median champion and her attack speed cap is modified to 9999.0, but all sources of damage (including on-hit damage) dealt by her basic attacks are reduced to 75%. Her attack speed does not increase through growth (per level).</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Bel\'Veth\'s ability casts each generate 2 stacks of Death in Lavender, lasting for 5 seconds, refreshing on basic attacks and subsequent casts, and stacking up to 6 times. While Bel\'Veth has stacks, she becomes ghosted and gains 20% - 40% (based on level) bonus attack speed. Her basic attacks each consume 1 stack.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Whenever Bel\'Veth scores a takedown against a champion, monster, or large minion within 3 seconds of damaging them, she generates a permanent stack of Lavender. Large minions and monsters generate 1 stack, champions and epic monsters generate 2 stacks.</p>\n<p class="ability-effect"><span class="ability-header">Lavender:</span> For each stack, Bel\'Veth gains 0.28% - 1.1% (based on level) bonus attack speed.</p>',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bel\'Veth dashes in the designated direction, though not through terrain, dealing physical damage to enemies she passes through. Against the first target, Void Surge can critically strike for (175% + 40%) damage and applies on-hit effects, with on-hit damage reduced to 75% effectiveness, and life steal at 100% effectiveness.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Bel\'Veth slams her tail in the target direction that deals magic damage to enemies hit, briefly  knocking up and  slowing them.',
      castTime: '0.5',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bel\'Veth slams her tail down in the target direction that deals magic damage to enemies hit, knocks them up for 0.75 seconds, and slows them by 50% for a duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bel\'Veth enters a defensive stance for 1.5 seconds, during which she is unable to move, but gains damage reduction and 20% (+ 100% life steal) life steal.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Bel\'Veth ends Royal Maelstrom.</p>',
        },
        {
          description:
