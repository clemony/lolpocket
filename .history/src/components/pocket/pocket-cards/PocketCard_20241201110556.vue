            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <div
                        ...
                        <div
                            class="flex gap-2 backdrop-blur-sm [&_>*]:!aspect-square [&_>*]:size-11 [&_>*]:justify-start [&_>*]:rounded-full [&_>*]:bg-neutral/70 [&_>*]:p-2px [&_>*]:text-neutral-content [&_>*]:shadow-sm [&_span]:hidden">
                            <Button
                                @click="
