  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Neeko has a collection of disguises to take on the appearance of allied champions. She can choose a new champion to switch her disguise or select herself to deactivate her disguise. Standing near a non-champion unit will collect its Sho'Ma, adding its disguise to the collection. She can collect only one Sho'Ma, but can discard or consume it.",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Neeko has a collection of disguises to take on the appearance of allied champions. She can choose a new champion to switch her disguise or select herself to deactivate her disguise, placing Inherent Glamour on a 0.5-second cooldown. Taking damage from a champion or turret puts Inherent Glamour on a 2-second cooldown.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Standing by the nearest visible allied or neutral non-champion non-structure unit while not disguised will gather its Sho\'Ma over 2 seconds, adding its disguise to the collection. Activating this disguise places Inherent Glamour on a 1-second cooldown. Neeko can collect only one Sho\'Ma, but can discard or consume it. She can store Sho\'Ma from the following units, so long as they are targetable:</span></p>\n\nNon-epic monsters\n Minions\n Traps\n Wards\n Pets\nJungle plants',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">While disguised, Neeko can use basic attacks while keeping her form. Her disguise breaks if she:</span></p>\n\nuses a damaging ability, summoner spell, or item active\nis immobilized\ntakes damage lethal to the disguised form\nis in the enemy spawn platform\nbegins a channel other than Recall and Empowered Recall\ndeals damage to a structure with a non-champion disguise form\n dies',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Neeko tosses a seed that blooms at the target location, dealing magic damage to nearby enemies.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Passive:  Neeko's  basic attacks  on-hit generate  stacks of Shapesplitter. At 2 stacks, her next basic attack will consume them all to become  non-projectile, deal bonus magic damage, and briefly grant her  bonus move speed.",
      castTime: "none",
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Neeko creates a clone of her current form, after which they both instantly become invisible for 0.5 seconds and gain bonus movement speed for 3 seconds. Shapesplitter can be recast at any time while the clone is active.</p>',
          leveling: [
            {
              attribute: "Bonus Movement Speed",
              modifiers: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Neeko sends her clone to the target location if it is not playing an emote or Recall animation.</p>',
        },
      ],
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Neeko slings a magical spiral in the target direction that deals magic damage and  roots enemies hit.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Neeko slings a magical spiral in the target direction that deals magic damage to enemies hit and roots them for a duration.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Neeko winds up spiritual essence over 1.25 seconds and highlights an area around herself, which is visible to enemies unless she is disguised. If Neeko is in a disguise, it will break after 0.5 seconds into the duration.</p>',
        },
        {
          description:
