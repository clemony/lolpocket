...
<template>
  <label
    :class="cn('h-full rounded-full overflow-hidden transition-all duration-300 relative size-17  grid place-items-center aspect-square ', {
    ...
    <img
      ...
      :class="cn('transition-all duration-300 bg-b3/80 rounded-full size-full', { 'scale-108 ': loaded })"
      @load="loaded = true" />
  </label>
</template>