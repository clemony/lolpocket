...
<template>
  ...
  >
    <!-- thumbnails -->
    <Carousel
      class="sticky -top-10 z-1 flex w-full flex-shrink-1 items-center justify-center gap-2 bg-b1/60 mask-x-from-transparent mask-x-from-0% mask-x-to-black mask-x-to-10% py-4 backdrop-blur-md"
      :opts="{ loop: true }"
