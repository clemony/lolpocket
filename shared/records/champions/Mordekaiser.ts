  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Mordekaiser\'s basic attacks are empowered to deal 40% AP bonus magic damage on-hit.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Mordekaiser generates a stack for each enemy champion or large monster hit by his damaging basic attacks or basic abilities, lasting for 4 seconds, refreshing on subsequent hits, and stacking up to 3 times. At 3 stacks, he gains Darkness Rise.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Darkness Rise:</span> Mordekaiser gains 3% / 6% / 9% (based on level) bonus movement speed and deals[ 5 (+ 30% AP) (+ 1% - 5% (based on level) of target\'s maximum health) magic damage every second ][ 0.625 (+ 3.75% AP) (+ 0.13% - 0.63% (based on level) of target\'s maximum health) magic damage every 0.125 seconds ]to nearby enemies. Against monsters, the damage is capped at[ 40 - 200 (based on level) per second. ][ 5 - 25 (based on level) per 0.125 seconds. ]</p>',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/Mordekaiser/ability-icon/p',
      notes:
        'Mordekaiser has a stack counter under his health bar that is not visible to other champions. It will light up when the maximum effect is active.\nDarkness Rise\'s area damage alone does not refresh Darkness Rise\'s buff.\nIf Darkness Rise is activated through either  Obliterate or  Death\'s Grasp, Mordekaiser will only receive 2 stacks of  Conqueror instead of the expected 4 stacks.(bug)',
      spellEffects: 'aoedot',
      targeting: 'Passive',
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Mordekaiser strikes his mace down in a line in the target direction, dealing magic damage to enemies within, increased if only one enemy is hit.</p>',
          leveling: [
            {
      ...
      maxCharges: -1,
      notes:
        'This ability will cast from wherever the caster is at the end of the cast time.\nThe ability will cast to wherever the caster\'s cursor was at the start of cast time.\nThe visual effect of Obliterate is formed in the original direction of the cast, while Mordekaiser\'s mace appears to slam in his facing direction. Neither of these portray the spell\'s effect accurately if Mordekaiser\'s location changes during the cast time.(bug)\nApplies  spell damage if it hits one target and  area damage to multiple targets.\nObliterate\'s damage against isolated enemies at:\nRank 1: 104 : 162.5 (based on level) (+ 91% AP)\nRank 2: 155.25 : 216 (based on level) (+ 94.5% AP)\nRank 3: 210 : 273 (based on level) (+ 98% AP)\nRank 4: 268.25 : 333.5 (based on level) (+ 101.5% AP)\nRank 5: 330 : 397.5 (based on level) (+ 105% AP)',
      projectile: 'FALSE',
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Mordekaiser gains magic penetration.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Mordekaiser summons a claw in the target direction that grants sight of the area. After 0.5 seconds, it deals magic damage to enemies within and pulls them 250 units.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
