                    ...
                    <Card
                        ...
                        <CardContent
                            ...
                            <div class="n flex w-full justify-center">
                                <div class="size-fit overflow-hidden">
                                    <div
                                        :class="
                                            cn(
                                                'border-box z-0 h-36 w-[90%] rounded-md after:absolute after:-left-4 after:-top-8 after:size-18 after:rounded-full after:border after:bg-base-100',
                                                {
