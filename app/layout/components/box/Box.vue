...
<template>
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            <Button variant="ghost" size="icon" :disabled="!mail">
              <icon name="pin" class="size-4.75 **:stroke-[2]" />
 ...
 -->
        ...
        <Tooltip>
          <TooltipTrigger as-child>
            <Button variant="ghost" size="icon" :disabled="!mail">
              <icon name="archive" class="size-4.5" />
        ...
        <Tooltip>
          <Popover>
            <PopoverTrigger as-child>
              <TooltipTrigger as-child>
                <Button variant="ghost" size="icon" :disabled="!mail">
                  <icon name="history" class="size-4.5" />
            ...
            <PopoverContent class="flex w-[535px] p-0">
              <div class="flex flex-col gap-2 border-r px-2 py-4">
                <div class="px-4 text-2 font-medium">Snooze until</div>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          <Button variant="ghost" size="icon" :disabled="!mail">
            <icon name="more-vertical" class="size-4.5" />
    ...
    <div v-if="mail" class="flex flex-1 flex-col">
      <div class="flex items-start p-4">
        ...
        <div v-if="mail.date" class="ml-auto text-2 text-bc/60">1/12/2046</div>
      </div>
      <Separator />
    ...
    <div v-else class="p-8 text-center text-bc/60">No message selected</div>
  </div>
</template>
