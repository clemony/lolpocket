...
<template>
    <label class="swap swap-flip relative h-[350px] w-[250px]">
        ...
        <Card
            ...
            <CardContent
                class="size-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100 to-30% pt-4">
                ...
                <div
                    class="grid w-full grid-flow-row auto-rows-auto grid-cols-3 justify-center justify-items-center gap-3">
