    ...
    <SidebarHeader>
        <SidebarMenu
            ...
            <SidebarMenuItem class="mx-2">
                <SidebarMenuButton
                    class="relative h-9 w-full items-center justify-start border border-base-300/80 bg-base-100/60 px-2 hover:cursor-text hover:border-base-300 hover:bg-base-100/60"
                    :class="{
