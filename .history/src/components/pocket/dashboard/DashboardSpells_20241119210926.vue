...
const spell1 = ref(props.pocket.spells[0].spell1) as spell
console.log(spell1)
const spell2 = ref(props.pocket.spells[0].spell2) as spell
console.log(spell2)
const alt1 = ref(props.pocket.spells[0].alt1) as spell
console.log(alt1)
const alt2 = ref(props.pocket.spells[0].alt2) as spell
console.log(alt2)
    ...
    <DisplayCard class="relative">
        <div class="grid grid-cols-3 px-5 pb-4" ref="el">
            ...
            <div class="items-center justify-self-end">
                <SpellPicker
                    v-model:model="spell1.value"
                    :arr="spellArr"
                    @update:model="(e) => (spell1 = e)"
                    :target="el"
                    :pocket />
            </div>
            <div class="items-center justify-self-end">
