...
<template>
    ...
    <SidebarProvider>
        <Sidebar
            collapsible="icon"
            class="justify-center before:absolute before:top-0 before:size-full before:rounded-2xl before:border-[6px] before:border-base-100/70 before:border-r-base-100/50"
            variant="floating">
            <MainSidebarHeader />
