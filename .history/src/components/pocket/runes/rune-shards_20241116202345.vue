...
const shard1 = ref('none')
const shard2 = ref('none')
const shard3 = ref('none')
function updateShards(slot, shard) {
    slot == 1 ? (shard1.value = shard)
    : slot == 2 ? (shard2.value = shard)
    : slot == 3 ? (shard3.value = shard)
    : ''

    pocket.value.runes[0].runeSets[model].shards = [
        shard1.value,
        shard2.value,
        shard3.value,
    ]
        ...
        <div
            ...
            <label
                ...
                <input
                    ...
                    v-model="shard1"
                    class="peer hidden"
                    @change="updateShards(set.slotID, shard)" />
