...
<template>
    <div v-if="pocket" :key="pocket.key" class="flex flex-col">
        ...
        <ul
            class="mt-6 flex h-9 items-center px-1 before:absolute before:h-9 before:w-[55px] before:rounded-md before:border before:border-base-200 before:bg-base-100 before:opacity-90 before:shadow-smooth [&_li]:z-10 [&_li]:w-20">
            <li>
                <label>Spells</label>
            </li>
            <li>
