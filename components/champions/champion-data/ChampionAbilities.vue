...
<template>
  <div class="flex gap-10 w-full">
    <div class="grid  gap-3 h-104 justify-between">
      <label v-tippy="champion.passive.name" class="aspect-square size-18 rounded-lg shadow-sm drop-shadow-sm relative cursor-pointer inset-shadow-sm">
      ...
      <label v-for="(ability, i) in spells" :key="i" v-tippy="ability.name" class="aspect-square size-18 rounded-lg shadow-sm drop-shadow-sm cursor-pointer inset-shadow-sm">
        <Image
