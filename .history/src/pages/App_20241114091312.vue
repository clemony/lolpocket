...
function toggleState(modalData) {
...
<template>
    <div 
     v-shortkey.once="['meta', 'n']"
        @shortkey="toggleState(newPocketModal)"
    class="open-new-pocket">
    </div>
    <div 
         v-shortkey.once="['meta', 'k']"
        @shortkey="toggleState(commandModal)" class="open-command">
    </div>

    <Modal v-model:open="gs.modalState" v-model:modal="modal" />
    <Titlebar />
    <Toaster />
    <SidebarProvider>
        <Sidebar collapsible="icon" class="justify-center">
            <MainSidebarHeader
                ...
                v-model:modal="modal"
                @update:state="toggleState(modal)" />
            ...
            <div
                ...
                <router-view v-slot="{ Component }">
                    <KeepAlive
                        ...
                        <component :is="Component" ref="currentComponent" @update:modalState="(modal) => toggleState(modal)"/>
                    </KeepAlive>
                </router-view>
            </div>
        </SidebarInset>
