...
<template>
    <div class="carousel flex w-full justify-center gap-2 py-2">
    <div id="form" class="carousel-item">


        <form
            ref="form"
            class="grid grid-cols-[4fr_1.5fr_2fr] gap-10 py-4 [&_label]:text-base"
    ...
    <div   class="carousel-item grid h-[250px] max-h-[250px] w-full auto-rows-min grid-cols-[1fr_3fr] overflow-hidden duration-500 animate-in animat
                    <IconPicker
                v-model:selectedIcon="selectedIcon"
                v-model:bgColor="bgColor"
                v-model:iconColor="iconColor"
                v-model:isShown="showIconPicker"
                @update:isShown="(v) => (showIconPicker = v)" />
    </div>
</template>
