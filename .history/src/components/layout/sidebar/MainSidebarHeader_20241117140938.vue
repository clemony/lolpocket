...
<template>
    <SidebarHeader>
        <SidebarMenu
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            variant="ghost"
                            size="md"
                            class="group/lol flex size-full shrink-0 flex-nowrap items-center gap-3 rounded-none !border-0 pb-3 ring-0 hover:bg-transparent focus:!border-0 focus:!outline-0 active:!bg-transparent active:hover:!bg-transparent data-[state=open]:[&_span]:underline"
                            :class="{ 'px-3': !collapsed }">
                            <div
                                class="flex aspect-square size-8 shrink-0 items-center justify-center rounded-md bg-neutral text-neutral-content/90 shadow-sm">
            ...
            <SidebarMenuItem
                class="mx-2.5 mt-1 flex flex-row gap-3"
                :class="{
                    'pr-4': !collapsed,
                }">
                <SidebarMenuButton
                ...
                <!--                 <SidebarMenuButton class="m-0 mt-2px max-w-fit !p-0" as-child>
                    <Button
                        variant="outline"
                        size="icon"
                        class="m-0 size-8 border-base-300 bg-base-100/40">
