...
const General = useTemplateRef('GeneralSettings')

const Appearance = useTemplateRef('AppearanceSettings')

const Account = useTemplateRef('AccountSettings')

const Hotkeys = useTemplateRef('HotkeySettings')

const Storage = useTemplateRef('StorageSettings')
