...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      blurb:
        "Active:  Master Yi briefly  vanishes and marks the target enemy, then rapidly marks up to 3 other nearby enemies. If there are no other eligible targets before then, Master Yi can mark the same enemies again.",
      castTime: "none",
      ...
      effects: [
        ...
        {
          description:
            "Master Yi then detonates the marks to deal physical damage and apply on-hit effects, with on-hit damage reduced to 75% effectiveness. Marks after the first on the same target instead detonate instantly upon application to deal 25% damage and apply on-hit effects, with on-hit damage reduced to 18.75% effectiveness. Alpha Strike deals bonus physical damage to monsters per hit.",
          leveling: [
            {
        ...
        {
          description:
            "Alpha Strike's primary and lesser damage can critically strike for[ (175% + 40%) and (43.75% + 10%) damage respectively. ][ 100% + 100% of bonus critical damage damage, reduced to 25% for the lesser damage. ]",
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Master Yi channels for up to 4 seconds, healing himself every 0.5 seconds, increased by 0% - 100% (based on missing health).</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Master Yi empowers his basic attacks within the next 5 seconds to deal bonus true damage on-hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Passive: Scoring a champion  takedown massively  reduces the current cooldowns of  Master Yi's basic abilities.",
      castTime: "none",
      cooldown: "85",
      cost: "100",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Scoring a champion takedown reduces the current cooldowns of Master Yi\'s basic abilities by 70%.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Master Yi cleanses himself from all slows and cripples. For the next 7 seconds, he gains ghosting, bonus attack speed, bonus movement speed, slow immunity, and cripple immunity.</p>',
          leveling: [
            {
