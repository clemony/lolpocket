    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-8 items-center'>
            <div class='relative w-fit'>
                <div class='join join-vertical rounded-lg shadow-sm '>
                    <div class='size-[70px] overflow-hidden join-item border-neutral border-2 grid place-items-center'>
                        <loadImg class=" size-[70px] scale-[108%] mr-1   aspect-square object-center shrink-0"
                            :url="`/img/champions/${clean(champion.name)}.webp`" />
                    </div>

                    <div class='join-item join join-horizontal w-full h-8'>
                        <VTooltip theme="tt" placement="bottom" class="w-1/2 overflow-hidden " alt="view on Wiki">

                            <a :href="champion.wiki" target="_blank">
                                <Button variant="neutral"
                                    class="items-center justify-center join-item size-full  group">
                        ...
                        <Button variant="neutral"
                            class="group/liked w-1/2 border-2 border-neutral join-item [&_svg]:absolute !apsect-square rounded-full [&_svg]:transition-all [&_svg]:duration-500 [&_svg]:pt-px [&_svg]:size-5"
