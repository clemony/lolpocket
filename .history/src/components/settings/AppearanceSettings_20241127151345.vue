        ...
        <div class="grid w-full grid-cols-3 gap-6 *:size-full">
            <DisplayCard
                ...
                <label
                    ...
                    <div
                        class="border-b3 bg-b1 text-base-content shadow-warm h-20 w-full cursor-pointer overflow-hidden rounded-xl border"
                        ...
                        <div class="grid h-full w-full grid-cols-[1fr_4fr]">
                            ...
                            <div
                                ...
                                <div
                                    class="color-chip bg-b2 text-base-content"></div>
                                <div
                                    class="color-chip bg-b3 text-base-content"></div>
                                <div
