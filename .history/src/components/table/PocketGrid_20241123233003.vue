...
[col-id='dateUpdated'] {
    ...
    & .ag-header-cell-label {
        @apply relative rotate-90 pl-3 text-2xl leading-none tracking-[-5px] before:absolute before:top-0.5 before:-ml-1 before:-rotate-90 before:text-4xl before:content-['⟳'];
    }
}
