...
<PopoverPortal>
    <PopoverContent @openAutoFocus.prevent
        class='bg-transparent p-0 border-none shadow-none animate-in fade-in-0 duration-1000'>
        <PopoverClose class='absolute -top-96 -left-96 w-screen h-screen bg-black/20  scale-150  '>


            <PopoverContent
                class=' !rounded-box relative px-7 py-5 bg-transparent p-0 border-none shadow-sm animate-in fade-in-0 duration-1000'
                align="start" :align-offset="-34" side="bottom" :side-offset="-146" @openAutoFocus.prevent :style="{
