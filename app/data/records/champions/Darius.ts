    ...
    "Q": [
      {
        ...
        "effects": [
          ...
          {
            "description": "Against champions and large monsters hit, Darius heals for 15% - 45% (based on number of targets hit by the outer radius) of his missing health. Enemies hit by the inner radius do not refresh the duration of or gain a new stack of Hemorrhage."
          },
          {
