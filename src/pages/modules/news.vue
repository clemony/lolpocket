...
<template>
  <div
    class="flex w-full pr-11 ml-5 absolute overflow-x-scroll h-64 content-center items-center gap-5 top-28 scrollbar-hide left-0 !z-1 pl-[286px] transition-all duration-1000 news-after">
