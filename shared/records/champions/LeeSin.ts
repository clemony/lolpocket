  ...
  abilities: [
    {
      ...
      affects: 'Self',
      blurb:
        'Innate: After  Lee Sin casts an ability, his next 2 basic attacks within a short time gain  bonus attack speed and restore  energy.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> After casting an ability, Lee Sin\'s next 2 basic attacks within 3 seconds gain 40% bonus attack speed and restore energy.</p>',
        },
        {
          description:
            'The first attack restores 20 / 30 / 40 (based on level) energy and the second attack restores[ 10 / 15 / 20 (based on level) energy. ][ half of the previous amount. ]',
        },
      ],
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lee Sin fires a sonic blast in the target direction that deals physical damage to the first enemy hit and marks them for a short time, during which they are  revealed.',
      castTime: '0.25',
      cooldown: '10 / 9 / 8 / 7 / 6',
      cost: '50',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin fires a sonic blast in the target direction that deals physical damage to the first enemy hit and marks them for 3 seconds, during which they are revealed.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lee Sin  dashes to the nearby enemy marked by  Sonic Wave, consuming the mark upon arrival to deal physical damage based on the target\'s missing health.',
      castTime: 'none',
      cooldown: '10 / 9 / 8 / 7 / 6',
      cost: '50',
      damageType: 'Physical damage',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin dashes to the nearby enemy marked by Sonic Wave. Upon arrival, he consumes the mark and deals physical damage, increased by 0% - 100% (based on target\'s missing health).</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      name: 'Safeguard',
      blurb:
        'Active:  Lee Sin  dashes to the target allied unit. If the ally is a  champion, both they and Lee Sin gain a  shield for a short time upon his arrival and Safeguard\'s cooldown is  halved.\nLee Sin can self-cast Safeguard to shield himself.',
      castTime: 'none',
      cooldown: '12',
      cost: '50',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin dashes to the target allied unit\'s location. If the ally is a champion upon arrival, both they and Lee Sin gain a shield for 2 seconds and Safeguard\'s cooldown is halved.</p>\nLee Sin can self-cast Safeguard to shield himself.',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Lee Sin gains  life steal and  spell vamp for a few seconds.',
      castTime: 'none',
      cooldown: '12',
      cost: '50',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin gains life steal and spell vamp for 4 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lee Sin deals magic damage to nearby enemies, marking them for a few seconds and, if they are not  invisible when struck,  revealing them.',
      castTime: '0.25',
      cooldown: '8',
      cost: '50',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin smashes the ground beneath him, dealing magic damage to nearby enemies, marking them for 4 seconds and, if they are not invisible when struck, revealing them for the same duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lee Sin sends a wave to nearby enemies marked by  Tempest, inflicting a decaying  slow that lasts a few seconds.',
      castTime: 'none',
      cooldown: '8',
      cost: '50',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin slows nearby enemies marked by Tempest, decaying over 4 seconds.</p>',
          leveling: [
            {
              attribute: 'Slow',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Lee Sin  roots the target enemy  champion and roundhouse kicks them, dealing physical damage and  knocking them back.',
      castTime: '0.25',
      collisionRadius: '160',
      cooldown: '110 / 85 / 60',
      cost: '0',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Lee Sin roots the target enemy champion over the cast time, then roundhouse kicks them to deal physical damage and knock them back up to 800 units over 0.8 seconds, rendering them airborne for 1 second.</p>',
          leveling: [
            {
              attribute: 'Physical Damage',
              modifiers: [
