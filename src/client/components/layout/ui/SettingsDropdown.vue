...
<template>
    <MenubarItem class="p-0 font-normal">
        <div class="text-2 flex items-center gap-2 px-1 py-1 text-left">
    ...
    <MenubarItem
        ...
        <icon icon="material-symbols:power-settings-new" class="ml-px size-4" />
        Quit
