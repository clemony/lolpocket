...
<template>
    <Card
        ...
        <CardHeader
            :class="
                cn(
                    'absolute z-20 w-full bg-base-100/95 px-8 pt-0 backdrop-blur-md transition-all duration-200',
                    { 'py-5': isAnchorVisible, 'py-2': !isAnchorVisible },
                    props.headerClass
                )
            ">
            <Collapsible
        ...
        <CardContent class="px-0 pb-0">
            <ScrollArea
                ...
                <div ref="topAnchor" class="h-20 w-full" scrollbar-over />
                <slot />
            </ScrollArea>
        </CardContent>
    </Card>
