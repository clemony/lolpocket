...
<template>
    <main class="w-full">
        <LayoutSpacer class="col-span-full !h-36" />
        <div class="grid w-full grid-cols-3 gap-6 [&_>*]:size-full">
            <DisplayCard description="Get rid of the wiggly wobblies." class="">
                <template #header>
                    <h2>Reduce Motion</h2>
                </template>
            ...
            <DisplayCard
                description="The little pocket that slides down in the sidebar. That thing."
                class="">
                <template #header>
                    <h2>Suppress Pocket Preview</h2>
                </template>
                <label class="label cursor-pointer">
                    <input
                        type="checkbox"
        ...
        <div class="mt-6 flex border-t border-t-base-200 pt-6">
            <Grow />
