        ...
        <PopoverTrigger
          ...
          <div
            :class="
              cn(
                `
                  group embla__slide pointer-events-none relative z-0 grid
                  size-full shrink-0 place-items-center overflow-hidden
                  rounded-lg border-0 p-0 shadow-sm shadow-black/15
                  drop-shadow-sm
                `,
                `
