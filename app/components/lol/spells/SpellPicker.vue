...
<template>
  <Popover>
    ...
    >
      <Button
        variant="secondary"
        class="relative grid size-16 place-items-center overflow-hidden p-0 hover:ring hover:ring-b4"
    ...
    >
      <div class="grid grid-cols-3 place-content-evenly gap-3">
        <label
          ...
          class="size-16 cursor-pointer! rounded-lg shadow-sm transition-[colors,opacity] duration-400 hover:ring-2 hover:ring-bc/60 disabled:opacity-70 disabled:inset-shadow-sm disabled:grayscale"
        >
          <input
            id="spells"
            v-model="selected"
