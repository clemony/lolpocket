...
export const sortMenu = computed<ContextMenuItem>(() => {
  const { localSettings } = storeToRefs(user())
  return {
    label: "Sort by",
    ...
    children: [
      ...
      {
        ui: {
          itemLeadingIcon: "**:stroke-[3.4]! scale-84"
        },
