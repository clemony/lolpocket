...
const champion: Champion = {
  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Active:</span> Nidalee hurls a javelin in the target direction that deals magic damage to the first enemy hit, increased by 30% - 225% (based on distance traveled).</p>",
          "leveling": [
            {
