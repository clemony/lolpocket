            ...
            <div class="flex flex-col gap-1 ">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger
                        ...
                        class="mt-6 aspect-square size-14 self-center rounded-full p-4 ring-neutral/80 ring-offset-base-100 data-[state=open]:ring-1 data-[state=open]:ring-offset-4">
                ...
                <Label for="pocket-tags" class="">Colors</Label>
                    <DropdownMenu class="w-full">
                        <DropdownMenuTrigger
                            class="rounded-md data-[state=open]:bg-base-200/60 w-full">
