  ...
  <div class="flex items-center gap-2">
    <DropdownMenu>
      <DropdownMenuTrigger class="btn btn-square btn-ghost group/drop data-[state=open]:border-b3/60 data-[state=open]:bg-b2/50">
        <icon
          name="gear-solid"
          class="group-data-[state=open]/drop:opacity-80 group-hove/dropr:opacity-80 opacity-60" />
      </DropdownMenuTrigger>
    ...
    <label
      ...
      class="btn btn-square  btn-ghost relative grid place-items-center group/pin *:tldr-20 *:size-5.75 *:dst *:absolute">
      <input
      ...
      <icon
        name="pin"
        class="  group-hover/pin:opacity-0 peer-checked:opacity-0 opacity-60 *:stroke-[1.8]" />

      <icon
        name="pin-solid"
        class="opacity-0  group-hover/pin:not-checked:opacity-100 group-hover/pin:not-checked:text-bc/50 peer-checked:opacity-60 peer-checked:hover:text-bc" />
