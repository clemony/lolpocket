...
<template>
    <div class="mt-48 size-full pl-8">
    ...
    <div
        class="absolute top-[105px] z-10 h-10 w-full bg-base-100/80 backdrop-blur-md">
        <ag-grid-vue
            :theme="pocketTheme"
            class="col-headers ml-8 h-full items-center !rounded-none bg-transparent"
            ref="headerGrid"
            id="header-grid"
...
[col-id='name'] .ag-header-cell-label {
    @apply pl-8 pr-4;
}
