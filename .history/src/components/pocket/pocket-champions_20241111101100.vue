            ...
            <CardHeader
                ...
                <div class='join mr-1'>
                    <Label variant="outline" size="icon"
                        class='join-item swap swap-flip relative  has-[:disabled]:cursor-default' alt="Filter Likes">


                        <input type="checkbox" name="viewLoved" v-model="cs.viewLoved" class="hidden"
