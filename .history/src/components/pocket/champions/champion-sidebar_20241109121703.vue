...
<div v-if="champion" class="">
    ...
    <Card>
        ...
        <CardHeader class='flex'>
            ...
            <LoadImg class="rounded-full size-24 border-base-300 border shadow-sm relative overflow-auto"
                :url="`/img/champions/${clean(champion.name)}.webp`">
                <VTooltip theme="tt"
                    class="group/glow glow absolute -bottom-[4px] -right-[5px] grid size-7 items-center justify-center rounded-full bg-neutral transition-all duration-500 before: hover:rotate-180"
                    alt="view on Wiki">
