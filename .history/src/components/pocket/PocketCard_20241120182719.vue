                ...
                <div class="flex w-full gap-3">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="size-full [&_:first-child]:-left-14 [&_:first-child]:-top-[2rem] [&_:last-child]:-bottom-[3.9rem] [&_:last-child]:-left-[0.8rem] [&_:nth-child(2)]:-bottom-[1rem] [&_:nth-child(2)]:-left-[3.9rem]">
                                <RuneSet :pocket="pocket" type="runes1" />
                            </div>
                            <div
                                class="z-0 size-full [&_:first-child]:-right-[4rem] [&_:first-child]:-top-[0.3rem] [&_:last-child]:-bottom-[3rem] [&_:last-child]:-right-[3.3rem]">
