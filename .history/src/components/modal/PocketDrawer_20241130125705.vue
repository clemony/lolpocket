...
<template>
    <div class="relative w-full justify-center">
        <form
            class="flex w-full gap-24 pt-4 [&_label]:text-base"
            @submit.prevent.stop="submitForm">
            <div class="flex w-1/2 gap-16">
                <div class="ml-px flex w-full flex-col gap-2 pl-4">
                ...
                <div class="flex flex-col justify-start">
                    <div class="flex flex-col gap-1">
                        ...
                        <button
                            ...
                            class="my-2 aspect-square size-16 self-center rounded-lg p-4 ring-neutral/80 hover:ring-1 hover:ring-offset-4">
                            <icon
                                :icon="selectedIcon"
