...
const spell1 = ref(pocket.spells[0].spell1 as spell) || undefined
const spell2 = ref(pocket.spells[0].spell2 as spell) || undefined
console.log(spell2)
const alt1 = ref(pocket.spells[0].alt1 as spell) || undefined
console.log(alt1)
const alt2 = ref(pocket.spells[0].alt2 as spell) || undefined
console.log(alt2)
