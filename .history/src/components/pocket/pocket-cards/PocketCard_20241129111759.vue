...
<template>
    <label class="relativebackdrop-blur-md swap swap-flip">
        ...
        <Card
            class="swap-off relative grid h-[270px] w-[250px] justify-center overflow-hidden rounded-xl bg-transparent px-2">
            <div
            ...
            <CardContent
                ...
                <div class="grid w-full px-3">
                    <div class="h-fit">
                        <div class="relative flex items-end py-4">
                            <div
                                class="flex w-full flex-row flex-wrap justify-start gap-1 justify-self-start [&_first-child]:!rounded-tl-full">
