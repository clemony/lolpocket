...
<template>
    ...
    <div class=" h-full w-full  *:scrollbar-hide ">
        ...
        <Splitpanes id="likeSplit" class="default-theme px-6 pb-2 w-full max-h-[calc(100%-100px)] h-[calc(100%-100px)]">
            <Pane size="50" max-size="70" min-size="30"
                ...
                <div class="flex flex-wrap w-full h-full max-h-full gap-4 p-2 overflow-y-scroll scroll-none pt-11 ">
                    <div v-for="(champion, index) in cs.likedChamps" :key="champion.name" :data-index="index" class="">
                        <button
                            ...
                            <div class="grid-image-container champ">
                                <img v-if="champion.type === 'champion'" :src="champion.img"
                                    :alt="champion.name + ' Image'" class="scale-[115%] aspect-square" />
         ...
         /* -------------------------------------------------------------------------- */ -->
            ...
            <Pane size="50" max-size="70" min-size="30"
                ...
                <div
                    ...
                    <VDropdown v-for="item in is.likedItems" :key="item.id" :overflow-padding="20" :shift="true"
                    ...
                    <VDropdown theme="detail" alt="Quick Search"
                        ...
                        <div
                            class=" group-hover/qs:opacity-40 group-hover/qs:scale-95 scale-105 z-20 opacity-0 select-none bg-[url('/img/ui/frame.webp')] bg-center bg-contain transition-all bg-no-repeat duration-200  w-full h-full brightness-0 cursor-zoom-in ">
