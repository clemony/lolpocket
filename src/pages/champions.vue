          ...
          <div
            ...
            <div class="col-span-2 grid grid-cols-3 p-1 auto-cols-max gap-1">
              ...
              <div class="col-start-2 col-span-2">
                <h1 class="font-semibold font-serif text-[1.4rem] mb-0 pb-1 test">{{ selectedChampion.name }}</h1>
                <p
              ...
              <div class="collapse-content">
                <table>
                  <tbody class="bg-white divide-y divide-gray-200 text-xs">
                    <tr v-for="(value, key) in ability.data" :key="key" class="lowercase">
                      <td class="normal-case">
                        {{ key }}
                      </td>
                      <td class="normal-case text-right">
                        {{ value }}
                      </td>
                    </tr>
                  </tbody>
