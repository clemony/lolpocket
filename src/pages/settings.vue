...
<template>
<main class="flex min-h-[calc(100vh-calc(var(--spacing)*16))] flex-1 flex-col gap-4 bg-muted/40 p-4 md:gap-8 md:p-10">
    <div class="mx-auto grid w-full max-w-6xl gap-2">
        <h1 class="font-size-9! font-semibold">
            Settings
        </h1>
    </div>
    <div class="mx-auto grid w-full max-w-6xl items-start gap-6 md:grid-cols-[180px_1fr] lg:grid-cols-[250px_1fr]">
        <nav class="grid gap-4 font-size-2 text-muted-foreground">
                ...
                <CardContent>
                    <form class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <label for="include"
                                class="font-size-2 font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
