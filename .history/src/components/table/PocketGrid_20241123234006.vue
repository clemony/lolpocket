...
[col-id='dateUpdated'] {
    ...
    & .ag-header-cell-label {
        @apply relative -mt-3.5 h-full w-full rotate-[75deg] -scale-x-[1] overflow-auto pl-3 text-2xl leading-none before:absolute before:top-0.5 before:-ml-1 before:-rotate-90 before:scale-[1] before:text-4xl before:leading-none before:content-['⟳'];
    }
}
