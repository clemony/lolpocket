            ...
            <CardContent
                ...
                <div class="mt-0 flex w-full">
                    <div class="w-1/2 pl-4">
                        ...
                        <div
                            class="flex h-fit items-center justify-start gap-3 pl-2 pt-2">
                            <div
                                :class="
                                    cn(
                                        'z-10 w-fit flex-col',
...
'[&_:last-child]:left-8 [&_:last-child]:top-22 [&_:last-child]:z-0'*/
                                ...
                                <div
                                    v-if="set.secondary != ''"
                                    class="8 z-20 size-12 rounded-full border border-base-200 bg-base-100/60 p-2 shadow-pretty backdrop-blur-sm">
                                    <img
