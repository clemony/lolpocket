    ...
    <div class="h-full w-full px-6 *:scrollbar-hide">
        <div class="flex w-full items-end px-2 py-6">
            <div class="flex grow items-center">
                <h2 class="p-1.5 font-size-9 font-bold">Champions</h2>
        ...
        <Splitpanes
            ...
            <Pane
                ...
                min-size="60"
                max-size="72"
                class="relative h-full rounded-box border border-b3 bg-b1/90! px-4 shadow-warm">
                <div
                    ...
                    <h2 class="grow justify-start font-size-4 font-semibold">
                        Primary
                    </h2>
                    <select
