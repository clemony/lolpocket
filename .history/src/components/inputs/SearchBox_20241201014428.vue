...
<template>
    <div :class="cn('relative m-0 p-0', props.class)">
        ...
        <input
            ...
            :class="
                cn(
                    'inset-0 mx-0 flex h-full w-full gap-2 self-center overflow-hidden border border-base-200 bg-transparent px-0 pb-0 pt-1 text-base tracking-normal placeholder-opacity-40 shadow-inner transition-opacity duration-300 placeholder:pt-1 placeholder:text-base placeholder:tracking-normal hover:ring-0 focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50',
                    props.inputClass
                )
            " />
