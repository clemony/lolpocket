...
<template>
    ...
    <main
        ...
        <div
            v-if="state == 'open'"
            class="command margin-auto z-[100] mt-24 opacity-0 delay-0 animate-in animate-out fade-in-0 slide-in-from-bottom-2/3 slide-out-to-bottom-2/3"
            :class="{ 'opacity-100': state == 'open' }">
            <Command />
        </div>
        <label>
            <input
