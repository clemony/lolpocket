...
const champions = computed (() => state.filteredChampions().stats().sort((a, b) => b.games - a.games).splice(0, 5))
    ...
    <ListboxContent class="w-full ">
      <transition-slide
        ...
        <ListboxItem
          ...
          :class="{ 'bg-b3/40 border-b3 shadow-xs  inset-shadow-sides bg-noise inset-shadow-b3/10': champion.name == championModel }">
          <div
