        ...
        <Card
            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        v-if="set"
                        class="col-start-1 grid h-fit w-full grid-flow-row auto-rows-auto grid-cols-3 items-start justify-items-center gap-1 overflow-hidden">
                        <div class="max-size-full max-h-[40px] overflow-hidden">
                            <img
                                v-if="
                                ...
                                "
                                class="size-[60px] object-cover object-top" />
                        </div>
