    ...
    <label class="swap swap-flip relative h-[350px] w-[250px]">
        ...
        <Card
            ...
            <CardContent
                ...
                <div class="mt-2 grid w-full grid-cols-[3fr_1fr] gap-3">
                    <div
                        class="grid w-full grid-flow-row auto-rows-auto grid-cols-3 justify-items-center gap-1">
                ...
                <div class="relative size-full">
                    ...
                    <div class="flex w-full" v-if="set">
                        <template v-for="rune in runes">
                            <div
                                class="flex w-full max-w-full flex-wrap items-center justify-center gap-2 px-2">
                                <LoadImg
                                    v-if="rune.name != 'none'"
                                    :url="rune.img"
