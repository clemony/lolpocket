          ...
          <div class="embla__slide p-2">
            ...
            >
              ...
              >
                ...
                <div
                  class="absolute bottom-4 left-6 grid w-max place-items-center rounded-full bg-black/70 px-5 py-1 text-4 font-medium text-white/80 italic opacity-90 backdrop-blur"
                >
                  {{ skin.name }}
                </div>
              </CardContent>
