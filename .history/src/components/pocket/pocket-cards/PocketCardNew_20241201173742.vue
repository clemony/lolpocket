            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <Card
                        ...
                        <CardContent
                            class="mt-0from-base-100/40 relative h-full w-inherit items-center bg-gradient-to-b from-0% via-base-100/70 via-15% to-base-100/80 to-30%">
                            <CardHeader class="relative mt-0 flex px-3 pb-1">
                                <CardTitle
                                    class="z-10 mt-0 pb-0 !text-lg italic leading-none">
