                ...
                <div class="size-full px-3">
                    <div class="mt-1">
                        ...
                        <div class="relative mt-4 flex h-fit items-end">
                            <div
                                class="first relative left-2 top-16 z-20 flex grow items-center justify-center first:absolute">
                                <Keystone :pocket="pocket" />
                            </div>
                            <div
                                class="relativeflex w-full flex-row flex-wrap justify-end gap-1 justify-self-end pl-24">
