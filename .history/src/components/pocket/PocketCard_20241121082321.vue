...
<template>
    <label class="swap swap-flip relative h-[250px] w-[300px] backdrop-blur-md">
        <input type="checkbox" />
        ...
        <Card
            ...
            <CardContent
                ...
                <div class="relative w-1/2 pl-3">
                    ...
                    <div
                        class="relative h-2 w-24 flex-col content-end items-end gap-3 [&_:first-child]:-right-2.5 [&_:first-child]:-top-4">
