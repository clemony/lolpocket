...
<template>
  ...
  >
    <PopoverTrigger
      class="items-between pointer-events-auto z-1! flex size-20 cursor-pointer flex-wrap justify-between gap-0.75! rounded-lg border border-b3/50! bg-b2/80 p-1.5 backdrop-blur-md hover:z-2!"
    >
      ...
      <AnimatePresence>
        <PopoverContent :side-offset="-60" align="start" as-child>
          <motion.div
            ...
            class="grid items-center overflow-hidden border border-b3/50 bg-b2/90 shadow-smooth backdrop-blur-md"
            :style="{
