...
<template>
    <div
        ...
        <input
            ...
            :class="
                cn(
                    'focus:!outline-offset-transparent peer flex h-10 w-full !border-0 border-transparent bg-transparent text-md placeholder:text-base-content/60 focus:!border-0 focus:!border-transparent focus:!shadow-none focus:!outline-0 focus:!outline-offset-0 focus:!outline-transparent focus:!ring-0 focus:!ring-transparent focus:!ring-offset-0 focus:!ring-offset-transparent disabled:cursor-not-allowed disabled:opacity-50',
                    props.class
                )
            "
