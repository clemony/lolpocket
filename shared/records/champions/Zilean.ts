  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Zilean generates 2 / 3.5 / 5 / 6 / 12 (based on level) experience (does not count towards his own level up) every 5 seconds. Time in a Bottle is on cooldown when the game starts and becomes disabled when everyone on Zilean\'s team including himself has reached level 18.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Zilean throws a ticking time bomb to the target location that will attach upon enemy contact,  revealing them. It will detonate after a short time or when the attached unit dies, dealing magic damage to nearby enemies hit.",
      castTime: "0.25",
      collisionRadius: "140",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zilean throws a ticking time bomb to the target location that grants sight of its surroundings. The bomb will attach itself to units that move within the epicenter, or those hit directly, revealing them.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Self",
      blurb:
        "Active:  Zilean  reduces the  remaining cooldowns of his other basic abilities.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zilean reduces the remaining cooldowns of Time Bomb and Time Warp by 10 seconds each.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zilean applies Time Warp to the target champion which lasts for 2.5 seconds.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Time Warp:</span> If the target is an ally, they gain bonus movement speed. If the target is an enemy, they are slowed.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Zilean places a protective time rune on the target allied champion or himself for 5 seconds.</p>',
        },
        {
          description:
