        ...
        <Card
            ...
            <CardContent
                ...
                <div class="relative w-1/2 pl-3">
                    ...
                    <div
                        class="relative z-0 h-2 w-24 flex-col content-end items-end gap-3 [&_:first-child]:-right-2.5 [&_:first-child]:-top-6 [&_:last-child]:-right-3 [&_:last-child]:top-5 [&_:nth-child(2)]:-top-0 [&_:nth-child(2)]:right-7">
