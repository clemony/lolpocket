...
<template>
    <div
        ...
        class="rounded-box bg-[20%_-45%] bg-no-repeat [background-size:200%]">
        <InfoCard
            cardClass="card h-[350px] w-[250px]  before:absolute before:size-full bg-transparent backdrop-blur-none bg-gradient-to-b from-base-100/60 from-0% to-base-100 via-base-100/70 to-30%">
            <template #header>
