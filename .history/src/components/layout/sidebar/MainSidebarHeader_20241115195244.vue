    ...
    <SidebarHeader>
        <SidebarMenu
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <SidebarMenuButton
                            variant="ghost"
                            size="lg"
                            class="flex size-full shrink-0 flex-nowrap items-center gap-3 rounded-none !border-0 pb-2 pt-3 ring-0 focus:!border-0 focus:!outline-0"
            ...
            <SidebarMenuItem class="mx-2">
                <SidebarMenuButton
                    class="hover-ring-neutral/60 relative h-9 w-full items-center justify-start border border-base-300/80 bg-base-100/60 px-2 hover:cursor-text hover:border-base-300 hover:bg-base-100/60 hover:ring-1"
                    :class="{
