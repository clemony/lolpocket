...
<template>
  <div class="flex w-full  field-box p-2 items-center gap-4 ">
    ...
    <div class="flex flex-col grow justify-center gap-1.5 drop-shadow-sm">
      ...
      <div class="flex items-center lowercase gap-4 align-baseline font-normal">
