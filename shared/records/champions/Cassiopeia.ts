  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate:  Cassiopeia gains  Movement Speed per level, but she cannot purchase  Boots items.",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Cassiopeia gains 4 - 72 (based on level) bonus movement speed, but she cannot purchase Boots items.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Blessing of Noxus Bonus:</span> Serpentine Grace\'s bonus movement speed is increased by 1 - 18 (based on level), for a total of 5 - 90 (based on level).</p>',
        },
      ],
      icon: "https://cdn.communitydragon.org/latest/champion/Cassiopeia/ability-icon/p",
      notes:
        "The movement speed from Serpentine Grace is worth  48 per level, up to a maximum of  864 at level 18.\nWithout other movement speed modifiers taken into account, Serpentine Grace grants Cassiopeia a total of 332 : 400 (based on level)  movement speed.\nAs  Magical Footwear grants boots, the rune will be replaced with  Cash Back.",
      targeting: "Passive",
    },
    {
      key: "Q",
      ...
      affects: "Enemies",
      blurb:
        "Active:  Cassiopeia blasts an area with  Poison after a brief delay, dealing magic damage over time to enemies hit. She gains  bonus movement speed if she hits an enemy  champion.",
      castTime: "0.25",
      cooldown: "3.5",
      cost: "50 / 55 / 60 / 65 / 70",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cassiopeia creates a blast at the target location that explodes after a 0.4-second delay. Enemies within the blast are poisoned for 3 seconds, taking magic damage every 0.429 seconds over the duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Cassiopeia spews several clouds of  Poison that linger, continually dealing magic damage to enemies within. They are also  slowed and  grounded.",
      castTime: "0.25",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cassiopeia spews forth 7 bolts of venom in an arc at the target location, creating toxic clouds at the area for 5 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cassiopeia launches her fangs at the target enemy that deal 52 - 120 (based on level) (+ 10% AP) magic damage. If this kills the target, Twin Fang\'s mana cost is refunded.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      angle: "80°",
      blurb:
        "Active:  Cassiopeia blasts in a cone, dealing magic damage to enemies hit and  stunning any that are facing her, while  slowing any others with their back turned.",
      castTime: "0.5",
      cooldown: "120 / 100 / 80",
      cost: "100",
      damageType: "Magic damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Cassiopeia blasts enemies in a cone in the target direction, dealing magic damage to enemies struck within and slowing them by 40% for 2 seconds. Enemies with their facing direction towards her are instead stunned for the same duration.</p>',
          leveling: [
            {
