...
<template>
  <div class="w-full gap-x-1 align-middle leading-normal text-pretty">
    ...
    <span v-if="data.effects" class="" v-html="data.effects" />
    ...
    >
      ...
      />
      <!-- &nbsp;Cooldown:&nbsp; -->
      <span class="" v-html="data.cooldown" />second cooldown
    </div>
  </div>
</template>
