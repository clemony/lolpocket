...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Bard fires an energy bolt in the target direction that deals magic damage and  slows the first enemy hit.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bard fires an energy bolt in the target direction that deals magic damage to the first enemy hit and slows them by 60% for a duration.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Allies',
      blurb:
        'Active:  Bard conjures a shrine which powers up over a period, disappearing when a champion steps on it.',
      castTime: '0.25',
      cooldown: '0',
      cost: '70',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bard conjures a shrine at the target location that gathers power over 5 seconds and grants sight of its surroundings for 1 second. Shrines last until they are consumed by champions moving over them. Up to 3 shrines may be active at a time.</p>',
        },
        {
          description:
            'If the champion was an ally or Bard himself, they are healed for an amount based on the shrine\'s power and gain bonus movement speed decaying over 1.5 seconds. The bonus movement speed can stack with subsequent shrines triggered.',
          leveling: [
            {
    ...
    },
    {
      ...
      blurb:
        'Active:  Bard opens a one-way portal through nearby terrain. Champions can enter by moving into the portal, however allies will be faster.',
      castTime: '0.25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bard opens a one-way magical corridor through a piece of terrain in the target direction for 10 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      name: 'Tempered Fate',
      blurb:
        'Active:  Bard sends spirit energy arcing to a location, putting all  champions,  minions,  monsters, and  turrets hit into  stasis for a short time.',
      castTime: '0.5',
      cooldown: '110 / 95 / 80',
      cost: '100',
      effectRadius: '350',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Bard sends magical energy arcing to the target location, granting sight of the area during travel. Upon impact, it puts all units within into stasis for 2.5 seconds, as well as stunning all enemy champions, minions, and turrets struck for the same duration. Enemies hit are revealed for the duration.</p>',
        },
        {
          description:
