...
defaultMinWidth: 50,
  ...
  defaultColDef: {
    ...
    cellClass: 'text-end grid justify-end size-full capitalize ',
...
const colDefs: (ColDef<Champion> | ColGroupDef<Champion>)[] = [
  ...
  { headerName: 'Atk Dmg', groupId: 'ad', children: [
    {
      valueGetter: (params) => {
        return Math.round((params.data.stats?.attackdamage + params.data.stats?.attackdamageperlevel * clvl.value * tlvl.value) * 100) / 100
      },
      headerName: 'Base',
    },
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.attackdamageperlevel },
  ] },
  { headerName: 'Atk Spd', groupId: 'as', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.attackspeedperlevel },
  ] },
  { headerName: 'Crit', groupId: 'crit', hide: true, children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.critperlevel, hide: true },
  ] },
  { headerName: 'Health', groupId: 'hp', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.hpperlevel },
  ] },
  { headerName: 'HP Regen', groupId: 'hpregen', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.hpregenperlevel },
  ] },
  { headerName: 'Mana', groupId: 'mp', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.mpperlevel },
  ] },
  { headerName: 'MP Regen', groupId: 'mpregen', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.mpregenperlevel },
  ] },
  { headerName: 'Armor', groupId: 'armor', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.armorperlevel },
  ] },
  { headerName: 'MR', groupId: 'mr', children: [
    ...
    { columnGroupShow: 'open', maxWidth: 60, headerName: 'Lvl 🞤', valueGetter: params => params.data.stats?.spellblockperlevel },
  ] },
  {
    headerName: 'Range',
    maxWidth: 70,
  ...
  ] },
  {
    headerName: 'Resource',
    children: [
      { field: 'partype', colId: 'resource', headerName: '', flex: 1, cellDataType: 'text', minWidth: 70 },
    ],
  },
  {
    headerName: 'Roles',
...
<template>
  <NuxtLayout
    name="header-layout" class=" pt-18" header-class="">
    <template #crumb>
