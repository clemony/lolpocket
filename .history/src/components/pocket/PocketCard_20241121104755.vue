            ...
            <CardContent
                ...
                <div class="flex w-full">
                    ...
                    <div class="w-1/2 pl-3">
                        <div
                            class="relative grid size-36 place-items-center border border-neutral">
                            <div class="z-20">
                            ...
                            <div
                                :class="
                                    cn(
                                        ...
                                        '[&_:first-child]:top-1 [&_:first-child]:z-0',

                                        '[&_:nth-child(2)]:-left-5 [&_:nth-child(2)]:top-12 [&_:nth-child(2)]:z-20',

                                        '[&_:last-child]:top-22 [&_:last-child]:left-0 [&_:last-child]:z-0'
                                    )
                                ">
                            ...
                            <div
                                :class="
                                    cn(
                                        'absolute left-16 top-0 z-0 mt-0.5',
                                        '[&_:first-child]:left-7 [&_:first-child]:top-9 [&_:first-child]:z-0',
                                        '[&_:last-child]:top-22 [&_:last-child]:left-3 [&_:last-child]:z-0'
                                    )
                                ">
                                <RuneSet :pocket="pocket" type="runes2" />
                            </div>
                            <!--         <div
                                class="relative z-0 mt-1 h-2 w-24 flex-col content-end items-end gap-3 [&_:first-child]:-right-2.5 [&_:first-child]:-top-6 [&_:last-child]:-right-2.5 [&_:last-child]:top-5 [&_:nth-child(2)]:-top-0.5 [&_:nth-child(2)]:right-7">
