...
[col-id='dateUpdated'] {
    ...
    & .ag-header-cell-label {
        @apply relative h-full -rotate-180 overflow-auto pl-3 text-xl leading-none tracking-[-5px] before:absolute before:top-0.5 before:-ml-1 before:-rotate-90 before:text-4xl before:leading-none before:content-[''];
    }
}
