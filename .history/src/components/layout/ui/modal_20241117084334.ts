...
export const editPocketModal:modal = {
        ...
        id: 'editPocket',
        title: 'Edit Pocket',
description: 'Some mistakes you CAN make twice. For those trying times of pure necessity and through intense struggle, you can update your Pocket information here.',
submitText: 'Finish',
}