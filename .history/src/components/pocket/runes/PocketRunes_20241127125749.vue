...
<template>
    <Layout2 :panel2Size="25">
        <template #panel1>
            <div class="flex justify-end gap-10 px-10">
                ...
                <div
                    ...
                    :class="primary">
                    <div
                        class="from-base-100/10 via-base-100/90 to-base-100 h-full bg-linear-to-b via-25%">
                        <RuneSelect
                ...
                <div>
                    <div
                        ...
                        <div
                            class="from-base-100/10 via-base-100/90 to-base-100 h-full bg-linear-to-b via-35% px-2">
                            <RuneSelect
                                :pocketKey="props.pocketKey"
                                :pocket="pocket"
                                :set="2"
        ...
        <template #panel2>
            <div
                class="border-base-300 bg-base-100/90! shadow-warm relative overflow-hidden rounded-xl border">
...
.focus-hover:focus-within {
    @apply border-base-300 bg-base-100/50 ring-offset-base-content/40 grow shadow-inner [&_button]:opacity-100;
}
</style>
