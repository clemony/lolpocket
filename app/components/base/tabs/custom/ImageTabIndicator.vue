...
<template>
  <TabsIndicator v-bind="{ ...forwarded, ...$attrs }" as-child :class="{ 'h-[100%]': props.orientation != 'vertical', 'w-[102%]': props.orientation == 'vertical' }">
    <motion.div
      :variants="variants"
      ...
      <motion.div
        class="h-full w-full rounded-lg bg-b1 text-bc shadow  scale-x-104"
