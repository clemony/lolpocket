    ...
    <div
        ...
        <label
            ...
            <VDropdown
                ...
                :disabled="rune.path == 'none'"
                id="imgwrap"
                class="shine h-[inherit] w-[inherit] opacity-80 ring-1 ring-base-300 brightness-90 grayscale transition-all duration-500 hover:opacity-100 hover:grayscale-0 peer-checked:opacity-100 peer-checked:brightness-100 peer-checked:grayscale-0">
