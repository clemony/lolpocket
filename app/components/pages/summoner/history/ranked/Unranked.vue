...
<template>
  <Field
    :class="cn('w-120 max-w-120 h-42 max-h-42  bg-b2/30 drop-shadow-xs border-b3/40 py-0 ', props.class)"
    ...
    <div class="overflow-hidden size-full grid grid-cols-[1.1fr_1fr_1fr] place-items-center h-42 content-center">
      ...
      <div class=" pt-3  overflow-hidden font-medium flex flex-col items-end justify-center pb-3 text-end **:text-bc/30 gap-2.75 dst">
        <p class="capitalize">
          Unranked
        </p>
