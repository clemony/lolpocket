            ...
            <div
              ...
              <div class="col-span-2 grid grid-cols-3 p-1 auto-cols-max gap-1">
                ...
                <div class="col-start-2 col-span-2">
                  ...
                  <p class="text-xs flex tracking-wide align-middle uppercase pt-0 mt-0 pb-1">
              ...
              <div
                ...
                <code v-for="(tag, index) in selectedChampion.tags" :key="index"
                  class="tracking-normal lowercase text-xs w-auto h-max flex flex-nowrap text-center"
