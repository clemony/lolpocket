        ...
        <div :style="containerStyle">
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <Card
                        class="swap-off relative grid h-[260px] w-[210px] justify-center overflow-hidden rounded-xl border-base-300 bg-transparent px-2 ring-1 ring-base-300 ring-offset-2 ring-offset-base-200/70">
                        <div
