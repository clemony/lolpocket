                        ...
                        <CardContent
                            ...
                            <div
                                ...
                                <div
                                    :class="
                                        cn(
                                            'before:bg-base-100after:shadow-smooth z-0 h-36 w-[90%] !overflow-hidden rounded-md',
                                            {
                                    ...
                                    ">
                                    <div
                                        class="size-full bg-[50%_10%] bg-no-repeat [background-size:200%] after:absolute after:left-1 after:top-2 after:isolate after:z-10 after:size-16 after:rounded-full after:ring-1 after:ring-neutral"
                                        :style="layer1" />
                                </div>
                            </div>
                            ...
                            <div class="size-full px-4">
                                <div class="flex h-full w-3/4 items-end">
                                    <div
