  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yasuo thrusts his sword in a line in the target direction that deals physical damage to enemies hit, applies on-hit effects to the first enemy hit, and triggers on-attack effects once. Steel Tempest\'s damage based on its AD ratio can critically strike for (175% + 40%) damage.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Steel Wind Rising:</span> If this hits at least one enemy, Yasuo generates a stack of Gathering Storm for 6 seconds, stacking up to 2 times and refreshing on subsequent hits. At 2 stacks, the next Steel Tempest cast consumes them all to become empowered with a new effect.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Gathering Storm Bonus:</span> Yasuo unleashes a whirlwind in the target direction that deals the same damage to enemies hit and knocks them up for 0.75 seconds, or 0.9 seconds in combination with Sweeping Blade.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yasuo raises a wall of wind that travels in the target direction over 0.6 seconds. It then drifts another 50 units over 3.4 seconds, blocking all hostile non- turret projectiles that hit it and granting sight of its surroundings.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Ride the Wind:</span> Sweeping Blade\'s damage is increased by 25% per stack, up to 100% at maximum stacks.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Yasuo  blinks to the target  airborne enemy champion and instantly generates max  Flow. He then briefly  knocks up,  reveals, and deals physical damage to all nearby  airborne enemies.",
      castTime: "none",
      cooldown: "70 / 50 / 30",
      cost: "0",
      damageType: "Physical damage",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Yasuo blinks to the opposite side of a visible airborne enemy champion nearest to the cursor, instantly generating maximum Flow while resetting Gathering Storm stacks.</p>',
        },
        {
          description:
        ...
        {
          description:
            "For the next 15 seconds, the damage dealt by Yasuo's critical strikes ignores 60% of the target's bonus armor.",
        },
        {
          description:
