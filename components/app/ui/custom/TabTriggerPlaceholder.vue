...
<template>
  <Motion
    ...
    :class="{ ' opacity-0  ring-transparent border-transparent ': props.modelValue != props.value, 'inset-shadow-sm inset-shadow-b3/30 border border-b3/60 bg-b2 btn  ': props.modelValue == props.value && props.store.returnValue.width != 0, 'border border-b3  drop-shadow-xxs btn ring-1 ring-b3/30 shadow-xs !bg-b1  drop-shadow-xs  text-bc': tabStyle }" @hover-start="(event) => console.log('hover start', event)">
