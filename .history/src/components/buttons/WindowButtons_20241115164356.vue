...
const maximize = ref()
const close = ref()
const { isOutside } = useMouseInElement(target, minimize, maximize, close)}
...
const minimizeIcon = ['mynaui:circle', 'mynaui:x-circle', 'mynaui:x-circle-solid']
const maximizeIcon = ['mynaui:circle', 'mynaui:x-circle', 'mynaui:x-circle-solid']
const closeI = ['mynaui:circle', 'mynaui:x-circle', 'mynaui:x-circle-solid']
