    ...
    <Accordion
        ...
        <AccordionItem
            ...
            <AccordionTrigger class="flex py-2">
                ...
                <div
                    class="text-5! grow px-4 text-start font-medium tracking-tight">
                    {{ ability.name }}
                </div>
                <p
                    class="font-cursive text-2 mr-6 scale-x-125 font-mono capitalize not-italic! no-underline! hover:no-underline!">
                    {{ ability.key }}
                </p>
            </AccordionTrigger>
