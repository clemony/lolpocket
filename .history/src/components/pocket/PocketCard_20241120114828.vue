...
<template>
    <label class="swap swap-flip relative h-[320px] w-[250px] backdrop-blur-md">
        ...
        <Card
            ...
            <CardContent
                class="relative grid h-full w-inherit items-center justify-center bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/80 to-30% pt-2">
                <CardHeader class="relative flex px-2">
                ...
                <div class="flex w-full gap-2">
                    <div class="w-1/2">
                        ...
                        <div class="-mt-4 ml-4 grid w-full justify-center">
                        ...
                        <div class="flex w-full">
                            ...
                            <div class="relative col-start-1 w-full"></div>
                            <div class="flex flex-col justify-end gap-2.5">
