...
<template>
    <div
        class="relative h-screen max-h-screen w-140 justify-center overflow-clip">
        <form
            class="[&_label]:text-3 max-h-inherit relative flex h-screen w-full flex-col gap-9 overflow-hidden pt-4 pr-8 pl-4"
