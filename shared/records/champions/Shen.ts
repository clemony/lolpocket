  ...
  abilities: [
    {
      ...
      affects: "Self",
      blurb:
        "Innate: Shen manifests a Spirit Blade that he can control with his abilities.",
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> After completing an ability\'s effects, Shen grants himself a shield for 47 - 120 (based on level) (+ 13% bonus health) for 2.5 seconds. If Shen affects at least one other champion with an ability, Ki Barrier\'s cooldown is reduced by 4 - 8 (based on level) seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Shen recalls his Spirit Blade to his location, which shortly  slows enemies hit while moving away from him.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Shen recalls his Spirit Blade to his location. Enemy champions hit are slowed for the next 2 seconds while moving away from Shen.</p>',
          leveling: [
            {
              attribute: "Slow",
              modifiers: [
        ...
        {
          description:
            "Once it arrives, Shen empowers his next 3 basic attacks within 8 seconds to gain 75 bonus range and deal bonus magic damage. Against structures, only the flat damage portion is applied.",
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Allies",
      blurb:
        "Active:  Shen primes his Spirit Blade, creating an area around it. After a short time, or when Shen or allied champions enter the area, the Spirit Blade briefly erupts a protective zone that  blocks enemy basic attacks that hit Shen or allied champions in the area.",
      castTime: "none",
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Passive: Dealing damage with  Twilight Assault or Shadow Dash will restore  energy.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Dealing damage with Twilight Assault or Shadow Dash restores 30 / 40 / 50 (based on level) energy.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Shen dashes to the target location, dealing physical damage to enemy champions and monsters he passes through and taunting them for 1.5 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Shen focuses his will, channeling for 3 seconds and granting the target allied champion a shield for 5 seconds at the time of cast, increased by 0% - 60% (based on target\'s missing health).</p>',
          leveling: [
            {
