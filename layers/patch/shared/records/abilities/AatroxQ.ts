...
const ability: Ability = {
  ...
  effects: [
    ...
    {
      description: 'The Darkin Blade deals 55% / 60% / 65% / 70% (based on level) damage against minions. Against monsters, the first cast deals 15 bonus physical damage, which is affected by the subsequent cast and Sweetspot damage modifiers; and the knock up duration from hitting the Sweetspot against them is doubled to 0.5 seconds.',
      leveling: [
        {
