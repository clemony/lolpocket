  ...
  "abilities": [
    {
      ...
      "effects": [
        {
          "description": "<p class=\"ability-effect\"><span class=\"ability-header\">Innate:</span> Periodically, Aatrox empowers his next basic attack to gain 50 bonus range and deal bonus magic damage equal to 4% - 8% (based on level) of the target's maximum health, capped at 100 - 320 (based on level) against monsters. Deathbringer Stance's damage applies life steal at 100% effectiveness.Aatrox heals for 100% of the post-mitigation bonus damage dealt, reduced to 25% against minions.</p>"
        },
        {
