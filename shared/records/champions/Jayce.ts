  ...
  "abilities": [
    ...
    },
    {
      ...
      "effects": [
        ...
        {
          "description": "To the Skies! deals 50 bonus physical damage to monsters."
        },
        {
    ...
    },
    {
      ...
      "blurb": "Passive:  Jayce's  basic attacks restore  mana  on-hit.",
      "castTime": "none",
      "cooldown": "10",
      "cost": "40",
    ...
    },
    {
      ...
      "affects": "Enemies",
      "blurb": "Active:  Jayce swings his hammer at the target enemy, briefly  rooting them and dealing magic damage based on the target's maximum health, then  knocks them back.",
      "castTime": "0.25",
