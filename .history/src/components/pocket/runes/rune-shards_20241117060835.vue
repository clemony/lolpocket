...
import { getShardIcon } from '@/lib/functions/GetColor'
    ...
    <div class="flex justify-center" :key="set.key">
        <div
            ...
            <label
                ...
                <div
                    class="shard-color flex size-12 shrink-0 items-center justify-center rounded-full border border-base-300 bg-gradient-to-br from-base-200/20 to-base-200/30 bg-clip-padding text-base-content/80 shadow-standard ring-1 ring-transparent ring-offset-2 ring-offset-transparent transition-all duration-300">
                    <Icon
                        :icon="getShardIcon(shard)"
                        class="size-6 drop-shadow-md transition-all duration-300" />
                </div>
            </label>
        </div>
    </div>
...
[data-tag='color-info']: drop-shadow-xs;
    }
}
