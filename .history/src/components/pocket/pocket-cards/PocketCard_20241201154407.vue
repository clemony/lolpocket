        ...
        <div :style="containerStyle">
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <Card
                        class="swap-off relative grid h-[260px] w-[210px] justify-center overflow-hidden rounded-xl bg-transparent px-2 ring-1 ring-neutral/80 ring-offset-1 ring-offset-base-100/80">
                        <div
