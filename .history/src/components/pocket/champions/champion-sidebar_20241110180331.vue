...
<div v-if="champion" class="flex-col w-full gap-6 max-w-inherit h-full pr-[3px]">
    ...
    <TabListPocket defaultTab="abilities" first="stats" class='mt-6 relative  overflow-hidden'>
        <!----------------------⟢ stats ⟣---------------------------->
        ...
        <Tab v-model:modelName="modelName" @click="modelName = 'abilities'" value="abilities"
            class='ability max-w-inherit w-inherit left-20 max-h-[calc(100% - 200px)] flex flex-col flex-1 overflow-hidden'>
            <template #header>
