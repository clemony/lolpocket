  ...
  abilities: [
    {
      ...
      effects: [
        {
          description: '<p class="ability-effect"><span class="ability-header">Innate:</span> Fizz is permanently ghosted and reduces every instance of incoming damage by 4 (+ 1% AP), up to a maximum of 50% reduction. The damage reduction is increased to 14 (+ 1% AP) against monsters.</p>'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: 'If Seastone Trident kills its target, the cooldown is reduced to 1 second and the mana cost is refunded. Otherwise, if the target is not killed, Fizz\'s basic attacks deal bonus magic damage on-hit for the next 5 seconds.',
          leveling: [
            {
