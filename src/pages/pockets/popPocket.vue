...
<template>
    <div
        ...
        <div class="flex items-center gap-2">
            <h1
                class="text-base font-semibold tracking-tight text-base-content">
                {{ title }}
            </h1>
        </div>
        <form
            ref="form"
            class="grid gap-3 max-w-[300px]"
            ...
            <div class="grid w-full grid-cols-2">
                <div
                    class="self-start pt-0 -mt-1 cursor-default label label-text-alt"></div>
                <input
                    v-close-popper
                    type="submit"
                    :value="button"
