  ...
  abilities: [
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: 'Critical strikes instead spray 6 missiles in a 50% wider cone. Secondary targets hit count as being critically struck.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description: 'Attacks alternate between Severum and his current off-hand weapon, each dealing 10 - 40 (based on level) (+ 22% - 40% (based on level) bonus AD) physical damage, affected by critical strike modifiers, and applying on-hit effects, with on-hit damage reduced to 25% effectiveness. Aphelios cannot perform attacks while affected by disarming crowd control or a lockout that disables basic attacks.'
        },
        {
          description: 'Aphelios cannot cast Phase nor Moonlight Vigil during Onslaught, but he is still able to move.'
        }
      ]
    },
    {
