...
<template>
<Accordion default-value="Q" collapsible class='max-h-[calc(100% - 200px)] overflow-hidden'>
    <AccordionItem v-for="(ability, key) in champion.abilities" :key="key" :value="key"
        class='last:border-b-transparent max-h-inherit flex-1 overflow-hidden'>
        ...
        <AccordionContent class='max-h-inherit overflow-y-scroll'>
