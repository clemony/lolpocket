  ...
  abilities: [
    {
      ...
      affects: 'Enemies',
      blurb:
        'Innate:  Kennen\'s  abilities apply a  stack of Mark of the Storm to enemies hit.',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Kennen\'s abilities apply a stack of Mark of the Storm to enemies hit for 6 seconds, refreshing on subsequent applications and stacking up to 3 times.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kennen throws a shuriken in the target direction that deals magic damage to the first enemy hit.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Passive:  Kennen\'s basic attacks  on-attack generate a stack of Electrical Surge, which stacks up to a cap. At max stacks, his next basic attack consumes them all to deal bonus magic damage and apply a stack of  Mark of the Storm.',
      castTime: '0.25',
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kennen sends out a surge of electricity that deals magic damage to all nearby enemies afflicted by Mark of the Storm or within Slicing Maelstrom.</p>',
          leveling: [
            {
              attribute: 'Magic Damage',
              modifiers: [
    ...
    },
    {
      ...
      blurb:
        'Active:  Kennen becomes lightning, a  ghosted form that gains  bonus movement speed for a short time. He deals magic damage to enemies he passes through and restores  energy if he damaged an enemy at all. Lightning Rush can be recast within the duration and automatically recasts afterwards.',
      castTime: 'none',
      cooldown: '10 / 9 / 8 / 7 / 6',
      cost: '80',
      damageType: 'Magic damage',
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Kennen ends Lightning Rush to gain bonus attack speed and be allowed to exceed the attack speed cap by the amount gained for 4 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Kennen summons a storm that strikes at nearby enemy champions, dealing magic damage. Enemies take increased damage from each subsequent strike.',
      castTime: '0.25',
      cooldown: '120 / 100 / 80',
      cost: '0',
      damageType: 'Magic damage',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Kennen summons a storm around himself for 3 seconds, gaining bonus armor and bonus magic resistance for the duration.</p>',
          leveling: [
            {
