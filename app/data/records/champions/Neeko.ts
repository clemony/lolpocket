    ...
    "Q": [
      {
        ...
        "effects": [
          ...
          {
            "description": "Blooming Burst will cast at max range if cast beyond that."
          }
        ],
        "cost": [
          50,
