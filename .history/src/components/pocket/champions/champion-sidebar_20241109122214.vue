        ...
        <CardHeader class='flex flex-row'>
            <div class='relative w-fit'>
                ...
                <VTooltip theme="tt" placement="bottom"
                    class="group/glow glow absolute -bottom-[1px] -right-[5px] grid size-9 items-center justify-center rounded-full  transition-all duration-500 before: hover:rotate-180"
                    alt="view on Wiki">
