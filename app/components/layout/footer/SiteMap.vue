...
<template>
  <div
    :class="
      cn(
        'bg-b2 relative before:size-full before:bg-b2 z-1 before:absolute before:z-0 text-bc flex w-full items-center justify-center border-t border-t-b3/60 h-146 min-h-146 max-h-146 z-1',
        className,
      )
    ">
    <div
      class="flex size-full flex-wrap justify-evenly z-1 gap-x-10 gap-y-16 px-12 pt-36 pb-40 [&_h3]:drop-shadow-sm [&_li]:drop-shadow-sm">
