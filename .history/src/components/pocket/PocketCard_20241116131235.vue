    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <div
                ...
                class="duration-400 absolute rounded-box bg-[20%_-45%] bg-no-repeat transition-all animate-in animate-out fade-in-100 fade-out-0 [background-size:200%]">
                <InfoCard
        ...
        <Transition
            ...
            <Card
                v-if="flip"
                class="duration-400 absolute h-[350px] w-[250px] transition-all animate-in animate-out fade-in-100 fade-out-0">
                hi
            </Card>
        </Transition>
    </label>
