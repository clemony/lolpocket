    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-8 items-center'>
            <div class='relative w-fit'>
                <div class='join join-vertical rounded-lg border border-base-200 overflow-hidden'>
                    <div
                        class='size-[75px]  join-item border-base-300 border grid place-items-center  overflow-y-hidden'>
                        <loadImg
                    ...
                    <div class='join-item join join-horizontal overflow-hidden w-[75px] h-9 -mr-px'>
