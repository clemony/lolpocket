        ...
        <Card
            ...
            <CardContent
                ...
                <CardHeader class="px-4">
                    <CardTitle class="pb-0 !text-[1.3rem] font-semibold">
                        {{ pocket.name }}
                    </CardTitle>
                    <CardDescription>
                ...
                <div
                    class="max-w-inherit mt-2 grid w-full grid-cols-[3fr_1fr] gap-3">
                    <div
                    ...
                    <div class="relative col-start-1 size-full">
                        ...
                        <template v-if="set">
                            <template v-for="rune in runes">
                                <div
                                    class="flex flex-row flex-wrap items-center justify-center gap-2 px-2">
                                    <LoadImg
                                        v-if="rune.name != 'none'"
                                        :url="rune.img"
