  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Periodically, Maokai empowers his next basic attack to have an uncancellable windup and heal him for 4% - 12.8% (based on level) maximum health after a 0.25-second delay.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Maokai sends a shockwave in the target direction that deals magic damage and briefly  slows enemies hit.",
      castTime: "0.3",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Maokai sends a shockwave in the target direction that deals magic damage to enemies hit and slows them by 99% for 0.25 seconds. Bramble Smash deals bonus magic damage to monsters.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Maokai  dashes to the target enemy while being  untargetable, dealing magic damage and briefly  rooting them upon arrival.",
      castTime: "none",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Maokai dashes to the target enemy while being untargetable. Upon arrival, he deals magic damage and roots them for a duration.</p>',
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Maokai flings a Sapling to the target location, granting sight of the area.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            "Each bramble deals magic damage to enemies hit and roots them for 0.75 - 2.25 (based on distance traveled) seconds.",
          leveling: [
            {
              attribute: "Magic Damage",
              modifiers: [
