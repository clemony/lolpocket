...
<template>
    <div
        :class="
            cn(
                'join relative flex items-center gap-2 self-center rounded-md border border-base-200 focus-within:outline-none focus-within:ring-1 focus-within:ring-neutral/40 hover:ring-1 hover:ring-neutral/5',
                props.class
            )
        ">
        <Icon
        ...
        <input
            ...
            @input="handleInput"
            spellcheck="false"
            class="focus-target:!border-0 focus-target:!border-transparent focus-target:!outline-0 focus-target:!outline-offset-0 focus-target:!ring-0 peer join-item flex h-10 grow !border-0 bg-transparent text-md shadow-none placeholder:text-base-content/60 focus:!border-0 focus:!border-transparent focus:!outline-0 focus:!outline-offset-0 focus:!ring-0 disabled:cursor-not-allowed disabled:opacity-50"
