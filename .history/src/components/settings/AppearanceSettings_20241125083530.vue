            ...
            <DisplayCard
                ...
                <label
                    ...
                    <div
                        ...
                        <div
                            class="grid h-full w-full grid-cols-[1fr_2fr_2fr] rounded-btn">
                            ...
                            <div class="flex h-full w-full items-center p-3">
                                <div
                                    class="flex aspect-square items-center rounded-full bg-neutral p-3">
                                    <div class="text-neutral-content">Bb</div>
                                </div>
                            </div>
                        </div>
                    </div>
