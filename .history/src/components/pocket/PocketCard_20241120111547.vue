            ...
            <CardContent
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="col-start-1 -ml-1 grid justify-center">
                        ...
                        <div
                            class="col-start-1 mt-4 flex max-w-full flex-row overflow-visible">
                            <div class="flex w-28 justify-between">
                                <ShardSet :pocket="pocket" />
                            </div>
                        </div>
                        <div
                            class="col-start-2 flex items-end justify-end gap-2.5">
