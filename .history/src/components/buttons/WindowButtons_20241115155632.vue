...
const classObject = [
    'p-1 hover:stroke-[1.5]  [&_svg]:shrink-0 shadow-inner hover:[&_svg]:opacity-100 [&_svg]:opacity-0 hover:shadow-base-300 size-4.5 rounded-full border border-neutral/20',
]
</script>
<template>
    <div
