...
<div v-if="champion" class="flex-col w-full gap-6 max-w-inherit h-full pr-[3px]">
    ...
    <Card>
        ...
        <CardHeader class='flex flex-row gap-8 items-center relative'>
            ...
            <div class='join-item join join-horizontal overflow-hidden h-9 inset-0 mt-3 absolute top-3 right-2 w-28'>
                ...
                <a :href="champion.wiki" target="_blank" class='w-1/2  join-item rounded-t-none'>
                    <Button variant="outline" class="items-center justify-center join-item size-full  group">
                        <Icon icon="ph:link-simple"
                            class=" !size-9 duration-500 transition-all  group-hover:rotate-180" />
                    </Button>
                </a>
