export function getStatAtLevel(base?: number, growth?: number, level = 18): number | null {
...
export function getAttackSpeedAtLevel(base?: number, growth?: number, ratio?: number, level = 18): number | null {
