  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Ashe\'s basic attacks deal bonus physical damage equal to (75% + 40%) critical strike chance. Critical strikes do not deal any additional damage.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Frost Shot:</span> Ashe\'s basic attacks and ability hits apply Frost to enemies for 2 seconds, which slows them by 20% - 30% (based on level) for the duration.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate - Critical Slow:</span> Ashe\'s critical strikes double Frost\'s slow strength to 40% - 60% (based on level), decaying over the first second of the duration to its normal strength.</p>',
        },
      ],
      icon: 'https://cdn.communitydragon.org/latest/champion/Ashe/ability-icon/p',
      notes:
        'Ashe\'s critical strikes are still considered critical strike damage and thus will be reduced by  Randuin\'s Omen\'s Resilience.\n Runaan\'s Hurricane\'s will not deal additional damage on  critical strikes.\n Cheap Shot will trigger on a subsequent basic attack even when the target is no longer slowed.(note)',
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> While Ranger\'s Focus is inactive, Ashe\'s basic attacks on-attack generate a stack of Focus for 4 seconds, refreshing on subsequent attacks and stacking up to 4 times. Stacks expire by one every second when the duration ends.</p>',
        },
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> For 6 seconds, Ashe gains bonus attack speed and empowers her basic attacks to fire a flurry of five arrows that deal modified physical damage. The flurries apply life steal and Frost Shot per arrow, but apply on-hit effects only once.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ashe shoots a volley of arrows in a cone in the target direction, each dealing physical damage to the first enemy hit, and applying Critical Slow to enemy champions hit.</p>',
          leveling: [
            {
              attribute: 'Arrows',
              modifiers: [
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Ashe sends a hawk spirit to a location,  exposing the area along its path and a large area at its destination.',
      castTime: '0.25',
      cooldown: '5',
      cost: '0',
      effectRadius: '1000',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Ashe sends a hawk spirit to a location, granting sight of the area along its path[ repeatedly for 0.5 seconds after every 100 units traveled ][ for effectively up-to 1.8 seconds at any location ]and at its destination for 5 seconds.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Ashe launches a crystal arrow of ice that  stuns the first enemy champion hit, dealing magic damage. The arrow accelerates initially and its stun duration increases the farther the arrow has traveled.',
      castTime: '0.25',
      cooldown: '100 / 80 / 60',
      cost: '100',
