...
export const inputVariants = tv({
  base: 'focus-within:ring-n1/50 input border-b3 ring-offset-b1 [&>svg]:text-tint-bc/70 h-10 h-12 w-full items-center text-sm inset-shadow-xs inset-shadow-black/4 **:text-sm focus-within:ring-1 focus-within:outline-0 focus-within:outline-offset-0 [&>svg]:size-4.5 [&>svg]:**:stroke-[2.2]',
  ...
  variants: {
    ...
    variant: {
      ...variantVariants,
      header:
        'text-xxs **:text-xxs [&_input]:text-xxs shrink-0 font-bold tracking-tight [&_input]:font-bold [&_input]:tracking-tight',
...
export const inputGroupVariants = tv({
  base: cn(
    'group/input-group rounded-field ring-bc/60 relative flex w-full items-center border inset-shadow-xs transition-[color,box-shadow] transition-all duration-200 outline-none focus-within:ring',
