...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      blurb:
        "Active:  Skarner rips a boulder out of the ground, empowering his next three basic attacks with  bonus attack speed and bonus physical damage to the target and surrounding enemies. The final attack slams the boulder, dealing additional damage based on each target's maximum health and  slowing them.",
      castTime: "0.35",
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Skarner ends Shattered Earth by throwing his boulder in the target direction. It explodes upon colliding with the first enemy hit, applying the same damage and slow to the target and surrounding enemies as the final attack would.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: "Enemies",
      blurb:
        "Active:  Skarner slams his claws into the ground,  shielding himself based on his maximum health and releasing a shockwave that quickly expands in a radius around him to deal magic damage to enemies hit and briefly  slow them.",
      castTime: "0.3",
      cooldown: "10 / 9 / 8 / 7 / 6",
      cost: "60 / 65 / 70 / 75 / 80",
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Skarner slams his claws into the ground, shielding himself equal to 8% of his maximum health for 2.5 seconds and releasing a shockwave that quickly expands in a radius around him to deal magic damage to enemies hit and slow them by 20% for 1 second.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Skarner ends Ixtal\'s Impact. If a target has been grabbed, he detaches them from himself.</p>',
        },
        {
          description:
            "Ixtal's Impact ends immediately if Skarner becomes immobilized, grounded, or silenced during the charge, detaching the grabbed target. While the target is grabbed, they are attached to Skarner in a position that is directly in front of him.",
        },
      ],
