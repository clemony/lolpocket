...
<template>
    <div
        ...
        :class="
            cn(
                'bg-b1/90 text-bc flex h-full w-(--sidebar-width) flex-col overflow-hidden rounded-xl',
                props.class
            )
        "
        v-bind="$attrs">
    ...
    <Sheet
        ...
        <SheetContent
            ...
            data-mobile="true"
            class="bg-b1/90 text-bc w-(--sidebar-width) overflow-hidden rounded-xl p-0 [&>button]:hidden"
            :style="{
    ...
    <div
        ...
        <div
            ...
            <div
                data-sidebar="sidebar"
                class="group-data-[variant=floating]:border-b2 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm">
