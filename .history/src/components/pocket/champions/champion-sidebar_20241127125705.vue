...
<template>
    <div
        ...
        <Card class="relative">
            ...
            <CardHeader class="flex flex-row items-center gap-8">
                <div class="relative w-fit">
                    <div
                        class="join-item border-base-300 grid size-[70px] place-items-center overflow-y-hidden rounded-lg border">
                        <loadImg
                ...
                <div class="flex h-full w-full flex-col *:shrink-0">
                    ...
                    <p
                        class="mt-1 flex scale-y-[99%] place-items-center pt-0 pr-3 pb-1 pl-[10px] -indent-[11px] text-sm font-medium tracking-wide text-pretty uppercase">
                        @ {{ champion.title }}
                    </p>
                    ...
                    <div
                        ...
                        <code
                            ...
                            :key="index"
                            class="badge flex h-max w-auto flex-nowrap text-center font-mono text-sm font-medium tracking-normal lowercase"
                            :data-tag="tag">
                            #{{ tag }}
                        </code>
                    </div>
        ...
        <Card class="mt-8 overflow-hidden px-6 pt-0 pb-3">
            <!------------------------⟢ tablist ⟣------------------------->
...
.collapse-title {
    ...
    img {
        @apply border-neutral/40 -ml-1 size-9 rounded-full border;
    }
