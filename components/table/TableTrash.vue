...
<template>
 ...
 <div class="flex items-center gap-4 pl-14">
    <label class="toggle rounded-full  toggle-lg  peer items-center    absolute left-4 bg-b3 has-checked:!bg-b1  before:rounded-full  border-b3
    
    before:!bg-b1  has-checked:before:!bg-domination ">
  <input type="checkbox" v-model="isDeletable">
  ...
  <button  :disabled="ps.trashFolder.length == 0" @click="handleDelete()" class="flex gap-4 ml-16 items-center">
