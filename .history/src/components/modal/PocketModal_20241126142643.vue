...
<template>
    <div class="relative w-full justify-center py-2">
        <div ref="elForm" class="carousel w-full min-w-full">
            <form
                ref="form"
                class="carousel-item flex w-full min-w-full py-4 [&_label]:text-base"
                ...
                <div
                    ref="elIcon"
                    class="carousel-item grid w-[72%] justify-end">
                    <IconPicker
