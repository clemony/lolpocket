            ...
            <div class="flex w-1/2 flex-col gap-1">
                ...
                <div class="join relative">
                    ...
                    <Button
                        ...
                        type="button"
                        size="sm"
                        class="group join-item absolute right-0 top-0"
                ...
                <TagsInput v-model="tags" class="flex-col">
                    <div
                        class="flex w-full flex-row flex-wrap justify-start gap-2">
                    ...
                    <DropdownMenu class="w-1/2">
                        <DropdownMenuTrigger
                            ...
                            <Button variant="ghost" size="sm">
                                <span
                                    class="size-4 justify-start rounded border border-base-300"
                                    :style="{
                                        backgroundColor: bgColor,
                                    }"></span>
                                Backdrop
