    ...
    <label class="relative size-fit">
        ...
        <Transition
            ...
            <div
                ...
                <InfoCard
                    cardClass=" h-[350px] w-[250px]  bg-transparent backdrop-blur-none bg-gradient-to-b from-base-100/40 from-0% to-base-100 via-base-100/70  transition-all duration-500"
                    :class="{ 'to-0%': flip, 'to-30%': !flip }">
                    <template #header>
                        <h2
                            v-if="!flip"
                            class="mt-6 duration-100 animate-in fade-in-0 slide-in-from-bottom-3">
                            {{ pocket.name }}
                        </h2>
                    </template>
