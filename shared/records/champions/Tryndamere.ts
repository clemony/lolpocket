  ...
  abilities: [
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Innate:</span> Tryndamere generates 5 Fury on his basic attacks, and 10 Fury on critical strikes and each time he kills an enemy. After 8 seconds without dealing or taking damage, Tryndamere loses 5 Fury per second.</p>',
        },
        {
          description:
            'Tryndamere gains 0% - 50% (based on Fury) critical strike chance.',
        },
      ],
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Passive:</span> Tryndamere gains bonus attack damage, plus an additional amount based on his missing health.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Tryndamere consumes all of his Fury to heal himself, increased for every point of Fury consumed.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      affects: 'Enemies',
      blurb:
        'Active:  Tryndamere reduces the  attack damage of nearby champions for a few seconds. Targets facing away from him are also  slowed.',
      castTime: '0.3',
      cooldown: '14',
      cost: '0',
      effectRadius: '850',
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Tryndamere reduces the bonus attack damage of nearby enemy champions for 4 seconds.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Tryndamere dashes to the target location, dealing physical damage to enemies hit and generating 2 Fury per enemy hit, increased to 5 Fury against champions.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Tryndamere becomes enraged, instantly gaining Fury and a minimum health threshold for 5 seconds.</p>',
          leveling: [
            {
      ...
      maxCharges: -1,
      notes:
        'Undying Rage will prevent  Mel\'s  Overwhelm\'s stacks from being consumed.',
      targeting: 'Auto',
    },
  ],
