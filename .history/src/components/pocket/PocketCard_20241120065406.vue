...
<template>
    <label
        ...
        <Card
            class="swap-off relative h-[320px] w-[250px] max-w-[250px] overflow-hidden rounded-box bg-base-100/95">
            <div
                class="mask absolute top-0 h-[200px] w-full bg-[20%_-225%] bg-no-repeat mask-b-12 [background-size:200%]"
                :style="{
                    backgroundImage: champImage,
                }"></div>
            <CardContent
                class="max-w-inherit relative size-full bg-gradient-to-b from-base-100/40 from-0% via-base-100/70 via-15% to-base-100/0 to-30% pt-2">
