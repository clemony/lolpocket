...
export const tabListVariants = tv({
  base: "relative grid size-full h-9 w-full max-w-full auto-cols-auto grid-flow-col items-center overflow-hidden rounded-xl border border-b3/80 px-1 py-0.5 inset-shadow-xs inset-shadow-black/2 dark:bg-b2/60 light:bg-tint-b2/40",
  extend: baseVariants,
  variants: {
    defaultVariants: {
      hover: "none",
