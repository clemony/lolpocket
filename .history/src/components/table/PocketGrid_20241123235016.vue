...
[col-id='dateUpdated'] {
    ...
    & .ag-header-cell-label {
        @apply before:text-5xl relative -mt-4 h-full w-full rotate-[65deg] -scale-x-[1] overflow-auto pl-3 text-md font-bold leading-none -tracking-[1px] before:absolute before:top-2 before:-ml-1 before:-rotate-[180deg] before:-scale-x-[1] before:font-thin before:leading-none before:content-['⟳'];
    }
}
