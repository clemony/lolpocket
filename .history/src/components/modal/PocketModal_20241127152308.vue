...
<template>
    <div class="relative w-full justify-center py-2">
        <form
            class="carousel [&_label]:text-4 flex gap-8 py-4"
            ...
            <div
                ...
                <div class="join">
                    <Input
                        ...
                        class="join-item text-4 h-10 border-r-0" />
                ...
                <TagsInput v-model="tags" class="flex-col p-2">
                    <div
                        class="*:text-4 flex w-full flex-row flex-wrap justify-start gap-2">
                    ...
                    <DropdownMenu class="w-full">
                        <DropdownMenuTrigger
                            ...
                            <Button
                                variant="ghost"
                                size="sm"
                                class="text-4 w-full justify-start">
                                <span
