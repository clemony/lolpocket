            ...
            <div
                ...
                <label class="swap swap-flip relative backdrop-blur-md">
                    ...
                    <Card
                        ...
                        class="swap-on flex h-[260px] w-[210px] items-center justify-center bg-center [background-size:210px_260px]">
                        <div
                            class="join join-vertical shadow-sm [&_>*]:justify-start">
                            <Button
                                class="join-item pr-8 capitalize"
                                variant="outline"
                                @click="
