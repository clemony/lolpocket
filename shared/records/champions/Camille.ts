...
const champion: Champion = {
  ...
  abilities: [
    ...
    },
    {
      ...
      affects: 'Self',
      blurb:
        'Active:  Camille\'s next basic attack deals bonus physical damage and grants her  bonus movement speed.',
      castTime: 'none',
      cooldown: '9 / 8 / 7 / 6 / 5',
      cost: '25',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Camille empowers her next basic attack within 4 seconds to have an uncancellable windup, gain 50 bonus range, deal bonus physical damage and grant her bonus movement speed for 1 second.</p>',
          leveling: [
            {
        ...
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Recast:</span> Camille mimics the first cast\'s effects. If Precision Protocol is recast after 1.5 seconds of the first attack, then the bonus damage is doubled, and 40% - 100% (based on level) of the attack\'s total damage will be dealt as true damage.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Camille sweeps her leg in a cone in the target direction over 1.1 seconds, during which she is ghosted and unable to declare basic attacks. Afterwards, she deals physical damage to all enemies within.</p>',
          leveling: [
            {
    ...
    },
    {
      ...
      blurb:
        'Active:  Camille fires a grapple,  dashing onto any terrain she hits and briefly perching onto it.',
      castTime: 'none',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Camille fires a grapple in the target direction. If the grapple collides with terrain, Camille will dash toward and attach to the terrain for 0.75 seconds, during which she gains the ability to cast Wall Dive.</p>',
        },
        {
          description:
    ...
    },
    {
      ...
      blurb:
        'Active:  Camille  dives onto an enemy champion, creating a zone around the target and  knocking away all other enemies.',
      castTime: 'none',
      cooldown: '140 / 115 / 90',
      cost: '100',
      ...
      effects: [
        {
          description:
            '<p class="ability-effect"><span class="ability-header">Active:</span> Camille becomes untargetable and leaps with displacement immunity towards the target enemy champion over 0.5 seconds, revealing them for the duration and disrupting their ongoing channels.</p>',
        },
        {
          description:
