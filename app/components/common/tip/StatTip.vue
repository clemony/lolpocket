...
<template>
  <div
    class="field-box w-54 border border-b3 bg-b1/80 px-3.5 pt-4 pb-2 bg-blend-screen drop-shadow-none"
  >
    <div
      class="field-legend -ml-2 flex items-center gap-1! text-2 dst text-shadow-sm"
    >
      <hicon v-if="stat.icon" :name="stat.icon" class="size-3.5!" />
      {{ stat.name }}
    </div>
