...
<template>
  <Popover v-model:open="isOpen">
    ...
    >
      <!-- search input -->
      <div
        class="from-b1 absolute top-0 z-1 w-full overflow-hidden bg-linear-to-b from-4% to-transparent to-80% px-2 pt-2 pb-1.5"
      >
        <InputGroup
      ...
      <!-- tabs -->
      <div
        class="from-b1 absolute bottom-0 w-full bg-linear-to-t from-4% to-transparent to-80% px-2 pb-2"
      >
        <Tabs
        ...
        >
          ...
          >
            <TabsTrigger
              ...
              :key="i"
              class="group/btn disabled:**:text-bc/40 on:*:opacity-100 on:**:text-nc! h-7 w-full *:opacity-60 hover:*:opacity-100"
