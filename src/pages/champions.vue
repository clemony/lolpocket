              ...
              <div class="col-span-2 grid grid-cols-3 p-1 auto-cols-max gap-1">
                <div
                  ...
                  <div class="rounded-full  grid justify-content-center object-contain z-0 my-auto h-16 w-16">
                    ...
                    <div
                      class="absolute grid place-items-center tooltip tooltip-bottom rounded-full  size-7 -bottom-[5px] -right-[5px] glow cursor-pointer"
                      data-tip="view on Wiki">
                      <a :href="selectedChampion.wiki" target="_blank"
                        class="badge flex  bg-base-content text-base-100 size-[22px] border-none object-cover overflow-hidden p-[3px] aspect-square z-10 pointer-events-none ring-[3px] ring-base-100">
