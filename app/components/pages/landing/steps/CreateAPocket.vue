  ...
  >
    <div class="absolute size-full" :style="layer0">
      ...
      >
        ...
        >
          <p class="font-medium tracking-tight dst">New Pocket</p>
          ...
          <div
            class="absolute right-5 bottom-6 z-10 badge badge-neutral bg-b1 bg-neutral badge-md text-3 shadow-pretty ring shadow-black/10 ring-b3"
          >
            Create
          </div>
        </div>
