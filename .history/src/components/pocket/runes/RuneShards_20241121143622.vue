            ...
            <label
                ...
                <div
                    :class="
                        cn(
                            /* bg */
                            'bg-gradient-to-br from-base-100/70 to-base-200/40 backdrop-blur-sm',
                            /* border */
                            'border border-b-base-300 border-l-base-300/50 border-r-base-300 border-t-base-300/50',
