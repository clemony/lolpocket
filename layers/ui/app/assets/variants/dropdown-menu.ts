export default {
  dropdownMenu: {
    slots: {
      arrow: "fill-p0/90",
      content:
        "min-w-32 shadow-lg shadow-black/8 drop-shadow-sm drop-shadow-black/6 rounded-lg ring  overflow-hidden   origin-(--reka-dropdown-menu-content-transform-origin) flex flex-col select-none data-[state=open]:data-[side=bottom]:animate-shift-toward-bottom-enter data-[state=closed]:data-[side=bottom]:animate-shift-toward-bottom-exit data-[state=open]:data-[side=left]:animate-shift-toward-left-enter data-[state=closed]:data-[side=left]:animate-shift-toward-left-exit data-[state=open]:data-[side=right]:animate-shift-toward-right-enter data-[state=closed]:data-[side=right]:animate-shift-toward-right-exit",
      group: "p-1 isolate",
      ...
      viewport: "relative divide-y scroll-py-1 overflow-y-auto flex-1",
    },
    variants: {
      color: {
        neutral: "",
        default: {
          arrow: "fill-p0/90",
          content: "bg-transparent ring-p3/60",
          viewport: "divide-p2  backdrop-blur-md bg-p0/94",
          label: "text-n5/80",
        },
      },
      active: {
