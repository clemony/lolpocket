...
<template>
    <div v-if="props.pocket" class="grid grid-cols-[1fr_3fr] gap-2 p-2">
        <div class="grid items-center justify-around gap-1">
            <!-------------------⟢ champ ⟣-------------------->
                ...
                <div
                    v-if="
                        ...
                        pocket.runes[0].runeSets[pocket.runes[0].starred]
                            .keystone.name != 'none'
                    "
                    class="flex !aspect-square size-[40px] justify-center rounded drop-shadow-sm">
                    <img
                        :src="
                            pocket.runes[0].runeSets[pocket.runes[0].starred]
                                .keystone.img
        ...
        <div class="grid w-full grid-cols-3 items-center justify-around gap-1">
            <template v-if="pocket.items[0].itemSets[pocket.items[0].starred]">
                <template
                    ...
                    <img
                        ...
                        class="r size-[40px] shrink-0 rounded shadow-sm" />
                </template>
            </template>
