...
<template>
    <div class="carousel w-full justify-center py-2">
        <div ref="el-form" class="carousel-item w-full min-w-full">
            <form
                ref="form"
                class="grid w-full grid-cols-[4fr_1.5fr_2fr] gap-10 py-4 [&_label]:text-base"
            ...
            <div ref="el-icon" class="carousel-item w-full">
                <div>
                    <label class="">
